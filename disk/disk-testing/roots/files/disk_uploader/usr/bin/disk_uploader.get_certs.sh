...
SOURCE=("/repo/projects/ugc/media/certs/disk_uploader.*.jks" "${SECDIST_PATH}/${SERVICE}.*.crt" "${SECDIST_PATH}/${SERVICE}.*.key")
TARGET=("/etc/yandex/disk/uploader/keys/kladun-keystore.jks" "/etc/yandex/disk/uploader/keys/disk_uploader.crt" "/etc/yandex/disk/uploader/keys/disk_uploader.key")
