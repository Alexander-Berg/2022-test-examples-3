...
@Ignore
public class GroupServiceTransactionsExportServiceTest extends AbstractPsBillingCoreTest {
    @Autowired
    ...
    @Test
    public void exportDay() throws Exception {
        ...
        YtExportSettings settings = new YtExportSettings(true, YPath.simple("//home/disk-dev/dsamuylov/test-export"), helper);
        groupServiceTransactionsExportService.exportLast2Months(new YtOperationsGroupTransactionsImpl(settings, 671, () -> 1000), true);
    }
    ...
    public void testRemoveOldExports() {
        ...
        groupServiceTransactionsExportService.removeOldExports(new YtOperationsGroupTransactionsImpl(settings, 671, () -> 1000) {
            @Override
            public void removeExportFolder(String path) {
                System.out.println("called removed for " + path);
            }
        });
