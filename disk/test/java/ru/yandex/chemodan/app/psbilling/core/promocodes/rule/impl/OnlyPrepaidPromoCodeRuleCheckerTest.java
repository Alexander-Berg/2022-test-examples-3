...
public class OnlyPrepaidPromoCodeRuleCheckerTest extends PsBillingPromoCoreTest {
    ...
    public void setUp() throws Exception {
        ...
        this.checker = factory.onlyPrepaid();
    ...
    @Test
    public void testOnlyPostpaidHidden() {
        val product = psBillingProductsFactory.createGroupProduct(x -> x
                .paymentType(GroupPaymentType.POSTPAID)
                .hidden(true)
        );
