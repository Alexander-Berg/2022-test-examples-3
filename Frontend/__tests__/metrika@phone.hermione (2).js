    ...
    describe('Метрика', () => {
        ...
        describe('Главная страница', () => {
            ...
            it('Ввод поискового запроса', async function() {
                ...
                await browser.setValue('.Search-Input input', 'sunt');
        ...
        describe('Каталог', () => {
            ...
            it('Ввод поискового запроса', async function() {
                ...
                await browser.click('.Search-Input');
                await browser.setValue('.Search-Input input', 'пантолеты');
                await browser.click('.Search-Button');
            ...
            it('Отправка целей опечаточника', async function() {
                ...
                await browser.click('.Search-Input');
                await browser.setValue('.Search-Input input', 'сообрашения');
                await browser.click('.Search-Button');
            ...
            it('Отправка цели про пустые результаты поиска', async function() {
                ...
                await browser.click('.Search-Input');
                await browser.setValue('.Search-Input input', 'ese');
                await browser.click('.Search-Button');
            ...
            it('Отправка цели про повторный поиск', async function() {
                ...
                await browser.click('.Search-Input');
                await browser.setValue('.Search-Input input', 'esse');
                await browser.click('.Search-Button');
                ...
                await browser.yaWaitForVisible(
                    'a.CategoryList-Item[href*="category_id=11"]',
            ...
            it('Переход в товар', async function() {
                ...
                await browser.yaWaitMetrikaHitsLength('Второй хит не был отправлен', 53911873, 2);
                await browser.yaAssertLastMetrikaHit(53911873, ['https://spideradio.github.io/rnd/jy7b4qqsed', {
                    referer: 'https://yandex.ru',
                    title: await browser.getTitle(),
                    params: {
                        __ym,
