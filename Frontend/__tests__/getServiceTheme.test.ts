    ...
    [ETheme.LIGHT, ETheme.DARK, ETheme.SYSTEM].forEach((theme) => {
      const expectedServiceTheme = getServiceTheme({
        neo: {
          ...
          flags: {
            'yxneo_news_service-theme': theme,
          },
        },
      });
    ...
    [ETheme.LIGHT, ETheme.DARK, ETheme.SYSTEM].forEach((theme) => {
      const expectedServiceTheme = getServiceTheme({
        neo: {
          ...
          page: 'story',
          flags: {
            'yxneo_news_service-theme': ETheme.LIGHT,
            'yxneo_news_phone_story_service-theme': theme,
          },
        },
      });
    ...
    [ETheme.LIGHT, ETheme.DARK, ETheme.SYSTEM].forEach((theme) => {
      const expectedServiceTheme = getServiceTheme({
        neo: {
          ...
          flags: {
            'yxneo_news_service-theme': 'auto',
            'yxneo_news_service-theme-default': theme,
          },
        },
      });
