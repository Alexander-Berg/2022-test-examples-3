...
describe('Ecom-tap', function() {
    ...
    it('Отображается соответствующий текст если ничего не найдено', function() {
        return this.browser
            ...
            .yaWaitForVisibleWithinViewport('.EmptySearchResult')
            .yaShouldBeVisible('.EmptySearchResult', 'Текст "Ничего не найдено" не появился')
            .assertView('plain', '.EmptySearchResult');
    });
