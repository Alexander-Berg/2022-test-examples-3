...
export const tests: ITest[] = [
  {
    ...
    expected: [
      {
        name: 'yxneo_sport_desktop_story_flag',
        hashObject: { service: 'sport', platform: 'desktop', page: 'story' },
      },
      {
        name: 'yxneo_sport_phone_story_flag',
        hashObject: { service: 'sport', platform: 'phone', page: 'story' },
      },
    ],
    flagTemplate: {
      'yxneo_${EService.SPORT}_${EPlatform}_${EPage.STORY}_flag': {
