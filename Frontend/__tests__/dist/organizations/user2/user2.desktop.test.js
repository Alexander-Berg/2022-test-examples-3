...
const ctxs = [
    {
        ...
        name: 'Denis Smirnov',
        retpath: '//yandex.ru',
        organizationsUrl: 'https://api.directory.yandex.ru/v6/organizations-by-session',
        addOrganizationUrl: 'https://connect.yandex.ru/portal/registration?action=add',
        contextSwitchUrl: 'https://connect.yandex.ru/portal/context?mode=portal',
        hasPlus: true,
    },
    {
        uid: 226291201,
