describe('Cover', function() {
    it('Внешний вид шапки без логотипа', async function() {
        ...
        await browser.assertView('cover', ['.Cover-Content', '.Cover-Icons', '.Search']);
    });
    ...
    describe('Новая шапка', function() {
        it('Внешний вид шапки без логотипа', async function() {
            ...
            await browser.assertView('cover', ['.Cover-Content', '.Cover-Icons', '.Search'], { ignoreElements: ['.CategoryList'] });
        });
        ...
        it('Внешний вид минишапки без логотипа', async function() {
            ...
            await browser.assertView('cover', ['.Cover', '.Search'], { ignoreElements: ['.CategoryList'] });
        });
        ...
        it('Внешний вид на странице товара', async function() {
            ...
            await browser.yaShouldNotBeVisible('.Search', 'На карточке товара не должно быть поиска');
        ...
        it('Внешний вид поиска', async function() {
            ...
            await browser.setValue('.Search-Input input', 'Текст');

            await browser.assertView('search', ['.Search']);
        });
    });
