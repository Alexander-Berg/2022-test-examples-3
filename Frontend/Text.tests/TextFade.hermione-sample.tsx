...
import { Text, TextOverflowValue } from '../desktop/bundle';

import '../../internal/components/BPage/BPage@desktop.css';
import { paragraphText } from '../__examples__/assets';
...
render(
    <BPage>
        <Hermione>
            {(['fade', 'fade-horizontal'] as TextOverflowValue[]).map((overflow, idx) => (
