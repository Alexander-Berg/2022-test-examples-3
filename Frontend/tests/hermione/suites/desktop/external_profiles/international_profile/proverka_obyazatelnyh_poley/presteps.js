...
const { getInternationalProfile } = require('../internationalProfile');
...
// ./tests/hermione/suites/desktop/external_profiles/international_profile/proverka_obyazatelnyh_poley/presteps.js
const prestep = async() => {
    try {
