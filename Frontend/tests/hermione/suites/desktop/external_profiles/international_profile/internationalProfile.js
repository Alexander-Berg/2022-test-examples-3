...
const getInternationalProfile = async() => {
    try {
        // [manual] Ручками установить статусы в такое положение:
        ...
        // const offer1 = await makeNewInternationalOffer(offer.id, firstName + ' ' + lastName);
        ...
        // Хвост с языком, чтобы отдалось на английском
        return (link.replace('https://femida-ext.test.yandex-team.ru', '') + '?lang=en');
    } catch (e) {
