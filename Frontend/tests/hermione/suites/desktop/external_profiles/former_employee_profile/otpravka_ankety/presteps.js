...
const { getFormerEmployeeExternalProfile } = require('../formerEmployee');
...
// ./tests/hermione/suites/desktop/external_profiles/former_employee_profile/otpravka_ankety/presteps.js
const prestep = async() => {
    try {
        const link = await getFormerEmployeeExternalProfile();
