...
describe('Внешняя анкета / Новый сотрудник', function() {
    ...
    it('Проверка ошибок валидации', function() {
        ...
        return this.browser
            ...
            .setReactSFieldValue(PO.externalOfferForm.fieldNdaAccepted(), true, 'checkbox-confirmed')
            // - do: клик на кнопку 'Отправить'
            .click(PO.externalOfferForm.submit())
            .waitForVisible(PO.externalOfferForm.formError())
            .pause(2000) // scrolling
    ...
    it('Отправка анкеты', function() {
        ...
        return this.browser
            ...
            .setReactSFieldValue(PO.externalOfferForm.fieldBirthday(), '08.09.1986', 'date')
            ...
            .setReactSFieldValue(PO.externalOfferForm.fieldEducation(), 2, 'select')
            // - do: выбрать значение в поле 'Направление'
            .setReactSFieldValue(PO.externalOfferForm.fieldEducationSphere(), 2, 'select')
            // - do: заполнить поле 'Учебное заведение'
            .setReactSFieldValue(PO.externalOfferForm.fieldEducationInstitution(), 'Life', 'input')
            // - do: заполнить поле 'Дата окончания'
            .setReactSFieldValue(PO.externalOfferForm.fieldEducationEndDate(), '08.09.2006', 'input')
