...
const { getNewEmployeeExternalProfile } = require('../newEmployee');
...
// ./tests/hermione/suites/desktop/external_profiles/new_employee/proverka_obyazatelnyh_poley/presteps.js
const prestep = async() => {
    try {
        const link = await getNewEmployeeExternalProfile();
