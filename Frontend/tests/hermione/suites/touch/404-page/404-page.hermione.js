...
describe('Внутренняя страница 404', () => {
    describe('Страница 404', () => {
        ...
        it('Переход на главную страницу (ЕГЭ)', function() {
            return this.browser
                .yaWaitChangeUrl(() => this.browser.click(PO.HeadTabsTouch.LinkItemFirst()))
                .yaCheckPageUrl('/tutor/ege/', defaultCheckPageConf)
                .getText(PO.HeadTabsTouch.LinkItemActive())
        ...
        it('Переход на главную страницу (ОГЭ)', function() {
            return this.browser
                .yaWaitChangeUrl(() => this.browser.click(PO.HeadTabsTouch.LinkItemSecond()))
