...
describe('container', function() {
    ...
    it('can resolve static bundle', function() {
        ...
        expect(di('test')).to.be.not.undefined;
    });
    ...
    it('shouldn\'t mix params into dependencies map', function() {
        let di = createContainer({
            resolvers: [
                staticResolver({
                    Test: function(deps) {
        ...
        let map = di({ test: 'test' });

        expect(Object.keys(map)).to.eql(['test']);
    });
