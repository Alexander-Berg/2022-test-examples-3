...
describe('Создание новой OKR цели', function() {
    beforeEach(function() {
        return this.browser
            .loginToGoals()
            .preparePage('main-okr', '/')
            .waitForVisible(PO.content())
            .yaOpenCreateMenuAndClick(PO.header, 'newGoalOKRButton')
    ...
    it('Форма создает цель по всем данным формы', function() {
        return this.browser
            ...
            .yaSuggestChooseItem(
                ...
                'Test',
                'Тестовый Value stream / Test (57040)',
            )
