describe('Textinput', () => {
    const elements = {
        ...
        borderlesslInput: '[data-testid=clear-clear]',
    };

    it('has-clear', function() {
        return this.browser
            .url('Textinput/hermione/hermione.html?scenario=legacy')
    ...
    it('pins', function() {
        return this.browser
            .url('Textinput/hermione/hermione.html?scenario=pins')
            .assertView('plain', [elements.container])
            .click(elements.borderlesslInput)
