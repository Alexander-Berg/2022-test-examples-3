...
const PO = require('./OrgAfishaCinema.page-object')('desktop');
...
specs({
    ...
    it('Ссылки и счетчики', async function() {
        ...
        await this.browser.yaCheckLink2({
            ...
            baobab: {
                path: '/$page/$parallel/$result/composite/tabs/about/afisha_cinema/title',
            },
        });
        ...
        await this.browser.yaCheckLink2({
            ...
            baobab: {
                path: '/$page/$parallel/$result/composite/tabs/about/afisha_cinema/scroller/companies-discovery-movie/companies-discovery-card/item',
            },
        });
        ...
        await this.browser.yaCheckLink2({
            ...
            baobab: {
                path: '/$page/$parallel/$result/composite/tabs/about/afisha_cinema/scroller/more',
            },
        });
    });
});
