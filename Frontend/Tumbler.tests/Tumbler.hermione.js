describe('Tumbler', () => {
    ...
    it('dynamic-both-label', function() {
        return this.browser
            .url('Tumbler/hermione/hermione.html?scenario=default')
    ...
    it('should render correctly with long label', function() {
        return this.browser
            .url('Tumbler/hermione/hermione.html?scenario=long-label')
