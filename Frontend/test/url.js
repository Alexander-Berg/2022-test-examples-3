...
let url1 = 'http://m.auto.yandex.ru:80/mini/cooper/9383453/offers?body_type=HATCHBACK';
let url2 = 'http://beta.yandex.com.tr/';
let url3 = 'https://mail.yandex.ru/';
let url4 = 'http://m.yandex.ru';
...
let httpsUrl = new Url({
    url: url3,
    routers: {
        desktop: require('./lib/routes/desktop'),
    },
});
let noMobileRoutesUrl = new Url({
    url: url4,
    routers: {
        desktop: require('./lib/routes/desktop'),
    },
