...
describe('ResourceResponseProcessorMixin', function() {
    var app = require('../app'),
        ...
        ResourceResponseProcessorMixin = app.ResourceResponseProcessorMixin,
        ResourceResponseProcessorError = ResourceResponseProcessorMixin.ResourceResponseProcessorError,
        createMockParams = require('./mocks/controller_params'),
        resourceName = 'resource-name',
        ProvidersError = require('nodules-controllers').ProvidersMixin.ProvidersError;
    ...
    describe('method', function() {
        var TestController = Controller
            ...
            testController,
            specificClientErrorHandlerResult = { data: 'OK' };
        ...
        describe('#processClientError()', function() {
            ...
            it('should return result of #processSpecificClientError() if not undefined', function() {
                var error = { code: 'SOME_CLIENT_ERROR_2' },
        ...
        describe('#logUnexpectedResponseError()', function() {
            ...
            it('should not log already logged error', function() {
                var error = Terror.createError('err').log();
                var logger = error.log = sinon.spy();
            ...
            it('should log unlogged terror', function() {
                var error = Terror.createError('err');
        ...
        describe('#callResource()', function() {
            var resourceMock = require('./mocks/resource'),
                resource;
            ...
            it('should call processResponse after resource execution', function(done) {
                var processResponse = sinon.spy(testController, 'processResponse');
            ...
            it('should process resource rejection errors with `#processResponseError`', function(done) {
                var resourceError = new Error(),
                    processResponseError = sinon.spy(testController, 'processResponseError');
