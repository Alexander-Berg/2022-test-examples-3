    ...
    describe('methods', function() {
        ...
        describe('"after" chain member', function() {
            ...
            it('should wrap all errors, except GateError and GateError inheritors into GateError.UNEXPECTED_ERROR',
                function(done) {
                    var MyGateError = GateError.create('MyGateError', { TEST_ERROR: [ 1337, 'Special test error' ] }),
                ...
                function(done) {
                    ...
                    disableDebugOutput(new MyGate(createMockParams()))
                        ...
                        .then(function(r) {
                            ...
                            assert.strictEqual(_r.error.message,
                                GateError.createError(GateError.CODES.UNEXPECTED_ERROR).bind({ type: '' }).message);
            ...
            function checkResponseWithError(referenceError, bindParams, ErrorCtor) {
                ...
                return function(r, debug) {
                    ...
                    assert.strictEqual(r.error.codeName, ErrorCtor.CODE_NAMES[referenceError]);
                    if (bindParams) {
                        assert.strictEqual(
                            r.error.message,
