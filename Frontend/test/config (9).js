    ...
    describe('method', function() {
        ...
        describe('.setServantHandle()', function() {
            it('should set handle with default host and port if only handle name was passed', function() {
                var defaultHost = 'some.host.com',
                    defaultPort = 1234,
                    handleName = 'some-backend-handle';
            ...
            it('should pass to servant other params', function() {
                var httpsHandle = { handle: 'https-handle',  port: 443, protocol: 'https:', ca: './MyInternalCa.pem' };
        ...
        describe('servant-setter', function() {
            var backendHandles = [ 'handle1', 'handle2', { handle: 'non-standard-handle', port: 1234 } ],
                setServantHandle;
