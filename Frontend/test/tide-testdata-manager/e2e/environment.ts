...
function restoreEnvironment(): void {
    ...
    mfs.restore();
    delete require.cache[path.resolve('test/tide-testdata-manager/fixtures/events.js')];
    delete require.cache[path.resolve('test/tide-testdata-manager/fixtures/tide-spy-plugin.js')];
