...
describe('ProvidersMixin', function() {
    ...
    describe('Mixin', function() {
        it('should be mixed properly using `Controller.mixin()`', function() {
            assert.mixedProperly(TestController, ProvidersMixin, 'ProvidersMixin',
    ...
    describe('.blocks and .providers relationship', function() {
        var BLOCKS = {
            ...
            ACTION_NAME = 'action1',
            BLOCKS_WITH_ACTION = [ 'paranja', 'spinner' ],
            BLOCKS_WITH_ACTION_PROVIDERS = [ 'opacity', 'speed', 'direction-left' ];
        ...
        describe('.getProvidersForBlocks()', function() {
            ...
            it('should return providers for blocks with required action', function() {
                assert.sameMembers(
                    TestController.getProvidersForBlocks(BLOCKS_WITH_ACTION, ACTION_NAME),
                    BLOCKS_WITH_ACTION_PROVIDERS
                );
            });
