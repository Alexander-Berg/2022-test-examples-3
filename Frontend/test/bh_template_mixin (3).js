...
describe('CoreBhTemplateMixin', function() {
    var app = require('../app'),
        ...
        CoreBhTemplateMixin = app.BhTemplateMixin,
        createMockParams = require('./mocks/controller_params'),
        createMockUser = require('./mocks/user'),
        bhBundlePath = path.resolve(__dirname, 'mocks/bh');
    ...
    describe('method', function() {
        ...
        describe('#getHTML()', function() {
            ...
            it('should return html of block', function() {
                var html = testController.getHTML('lalala', {});
