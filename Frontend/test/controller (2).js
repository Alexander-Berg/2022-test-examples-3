...
describe('CoreController', function() {
    ...
    describe('method', function() {
        let CoreControllerError = CoreController.CoreControllerError;
        let coreController;
        ...
        describe('#isRedirectError()', function() {
            ...
            it('should return false if error code is not REDIRECT', function() {
                let error = CoreControllerError.createError('SOME_CODE');
        ...
        describe('#getCurrentRouteName()', function() {
            let routeName = 'fasdfasdf';
            let getName = sinon.stub().returns(routeName);
