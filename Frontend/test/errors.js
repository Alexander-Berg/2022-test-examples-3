            ...
            .fail(function(e) {
                ...
                assert.strictEqual(
                    ...
                    'Invalid XML <simple> ' +
                        ...
                        '\nLine: 0' +
                        '\nColumn: 23' +
                        '\nChar: > 127.0.0.1:' + server.port + '/test: ' + INVALID_XML,
                );
    ...
    'errors: invalid json in mandatory resource': httpTest(function(done, server) {
        ...
        return resource('simple', null, { port: server.port, isMandatory: true })
            .fail(function(e) {
                ...
                assert.strictEqual(
                    e.message,
                    'Invalid JSON <simple> SyntaxError: Unexpected token < 127.0.0.1:' +
        ...
        return resource('unexpected-result', null, { isMandatory: true })
            .fail(function(e) {
                ...
                assert.strictEqual(e.message,
                    'Unexpected result <unexpected-result> {\"some\":\"trololo\"} example.com');
    ...
    'errors: invalid-arguments in mandatory resource': function(done) {
        return resource('invalid-arguments', null, { isMandatory: true })
            .fail(function(e) {
                ...
                assert.strictEqual(e.message, 'Invalid method arguments <invalid-arguments> example.com');
