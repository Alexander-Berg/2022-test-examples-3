...
describe('Notifications', function() {
    ...
    let NotificationsError = Notifications.NotificationsError;
    let createMockParams = require('./mocks/controller_params');
    let notifications;

    it('should create new instance properly', function() {
        let notificationsCookie = { someparam: 'someval' };
        let reqRes = createMockParams({
            req: {
                cookies: {
    ...
    describe('method', function() {
        ...
        let FIRST_TANKER_KEY = 'FIRST_TANKER_KEY';
        let SECOND_TANKER_KEY = 'SECOND_TANKER_KEY';
        ...
        describe('#get()', function() {
            ...
            it('should return an empty array if passed place doesn’t exist', function() {
                let notificationsCookie = notifications.get('local');
        ...
        describe('#parseCookie()', function() {
            ...
            it('should set _dataInvalid if cookie is invalid and log an error', function() {
                let logger = NotificationsError.prototype.logger;
        ...
        describe('#getData()', function() {
            it('should return copy of its’s own _data property', function() {
                let gottenData = notifications.getData();
