/* global describe, it, CodeMap, CodeEntry */
...
describe('CodeMap', function() {
  it('should find 64-bit dynamic JS code address', function() {
    ...
    codeMap.addLibrary(libAddress, new CodeEntry(0x1000, 'lib', 'CPP'));
    ...
    codeMap.addCode(jsAddress, new CodeEntry(0x1000, 'myScript', 'JS'));
