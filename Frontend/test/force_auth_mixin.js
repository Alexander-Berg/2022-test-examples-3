...
describe('ForceAuthMixin', function() {
    ...
    let CoreControllerError = Controller.CoreControllerError;
    let ForceAuthMixin = app.ForceAuthMixin;
    ...
    describe('Mixin', function() {
        ...
        it('should add checkAuth function to before chain', function() {
            ...
            let before = TestController.prototype._beforeChain;
    ...
    describe('method', function() {
        let TestController = Controller
            ...
            .mixin(ForceAuthMixin);
        let testController;
        let PASSPORT_BASE = 'https://passport.yandex';
        let CURRENT_URL = 'http://wmfront.yandex.ru/app-core';
        ...
        describe('#getPassportHost()', function() {
            ...
            tlds.forEach(function(tld) {
                let zoneTestController = new TestController(createMockParams({
                    req: {
                        urlHelper: new Url({
