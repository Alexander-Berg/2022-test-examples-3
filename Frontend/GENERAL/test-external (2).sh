...
tmp_dir=`mktemp -d -t "tap-ecom-mocks-api.XXXXXXXX"`
...
git clone git@github.com:yandex/tap-ecom-mocks-api.git $repo_dir
...
package_file="yandex-tap-ecom-mocks-api-${version}.tgz"
