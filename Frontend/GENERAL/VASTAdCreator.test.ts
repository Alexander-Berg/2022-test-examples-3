...
import { VASTAdCreator } from './VASTAdCreator';

describe('VASTAdCreator', () => {
    it('should create correct VAST Ad', () => {
        const ad = {
            settings: {
                '2': {
                    linkTail: 'linkTail',
                    viewNotices: ['viewNotice1', 'viewNotice2', '${FALSE_CLICK_URL}'],
                },
            },
            dc_params: {
                data_params: {
        ...
        const expectedVast = normalizeVast(`
            ...
            <Ad id="a34sdf" sequence="2">
                <InLine>
                    ...
                    <Impression id="view_notice_pixel"><![CDATA[bs_data.count_links.falseClick]]></Impression>
                    ...
                    <Extensions>
                        ...
                        <Extension type="adoffsetdata">
                            <AdOffset>AdOffsetString</AdOffset>
                        </Extension>
                    </Extensions>
                </InLine>
            </Ad>
        `);
        const vastAdCreator = new VASTAdCreator(ad, { sequence: 2, adOffset: 'AdOffsetString' });
        ...
        const resultVast = normalizeVast(vastXMLString);
