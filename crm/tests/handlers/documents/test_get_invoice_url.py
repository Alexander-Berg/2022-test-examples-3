...
URL = '/api/agencies/1/documents/invoices/1/download_url'


async def test_get_invoice_url(
    ...
    service_discovery.documents.get_invoice_url.return_value = return_value
