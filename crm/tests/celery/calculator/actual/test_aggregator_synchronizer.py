...
from crm.agency_cabinet.rewards.server.src.celery.tasks.calculator.actual.aggregator.synchronizer import \
    AggregatorBusinessActualDataSynchronizer
...
async def test_add_calculator_data_business(contract_aggregator):
    await AggregatorBusinessActualDataSynchronizer().process_data(
        [
