...
const method = require('./create_reply_later.js');
...
test('вызывает do-reply-later-create', async () => {
    core.params = { mid: '1', date: 42, ensureFolder: true, uuid: 'deadbeef' };
    core.request.mockResolvedValueOnce({});

    await method.call(core);

    expect(core.request).toHaveBeenCalledWith('do-reply-later-create', {
        mid: '1',
        date: 42,
        ensureFolder: true
    });
