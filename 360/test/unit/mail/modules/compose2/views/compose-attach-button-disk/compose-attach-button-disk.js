describe('Daria.vComposeAttachButtonDisk', function() {
    beforeEach(function() {
        this.view = ns.View.create('compose-attach-button-disk');
    });

    var MIXIN_NAME = 'compose-attach-open-disk-mixin';

    it('Параметры вида должны быть такими же, как и у vCompose2', function() {
        expect(ns.View.info('compose-attach-button-disk').params).to.be.equal(ns.View.info('compose2').params);
    });
