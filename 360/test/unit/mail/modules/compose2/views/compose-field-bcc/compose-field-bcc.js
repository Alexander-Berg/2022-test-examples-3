describe('Daria.vComposeFieldBcc', function() {
    beforeEach(function() {
        this.view = ns.View.create('compose-field-bcc');
    ...
    describe('FIELD_NAME', function() {
        it('Должен быть `bcc`', function() {
            expect(Object.getPrototypeOf(this.view).FIELD_NAME).to.be.equal('bcc');
        });
