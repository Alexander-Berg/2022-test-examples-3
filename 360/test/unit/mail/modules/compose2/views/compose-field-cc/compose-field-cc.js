describe('Daria.vComposeFieldCc', function() {
    beforeEach(function() {
        this.view = ns.View.create('compose-field-cc');
    ...
    describe('FIELD_NAME', function() {
        it('Должен быть `cc`', function() {
            expect(Object.getPrototypeOf(this.view).FIELD_NAME).to.be.equal('cc');
        });
