...
describe('router: new route parsing method', function() {
    ...
    describe('parameter validation', function() {
        ...
        for (var i = 0; i < _tests.length; i++) {
            (function(test) {
                var name = String(test.value) + ' (' + typeof (test.value) + ') ' + (test.result ? 'is' : 'is not') + ' ' + test.type;
                it(name, function() {
    ...
    describe('parse section', function() {
        var _tests = {
            ...
            'prefix-{param:int}': {
                is_optional: false,
                items: [ { default_value: 'prefix-' }, { name: 'param', type: 'int', default_value: undefined, is_optional: false, is_filter: false, filter_value: undefined } ]
            },
