describe('ns.View bind events', function() {
    beforeEach(function() {
        ...
        this.sinon.stub(this.view._$window, 'on').callsFake(no.nop);
        this.sinon.stub(this.view._$window, 'off').callsFake(no.nop);

        this.sinon.stub(this.view._$document, 'on').callsFake(no.nop);
        this.sinon.stub(this.view._$document, 'off').callsFake(no.nop);

        this.sinon.stub(this.view.$node, 'on').callsFake(no.nop);
        this.sinon.stub(this.view.$node, 'off').callsFake(no.nop);
        ...
        this.sinon.stub(this.view.$node, 'find').callsFake(function() {
            return {
                on: that.findOnSpy,
                off: that.findOffSpy
            };
