describe('ns.page.history', function() {
    ...
    describe('.replace', function() {
        ...
        it('пустая история - меняется только текущий урл', function() {
            this.sinon.stub(ns.page.history, '_current').value(this.url1);
        ...
        it('в истории 1 урл - меняется только текущий урл', function() {
            this.sinon.stub(ns.page.history, '_current').value(this.url2);
            this.sinon.stub(ns.page.history, '_history').value([
                this.url1
            ]);
        ...
        it('в истории 2 урла - меняется только текущий урл', function() {
            this.sinon.stub(ns.page.history, '_current').value(this.url3);
            this.sinon.stub(ns.page.history, '_history').value([
                this.url1,
                this.url2
            ]);
