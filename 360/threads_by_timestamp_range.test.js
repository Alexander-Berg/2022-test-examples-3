...
const method = require('./threads_by_timestamp_range');
...
beforeEach(() => {
    ...
    core = {
        ...
        service: jest.fn((service) => service === 'taksa' ? mockTaksa : mockMeta),
        request: jest.fn(() => filteredLabelsMock),
        console: {
            error: jest.fn()
        },
        yasm: {
...
describe('одиночный запрос', () => {
    ...
    it('happy path', async () => {
        ...
        mockMeta.mockResolvedValueOnce(threadsByFolderMock);
