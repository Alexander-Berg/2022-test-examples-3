const updateTodoList = require('../do-update-todo-list');

describe('models:todo -> do-update-todo-list', () => {
  let coreMock;
  let serviceFn;
  let todoFn;
  ...
  test('должен ходить в ручку todo с нужными параметрами', () => {
    ...
    updateTodoList(params, coreMock);

    expect(todoFn).toHaveBeenCalledTimes(1);
    expect(todoFn).toHaveBeenCalledWith(`/update-todo-list`, params);
  });
});
