import { DefaultFileSystemPath } from '../../src/default-file-system-path'

describe.skip(DefaultFileSystemPath, () => {
  const path = new DefaultFileSystemPath()
  ...
  it('should return parsed path', () => {
    expect(path.parse('/foo/bar.txt//')).toStrictEqual({ dir: '/foo', base: 'bar.txt', ext: '.txt', name: 'bar' })
    expect(path.parse('/foo/bar.txt/')).toStrictEqual({ dir: '/foo', base: 'bar.txt', ext: '.txt', name: 'bar' })
    expect(path.parse('/foo/bar.txt')).toStrictEqual({ dir: '/foo', base: 'bar.txt', ext: '.txt', name: 'bar' })
    expect(path.parse('bar.txt//')).toStrictEqual({ dir: '.', base: 'bar.txt', ext: '.txt', name: 'bar' })
    expect(path.parse('bar.txt/')).toStrictEqual({ dir: '.', base: 'bar.txt', ext: '.txt', name: 'bar' })
    expect(path.parse('bar.txt')).toStrictEqual({ dir: '.', base: 'bar.txt', ext: '.txt', name: 'bar' })
    expect(path.parse('/foo/.bar.txt')).toStrictEqual({ dir: '/foo', base: '.bar.txt', ext: '.txt', name: '.bar' })
    expect(path.parse('/foo/.bar')).toStrictEqual({ dir: '/foo', base: '.bar', ext: '', name: '.bar' })
    expect(path.parse('/foo/bar')).toStrictEqual({ dir: '/foo', base: 'bar', ext: '', name: 'bar' })
    expect(path.parse('/foo/bar.')).toStrictEqual({ dir: '/foo', base: 'bar.', ext: '.', name: 'bar' })
  })
})
