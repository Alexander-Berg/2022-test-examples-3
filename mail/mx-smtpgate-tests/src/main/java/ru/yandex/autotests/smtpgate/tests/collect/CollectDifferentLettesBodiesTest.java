...
@Feature("COLLECT")
@Aqua.Test
@Title("CollectDifferentLettesBodiesTest. Поверка передачи содержимого письма через COLLECT")
...
public class CollectDifferentLettesBodiesTest {
    ...
    public void shouldSeeLetterBodyDelivery() throws Exception {
        assertThat("Неверный ответ Collect-запроса!", response, allOf(hasStatusCode(OK_200),
        ...
        assertThat("В результате Collect-запроса тело письма доставилось некорректно!",
