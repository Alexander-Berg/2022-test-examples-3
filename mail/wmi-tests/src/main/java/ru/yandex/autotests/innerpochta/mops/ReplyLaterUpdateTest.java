...
@Aqua.Test
@Title("[MOPS] Переустановка времени reply_later-стикера до поднятия")
...
public class ReplyLaterUpdateTest extends MopsBaseTest {
    ...
    @Test
    @Title("Проверяем update стикера без uid'а")
    ...
    @Test
    @Title("Проверяем update стикера без даты")
    ...
    @Test
    @Title("Проверяем update стикера с некорректной датой")
    ...
    @Test
    @Title("Проверяем update стикера без мида")
    ...
    @Test
    @Title("Проверяем update стикера с несуществующим mid'ом")
    ...
    @Test
    @Title("Проверяем update стикера с некорректным mid'ом")
    ...
    @Test
    @Title("Создаём стикер, изменяем дату, ждем поднятия")
    ...
    @Test
    @Title("Создаём стикер, изменяем дату, проверяем корректность измененной даты")
