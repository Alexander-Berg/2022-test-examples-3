...
class TestWebUi:
    ...
    def test_update_service_tvm_apps_admin_success(self):
        ...
        resp, result = xiva_webui_api.service_update(
            ...
            {"owner": "abc-service", "owner_type": "abc"},
            {
                ...
                "tvm_publishers": {
                    "sandbox": [{"id": 12345, "name": "unknown", "suspended": True}]
                },
            },
        )
        assert_ok(resp)
    ...
    def test_update_service_tvm_apps_not_admin_fails(self):
        ...
        assert_bad_request(resp, '{"error":"must be admin to edit tvm_publishers field"}')
        assert_equal(self.xconf_server.total_requests, 0)

    def test_update_service_tvm_apps_missed_success(self):
        self.auth_one_user(400)
        self.auth_services("abc-service")
        self.set_xconf_responses(
            [packb([0, []]), "0"],
    ...
    def test_update_service_tvm_apps_cant_change_name(self):
        self.auth_one_user(400)
        self.auth_services("abc-service")
        self.set_xconf_responses(
            [packb([0, []]), "0"],
        ...
        resp, result = xiva_webui_api.service_update(
            ...
            {"owner": "abc-service", "owner_type": "abc"},
            {
                ...
                "queued_delivery_by_default": True,
                "tvm_publishers": {
                    "sandbox": [{"id": 12345, "name": "newname", "suspended": False}]
                },
            },
        )
        assert_ok(resp)
    ...
    def test_update_service_tvm_apps_cant_add_app(self):
        self.auth_one_user(400)
        self.auth_services("abc-service")
        self.set_xconf_responses(
            [packb([0, []]), "0"],
        ...
        resp, result = xiva_webui_api.service_update(
            ...
            {"owner": "abc-service", "owner_type": "abc"},
            {
                ...
                "tvm_publishers": {
                    "sandbox": [
                        {"id": 12345, "name": "unknown", "suspended": False},
                        {"id": 67890, "name": "newapp", "suspended": False},
                    ]
                },
            },
        )
