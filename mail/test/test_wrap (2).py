...
test_path = yatest.common.source_path('mail/nodejs/js/langdetect/test')
data_path = yatest.common.source_path('mail/nodejs/js/langdetect/test/lang_detect_data.txt')
