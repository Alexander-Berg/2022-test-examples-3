...
public class IexProxyAlfaEmcRefundTest extends TestBase {
    ...
    @Test
    public void testAxisStoreAlfaEmc() throws Exception {
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_alfa_emc.json").
    ...
    @Test
    public void testAxisStoreAlfaEmcArnOnly() throws Exception {
        final String cfg = "extrasettings.axis-facts = refund_fbl\n"
            + "entities_rcpt_uid.1120000000002254 = refund_fbl\n"
            + "postprocess_rcpt_uid.1120000000002254 ="
                + "refund_fbl:http://localhost:" + IexProxyCluster.IPORT
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_alfa_emc_only_arn.json").
                        toURI()), ContentType.APPLICATION_JSON);
    ...
    @Test
    public void testAxisStoreAlfaEmcWithoutAmount() throws Exception {
        final String cfg = "extrasettings.axis-facts = refund_fbl\n"
            + "entities_rcpt_uid.1120000000002254 = refund_fbl\n"
            + "postprocess_rcpt_uid.1120000000002254 ="
                + "refund_fbl:http://localhost:" + IexProxyCluster.IPORT
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_alfa_emc_without_amount.json").
                        toURI()), ContentType.APPLICATION_JSON);
