...
public class IexProxyOnlyAttachRefundTest extends TestBase {
    ...
    @Test
    public void testAxisStoreOnlyAttach() throws Exception {
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_refund_empty.json").
