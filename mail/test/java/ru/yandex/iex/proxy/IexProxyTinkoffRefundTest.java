...
public class IexProxyTinkoffRefundTest extends TestBase {
    ...
    @Test
    public void testAxisStoreTinkoffDispute() throws Exception {
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            cluster.corpFilterSearch().add(
                ...
                IexProxyTestMocks.filterSearchPgResponse(
                    mid, stid, "", "dispute", "dispute", "tinkoff.ru", "Tinkoff dispute subject"));

            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_tinkoff_dispute.json").
    ...
    @Test
    public void testAxisStoreTinkoffAcqMonitoring() throws Exception {
        final String cfg = "extrasettings.axis-facts = refund_fbl\n"
            + "entities_rcpt_uid.1120000000002254 = refund_fbl\n"
            + "postprocess_rcpt_uid.1120000000002254 ="
                + "refund_fbl:http://localhost:" + IexProxyCluster.IPORT
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_tinkoff_acq_monitoring.json").
                        toURI()), ContentType.APPLICATION_JSON);
    ...
    @Test
    public void testAxisStoreTinkoffAcqMonitoringWithSpaces() throws Exception {
        final String cfg = "extrasettings.axis-facts = refund_fbl\n"
            + "entities_rcpt_uid.1120000000002254 = refund_fbl\n"
            + "postprocess_rcpt_uid.1120000000002254 ="
                + "refund_fbl:http://localhost:" + IexProxyCluster.IPORT
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(
                    getClass().getResource("coke_tinkoff_acq_monitoring_with_spaces.json").
                        toURI()), ContentType.APPLICATION_JSON);
