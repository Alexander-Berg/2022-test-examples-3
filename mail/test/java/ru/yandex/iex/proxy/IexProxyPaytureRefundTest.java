...
public class IexProxyPaytureRefundTest extends TestBase {
    ...
    @Test
    public void testAxisStorePaytureNextHopEmpty() throws Exception {
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(getClass().getResource("coke_payture_one_row.json").
