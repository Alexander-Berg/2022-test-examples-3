...
public class IexProxyCardpayRefundTest extends TestBase {
    ...
    @Test
    public void testAxisStoreCardpayOneRow() throws Exception {
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity cokeJson = new FileEntity(
                new File(getClass().getResource("coke_cardpay_one_row.json").
