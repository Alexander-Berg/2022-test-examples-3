...
public class IexProxyMediaTest extends TestBase {
    ...
    private static final String COMBO_MAIL = "combo_mail";

    @Test
    public void testAxisStoreComboMail() throws Exception {
        final String cfg = "extrasettings.axis-facts = combo_mail\n"
            + "postprocess_domain.gmail$com ="
                + "combo_mail:http://localhost:" + IexProxyCluster.IPORT
                + "/combo_mail\n";
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity tikaiteJson = new FileEntity(
                new File(getClass().getResource("./media/tikaite_response_orders_combo_mail.json").
                    toURI()), ContentType.APPLICATION_JSON);
            cluster.tikaite().add(
                MAIL_HANDLER + '*',
            ...
            FileEntity mediaNewSub = new FileEntity(
                new File(getClass().getResource("media/new_sub.json").
                    toURI()), ContentType.APPLICATION_JSON);
            //FileEntity mediaFiscalCombo = new FileEntity(
            //    new File(getClass().getResource("media/fiscal_combo.json").
            //        toURI()), ContentType.APPLICATION_JSON);

            cluster.media().add(
                "/*",
                new StaticHttpItem(HttpStatus.SC_OK, mediaNewSub));

            LinkedHashMap<String, Object> mediaResponse = new LinkedHashMap<>();
            mediaResponse.put("entity", COMBO_MAIL);

            cluster.axis().add(
                AXIS_URI,
                new AxisVerifier(UID_VALUE, MAIL)
                    .add(COMBO_MAIL, mediaResponse));
            HttpAssert.assertStatusCode(HttpStatus.SC_OK, client, post);
        }
    }

    @Test
    public void testAxisStoreComboMailFiscal() throws Exception {
        final String cfg = "extrasettings.axis-facts = combo_mail\n"
            + "postprocess_domain.gmail$com ="
                + "combo_mail:http://localhost:" + IexProxyCluster.IPORT
                + "/combo_mail\n";
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity tikaiteJson = new FileEntity(
                new File(getClass().getResource("./media/tikaite_response.json").
                    toURI()), ContentType.APPLICATION_JSON);
            cluster.tikaite().add(
                MAIL_HANDLER + '*',
                new StaticHttpItem(HttpStatus.SC_OK, tikaiteJson),
    ...
    @Test
    public void testAxisDontStoreNotComboFiscal() throws Exception {
        final String cfg = "extrasettings.axis-facts = combo_mail\n"
            + "postprocess_domain.gmail$com ="
                + "combo_mail:http://localhost:" + IexProxyCluster.IPORT
                + "/combo_mail\n";
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity tikaiteJson = new FileEntity(
                new File(getClass().getResource("./media/tikaite_response_non_combo_fiscal.json").
                    toURI()), ContentType.APPLICATION_JSON);
            cluster.tikaite().add(
                MAIL_HANDLER + '*',
                new StaticHttpItem(HttpStatus.SC_OK, tikaiteJson),
    ...
    @Test
    public void testAxisEmptyStoreTooLongResponseComboMail() throws Exception {
        final String cfg = "extrasettings.axis-facts = combo_mail\n"
            + "postprocess_domain.gmail$com ="
                + "combo_mail:http://localhost:" + IexProxyCluster.IPORT
                + "/combo_mail\n";
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            FileEntity mediaNewSub = new FileEntity(
                new File(getClass().getResource("media/new_sub_too_long.json").
                    toURI()), ContentType.APPLICATION_JSON);
            //FileEntity mediaFiscalCombo = new FileEntity(
            //    new File(getClass().getResource("media/fiscal_combo.json").
            //        toURI()), ContentType.APPLICATION_JSON);
