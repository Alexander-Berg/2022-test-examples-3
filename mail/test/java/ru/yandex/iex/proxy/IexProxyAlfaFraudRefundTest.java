...
public class IexProxyAlfaFraudRefundTest extends TestBase {
    ...
    @Test
    public void testAxisStoreAlfaFraudFewTables() throws Exception {
            ...
            CloseableHttpClient client = Configs.createDefaultClient())
        {
            ...
            cluster.corpFilterSearch().add(
                ...
                IexProxyTestMocks.filterSearchPgResponse(
                    mid, stid, "", "user", "fraudmonitoring", "alfabank.ru", "alfa fraud subject"));

            FileEntity cokeJson = new FileEntity(
                new File(getClass().getResource("coke_alfafraud_few_tables.json").
