...
class YaSearchParserTest {
    ...
    void parseHtml() throws IOException {
        URL url = Resources.getResource("serp/ya/serp.html");
        String html = Resources.toString(url, Charset.defaultCharset());

        YaSearchParser parser = new YaSearchParser();
        MailSearchScrapedData parsed = parser.parse(html);

        URL expectedUrl = Resources.getResource("serp/ya/parsed_serp.json");
