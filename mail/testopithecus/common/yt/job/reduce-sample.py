...
if __name__ == "__main__":
    ...
    yt.run_map(
        'bash run-script.sh',
        local_files=["run-script.sh", "script.js"],
        input_format='json',
        output_format='json',
        ...
        spec={
            'mapper': {
                'layer_paths': [
                    '//home/cocainum/xrater/porto/node12/node_layer.tar.gz',
                    '//home/cocainum/xrater/porto/node12/porto_layer_search_ubuntu_trusty_subagent_yt-2019-07-18-17.42.49.tar.gz',
                ],
