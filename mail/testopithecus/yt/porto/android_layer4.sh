...
mkdir /usr/.android/
sdkmanager --sdk_root=${ANDROID_SDK_ROOT} "emulator" "platform-tools" "platforms;android-28" "system-images;android-28;google_apis;x86" >> install_log
...
echo "no" | avdmanager -v create avd --force --name "android_28" --device "pixel" --package "system-images;android-28;google_apis;x86" --tag "google_apis" --abi "x86"
