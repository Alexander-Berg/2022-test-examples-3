 ...
 */
@Aqua.Test(title = "Тестирование preview фильтров на существование заголовков",
        description = "Тестирование preview фильтров на существование заголовков")
@Title("PreviewExistHeaderFiltersTest.Тестирование preview фильтров на существование заголовков [MAILDEV-809]")
@Description("Тестирование preview фильтров на существование заголовков")
@Feature("Yfurita.Preview")
@RunWith(Parameterized.class)
public class PreviewExistHeaderFiltersTest {
    private static final String FOLDER_WITH_TEST_LETTERS = "header-test";
    ...
    @Credentials(loginGroup = "PreviewExistHeaderFiltersTest")
    ...
    public static Collection<Object[]> data() throws Exception {
        return asList(
                new Object[]{"Peterburg", "5", "4", asList("1.eml", "2.eml", "3.eml")},
                new Object[]{"peterburg", "5", "3", asList("1.eml", "2.eml", "3.eml")},
                new Object[]{"Peterburg", "6", "2", asList("4.eml", "5.eml", "6.eml", "7.eml")},
                new Object[]{"pEterburg", "6", "dfsfds", asList("4.eml", "5.eml", "6.eml", "7.eml")},
                new Object[]{"Subject", "5", "sdffds",
                        asList("1.eml", "2.eml", "3.eml", "4.eml", "5.eml", "6.eml", "7.eml")},
                //  new Object[]{"subject", "5", "sdsd",
                // asList("1.eml", "2.eml", "3.eml", "4.eml", "5.eml","6.eml","7.eml")},
                new Object[]{"Subject", "6", "fdssfddfs", asList()},
                new Object[]{"Bla-bla", "5", "", asList("6.eml")},
                new Object[]{"x-job", "5", "", asList("7.eml")}
        );
    }
