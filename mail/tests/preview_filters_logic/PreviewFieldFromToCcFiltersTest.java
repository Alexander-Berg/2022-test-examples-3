...
@Aqua.Test(title = "Тестирование preview фильтров на заголовки to,cc,from",
        description = "Тестирование preview фильтров на на заголовки to,cc,from")
@Title("PreviewFieldFromToCcFiltersTest.Тестирование preview фильтров на заголовки to,cc,from")
@Description("Тестирование preview фильтров на заголовки to,cc,from")
@Feature("Yfurita.Preview")
@RunWith(Parameterized.class)
public class PreviewFieldFromToCcFiltersTest {
    private static final String FOLDER_WITH_TEST_LETTERS = "from-to-test";
    ...
    @Credentials(loginGroup = "PreviewFieldFromToCcFiltersTest")
        ...
        return asList(
                new Object[]{
                        newHashMap(new Builder<String, String>()
                                .put(FIELD1.getName(),"from")
                                .put(FIELD2.getName(),"1")
                                .put(FIELD3.getName(),"yantester@ya.ru")
                                .build()),
                ...
                new Object[]{
                        newHashMap(new Builder<String, String>()
                                .put(FIELD1.getName(),"cc")
                                .put(FIELD2.getName(),"3")
                                .put(FIELD3.getName(),"robbitter-8858199438")
                                .build()),
                        asList("4.eml")},
                new Object[]{
                        newHashMap(new Builder<String, String>()
                                ...
                                .put(FIELD3.getName(),"robbitter")
                                .build()),
                        asList("1.eml","2.eml","3.eml", "5.eml", "6.eml","7.eml")},
                new Object[]{
                        newHashMap(new Builder<String, String>()
                                .put(FIELD1.getName(),"cc")
                                .put(FIELD2.getName(),"2")
                                .put(FIELD3.getName(),"robbitter")
                                .build()),
                        asList("1.eml","2.eml","3.eml","4.eml", "5.eml", "6.eml","7.eml")});
    }
    ...
    @Test
    @Title("Проверяем работу фильров на СООТВЕТСТВИЕ TO,CC,FROM в письме (preview по id фильтра)")
    @Description("Проверяем работу фильров на СООТВЕТСТВИЕ TO,CC,FROM в письме через preview запрос по id фильтра")
    ...
    @Test
    @Title("Проверяем работу фильров на СООТВЕТСТВИЕ TO,CC,FROM в письме (preview по условиям)")
    @Description("Проверяем работу фильров на СООТВЕТСТВИЕ TO,CC,FROM в письме через preview запрос по условиям")
