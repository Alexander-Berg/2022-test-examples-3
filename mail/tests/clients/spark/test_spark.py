...
from sendr_interactions.clients.spark import SparkClient
from sendr_interactions.clients.spark.exceptions import SparkAuthError, SparkGetInfoError, SparkSessionEndError


@pytest.fixture
def spark_client(client_mocker):
    client = client_mocker(SparkClient)
    client.BASE_URL = 'http://hello'
    client.LOGIN = '123'
    client.PASSWORD = '456'
    client.DEBUG = True
