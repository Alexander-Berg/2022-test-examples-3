Feature: Conninfo when shard has replica and unrachable host 
  ...
  Scenario: Alive and dead replcia should be returned when shard has replica and unreachable host
