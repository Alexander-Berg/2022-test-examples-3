...
from helpers.helpers import client_initial_state, get_cars, get_car, get_current_session, \
    end_session_and_get_bill, acceptance, end_session, riding, parking, get_mileage, set_mileage, create_debt, \
    check_debt, expect_http_code, remove_debt, lock_car, unlock_car, reservation, \
    get_offer
...
class TestHourlyOffer(BaseTestClass):
