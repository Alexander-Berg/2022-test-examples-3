...
from ..backend.packet_handlers import SaasDriveNavigatorPrestableRidingSubmitterPacketHandler
...
class TelematicsDataSaasDriveNavigatorSubmissionTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        SaasDriveNavigatorPrestableRidingSubmitterPacketHandler.status_cache = self.state_cache
        SaasDriveNavigatorPrestableRidingSubmitterPacketHandler.current_ride_cache = (
            self.state_cache
        )

        saas_submitter_packet_handler = SaasDriveNavigatorPrestableRidingSubmitterPacketHandler(
