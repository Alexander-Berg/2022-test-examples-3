...
import LevitanCashback from '@self/root/src/spec/page-objects/LevitanCashback';
import LevitanText from '@self/root/src/spec/page-objects/LevitanText';
...
export const checkCashbackTextTestCase = async (
    ...
    const cashback = container.querySelector(`${LevitanCashback.root} ${LevitanText.root}`);
...
export const checkStyleTestCase = async (
    ...
    const {container} = await apiaryLayer.mountWidget(widgetPath, widgetParams);
    const cashback = container.querySelector(`${LevitanCashback.root}`);
