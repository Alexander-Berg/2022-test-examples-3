...
class LrmPvzOutToCourierInAggregatedProcessorTest : StartrekProcessorTest() {
    @Captor
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/lrm_pvz_out_to_courier_in/create_single.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/lrm_pvz_out_to_courier_in/create_single.xml",
    ...
    fun createIssueTest() {
        ...
        assertSoftly {
            issueValues.getOrThrow("summary") shouldBe "[MQM] 01-11-2020: МК СД (1337, NO_MC_NAME_FOUND) не принято курьерами из ПВЗ"
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/lrm_pvz_out_to_courier_in/comment_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/lrm_pvz_out_to_courier_in/comment_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/lrm_pvz_out_to_courier_in/close_all_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/lrm_pvz_out_to_courier_in/close_all_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
