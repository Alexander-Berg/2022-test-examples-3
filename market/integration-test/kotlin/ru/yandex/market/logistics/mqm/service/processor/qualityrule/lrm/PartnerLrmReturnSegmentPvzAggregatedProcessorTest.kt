...
class PartnerLrmReturnSegmentPvzAggregatedProcessorTest : StartrekProcessorTest() {
    ...
    fun createIssueTest() {
        ...
        assertSoftly {
            issueValues.getOrThrow("summary") shouldBe "[MQM] 01-11-2020: ПВЗ 172 вовремя не отгрузил заказы"
            issueValues.getOrThrow("description") shouldBe "Список заказов в приложении (кол-во заказов: 3)\nORDER1,ORDER2,ORDER3"
