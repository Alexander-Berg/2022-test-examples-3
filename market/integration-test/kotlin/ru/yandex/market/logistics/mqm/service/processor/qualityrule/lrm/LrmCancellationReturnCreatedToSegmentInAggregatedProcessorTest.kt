...
class LrmCancellationReturnCreatedToSegmentInAggregatedProcessorTest : StartrekProcessorTest() {
    @Captor
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/date_lrm_return_cancellation_segment_in/create_single.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/date_lrm_return_cancellation_segment_in/create_single.xml",
    ...
    fun createIssueTest() {
        ...
        assertSoftly {
            issueValues.getOrThrow("summary") shouldBe "[MQM] 01-11-2020: нет движения по невыкупам в возвратном маршруте"
            ...
            read.numberOfColumns shouldBe 1
        }
    }

    @DisplayName("Добавление комментариев в тикета Startrek для просроченных план-фактов")
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/date_lrm_return_cancellation_segment_in/comment_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/date_lrm_return_cancellation_segment_in/comment_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/date_lrm_return_cancellation_segment_in/close_all_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/date_lrm_return_cancellation_segment_in/close_all_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
