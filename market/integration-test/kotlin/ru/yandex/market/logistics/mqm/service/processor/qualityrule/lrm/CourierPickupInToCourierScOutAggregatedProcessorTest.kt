...
class CourierPickupInToCourierScOutAggregatedProcessorTest : StartrekProcessorTest() {
    @Captor
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/courier_pickup_in_to_courier_sc_out/create_single.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/courier_pickup_in_to_courier_sc_out/create_single.xml",
    ...
    fun createIssueTest() {
        ...
        assertSoftly {
            issueValues.getOrThrow("summary") shouldBe "[MQM] 01-11-2020: МК СД (1337, NO_MC_NAME_FOUND) не возвращено курьерами на СЦ"
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/courier_pickup_in_to_courier_sc_out/comment_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/courier_pickup_in_to_courier_sc_out/comment_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/courier_pickup_in_to_courier_sc_out/close_all_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/courier_pickup_in_to_courier_sc_out/close_all_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
