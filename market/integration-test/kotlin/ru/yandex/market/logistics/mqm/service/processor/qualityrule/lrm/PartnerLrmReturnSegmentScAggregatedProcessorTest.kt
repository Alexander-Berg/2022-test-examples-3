...
class PartnerLrmReturnSegmentScAggregatedProcessorTest : StartrekProcessorTest() {
    @Captor
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/partner_lrm_return_segment_sc/create_single.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/partner_lrm_return_segment_sc/create_single.xml",
    ...
    fun createIssueTest() {
        ...
        assertSoftly {
            issueValues.getOrThrow("summary") shouldBe "[MQM] 01-11-2020: С сортировочного центра (NO_SC_NAME, 172) не были вовремя отгружены заказы"
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/partner_lrm_return_segment_sc/comment_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/partner_lrm_return_segment_sc/comment_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/partner_lrm_return_segment_sc/close_all_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/partner_lrm_return_segment_sc/close_all_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
