...
class CourierInToLrmScInAggregatedProcessorTest : StartrekProcessorTest() {
    @Captor
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/courier_in_to_lrm_sc_in/create_single.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/courier_in_to_lrm_sc_in/create_single.xml",
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/courier_in_to_lrm_sc_in/comment_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/courier_in_to_lrm_sc_in/comment_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/courier_in_to_lrm_sc_in/close_all_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/courier_in_to_lrm_sc_in/close_all_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
