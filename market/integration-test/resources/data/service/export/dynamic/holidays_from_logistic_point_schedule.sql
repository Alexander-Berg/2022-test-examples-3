...
INSERT INTO calendar_day
    (calendar_id, day, is_holiday)
VALUES (100, '2018-10-12', TRUE), -- 8th day in days set
       (100, '2018-10-13', TRUE); -- 9th day in days set, must be overridden by wh holiday

INSERT INTO partner (id, name, status, type, billing_client_id, rating, calendar_id, location_id, tracking_type)
VALUES (1, 'Dropship service 1. Has wh schedule & single calendar holiday', 'active', 'DROPSHIP', 124, 1, 100, 255,
        NULL),
       (2, 'Dropship service 2. Has no wh schedule & no calendar holiday', 'active', 'DROPSHIP', 124, 2, NULL, 255,
        'status1'),
       (3, 'Dropship service 3. Has 24/7 warehouse & no calendar holiday', 'active', 'DROPSHIP', 124, 3, NULL, 255,
        NULL),
       (4, 'Delivery service', 'active', 'DELIVERY', 124, 4, NULL, 255, 'status2'),
       (5, 'Sorting center', 'active', 'SORTING_CENTER', 124, 5, NULL, 255, NULL);
...
INSERT INTO schedule_day
    (schedule_id, day, time_from, time_to, is_main)
VALUES (10, 1, '10:00', '20:00', TRUE),
       (10, 2, '10:00', '20:00', TRUE),
       (10, 3, '10:00', '20:00', TRUE),
       (10, 4, '10:00', '20:00', TRUE),
       (10, 5, '10:00', '20:00', TRUE),
       (20, 1, '10:00', '20:00', TRUE),
       (20, 2, '10:00', '20:00', TRUE),
       (20, 3, '10:00', '20:00', TRUE),
       (20, 4, '10:00', '20:00', TRUE),
       (20, 5, '10:00', '20:00', TRUE),
       (20, 6, '10:00', '20:00', TRUE),
       (20, 7, '10:00', '20:00', TRUE);
...
VALUES (1, 1, 'warehouse1', 'WAREHOUSE', TRUE, 1, 10),
       ...
       (3, 1, 'warehouse3', 'WAREHOUSE', TRUE, 3, 20),
