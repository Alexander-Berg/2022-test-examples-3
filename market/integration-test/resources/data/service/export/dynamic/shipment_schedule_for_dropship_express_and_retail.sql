...
VALUES (1, 'Dropship service', 'active', 'DROPSHIP', 124, 1, NULL, 255, NULL),
       ...
       (100, 'retail partner', 'testing', 'RETAIL', 124, 1, NULL, 1, NULL);
...
VALUES (1, 1, 2, 0, FALSE, 1, 'WITHDRAW', 10),
       ...
       (4, 100, 1006360, 0, TRUE, 100, 'WITHDRAW', 10);
...
VALUES (1, 'some address'), (2, 'some retail address');
...
VALUES (1, 1, 'warehouse1', 'WAREHOUSE', TRUE, 1, 10),
       ...
       (100, 2, 'business-warehouse', 'WAREHOUSE', TRUE, 100, 100);
