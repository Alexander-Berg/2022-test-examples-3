...
import ru.yandex.market.mbo.cms.exporter.config.CmsExporterConf;

/**
 * @author commince
 */
@Configuration
@Import({CmsExporterConf.class, CmsIntegrationTestConf.class, })
public class CmsExporterIntegrationTestConf {
