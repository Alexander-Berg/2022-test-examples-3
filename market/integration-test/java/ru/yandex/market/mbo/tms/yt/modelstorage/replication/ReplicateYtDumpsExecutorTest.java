...
public class ReplicateYtDumpsExecutorTest {
    ...
    public void doRealJob() throws Exception {
        replicateYtDumpsExecutor.doRealJob(context);

        YPath replicatedRecent = YPath.simple(mboRootPath).child("export").child("recent");
