...
class OrderCancellingByYandexIdTest extends BaseContextualTest {
    private static final String YANDEX_ID = "some_unique_yandex_id";
    ...
    void initMock() throws ApiMethodProcessingException {
        ...
        shipment.setId(123);
        given(client.searchShipmentsByBarcodeOrOrderNum(YANDEX_ID)).willReturn(new Shipment[]{shipment});
        ...
        given(client.deleteOrderFromBatch(Mockito.anyInt())).willReturn(response);

        given(client.searchShipmentById(Mockito.matches(String.valueOf(shipment.getId()))))
            .willThrow(new ApiMethodProcessingException());
    ...
    void testPositiveCancelOrder() throws Exception {
        mockMvc.perform(post(
            ...
            .content(FixtureRepository.getCancelOrderRequest(YANDEX_ID, "")))
