...
import ru.yandex.market.delivery.tracker.client.tracking.lgw.ds.LgwDsMovementClientAdapter;
...
class LgwMovementRequestResponseParsingTest extends AbstractLgwParsingTest {

    private static final long SERVICE_ID = 145L;
    private static final String DS_HISTORY_URL = "/delivery/getMovementStatusHistory";
    private static final String DS_STATUS_URL = "/delivery/getMovementStatus";

    private LgwDsMovementClientAdapter lgwDsMovementClientAdapter;

    @BeforeEach
    void additionalSetup() {
        DeliveryClient deliveryClient = configuration.deliveryClient();

        lgwDsMovementClientAdapter = new LgwDsMovementClientAdapter(deliveryClient);
    }

    @Test
    void dsGetMovementStatus() throws ParseException, IOException {
        testGetMovementStatus(lgwDsMovementClientAdapter, DS_STATUS_URL);
    }

    @Test
    void dsGetMovementStatusHistory() throws ParseException, IOException {
        testGetMovementStatusHistory(lgwDsMovementClientAdapter, DS_HISTORY_URL);
    }

    private void testGetMovementStatus(TrackingService trackingService, String statusUrl)
        ...
        setupMockServerExpectation(statusUrl, "get_movement_status.json");
    ...
    private void testGetMovementStatusHistory(TrackingService trackingService, String historyUrl)
        throws ParseException, IOException {
        ...
        setupMockServerExpectation(historyUrl, "get_movement_status_history.json");
