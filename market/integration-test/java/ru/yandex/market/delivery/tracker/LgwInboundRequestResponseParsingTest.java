...
import ru.yandex.market.delivery.tracker.client.tracking.lgw.ff.LgwFfInboundClientAdapter;
import ru.yandex.market.logistic.gateway.client.FulfillmentClient;
import ru.yandex.market.logistic.gateway.common.model.common.StatusCode;

class LgwInboundRequestResponseParsingTest extends AbstractLgwParsingTest {

    private static final long SERVICE_ID = 145L;
    private static final String FF_HISTORY_URL = "/fulfillment/getInboundStatusHistory";
    private static final String FF_STATUS_URL = "/fulfillment/getInboundStatus";

    private LgwFfInboundClientAdapter lgwFfInboundClientAdapter;

    @BeforeEach
    void additionalSetup() {
        FulfillmentClient fulfillmentClient = configuration.fulfillmentClient();

        lgwFfInboundClientAdapter = new LgwFfInboundClientAdapter(fulfillmentClient);
    }

    @Test
    void ffGetInboundStatus() throws ParseException, IOException {
        testGetInboundStatus(lgwFfInboundClientAdapter, FF_STATUS_URL);
    }

    @Test
    void ffGetInboundStatusHistory() throws ParseException, IOException {
        testGetInboundStatusHistory(lgwFfInboundClientAdapter, FF_HISTORY_URL);
    }

    private void testGetInboundStatus(TrackingService trackingService, String statusUrl)
        ...
        setupMockServerExpectation(statusUrl, "get_inbound_status.json");
    ...
    void testGetInboundStatusHistory(TrackingService trackingService, String historyUrl)
        throws ParseException, IOException {
        ...
        setupMockServerExpectation(historyUrl, "get_inbound_status_history.json");
