...
import ru.yandex.market.delivery.gruzin.client.config.GruzinApiProperties;
import ru.yandex.market.delivery.gruzin.client.config.TestClientConfiguration;
...
public class AbstractClientTest {
    ...
    @Autowired
    protected GruzinApiProperties gruzinApiProperties;
