...
@DisplayName("Тесты обработчика СЦ-СД для создания и обновления тикетов по просрочки")
class SortingCenterToDeliveryServiceIntakeProcessorTest extends StartrekProcessorTest {
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/create_ticket_with_one_planfact.xml")
    @ExpectedDatabase(
        value =
            "/service/processor/qualityrule/after/intake/sc_ds/scheduled_today_when_work_starts.xml",
    ...
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/create_ticket_with_one_planfact.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/scheduled_tomorrow_when_work_starts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/create_ticket_with_one_planfact.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/create_ticket_with_one_planfact.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    void createSingleIssueTest() {
        String summary = "[MQM] 07-11-2020: СД Тестовая служба доставки вовремя не приняла заказы с СЦ Тестовый СЦ.";
        ...
        String[] tags = new String[]{"Тестовый СЦ:987654321", "Тестовая служба доставки:987654322"};
        createSingleIssue(summary, description, tags);
    }

    @DisplayName("Заказ YANDEX_GO. Создание тикета в Startrek для одного просроченного план-факта отгрузки СЦ-СД")
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/create_ticket_with_one_planfact.xml")
    @DatabaseSetup(
        value = "/service/processor/qualityrule/before/intake/sc_ds/go_order_create_ticket_with_one_planfact.xml",
        type = DatabaseOperation.UPDATE
    )
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/go_order_create_ticket_with_one_planfact.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    void goOrdercreateSingleIssueTest() {
        String summary = "[MQM][Доставка Наружу] " +
            "07-11-2020: СД Тестовая служба доставки вовремя не приняла заказы с СЦ Тестовый СЦ.";
        String description = String.join(
            "\n",
            "https://abo.market.yandex-team.ru/order/777",
            "",
        ...
        String[] tags = new String[]{
            ...
            "Тестовый СЦ:987654321",
            "Тестовая служба доставки:987654322"
        };
        createSingleIssue(summary, description, tags);
    }

    private void createSingleIssue(String summary, String description, String[] tags) {
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/create_ticket_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/create_ticket_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @DisplayName("Заказ YANDEX_GO. Создание тикета в Startrek для просроченных план-фактов отгрузки СЦ-СД")
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/create_ticket_with_some_planfacts.xml")
    @DatabaseSetup(
        value = "/service/processor/qualityrule/before/intake/sc_ds/go_order_create_ticket_with_some_planfacts.xml",
        type = DatabaseOperation.UPDATE
    )
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/go_order_create_ticket_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    void goOrderCreateAggregatedIssueTest() {
        String summary = "[MQM][Доставка Наружу] " +
            "07-11-2020: СД Тестовая служба доставки вовремя не приняла заказы с СЦ Тестовый СЦ.";
        String[] tags = new String[]{
            "yandex_go-доставка_наружу",
    ...
    private void createAggregatedIssue(String summary, String[] tags) {
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/comment_with_some_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/comment_with_some_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/close_all_planfacts.xml")
    @ExpectedDatabase(
        value = "/service/processor/qualityrule/after/intake/sc_ds/close_all_planfacts.xml",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED
    )
    ...
    @Test
    @DatabaseSetup("/service/processor/qualityrule/before/intake/sc_ds/reopen_ticket.xml")
