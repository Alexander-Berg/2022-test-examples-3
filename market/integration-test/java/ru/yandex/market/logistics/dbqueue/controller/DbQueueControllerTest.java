...
class DbQueueControllerTest extends AbstractContextualTest {
    ...
    public void testListWithPagingZero(int page) throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders
                    .get("/admin/dbqueue")
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(jsonContent(String.format("page%d.json", page)));
    }
    ...
    public void testFilteringSecondAttempt(int attempt) throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders
                    .get("/admin/dbqueue")
                    .param("attempt", String.valueOf(attempt))
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(jsonContent(String.format("attempt%d.json", attempt)));
    }
    ...
    @Test
    public void testListExtWithPagingZero() throws Exception {
        mockMvc.perform(
            MockMvcRequestBuilders
                .get(DbQueueSlug.TASK_LOG)
                .param("page", "0")
    ...
    @Test
    public void testListExtWithPagingOne() throws Exception {
        mockMvc.perform(
            MockMvcRequestBuilders
                .get(DbQueueSlug.TASK_LOG)
                .param("page", "1")
