...
public class SpringTestConfiguration {
    ...
    @Bean
    public QueueDao queueDao(DataSource dataSource, QueueTableSchema queueTableSchema) {
        return new PostgresQueueDao(new JdbcTemplate(dataSource), queueTableSchema);
    }
