...
import ru.yandex.market.logistics.les.lom.OrderReturningEvent;
...
@DisplayName("Тест на отправку ивента о возвращении заказа в LES")
class ExportOrderReturningProcessorTest extends AbstractExportLesEventProcessorTest {
    @Autowired
    private ExportOrderReturningProcessor processor;

    @Test
    @DisplayName("Отправка ивента о о возвращении заказа")
    ...
    void success() {
        ...
        Event event = new Event(
            ...
            OrderReturningEvent.EVENT_TYPE,
            new OrderReturningEvent(
                1L,
                "LO1",
                "+79999999999"
            ),
