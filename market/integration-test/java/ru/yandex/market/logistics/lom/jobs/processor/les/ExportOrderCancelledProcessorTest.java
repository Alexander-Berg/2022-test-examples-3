...
import ru.yandex.market.logistics.les.lom.OrderCancelledEvent;
...
@DisplayName("Тест на отправку ивента о отмене заказа")
class ExportOrderCancelledProcessorTest extends AbstractExportLesEventProcessorTest {
    @Autowired
    private ExportOrderCancelledProcessor processor;

    @Test
    @DisplayName("Отправка ивента о отмене заказа")
