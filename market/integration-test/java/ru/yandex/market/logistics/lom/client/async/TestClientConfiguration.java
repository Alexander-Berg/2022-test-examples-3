...
public class TestClientConfiguration {
    ...
    @Bean
    public LomDeliveryServiceConsumerClient deliveryConsumerClient(
        HttpTemplate httpTemplate
    ) {
        return new LomDeliveryServiceConsumerClientImpl(httpTemplate);
    }

    @Bean
    public LomFulfillmentConsumerClient fulfillmentConsumerClient(HttpTemplate httpTemplate) {
        return new LomFulfillmentConsumerClientImpl(httpTemplate);
    }
