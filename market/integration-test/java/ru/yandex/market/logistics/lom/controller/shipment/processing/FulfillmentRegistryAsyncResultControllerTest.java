...
class FulfillmentRegistryAsyncResultControllerTest extends AbstractRegistryAsyncResultControllerTest {
    @Nonnull
    @Override
    ResultActions performCall(String method, String requestFileName) throws Exception {
        return mockMvc.perform(
            put("/registries/ff/" + method)
    ...
    QueueType getQueueType() {
        return QueueType.FULFILLMENT_CREATE_REGISTRY_EXTERNAL;
    }
}
