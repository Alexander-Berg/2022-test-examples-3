...
// TODO: После выкладки MARKETWMS-1673 на все склады удалить
class CancelOrderWithoutCancelFlagTest extends AbstractFunctionalTest {
     ...
     */
    @DatabaseSetup(
        value = "/fixtures/functional/cancel_order/common/state_without_orderstatussetup.xml",
