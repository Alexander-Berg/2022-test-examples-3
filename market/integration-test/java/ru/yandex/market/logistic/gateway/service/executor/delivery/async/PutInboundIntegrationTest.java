...
import static ru.yandex.market.logistic.api.model.common.PartnerMethod.PUT_INBOUND_DS;
...
public class PutInboundIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeSuccess() throws Exception {
        MockRestServiceServer mockServer = createMockServerByRequest(PUT_INBOUND_DS);
    ...
    private ClientTask getCreateInboundTask(final String filename) {
        ...
        task.setFlow(RequestFlow.DS_PUT_INBOUND);
