...
public class GetOrdersReturnOutboundIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeSuccess() {
        ...
        prepareMockServerXmlScenario(
            ...
            "fixtures/response/delivery/get_outbound/response_orders_return.xml"
        );

        TaskMessage message = getOutboundExecutor.execute(new ExecutorTaskWrapper(GET_OUTBOUND_TASK_ID, 0));
        String expectedContent = getFileContent("fixtures/executors/get_outbound/task_response_orders_return.json");
