...
import ru.yandex.market.logistic.gateway.common.model.delivery.request.PutMovementRegistryRequest;
...
public class PutMovementRegistryErrorIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeError() throws IOException {
        String messageContent = getFileContent("fixtures/executors/put_movement_registry/task_message_ds.json");
        ...
        verify(fulfillmentWorkflowDeliveryConsumerClient).setPutMovementRegistryError(
    ...
    private ClientTask getClientTask(String filename) {
        return new ClientTask()
            ...
            .setFlow(RequestFlow.DS_PUT_MOVEMENT_REGISTRY_ERROR)
