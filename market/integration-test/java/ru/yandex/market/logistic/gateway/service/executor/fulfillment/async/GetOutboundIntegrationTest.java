...
import static ru.yandex.market.logistic.api.model.common.PartnerMethod.GET_OUTBOUND_FF;
...
public class GetOutboundIntegrationTest extends AbstractIntegrationTest {
    ...
    @Before
    public void setUp() {
        mockServer = createMockServerByRequest(GET_OUTBOUND_FF);
    ...
    public void executeSuccess() {
        ...
        prepareMockServerXmlScenario(
            ...
            "fixtures/response/fulfillment/get_outbound/response.xml"
        );

        TaskMessage message = getOutboundExecutor.execute(new ExecutorTaskWrapper(GET_OUTBOUND_TASK_ID, 0));
        String expectedContent = getFileContent("fixtures/executors/get_outbound/task_response_FF.json");
    ...
    public void executeFailure() {
        ...
        prepareMockServerXmlScenario(
            ...
            "https://localhost/query-gateway",
            "fixtures/request/common/get_outbound/request.xml",
            "fixtures/response/fulfillment/get_outbound/response_error.xml"
        );
