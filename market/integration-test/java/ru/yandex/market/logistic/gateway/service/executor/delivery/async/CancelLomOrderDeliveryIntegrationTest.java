 ...
 */
public class CancelLomOrderDeliveryIntegrationTest extends AbstractIntegrationTest {
    ...
    @Test
    public void executeTechError() {
        mockTaskMessage("fixtures/executors/cancel_order/cancel_order_task_tech_error.json");
        ...
        verify(lomClient).setCancelOrderError(
            ...
            eq(PARTNER_ID),
            eq(true),
            eq("org.springframework.web.client.HttpServerErrorException$BadGateway: 502 Bad Gateway"),
            eq(9999)
        );
    }
    ...
    private ClientTask getCancelOrderTask(String filename) {
        ...
        task.setFlow(RequestFlow.DS_CANCEL_ORDER_SUCCESS);
