...
public class PushOutboundStatusHistoryDeliveryTest extends AbstractIntegrationTest {
    @Autowired
    private TrackerApiClient trackerApiClient;

    @Test
    public void testDeliveryPushOutboundsStatusHistorySuccessful() throws Exception {
        String xmlResponse = performRequest("fixtures/request/delivery/push_outbound_status_history/" +
            "delivery_push_outbound_status_history.xml");
        ...
        String expectedXml = getFileContent("fixtures/response/delivery/push_outbound_status_history/" +
            "delivery_push_outbound_status_history.xml");
    ...
    @Test
    public void testSeveralPartnersPushOutboundsStatusHistorySuccessful() throws Exception {
        String xmlResponse = performRequest("fixtures/request/delivery/push_outbound_status_history/" +
            "universal_delivery_push_outbound_status_history.xml");
    ...
    @Test
    public void testDeliveryPushOutboundsStatusHistoryInvalidTokenError() throws Exception {
        String xmlResponse = performRequest("fixtures/request/delivery/push_outbound_status_history/" +
            "delivery_push_outbound_status_history_invalid_token.xml");
