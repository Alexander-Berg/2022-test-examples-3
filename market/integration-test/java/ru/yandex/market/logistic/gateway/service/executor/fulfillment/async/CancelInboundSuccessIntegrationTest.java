...
/**
 * Интеграционный тест для {@link CancelInboundSuccessExecutor}.
 */
public class CancelInboundSuccessIntegrationTest extends AbstractIntegrationTest {

    private final static long INBOUND_SUCCESS_TASK_ID = 510L;
    ...
    @Autowired
    private CancelInboundSuccessExecutor cancelInboundSuccessExecutor;
    ...
    public void executeSuccess() throws Exception {
        ClientTask task = getCancelInboundSuccessTask("fixtures/executors/cancel_inbound/cancel_inbound_task_response.json");
        ...
        cancelInboundSuccessExecutor.execute(new ExecutorTaskWrapper(INBOUND_SUCCESS_TASK_ID, 0));
    }

    private ClientTask getCancelInboundSuccessTask(final String filename) throws IOException {
        ClientTask task = new ClientTask();
        task.setId(INBOUND_SUCCESS_TASK_ID);
        task.setStatus(TaskStatus.IN_PROGRESS);
        task.setFlow(RequestFlow.FF_CANCEL_INBOUND_SUCCESS);
