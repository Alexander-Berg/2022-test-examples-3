...
public class UpdateCourierIntegrationTest extends AbstractIntegrationTest {
    ...
    public void setup() throws IOException {
        mockServer = createMockServerByRequest(PartnerMethod.UPDATE_COURIER_FF);
    ...
    public void executeSuccess() throws Exception {
        ClientTask task = getClientTask(
            "fixtures/executors/update_courier/update_courier_ff.json"
        );
        ...
        prepareMockServerXmlScenario(
            mockServer,
            GATEWAY_URL,
            "fixtures/request/fulfillment/update_courier/update_courier.xml",
            "fixtures/response/fulfillment/update_courier/update_courier.xml"
        );

        TaskMessage response = updateCourierExecutor.execute(new ExecutorTaskWrapper(TASK_ID, 0));
        softAssert.assertThat(
            new JsonMatcher(
                getFileContent("fixtures/executors/update_courier/update_courier_message_response_ff.json")
            )
    ...
    public void executeFailed() throws IOException {
        ...
        prepareMockServerXmlScenario(
            ...
            GATEWAY_URL,
            "fixtures/request/fulfillment/update_courier/update_courier.xml",
            "fixtures/response/fulfillment/update_courier/update_courier_error.xml"
        );
    ...
    public void executeValidationFailed() throws IOException {
        ClientTask task = getClientTask(
            "fixtures/executors/update_courier/update_courier_nulls_ff.json"
        );
    ...
    private ClientTask getClientTask(String filename) {
        ...
        task.setFlow(RequestFlow.FF_UPDATE_COURIER);
