...
public class PutInboundRegistrySuccessIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeSuccess() {
        ...
        TaskMessage message = putInboundRegistrySuccessExecutor.execute(new ExecutorTaskWrapper(TASK_ID, 0));
    ...
    private ClientTask getClientTask(String filename) {
        ...
        task.setFlow(RequestFlow.DS_PUT_INBOUND_REGISTRY_SUCCESS);
