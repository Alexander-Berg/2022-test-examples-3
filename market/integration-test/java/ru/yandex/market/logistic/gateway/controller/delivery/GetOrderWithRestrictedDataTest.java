...
public class GetOrderWithRestrictedDataTest extends AbstractIntegrationTest {
    ...
    public void execute() throws Exception {
        prepareMockServerXmlScenario(
            ...
            "fixtures/response/delivery/get_order/delivery_get_order_with_restricted_data.xml"
        );
        ...
        String expectedJson = getFileContent("fixtures/response/delivery/get_order/delivery_get_order_with_restricted_data.json");
