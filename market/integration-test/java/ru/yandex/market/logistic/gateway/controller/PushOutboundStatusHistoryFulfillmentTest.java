...
public class PushOutboundStatusHistoryFulfillmentTest extends AbstractIntegrationTest {

    @Autowired
    private TrackerApiClient trackerApiClient;

    @Test
    public void testFulfillmentPushOutboundStatusHistorySuccessful() throws Exception {
        String xmlResponse = performRequest("fixtures/request/fulfillment/push_outbound_status_history/" +
            "fulfillment_push_outbound_status_history.xml");
        ...
        String expectedXml = getFileContent("fixtures/response/fulfillment/push_outbound_status_history/" +
            "fulfillment_push_outbound_status_history.xml");
    ...
    @Test
    public void testSeveralPartnersPushOutboundStatusHistorySuccessful() throws Exception {
        String xmlResponse = performRequest("fixtures/request/fulfillment/push_outbound_status_history/" +
            "universal_fulfillment_push_outbound_status_history.xml");
    ...
    @Test
    public void testFulfillmentPushPushOutboundStatusHistoryInvalidTokenError() throws Exception {
        String xmlResponse = performRequest("fixtures/request/fulfillment/push_outbound_status_history/" +
            "fulfillment_push_outbound_status_history_invalid_token.xml");
