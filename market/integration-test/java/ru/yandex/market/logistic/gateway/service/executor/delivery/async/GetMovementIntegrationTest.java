...
import static ru.yandex.market.logistic.api.model.common.PartnerMethod.GET_MOVEMENT_DS;
...
public class GetMovementIntegrationTest extends AbstractIntegrationTest {
    ...
    @Before
    public void setUp() {
        mockServer = createMockServerByRequest(GET_MOVEMENT_DS);
    ...
    public void executeSuccess() {
        ...
        prepareMockServerXmlScenario(
            ...
            "fixtures/response/delivery/get_movement/delivery_get_movement_response.xml"
        );

        TaskMessage message = getMovementExecutor.execute(new ExecutorTaskWrapper(GET_MOVEMENT_TASK_ID, 0));
        String expectedContent =
            getFileContent("fixtures/executors/get_movement/get_movement_task_response_ds.json");
    ...
    public void executeFailure() {
        ...
        prepareMockServerXmlScenario(
            ...
            "https://localhost/query-gateway",
            "fixtures/request/common/get_movement_request.xml",
            "fixtures/response/delivery/get_movement/delivery_get_movement_response_error.xml"
        );
    ...
    private ClientTask getClientTask(String filename) {
        return new ClientTask()
            ...
            .setFlow(RequestFlow.DS_GET_MOVEMENT)
