...
import ru.yandex.market.logistic.gateway.common.model.delivery.request.PutInboundRegistryRequest;
...
public class PutInboundRegistryErrorIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeError() throws IOException {
        ...
        PutInboundRegistryRequest expectedRequest =
            new ObjectMapper().readValue(messageContent, PutInboundRegistryRequest.class);

        ClientTask task = getClientTask("fixtures/executors/put_inbound_registry/task_response_error.json");
        ...
        TaskMessage message = putInboundRegistryErrorExecutor.execute(new ExecutorTaskWrapper(TASK_ID, 0));
    ...
    private ClientTask getClientTask(String filename) {
        return new ClientTask()
            ...
            .setFlow(RequestFlow.DS_PUT_INBOUND_REGISTRY_ERROR)
