...
import ru.yandex.market.logistic.gateway.model.delivery.GetMovementExecutorResponse;
...
public class GetMovementSuccessIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeSuccess() throws IOException {
        String content = getFileContent("fixtures/executors/get_movement/get_movement_task_response_ds.json");
        ...
        verify(tmDeliveryConsumerClient).setGetMovementSuccess(
    ...
    private ClientTask getClientTask(String message) {
        ...
        task.setFlow(RequestFlow.DS_GET_MOVEMENT_SUCCESS);
