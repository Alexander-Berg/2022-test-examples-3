...
import static ru.yandex.market.logistic.api.model.common.PartnerMethod.GET_INBOUND_DS;
...
public class GetInboundIntegrationTest extends AbstractIntegrationTest {
    ...
    @Before
    public void setUp() {
        mockServer = createMockServerByRequest(GET_INBOUND_DS);
    ...
    public void executeSuccess() {
        ...
        prepareMockServerXmlScenario(
            ...
            "fixtures/response/delivery/get_inbound/response.xml"
        );

        TaskMessage message = getInboundExecutor.execute(new ExecutorTaskWrapper(GET_INBOUND_TASK_ID, 0));
        String expectedContent = getFileContent("fixtures/executors/get_inbound/task_response.json");
    ...
    public void executeFailure() {
        ...
        prepareMockServerXmlScenario(
            ...
            "https://localhost/query-gateway",
            "fixtures/request/common/get_inbound/request.xml",
            "fixtures/response/delivery/get_inbound/response_error.xml"
        );
