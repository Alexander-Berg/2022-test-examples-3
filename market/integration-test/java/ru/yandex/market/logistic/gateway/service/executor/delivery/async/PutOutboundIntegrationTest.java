...
import static ru.yandex.market.logistic.api.model.common.PartnerMethod.PUT_OUTBOUND_DS;
...
public class PutOutboundIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeSuccess() throws Exception {
        MockRestServiceServer mockServer = createMockServerByRequest(PUT_OUTBOUND_DS);
    ...
    private ClientTask getCreateOutboundTask(final String filename) {
        ...
        task.setFlow(RequestFlow.DS_PUT_OUTBOUND);
