...
public class PutOutboundRegistryErrorIntegrationTest extends AbstractIntegrationTest {
    ...
    public void executeErrorTm() {
        ...
        softAssert.assertThat(message.getMessageBody()).isNull();
        verify(transportManagerClient).setPutOutboundRegistryError(
            123456L,
            "5927638",
            "39292337",
            145L,
    ...
    private TaskMessage execute(TaskResultConsumer consumer) {
        ...
        ClientTask task = getClientTask("fixtures/executors/put_outbound_registry/task_response_error.json", consumer);
        ...
        return putOutboundRegistryErrorExecutor.execute(new ExecutorTaskWrapper(TASK_ID, 0));
    }
    ...
    private ClientTask getClientTask(String filename, TaskResultConsumer consumer) {
        return new ClientTask()
            ...
            .setFlow(RequestFlow.FF_PUT_OUTBOUND_REGISTRY_ERROR)
