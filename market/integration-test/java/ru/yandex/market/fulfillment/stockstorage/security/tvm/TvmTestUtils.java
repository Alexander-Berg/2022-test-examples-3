...
class TvmTestUtils {
    ...
    private static final String PAGE_MATCH_URL = "/pageMatch";
    ...
    static MockHttpServletRequestBuilder builderWithEmptyUserTicket() {
        return builderWithServiceTicket()
                .header(USER_SERVICE_TICKET_HEADER, "");
    }
}
