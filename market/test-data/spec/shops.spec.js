...
const productionShops = require('../production-shops');
const testingShops = require('../testing-shops');
const freeTestingShops = require('../free-testing-shops');

const expectShop = shop => {
