...
public class SkuChangeStocksAmountMessageProducerTest extends AbstractContextualTest {

    @Autowired
    private SkuChangeStocksAmountMessageProducer messageProducer;
    ...
    @Test
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/1/queue_state.xml",
    ...
    @Test
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/2/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
     ...
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_stocks_amount_message_producer/3/queue_state.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/3/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
     ...
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_stocks_amount_message_producer/4/queue_state.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/4/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
     ...
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_stocks_amount_message_producer/6/warehouse_property.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/6/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
     ...
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_stocks_amount_message_producer/7/warehouse_property.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/7/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
    ...
    /**
     * Тест №8: проверка, что при ENABLE_RTY_NOTIFICATIONS_ABOUT_STOCKS_AMOUNT_CHANGING=false
     * ничего не попадет в очередь
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_stocks_amount_message_producer/8/warehouse_property.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_stocks_amount_message_producer/8/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
