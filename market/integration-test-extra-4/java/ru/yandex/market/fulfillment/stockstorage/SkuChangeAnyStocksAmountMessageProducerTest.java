...
public class SkuChangeAnyStocksAmountMessageProducerTest extends AbstractContextualTest {

    @Autowired
    private SkuChangeAnyStocksAmountMessageProducer messageProducer;
    ...
    @Test
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/1/queue_state.xml",
    ...
    public void pushBatchOnEmptyQueue() {
        ...
        messageProducer.produceIfNecessaryAsync(batch);
    ...
    @Test
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/2/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
     ...
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_any_stocks_amount_message_producer/3/queue_state.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/3/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
     ...
     */
    @Test
    @DatabaseSetup(value = "classpath:database/states/change_any_stocks_amount_message_producer/4/queue_state.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/4/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
    ...
    public void pushEmptyBatch() {
        messageProducer.produceIfNecessaryAsync(Collections.emptyList());
        asyncWaiterService.awaitTasks();
    }
    ...
    @Test
    @DatabaseSetup(
            value = "classpath:database/states/change_any_stocks_amount_message_producer/6/warehouse_property.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/6/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
    public void pushBatchWithDefaultAndDoNothingStrategies() {
        ...
        messageProducer.produceIfNecessaryAsync(ImmutableList.of(unitId1, unitId2, unitId3));
        asyncWaiterService.awaitTasks();
    }
    ...
    @Test
    @DatabaseSetup(
            value = "classpath:database/states/change_any_stocks_amount_message_producer/7/warehouse_property.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/7/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
    ...
    /**
     * Тест №8: проверка, что при ENABLE_RTY_NOTIFICATIONS_ABOUT_ANY_TYPES_OF_STOCKS_AMOUNT_CHANGING=false
     * ничего не попадет в очередь
     */
    @Test
    @DatabaseSetup(
            value = "classpath:database/states/change_any_stocks_amount_message_producer/8/warehouse_property.xml")
    @ExpectedDatabase(
            value = "classpath:database/expected/change_any_stocks_amount_message_producer/8/queue_state.xml",
            assertionMode = NON_STRICT_UNORDERED)
