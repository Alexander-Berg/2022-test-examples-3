...
class SQLValidationCallableStatement extends SQLValidationPreparedStatement<CallableStatement> implements CallableStatement {
    SQLValidationCallableStatement(CallableStatement statement, SQLValidator validator, ResultSetAccounter resultSetAccounter) {
        super(statement, validator, resultSetAccounter);
    }
