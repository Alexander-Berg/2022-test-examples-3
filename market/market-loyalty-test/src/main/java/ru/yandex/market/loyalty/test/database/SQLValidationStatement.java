...
class SQLValidationStatement<T extends Statement> implements Statement {
    protected T statement;
    private SQLValidator validator;
    private final ResultSetAccounter resultSetAccounter;

    SQLValidationStatement(T statement, SQLValidator validator, ResultSetAccounter resultSetAccounter) {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        resultSetAccounter.increase(rs.hashCode(), sql);

        return new ResultSetAdapter(rs) {
            @Override public void close() throws SQLException {
                resultSetAccounter.decrease(rs.hashCode());
                super.close();
            }
        };
    }
    ...
    //<editor-fold desc="not interesting">
    @Override
    public <U> U unwrap(Class<U> iface) throws SQLException {
    ...
    public void close() throws SQLException {
        ...
        if (currentResultSet != null && !currentResultSet.isClosed()) {
            resultSetAccounter.decrease(currentResultSet.hashCode());
        }
        statement.close();
    }
