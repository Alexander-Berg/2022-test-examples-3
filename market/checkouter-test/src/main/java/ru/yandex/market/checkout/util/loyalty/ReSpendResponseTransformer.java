...
public class ReSpendResponseTransformer extends AbstractLoyaltyBundleResponseTransformer {

    public ReSpendResponseTransformer(ObjectMapper marketLoyaltyObjectMapper) {
    ...
    public ResponseDefinition transform(
        ...
        // TODO: 22.06.2022 Вторая итерация
    ...
    public String getName() {
        return "loyalty-respend-cashback-transformer";
    }
}
