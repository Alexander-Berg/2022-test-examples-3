...
import BrandsListSuite from '@self/platform/spec/gemini/test-suites/blocks/Brands/brands-list';
    ...
    childSuites: [
        {
            ...
            before(actions) {
                ...
                MainSuite.before(actions);
                const selector = [PopularSuite.selector, BrandsListSuite.selector].join(', ');
