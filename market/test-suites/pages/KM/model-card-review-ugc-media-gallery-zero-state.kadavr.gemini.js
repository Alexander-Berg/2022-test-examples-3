...
import UgcMediaGalleryZeroStateSuite from '@self/platform/spec/gemini/test-suites/blocks/UgcMediaGallery/zeroState';
...
export default {
    suiteName: 'Model-card-review-UGC-media-gallery-zero-state[KADAVR]',
    ...
    before(actions) {
        ...
        const userReviewWithoutPhotos = createUserReviewWithoutPhotos(reviewProductId, reviewUserUid);
