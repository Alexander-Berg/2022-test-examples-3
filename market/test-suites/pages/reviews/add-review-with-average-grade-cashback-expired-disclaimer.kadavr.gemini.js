...
const userReviewWithAverageGrade = {
...
export default {
    suiteName: 'add-review-with-average-grade-cashback-expired-disclaimer[KADAVR]',
    url,
    before(actions) {
        createSession.call(actions);
        setState.call(actions, 'report', reportProduct);
        setState.call(actions, 'schema', {
            gradesOpinions: [userReviewWithAverageGrade],
            modelOpinions: [userReviewWithAverageGrade],
        });
