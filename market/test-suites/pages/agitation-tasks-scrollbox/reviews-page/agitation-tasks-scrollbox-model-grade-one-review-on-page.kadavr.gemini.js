...
/**
 * Одна агитация на оценку на товар на странице отзывов (один отзыв на странице)
 */
export default {
    suiteName: 'AgitationTasksScrollBoxOneSnippetReviewPageModelGrade[KADAVR]',
    url: {
        pathname: getPath(),
    },
    before(actions) {
