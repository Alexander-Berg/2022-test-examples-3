...
const permit = permitCreator(ROUTE_NAMES.MODEL_QUESTIONS);

export default {
    suiteName: 'Model questions',
    childSuites: USERS.reduce((suites, user) => {
        const vendor = 3301;
        const modelId = 6213009;
        const url = buildUrl(ROUTE_NAMES.MODEL_QUESTIONS, {vendor, modelId});
