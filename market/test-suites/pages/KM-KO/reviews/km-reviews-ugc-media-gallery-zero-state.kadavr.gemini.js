...
import {reportProduct, reviewWithoutPhotosSchema} from '../mocks/product-with-review.mock';

export default {
    suiteName: 'KM-reviews-UGC-media-gallery-zero-state[KADAVR]',
    url: '/product--random-fake-slug/14236972/reviews',
    before(actions) {
        createSession.call(actions);
        setState.call(actions, 'report', reportProduct);
        setState.call(actions, 'schema', reviewWithoutPhotosSchema);
