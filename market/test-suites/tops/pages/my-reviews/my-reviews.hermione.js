...
import UserReviewsAchievements from '@self/platform/spec/page-objects/UserReviewsAchievements';
import LockIcon from '@self/platform/spec/page-objects/components/ReviewsAchievement/LockIcon';
...
module.exports = makeSuite('Страница "Мои отзывы".', {
    environment: 'kadavr',
    story: {
        'Ачивки.': mergeSuites(
            {
            ...
            prepareSuite(ReviewsAchievementModalSuite, {
                hooks: {
                    async beforeEach() {
                        ...
                        return Promise.all([
                            this.userReviewsAchievements.getNthAchievementModalImageHref(1),
                            this.userReviewsAchievements.getNthAchievementModalImageHref(3),
                        ]).then(([prevAchievementImageHref, nextAchievementImageHref]) => {
                            this.params = assign({
                                prevAchievementImageHref,
                                nextAchievementImageHref,
                            }, this.params);
                ...
                hooks: {
                    async beforeEach() {
                        ...
                        return this.browser.yaProfile('ugctest3', 'market:my-reviews', {
                            ...
                            .yaClosePopup(this.createPageObject(RegionPopup))
                            .then(() => this.browser.waitForVisible(ReviewsAchievementModal.root, 5000));
                    },
                    afterEach() {
                        return this.browser.yaLogout();
                    },
