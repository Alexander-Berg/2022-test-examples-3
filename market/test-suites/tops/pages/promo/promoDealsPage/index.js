...
import RollPromoDealsSuite from '@self/platform/spec/hermione/test-suites/blocks/Roll/_promo-deals';
...
import Breadcrumbs from '@self/platform/spec/page-objects/Journal/JournalBreadcrumbs';
...
const SNIPPETS_COUNT_WITH_LOAD_MORE_BUTTON = 11;
...
export default makeSuite('Лендинг акций.', {
    ...
    story: mergeSuites(
        ...
        prepareSuite(RollPromoDealsSuite, {
            params: {
                snippetsCountBeforeLoading: 10,
        ...
        prepareSuite(FeedSnippetPromoDealsSuite, {
            params: {
                id: 0, // равен индексу первого элемента (проверяемого)
                entity: 'offer',
            },
            pageObjects: {
                feedSnippet() {
                    return this.createPageObject(FeedSnippet, {
