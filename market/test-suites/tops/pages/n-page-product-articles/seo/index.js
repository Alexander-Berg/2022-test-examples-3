...
// import productSeoMock from './mocks/product.mock';

const PRODUCT_ARTICLES_ROUT_NAME = 'market:product-articles';
            ...
            ({routeParams, testParams, mock}) => prepareSuite(PageH1Suite, {
                ...
                hooks: {
                    async beforeEach() {
                        ...
                        return this.browser.yaOpenPage(PRODUCT_ARTICLES_ROUT_NAME, routeParams);
                    },
                },
                params: testParams.articles,
            })
        ),
        createStories(
