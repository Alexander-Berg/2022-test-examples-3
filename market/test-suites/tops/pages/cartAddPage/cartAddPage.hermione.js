...
import embedCartAdd from '@self/platform/spec/hermione2/test-suites/blocks/embedCartAdd';
import embedCartAddFallbacks from '@self/platform/spec/hermione2/test-suites/blocks/embedCartAdd/fallbacks';
import {
    ...
    story: mergeSuites(
        prepareSuite(embedCartAdd, {
            pageObjects: {
                ...
                counterButton() {
                    return this.browser.createPageObject(CounterCartButton);
                },
            },
            hooks: {
                async beforeEach() {
        ...
        prepareSuite(embedCartAddFallbacks, {
            pageObjects: {
                view() {
                    return this.browser.createPageObject(EmbedCartAdd);
                },
