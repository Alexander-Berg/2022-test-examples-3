...
import notExist from './paymentOrderButton/notExist';

module.exports = makeSuite('Наличие кнопки "Оплатить".', {
    ...
    story: mergeSuites(
        ...
        makeSuite('Заказ типа доставки PICKUP', {
            ...
            story: prepareSuite(notExist, {
                suiteName: 'Статус заказа PROCESSING.',
                params: {
                    status: 'PROCESSING',
                },
            }),
