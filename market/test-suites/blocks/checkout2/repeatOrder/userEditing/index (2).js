...
import RecipientList from
    '@self/root/src/widgets/content/checkout/common/CheckoutRecipient/components/Popup/components/RecipientList/__pageObject/index.touch';
...
import RecipientPopup from '@self/root/src/widgets/content/checkout/common/CheckoutRecipient/components/Popup/__pageObject/index.touch.js';
                ...
                await this.browser.allure.runStep(
                    ...
                    async () => {
                        ...
                        await this.browser.allure.runStep(
                            ...
                            async () => {
                                await this.recipientPopupContainer.waitForVisible();
                            }
                        );
                    }
                );
                ...
                await this.browser.allure.runStep(
                    ...
                    async () => {
                        ...
                        await this.browser.allure.runStep(
                            'Выбрать пресет.',
                            async () => {
                                await this.recipientList.clickRecipientListItemByRecipient(editedRecipient);
                            }
                        );
                    }
                );
