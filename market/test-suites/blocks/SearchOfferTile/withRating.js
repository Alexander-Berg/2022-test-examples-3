 ...
 */
export default makeSuite('Тайловый сниппет оффера. Рейтинг и отзывы магазина.', {
    environment: 'kadavr',
    story: {
        'По умолчанию': {
            ...
            'должна отображаться кнопка "В магазин"': makeCase({
                ...
                issue: 'MARKETFRONT-6188',
                test() {
                    return this.snippet.goToShopButton.isExisting().should.eventually.to.equal(
        ...
        'При клике на кнопку "В магазин"': {
            'должен открываться сайт магазина в другой вкладке': makeCase({
                ...
                async test() {
                    ...
                    await this.snippet.clickGoToShopButton();
