 ...
 */
export default makeSuite('Форма отзыва на магазин. GET-параметр feedbackOrderId. Позитивный рейтинг доставки.', {
    id: 'm-touch-3389',
    issue: 'MARKETFRONT-16113',
    feature: 'Оставление отзыва',
    environment: 'kadavr',
    params: {
        expectedPositiveDeliveryQuestions: 'Список вопросов о доставке, если оценка позитивная',
    },
    story: {
        beforeEach() {
            ...
            'должен отображаться корректный список вопросов о доставке': makeCase({
                async test() {
                    ...
                    await this.shopReviewNew.getDeliveryTitle()
                        .should.eventually.be.equal('Что понравилось?', 'Заголовок вопросов правильный');
