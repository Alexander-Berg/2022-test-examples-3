    ...
    return {
        'Наличие у заказа ссылки "продлить".': makeCase({
            ...
            async test() {
                ...
                await this.browser.yaSlowlyScroll(ProlongateLink.root);
                await this.allure.runStep(
        ...
        'Успешное продление даты доставки на странице "Мои заказы".': makeCase({
        ...
        'Успешное продление даты доставки на странице заказа.': makeCase({
            // ПВЗ 'marketfront-5064'
            // Постамат 'marketfront-5065'
            id: type === 'PICKUP' ? 'marketfront-5064' : 'marketfront-5065',
            issue: 'MARKETFRONT-51587',
