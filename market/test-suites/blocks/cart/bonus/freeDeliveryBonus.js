...
module.exports = makeSuite('На бесплатную доставку.', {
    params: {
        deliveryBonus: 'Купон бесплатной доставки [получаем из конфига]',
    },
    defaultParams: {
        deliveryBonus: bonuses.FREE_DELIVERY,
    },
    story: {
        async beforeEach() {
            return prepareState.call(this, [this.params.deliveryBonus]);
        },
        'Бейджик не появляется у сниппета.': makeCase({
            id: 'bluemarket-2480',
            async test() {
