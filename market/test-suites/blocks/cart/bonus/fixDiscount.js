...
module.exports = makeSuite('на фиксированную скидку.', {
    params: {
        fixedBonus: 'Купон фиксированной скидки [получаем из конфига]',
    },
    defaultParams: {
        fixedBonus: bonuses.FIXED,
    },
    story: {
        async beforeEach() {
            return prepareState.call(this, [this.params.fixedBonus]);
        },
