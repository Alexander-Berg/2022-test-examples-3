...
module.exports = makeSuite('Заголовок группы фармы 2.', {
    environment: 'kadavr',
    id: 'm-touch-3612',
...
async function checkOrder() {
    await this.firstTitle.getTitleText().should.be.eventually.equal('Доставка Яндекса и продавцов');
    await this.secondTitle.getTitleText().should.be.eventually.equal('Лекарства и товары для здоровья');
}
