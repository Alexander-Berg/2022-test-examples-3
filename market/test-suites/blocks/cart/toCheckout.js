...
// import SimpleCheckout from '@self/project/src/widgets/content/checkout/simple/SimpleCheckout/components/View/__pageObject';
    ...
    story: {
        beforeEach() {
            this.setPageObjects({
                ...
                cartList: () => this.createPageObject(CartItemGroup),
                cartItem: () => this.createPageObject(CartItem, {parent: this.cartList.firstItem}),
                ...
                // simpleCheckout: () => this.createPageObject(SimpleCheckout),
                // checkoutCartItems: () => this.createPageObject(CheckoutCartItems, {
                //    parent: this.simpleCheckout,
                // }),
