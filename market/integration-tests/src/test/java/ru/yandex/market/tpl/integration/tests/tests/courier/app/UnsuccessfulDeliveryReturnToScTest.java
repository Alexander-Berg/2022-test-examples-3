...
public class UnsuccessfulDeliveryReturnToScTest {
    ...
    @Test
    @Feature("Доставка")
    @Stories({@Story("Забрать посылку из СЦ"), @Story("Отменить заказ"), @Story("Вернуть посылку в СЦ")})
    @DisplayName(value = "Тест отмены доставки и возврат посылки в СЦ")
    void test() {
