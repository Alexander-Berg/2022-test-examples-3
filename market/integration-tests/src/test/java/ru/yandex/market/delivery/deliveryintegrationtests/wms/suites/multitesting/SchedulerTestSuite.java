...
@DisplayName("Scheduler suite")
@SelectPackages("ru.yandex.market.delivery.deliveryintegrationtests.wms.tests.selenium.scheduler")
...
public class SchedulerTestSuite {
    ...
    public void runSuite() {
        ...
        Result run = junit.run(SchedulerTestSuite.class);
