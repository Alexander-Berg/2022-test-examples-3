...
public class DeliveryCreateOrderStressTest {
    private final DeliveryApiFacade deliveryApiFacade;
    private final ManualApiClient manualApiClient;
    private final StepwiseStressShooter stressShooter = new ConstStressShooter(2, 30);
    ...
    @BeforeEach
    void before() {
        this.externalOrderIds = IntStream.range(0, stressShooter.maxActionsCount())
    ...
    void test() {
        ...
        stressStat.clear();
        this.shootingResult = stressShooter.shoot(createActions);
