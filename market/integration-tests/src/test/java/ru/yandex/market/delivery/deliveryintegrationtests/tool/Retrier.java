...
import ru.yandex.market.delivery.deliveryintegrationtests.tool.exception.ClientLevelException;
import ru.yandex.market.delivery.deliveryintegrationtests.tool.exception.RetriedAssertionError;
        ...
        for (int i = 1; i <= RETRIES_TINY; i++) {
            ...
            try {
                ...
                if ((error instanceof ElementNotFound
                        || error instanceof InvalidElementStateException
