...
public class DeliveryGetOrdersStatusStressTest {
    private final DeliveryApiFacade deliveryApiFacade;
    private final ManualApiClient manualApiClient;
    private final StepwiseStressShooter stressShooter = new StepwiseStressShooter(50, 70, 10, 30);
