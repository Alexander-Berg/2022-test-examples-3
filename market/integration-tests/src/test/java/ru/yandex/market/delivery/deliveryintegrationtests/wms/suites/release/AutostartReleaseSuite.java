...
@DisplayName("Autostart Release Suite")
@SelectPackages("ru.yandex.market.delivery.deliveryintegrationtests.wms.tests.selenium.order")
@IncludeTags("AutostartReleaseSuite")
@RunWith(JUnitPlatform.class)
public class AutostartReleaseSuite {

    @Test
    public void runSuite() {
        JUnitCore junit = new JUnitCore();
        junit.addListener(new RunListener());
        Result run = junit.run(AutostartReleaseSuite.class);
