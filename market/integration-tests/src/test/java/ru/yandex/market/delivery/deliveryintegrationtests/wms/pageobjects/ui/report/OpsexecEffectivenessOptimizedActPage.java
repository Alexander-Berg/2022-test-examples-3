...
public class OpsexecEffectivenessOptimizedActPage extends ReportHistoryTabPage<OpsexecEffectivenessOptimizedActPage> {
    ...
    public OpsexecEffectivenessOptimizedActPage(WebDriver driver) {
        super(driver);
        wait.until(urlMatches(getUrl()));
    }

    protected String getUrl() {
        return "opsexeceffectiveness_grouped";
    }

    public OpsexecEffectivenessOptimizedActPage runReport(String currentDate, String timeFrom, String timeTo) {
        typeReport.click();
