...
@DisplayName("Time-Consuming Test Suite")
@SelectPackages("ru.yandex.market.deliveryintegrationtests.delivery.tests.dropship.DropshipWarehouseHandlingDurationTest")
