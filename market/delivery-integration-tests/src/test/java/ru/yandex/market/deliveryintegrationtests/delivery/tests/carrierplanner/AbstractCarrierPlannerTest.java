...
import step.CarrierPlannerSteps;
...
public abstract class AbstractCarrierPlannerTest extends AbstractTest {

    protected static final CarrierPlannerSteps CARRIER_PLANNER_STEPS = new CarrierPlannerSteps();
