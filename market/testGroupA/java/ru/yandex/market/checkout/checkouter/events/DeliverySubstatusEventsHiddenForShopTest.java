 ...
 * @author mmetlov
 */
public class DeliverySubstatusEventsHiddenForShopTest extends AbstractWebTestBase {
    ...
    public static Stream<Arguments> parameterizedTestData() {
        ...
        parameters.addAll(EventsTestUtils.parameters(new ClientInfo(ClientRole.SHOP, OrderProvider.SHOP_ID)));
        parameters.addAll(EventsTestUtils.parameters(new ClientInfo(ClientRole.SHOP_USER, 123L,
    ...
    public void shouldSkipDeliverySubstatusChangeEvents(String caseName, EventsTestUtils.EventGetter eventGetter)
            throws Exception {
        ...
        assertThat(lastNEvents(events, 1), contains(
        ...
        assertThat(event.getOrderBefore().getSubstatus(), is(nullValue()));
        assertThat(event.getOrderAfter().getStatus(), is(DELIVERED));
        assertThat(event.getOrderAfter().getSubstatus(), is(OrderSubstatus.DELIVERY_SERVICE_DELIVERED));
    }
}
