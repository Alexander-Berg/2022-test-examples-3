...
public class CrmRobotCancellationRequestProcessingTest extends AbstractWebTestBase {
    ...
    public void createCancellationRequestStarted() throws Exception {
        ...
        response = cancellationRequestHelper.createCancellationRequest(
                order.getId(), cancellationRequest, CRM_ROBOT_CLIENT_INFO);
        ...
        order = orderStatusHelper.updateOrderStatus(order.getId(), CRM_ROBOT_CLIENT_INFO, CANCELLED, USER_CHANGED_MIND);
