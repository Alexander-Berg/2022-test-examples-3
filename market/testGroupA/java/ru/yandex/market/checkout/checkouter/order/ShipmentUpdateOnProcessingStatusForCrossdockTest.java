...
public class ShipmentUpdateOnProcessingStatusForCrossdockTest extends AbstractWebTestBase {
    ...
    public void setUp() {
        ...
        supplierShipmentDateTime = Instant.parse("2019-10-14T13:40:00Z");
        ...
        parameters.getBuiltMultiCart()
                .getCarts()
                .forEach(o -> o.setProperty(OrderPropertyType.ASYNC_OUTLET_ANTIFRAUD, true));
