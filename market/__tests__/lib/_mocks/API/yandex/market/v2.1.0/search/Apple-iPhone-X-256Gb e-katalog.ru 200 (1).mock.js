...
const query = {
    text: 'url:"www.e-katalog.ru/APPLE-IPHONE-X-256GB.htm*"'
};

const result = {
    comment: 'text = "url:"www.e-katalog.ru/APPLE-IPHONE-X-256GB.htm*""',
    status: 200,
    body: {
        status: 'OK',
        context: {
            ...
            processingOptions: {
                checkSpelled: true,
                text: 'url:"www.e-katalog.ru/APPLE-IPHONE-X-256GB.htm*"',
                actualText: 'url:"www.e-katalog.ru/APPLE-IPHONE-X-256GB.htm*"',
                highlightedText: '',
                adult: false
            },
