...
const RESPONSE = expect.objectContaining({
    ...
    searchInfo: {
        originalQuery: 'Электрическая зубная щетка Braun Oral-B Vitality D12.514K Frozen',
        filteredQuery: 'Электрическая зубная щетка Braun Oral-B Vitality D12.514K Frozen',
        convertedPrice: {
