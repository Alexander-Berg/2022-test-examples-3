...
const expectedOffers = [
    {
        ...
        shop: {
            ...
            rating: { value: 5, count: 53, status: { id: 'ACTUAL', name: 'Рейтинг нормально рассчитан' } },
            organizations: [
                {
                    name: 'Индивидуальный предприниматель Ащин Илья Евгеньевич',
                    ogrn: '311774609700375',
        ...
        delivery: {
            ...
            inStock: false,
            global: false,
            options: [{ service: { id: 99, name: 'Собственная служба доставки' }, brief: 'на&nbsp;заказ' }],
            localOptions: [{ conditions: { price: { value: '300' } }, default: true }]
        },
        category: {
            id: 7811901,
            name: 'Платья',
        ...
        vendor: { id: 15153371, name: 'Бутик Полной Моды' },
        warranty: false,
        recommended: false,
        link:
            'https://market.yandex.ru/offer/RmQaLeqbFva3C8kl_Kc3Ew?hid=7811901&model_id=1846357271&pp=1002&clid=2210590&distr_type=4&cpc=wZMYL9_a9ajzF4Aoh9pWxRD8IEVny7ACi43t0yHuZYDl_J2Shfaq-sBVkaDR7Zz5NKkxRPH6VbzkC4ynieu41BCsRadfVirmfsh9St2-ZrwPoI_Kz59RUn5_zBYQ0-9K&lr=213',
        paymentOptions: { canPayByCard: false },
        bigPhoto: {
            width: 377,
            height: 566,
            url: 'https://avatars.mds.yandex.net/get-marketpic/248830/market_62FmoJHVzLePI2KnG8Pb0w/orig'
        ...
        context: {
            ...
            page: { number: 1, count: 30, total: 1, totalItems: 21 },
            processingOptions: {
                checkSpelled: true,
                text: 'Платье, Adelin Fostayn',
                actualText: 'Платье, Adelin Fostayn',
