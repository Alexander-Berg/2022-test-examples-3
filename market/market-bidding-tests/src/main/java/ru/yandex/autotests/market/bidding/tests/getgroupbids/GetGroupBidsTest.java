package ru.yandex.autotests.market.bidding.tests.getgroupbids;
 ...
 * Date: 17.09.2014
 */
@Aqua.Test(title = "Запрос GET /groups/{groupId}/bids")
@Features("GET /groups/{groupId}/bids")
@Stories("Сравнивание с БД")
@Issue("AUTOTESTMARKET-42")
@RunWith(Parameterized.class)
public class GetGroupBidsTest {
    ...
    public GetGroupBidsTest(long groupId) {
    ...
    @Test
    @Title("Запрос GET /groups/{groupId}/bids должен возвращать данные из БД")
    public void getGroupBidsRequestShouldReturnDataFromDatabase() {
        bidding.backend.group(shopId, groupId).shouldReturnBidsFrom(bidding.database);
    }
}
