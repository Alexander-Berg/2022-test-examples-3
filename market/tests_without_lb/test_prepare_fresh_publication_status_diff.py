...
PARTNERS = [
    # shop_id=1..9 - включенные магазины -> диффы не считаем
    {
        'shop_id': i,
        'status': 'publish',
        'mbi': dict2tskv({
    ...
    # shop_id=10 магазин в шопсдате выключен -> диффы не считаем
    {
        'shop_id': 10,
        'status': 'disable',
        'mbi': dict2tskv({
    ...
    # shop_id=20 магазина нет в шопсдат -> дифы не считаем
    ...
    # shop_id=40 магазин в шопсдате в PS -> дифф считаем
    {
        'shop_id': 40,
        'status': 'disabled',
        'mbi': dict2tskv({
...
OFFERS = [
    {
        'business_id': 1,
        'offer_id': 'only_external_without_warehouse_skip',
        'shop_id': 2,
        'warehouse_id': 0,
    ...
    {
        'business_id': 2,
        'offer_id': 'only_external_with_warehouse_skip',
        'shop_id': 2,
        'warehouse_id': 1,
        'add_to_datacamp_table': False,
        'add_to_indexation_table': True,
    ...
    {
        'business_id': 7,
        'offer_id': 'unknown2published_without_version',
        'shop_id': 7,
        'warehouse_id': 7,
    ...
    {
        'business_id': 7,
        'offer_id': 'unknown2not_published_without_version',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
    ...
    {
        'business_id': 3,
        'offer_id': 'both_offer_mismatch',  # but only datacamp warehouse
        'shop_id': 2,
        'warehouse_id': 1,
        'add_to_datacamp_table': True,
    ...
    {
        'business_id': 3,
        'offer_id': 'both_offer_mismatch',  # but only external warehouse
        'shop_id': 2,
        'warehouse_id': 2,
        'add_to_datacamp_table': False,
        'add_to_indexation_table': True,
    ...
    {
        'business_id': 4,
        'offer_id': 'only_datacamp_offer_without_warehouse',
        'shop_id': 2,
        'warehouse_id': 0,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': False,
    ...
    {
        'business_id': 4,
        'offer_id': 'only_datacamp_offer_with_warehouse',
        'shop_id': 2,
        'warehouse_id': 4,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': False,
    ...
    {
        'business_id': 4,
        'offer_id': 'only_datacamp_offer_without_warehouse_not_published',
        'shop_id': 2,
        'warehouse_id': 0,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': False,
    ...
    {
        'business_id': 4,
        'offer_id': 'only_datacamp_offer_without_publication',
        'shop_id': 3,
        'warehouse_id': 6,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': False,
    ...
    },
    {
        ...
        'external_publication_status': None,
        'verdicts': None,
        'external_verdicts': [DTC.Explanation(code='333'), DTC.Explanation(code='555')],
        'version': None,
        'external_version': None
    },
    {
        'business_id': 7,
        'offer_id': 'no_versions',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
        ...
        'external_publication_status': DTC.PublicationStatus.NOT_PUBLISHED,
        'verdicts': None,
        'external_verdicts': [DTC.Explanation(code='333')],
        'version': None,
        'external_version': None
    },
    {
        'business_id': 7,
        'offer_id': 'offer_version_first_time_and_not_published',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
        ...
        'external_verdicts': [DTC.Explanation(code='333')],
        'version': None,
        'external_version': DTC.VersionCounter(counter=7)
    },
    {
        'business_id': 7,
        'offer_id': 'offer_version_first_time',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
    ...
    },
    {
        ...
        'verdicts': None,
        'external_verdicts': [DTC.Explanation(code='333')],
        'version': DTC.VersionCounter(counter=77),
        'external_version': DTC.VersionCounter(counter=77)
    },
    {
        'business_id': 7,
        'offer_id': 'diff_versions_equal_status',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
        ...
        'external_verdicts': None,
        'version': DTC.VersionCounter(counter=77),
        'external_version': DTC.VersionCounter(counter=78)
    },
    {
        'business_id': 7,
        'offer_id': 'diff_versions_and_status',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
    ...
    {
        'business_id': 7,
        'offer_id': 'diff_versions_with_same_status',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': True,
    ...
    {
        'business_id': 7,
        'offer_id': 'offer_only_in_generation',
        'shop_id': 7,
        'warehouse_id': 7,
        'add_to_datacamp_table': True,
        'add_to_indexation_table': False,
    ...
    },
    {
        ...
        'external_verdicts': None,
        'version': None,
        'external_version': DTC.VersionCounter(counter=7777)
    },
...
def build_row(business_id, offer_id, shop_id, warehouse_id, timestamp=10, publication_status=None, verdicts=None, version=None):
    offer = DTC.Offer(
        ...
        offer.status.CopyFrom(
            DTC.OfferStatus(
                publication=DTC.PublicationStatus(
                    ...
                    original_partner_data_version=version
                ),
            )
        )
...
def build_offers(offers, add_row_key, publication_status_key, verdicts_key, version_key):
    result = list()
    for offer in offers:
...
def datacamp_offers():
    return build_offers(OFFERS, 'add_to_datacamp_table', 'publication_status', 'verdicts', 'version')


@pytest.fixture(scope='module')
def external_offers():
    return build_offers(OFFERS, 'add_to_indexation_table', 'external_publication_status', 'external_verdicts', 'external_version')
    ...
    config = RoutinesConfigMock(
        ...
        config={
            ...
            'yt': {
                ...
                'publication_status_diff_dir': 'yt_fresh_publication_status_diff_dir',
...
@pytest.yield_fixture(scope='module')
def prepare_fresh_publication_status_diff_http_request(routines_http, config):
    response = routines_http.post('/prepare_fresh_publication_status_diff?cluster={}&color={}&table=//home/external'.format(
...
@pytest.yield_fixture(scope='module')
def result_offers(yt_server, config, prepare_fresh_publication_status_diff_http_request):
    yt_client = yt_server.get_yt_client()
    return list(yt_client.read_table(yt.ypath_join(config.yt_fresh_publication_status_diff_dir, 'recent')))


def test_response(prepare_fresh_publication_status_diff_http_request):
    assert_that(prepare_fresh_publication_status_diff_http_request, HasStatus(200))


def test_yql_attribute(yt_server, prepare_fresh_publication_status_diff_http_request, config):
    yt_client = yt_server.get_yt_client()
    attr = yt_client.get(config.yt_fresh_publication_status_diff_dir + '/recent/@_yql_proto_field_offer')

    assert_that(attr, is_not(None))


def test_timestamp(yt_server, prepare_fresh_publication_status_diff_http_request, config):
    yt_client = yt_server.get_yt_client()
    attr = yt_client.get(config.yt_fresh_publication_status_diff_dir + '/recent/@timestamp')
...
def test_skip_non_datacamp(result_offers):
...
def test_mismatch(result_offers):
    assert_that(result_offers, is_not(HasDatacampYtUnitedOffersRows([
        {
            'business_id': 3,
            'offer_id': 'both_offer_mismatch',
            'shop_id': 2,
            'warehouse_id': 1,
            'offer': IsSerializedProtobuf(DTC.Offer, {
                'identifiers': {
...
def test_no_version(result_offers):
    assert_that(result_offers, HasDatacampYtUnitedOffersRows([
        {
            'business_id': 7,
            'offer_id': 'unknown2published_without_version',
...
def test_verdicts(result_offers):
    assert_that(result_offers, is_not(HasDatacampYtUnitedOffersRows([
        {
            'business_id': 5,
            'offer_id': 'empty_verdicts',
...
def test_versions(result_offers):
    assert_that(result_offers, is_not(HasDatacampYtUnitedOffersRows([
        {
            'business_id': 7,
            'offer_id': 'no_versions',
    ...
    assert_that(result_offers, is_not(HasDatacampYtUnitedOffersRows([
        {
            ...
            'offer': IsSerializedProtobuf(DTC.Offer, {
                ...
                'status': {
                    'publication': {
                        'value': DTC.PublicationStatus.NOT_PUBLISHED,
                        'original_partner_data_version': DTC.VersionCounter(counter=7),
                    },
                },
                'resolution': {
                    'by_source': [{
    ...
    assert_that(result_offers, is_not(HasDatacampYtUnitedOffersRows([
        {
            ...
            'offer': IsSerializedProtobuf(DTC.Offer, {
                ...
                'status': {
                    'publication': {
                        'value': DTC.PublicationStatus.PUBLISHED,
                        'original_partner_data_version': DTC.VersionCounter(counter=78),
                    },
                },
            }),
        },
    ...
    assert_that(result_offers, HasDatacampYtUnitedOffersRows([
        {
            ...
            'offer': IsSerializedProtobuf(DTC.Offer, {
                ...
                'status': {
                    'publication': {
                        'value': DTC.PublicationStatus.PUBLISHED,
                        'original_partner_data_version': DTC.VersionCounter(counter=7777),
                    },
                },
            }),
        },
