 ...
 * @date 9/2/15
 */
@Aqua.Test(title = "Тест на архивацию feed_log в YT")
@Feature("barc")
...
@ContextConfiguration({
        "classpath*:ru/yandex/autotests/market/billing/backend/barc/FeedLogMigrationTestSupport.xml",
...
public class FeedLogMigrationTest {
    @ClassRule
    ...
    public void testDataExists() throws IOException {
        ...
        long count = barcDaoSteps.getYTFeedLogsCount(
    ...
    public void testEquivalency() throws IOException {
        archivingSteps.compareBillingAndYTArchivedFeedLog(
