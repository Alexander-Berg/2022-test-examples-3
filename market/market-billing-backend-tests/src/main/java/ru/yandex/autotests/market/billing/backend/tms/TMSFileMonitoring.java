 ...
 */
@Aqua.Test(title = "Мониторинг обновления файлов в эллиптиксе после запуска соответствующих tms задач")
@Feature("tmsTask.monitoring")
@RunWith(Parameterized.class)
public class TMSFileMonitoring {
    ...
    private static MarketBillingConsoleResource consoleResource = new MarketBillingConsoleResource(ConsoleConnector.BILLING);
