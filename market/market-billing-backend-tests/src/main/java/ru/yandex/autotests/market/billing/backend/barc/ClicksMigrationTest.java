...
import ru.yandex.autotests.market.billing.backend.core.dao.wuser.configuration.WuserDatasource;
import ru.yandex.autotests.market.billing.backend.core.dao.wuser.service.MigrationClicksService;
import ru.yandex.autotests.market.billing.backend.core.dao.yql.YTClicksService;
 ...
 * @since 07.06.17
 */
@Aqua.Test(title = "Тест на архивацию clicks в YT")
@Feature("barc")
...
@CommonSpringTest(classes = {
        ...
        MigrationClicksService.class,
        YTClicksService.class, MarketBillingConsoleFactory.class})
@WuserDatasource
@ActiveProfiles(profiles = {"test", "migration"})
@ContextConfiguration({
        "classpath*:ru/yandex/autotests/market/billing/backend/barc/ClicksMigrationTestSupport.xml",
...
public class ClicksMigrationTest {
    @ClassRule
    ...
    @Test
    @Title("Джоба migrateClicksExecutor отработала без ошибок")
    ...
    public void testDataExists() throws IOException {
        ...
        long count = barcDaoSteps.getYTClicksCount(
    ...
    public void testEquivalency() throws IOException {
        archivingSteps.compareBillingAndYTArchivedClicks(
