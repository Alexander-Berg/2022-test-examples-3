...
import ru.yandex.autotests.market.billing.backend.core.dao.yql.YTAuctionResultService;
 ...
 * @since 13.06.17
 */
@Aqua.Test(title = "Тест на архивацию auction_rule в YT")
@Feature("barc")
@CommonSpringTest(classes = {
        ...
        YTAuctionResultService.class, MarketBillingConsoleFactory.class})
@ActiveProfiles(profiles = {"test", "migration"})
@ShopsWebDatasource
@ContextConfiguration({
        "classpath*:ru/yandex/autotests/market/billing/backend/barc/AuctionResultMigrationTestSupport.xml",
...
public class AuctionResultMigrationTest {
    @ClassRule
    ...
    @Test
    @Title("Джоба migrateAuctionResultExecutor отработала без ошибок")
    ...
    public void testDataExists() throws IOException {
        ...
        long count = barcDaoSteps.getYTAuctionResultsCount(
    ...
    public void testEquivalency() throws IOException {
        archivingSteps.compareBillingAndYTArchivedAuctionResult(
