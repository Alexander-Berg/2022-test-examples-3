...
test_data = [
    {
        'offer_id': '1',
        'expected_exclusive': None,
    },
    {
        'offer_id': '2',
        'exclusive': '1',
        'expected_exclusive': '1',
    },
]
...
def test_exclusive_snippet(genlog_snippet_workflow):
    expected_exclusive = [
        {
            'offer_id': x['offer_id'],
            'exclusive': x['expected_exclusive'],
        }
        for x in test_data
    ]
    for expected in expected_exclusive:
        assert_that(
            genlog_snippet_workflow,
