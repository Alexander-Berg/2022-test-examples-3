...
test_data = [
    ...
    # blue offers
    {
        ...
        'model_id': 1,
        'expected_url': (
            'https://market.yandex.ru/product/1?offerid=dddddddddddddddddddddd&sku=0'
        ),
    },
    {
        'offer_id': '40',
        ...
        'model_id': 1,
        'expected_url': (
            'https://market.yandex.ru/product--novyi-iphone-m-pro/1?'
            'offerid=dddddddddddddddddddddd&sku=0'
        ),
    },
    {
        'offer_id': '400',
        ...
        'expected_url': (
            'https://market.yandex.ru/product--novyi-iphone-m-pro/1?'
            'offerid=dddddddddddddddddddddd&sku=100500'
        ),
    },
    {
        'offer_id': '5',
        ...
        'expected_url': (
            ...
            'offerid=eeeeeeeeeeeeeeeeeeeeee&sku=0'
        ),
    },
    {
        'offer_id': '50',
        ...
        'model_id': 1,
        'expected_url': (
            'https://market.yandex.ru/product--bubushkofon-3000/1?'
            'offerid=eeeeeeeeeeeeeeeeeeeeee&sku=0'
        ),
    },
    {
        ...
        'expected_url': (
            'https://market.yandex.ru/product--bubushkofon-3000/1?'
            'offerid=eeeeeeeeeeeeeeeeeeeeee&sku=500100'
        ),
    },
]
