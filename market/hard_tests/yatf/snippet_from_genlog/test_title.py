...
test_data = [
    ...
    },
    {
        'offer_id': '3',
        'feed_id': 3,
        'title': 'Самый лучший на свете Apple iPhone 10x "№,°\'` ®:',
    },
]
...
def test_title_arc(arc_workflow, expected_title_arc):
    for expected in expected_title_arc:
        assert_that(
            arc_workflow,
...
def test_title_snippet(genlog_snippet_workflow, expected_title_snippet):
    for expected in expected_title_snippet:
        assert_that(
            genlog_snippet_workflow,
