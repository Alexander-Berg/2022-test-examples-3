...
test_data = [
    {
        'offer_id': '1',
        'expected_hype_goods': None,
    },
    {
        'offer_id': '2',
        'hype_goods': True,
        'expected_hype_goods': '1',
    },
    {
        'offer_id': '3',
        'hype_goods': False,
        'expected_hype_goods': '0',
    },
]
...
def genlog_rows():
    ...
    for data in test_data:
        offer = default_genlog(
            ...
            hype_goods=data.get('hype_goods', None),
        )
        feed.append(offer)
    return feed
...
def test_hype_goods_snippet(genlog_snippet_workflow):
    expected_hype_goods = [
        {
            'offer_id': x['offer_id'],
            'hype_goods': x['expected_hype_goods'],
        }
        for x in test_data
    ]
    for expected in expected_hype_goods:
        assert_that(
            genlog_snippet_workflow,
