...
import static ru.yandex.market.logistics.test.integration.db.PostgresqlDataTypeFactoryExt.TEXT_ARRAY;

/**
 * Тип колонки TEXT[].
 *
 * Пример использования: list_column="{value1,value2}"
 */
public class TextArrayDataType extends AbstractDataType {

    public TextArrayDataType() {
        super(TEXT_ARRAY, Types.OTHER, Array.class, false);
    }
