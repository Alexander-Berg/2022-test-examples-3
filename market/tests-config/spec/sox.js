...
// const {readTestPalmOAuthToken} = require('../readOAuthToken');
//
// // https://wiki.yandex-team.ru/testpalm/testpalmdoc/api/
// const TP_API = new URL('https://testpalm-api.yandex-team.ru/');
// const TESTPALM_OAUTH_API_TOKEN = process.env['TESTPALM_OAUTH_API_TOKEN'] || readTestPalmOAuthToken();
...
//                     if (soxSet.has(id)) {
//                         failures.push(id);
//                         console.warn(`${name}: ${issue} ${id} ${fullName}`);
//                     }
//                 }
//             }
//         }
