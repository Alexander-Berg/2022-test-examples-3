...
class MainTest(unittest.TestCase):
    ...
    #         ticket,
    #         [u'damir-askarov', u'm-krasavin', u'yaroshevsk'],
    #         u"""Пожалуйста, напишите "OK", если готовы согласовать тикет.OK ожидается от каждого призванного руководителя.
    #                 + +!!(yellow)(?_код_автоматизации_markethire/ok_requested_stage=offer?)!!++""",
    #     )
    #     set_heads_ok(ticket, [u'damir-askarov', u'm-krasavin', u'yaroshevsk'])
    #
    #     add_summon_comment(
    #         ticket,
    #         [u'kiko'],
    #         u"""Все руководители согласовали тикет.
    #             + +!!(yellow)(?_код_автоматизации_markethire/ok_hr_requested_stage=offer?)!!++""",
    #     )
    #
    ...
    #     processor.create_comment.assert_called_with(
    #         TICKET_ID,
    #         u'Все руководители и HR согласовали тикет.',
    #         requested=[u'avalkov'],
