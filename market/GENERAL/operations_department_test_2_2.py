...
TICKET_ID = u'MARKETJOBTEST-14'
DEPARTMENT = u'yandex_monetize_market_3957_9270'
TYPE = u'hire_to_replace'
STAGE = u'vacancy'


# Департамент операционного управления - вакансия на замену
class MainTest(unittest.TestCase):
    ...
    def test_call_1(self):
        ...
        self.assertListEqual(res, [u'apogorelets', u'avalkov'])
    ...
    def test_call_3(self):
        ...
        set_heads_ok(ticket, [u'apogorelets', u'avalkov'])
    ...
    def test_call_4(self):
        ...
        processor = OperationsDepartmentProcessor()
        processor.create_comment = Mock()
        processor.summon_ceo2 = Mock()

        processor.process_ticket(ticket, ticket['dep'], root_deps)

        processor.create_comment.assert_called_once()
        processor.summon_ceo2.assert_not_called()
        processor.create_comment.assert_called_with(
            TICKET_ID,
