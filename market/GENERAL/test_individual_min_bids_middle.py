...
MIN_BID2_CARD_2000 = 50  # 0.5 * 34 + 0.5 * ceil(0.01 * 0.1 * 20000 / 0.3) = 50
...
class T(TestCase):
    ...
    def prepare_min_bids2(cls):
        cls.index.creation_time = 1583226000  # Tue Mar  3 12:00:00 STD 2020 , in the middle of experiment (partial on)
    ...
    def test_individual_min_bids_on(self):
        '''
        Проверяем, что значение минимального бида зависит от цены оффера и мин. цены модели.
        '''
