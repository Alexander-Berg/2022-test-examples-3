...
class T(TestCase):
    """
    Проверяем работу индивидуальных ставок ДО момента начала перехода
    """

    @classmethod
    def prepare_min_bids2(cls):
        cls.index.creation_time = 1582621200  # Tue Feb 25 12:00:00 STD 2020 , first day of experiment (still off)
