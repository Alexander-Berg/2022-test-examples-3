-- Automatically saved for VIEW.SITE_CATALOG.V_AS_CLUST_LIST_METRIC_TEST at 2022/04/12

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SITE_CATALOG"."V_AS_CLUST_LIST_METRIC_TEST" ("ID", "NAME", "DATA_COUNT", "NEW_PAIRS_COUNT", "LAST_EDITOR_LOGIN", "CHECKING_STATE", "ASSESS_TYPE", "CHECK_DATE", "CLUSTER_PRECISION", "CLUSTER_RECALL", "CLUTCHER_RECALL", "F1_CLUSTER", "R1_CLUSTER", "GROUP_ID", "CREATE_DATE", "IS_ROBOT_LIST") AS 
  SELECT "ID",
      list_info.name
      || ' ('
