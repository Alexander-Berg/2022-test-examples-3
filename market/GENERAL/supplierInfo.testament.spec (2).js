...
const WIDGET_PATH = require.resolve('@self/platform/widgets/pages/ShopInfoPage');
    ...
    describe('Информация о продавце', () => {
        ...
        describe('Юридическая информация о СМЗ', () => {
            test('Отображается только ИНН и ФИО', async () => {
                ...
                const fullNameText = await screen.findByText(`Владелец: ${FULL_NAME}`);
