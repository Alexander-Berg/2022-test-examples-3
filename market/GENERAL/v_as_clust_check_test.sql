...
CREATE OR REPLACE FORCE VIEW "V_AS_CLUST_CHECK_TEST" ("LIST_ID", "FIRST_OFFER_ID", "SECOND_OFFER_ID", "OPERATOR_STATUS", "FIRST_OFFER_ID_CLUSTER", "SECOND_OFFER_ID_CLUSTER", "TP", "FP", "TN", "FN") AS
