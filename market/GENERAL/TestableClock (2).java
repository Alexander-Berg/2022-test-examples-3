package ru.yandex.market.checkout.common.time;
...
public class TestableClock extends Clock {
    ...
    @Nonnull
    public static TestableClock getInstance() {
        return TestableClockHolder.INSTANCE;
    }
    ...
    static class TestableClockHolder {

        private static final TestableClock INSTANCE = new TestableClock();
    }
}
