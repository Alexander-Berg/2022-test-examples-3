...
class T(TestCase):
    ...
    def test_contextual_wizard_for_error_message(self):
        ...
        self.report.request_bs('place=parallel&text=apple&rids=202')
    ...
    def test_has_books_in_result(self):
        ...
        """
        result = self.report.request_bs('place=parallel&text=5779310157&ignore-mn=1&debug=1')
        ...
        result = self.report.request_bs('place=parallel&text=5779310158&ignore-mn=1&debug=1')
        self.assertFalse(result.contains('basesearch-book')[0])

    def test_tbs_and_prun(self):
        response = self.report.request_bs('place=parallel&text=iphone&debug=1')
        ...
        response = self.report.request_bs(
            'place=parallel&text=iphone&rearr-factors=prun-count=1000;tbs-value=1000;tbs-version=0;tbs-to-tbh-mul=2.5&debug=1'
        )
    ...
    def test_wizard_rules_and_empty_qtree4market(self):
        ...
        response = self.report.request_bs(
            'place=parallel&text=test&rearr-factors=market_parallel_wizard=1&wizard-rules={"Market":null}', strict=False
        )
    ...
    def test_non_product_request_threshold_experiment_empty_request(self):
        ...
        """
        request = 'place=parallel&rearr-factors=non_product_request_threshold=0.03;market_parallel_wizard=1&text='
    ...
    def test_debug_category_factors(self):
        ...
        response = self.report.request_bs(
            'place=parallel&text=iphone&debug=1&rearr-factors=market_categ_wiz_with_redirect_formula=1'
        )
    ...
    def test_category_relevance_and_redirect_factors(self):
        ...
        response = self.report.request_bs(
            'place=parallel&text=iphone&rearr-factors=market_categ_wiz_with_redirect_formula=1'
        )
        ...
        response = self.report.request_bs(
            'place=parallel&text=phone&rearr-factors=market_categ_wiz_with_redirect_formula=1'
        )
    ...
    def test_additional_blender_factors(self):
        ...
        """
        response = self.report.request_bs(
            'place=parallel&text=iphone&rearr-factors=market_parallel_calc_factors_aggr=0'
        )
        self.assertFragmentIn(
            response,
            {
        ...
        response = self.report.request_bs(
            'place=parallel&text=iphone&rearr-factors=market_calc_region_factors=1;market_parallel_calc_factors_aggr=0'
        )
        self.assertFragmentIn(response, {"market_factors": [{"base.user_distance_to_moscow_max": NotEmpty()}]})

        response = self.report.request_bs(
            'place=parallel&rids=213&text=паяльник+детский&rearr-factors=market_parallel_calc_factors_aggr=0'
        )
        self.assertFragmentIn(
            response,
            {
        ...
        response = self.report.request_bs(
            'place=parallel&rids=213&text=паяльник+детский'
    ...
    def test_json_format(self):
        ...
        response = self.report.request_json(
            'place=parallel&rids=213&text=паяльник+детский&bsformat=2&debug=da&trace-wizards=1&debug-doc-count=10'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_model_blender_factors(self):
        ...
        """
        query = 'place=parallel&text=model+with+factors&rearr-factors=market_parallel_calc_factors_aggr=0'
    ...
    def test_doc_factors(self):
        ...
        """
        request = 'place=parallel&text=learn+formula&debug=da'
        ...
        request = 'place=parallel&text=special+blue+offer&debug=da&rearr-factors=market_cpa_offers_incut_count=0;'
        ...
        request = 'place=parallel&text=direct&debug=da&rearr-factors=market_enable_direct_offers_wizard=1'
        response = self.report.request_bs(request)
        self.assertFragmentIn(
            response,
            {
    ...
    def test_disabled_doc_factors(self):
        ...
        request = 'place=parallel&text=iphone disabled&debug=da&rearr-factors=market_enable_direct_offers_wizard=1;market_disable_document_factors={}'
    ...
    def test_response_error(self):
        ...
        """
        response = self.report.request_xml('place=parallel&text=%F0', strict=False)
        self.assertFragmentIn(
            response,
            '''
            <error code="1010">
        ...
        response = self.report.request_json('place=parallel&text=%F0', strict=False)
        self.assertFragmentIn(
            response,
            {
                'error': {
        ...
        response = self.report.request_bs_pb('place=parallel&text=%F0', strict=False)
        ...
        response = self.report.request_plain('place=parallel&text=%F0&bsformat=7&hr=json', strict=False)
    ...
    def test_offer_incut_bg(self):
        ...
        response = self.report.request_bs(
            "place=parallel&text=iphone&debug=1&rearr-factors=market_parallel_wizard=1&wizard-rules={}&relev-factors=bgfactors=FeXQkj-1AT0Klz_AAQGSCgUVPQoHQA,,".format(
    ...
    def test_fixed_qtree_on_misspell(self):
        ...
        def make_request(text, qtree_markup, use_fixed_tree=True, misspell_threshold=None):
            request = 'place=parallel&text={0}'.format(text)
    ...
    def test_search_in_top_kishka(self):
        ...
        _ = self.report.request_bs(
            'place=parallel&text=kawabunga&rids=213&debug=da&trace_wizard=1' '&rearr-factors=parallel_allow_panther=0;'
        )

        _ = self.report.request_bs('place=parallel&text=kawabunga&rids=213&debug=da&trace_wizard=1')

        _ = self.report.request_bs(
            'place=parallel&text=kawabunga&rids=213&debug=da&trace_wizard=1' '&rearr-factors=parallel_smm=1.0'
        )
    ...
    def test_search_in_top_kishka_2(self):
        ...
        _ = self.report.request_bs(
            'place=parallel&text=kawabunga&rids=213&debug=da&trace_wizard=1' '&rearr-factors=parallel_smm=0.1'
        )
    ...
    def test_bids_and_formula_in_output(self):
        ...
        response = self.report.request_bs_pb('place=parallel&text=talkysh+kaleve&debug=da')
        searcher_props = response.get_searcher_props()
    ...
    def test_fixed_base_formula(self):
        ...
        response = self.report.request_bs(
            'place=parallel&text=gvozdoder&rearr-factors=market_offers_incut_threshold=0.0;'
        )
    ...
    def test_request_factors(self):
        ...
        """
        response = self.report.request_bs('place=parallel&text=kiyanka+rezinovaya&debug=1')
    ...
    def test_request_factors_feature_log(self):
        ...
        for _ in range(20):  # Факторы пишутся только на каждый 10 запрос
            self.report.request_bs_pb('place=parallel&text=iphone&reqid=12345')
        self.feature_log.expect(
            document_type=9,
            req_id=12345,
    ...
    def test_reject_stop_request(self):
        ...
        https://st.yandex-team.ru/MARKETOUT-40384
        """
        response = self.report.request_bs('place=parallel&text=маркет')
        self.assertFragmentNotIn(response, {})

        # несколько слов
        response = self.report.request_bs('place=parallel&text=запрещенный+запрос')
        self.assertFragmentNotIn(response, {})

        # работает только на точное соответствие запросу
        response = self.report.request_bs('place=parallel&text=маркет+яндекс')
        self.assertFragmentIn(response, {})
        response = self.report.request_bs('place=parallel&text=запрещенный')
        self.assertFragmentIn(response, {})
    ...
    def test_stop_list_disabling(self):
        ...
        response = self.report.request_bs(
            'place=parallel&text=запрещенный+запрос&rearr-factors=market_parallel_stop_list_disable=1'
        )
        self.assertFragmentIn(response, {})
    ...
    def test_family_banned_requests(self):
        ...
        response = self.report.request_bs_pb('place=parallel&text=porn+stuff&family=2')
        self.assertFragmentNotIn(response, {})

        # словоформа из запроса есть в списке, пустой ответ
        response = self.report.request_bs_pb('place=parallel&text=купить+херню&family=2')
        self.assertFragmentNotIn(response, {})

        # нет family слов в запросе, есть ответ
        response = self.report.request_bs_pb('place=parallel&text=usual&family=2')
        self.assertFragmentIn(response, {})

        # family отключен, не смотрим список, есть ответ
        response = self.report.request_bs_pb('place=parallel&text=some+drug')
        self.assertFragmentIn(response, {})
    ...
    def test_reject_heavy_request(self):
        ...
        for flag in [1, 2]:
            response = self.report.request_bs(
                'place=parallel&text=что+кто' '&rearr-factors=market_parallel_reject_heavy_requests={}'.format(flag)
            )
            self.assertFragmentNotIn(response, {})

        # Флаг market_parallel_reject_heavy_requests=0 отключает проверку, ответ есть
        response = self.report.request_bs(
            'place=parallel&text=что+кто' '&rearr-factors=market_parallel_reject_heavy_requests=0'
        )
        self.assertFragmentIn(response, {})

        # По дефолту флаг market_parallel_reject_heavy_requests включен, нет ответа
        response = self.report.request_bs('place=parallel&text=что+кто')
        self.assertFragmentNotIn(response, {})
        ...
        response = self.report.request_bs('place=parallel&text=что+кто+киянка')
        self.assertFragmentIn(response, {})
        ...
        for flag, count in flags:
            ...
            response = self.report.request_bs(
                'place=parallel&text={}&rearr-factors=;{}'.format('киянка+' * (count + 1), flag)
            )
            self.assertFragmentNotIn(response, {})
            ...
            response = self.report.request_bs(
                'place=parallel&text={}&rearr-factors=;{}'.format('киянка+' * count, flag)
            )
            self.assertFragmentIn(response, {})
        ...
        response = self.report.request_bs(
            'place=parallel&rearr-factors=market_parallel_reject_heavy_requests=0' '&text={}'.format('киянка+' * 15)
        )
        self.assertFragmentIn(response, {})
    ...
    def test_rejecting_requests_with_long_words(self):
        ...
        response = self.report.request_bs('place=parallel&debug=1&text=' + long_words)
        self.assertFragmentNotIn(response, {})

        # Без флага market_parallel_max_request_word_length запросы, содержащие слова меньше 30 символов
        # обрабатываются. Ответ есть.
        response = self.report.request_bs('place=parallel&debug=1&text=' + short_words)
        self.assertFragmentIn(response, {})

        # С флагом market_parallel_max_request_word_length=0 обрабатываются запросы с любой длинной слов.
        response = self.report.request_bs(
            'place=parallel&debug=1&text=' + short_words + '&rearr-factors=market_parallel_max_request_word_length=0'
        )
        self.assertFragmentIn(response, {})

        response = self.report.request_bs(
            'place=parallel&debug=1&text=' + long_words + '&rearr-factors=market_parallel_max_request_word_length=0'
        )
        self.assertFragmentIn(response, {})
    ...
    def test_hid_filtering(self):
        ...
        """
        request = 'place=parallel&text=tank&rid=1&rearr-factors=market_offers_incut_align=1'
    ...
    def test_base_search_pre_filter(self):
        ...
        """
        request = 'place=parallel&text=PreFilter&rearr-factors=market_parallel_pre_filter_mn_algo=pre_filter_mn_algo;'
    ...
    def test_multitoken_factors(self):
        ...
        request = "place=parallel&text=filter+fz-a60mfe&wizard-rules={}&debug=1".format(urllib.quote(json.dumps(qtree)))
    ...
    def test_nearest_city_region(self):
        ...
        """
        request = 'place=parallel&text=Миксер+кухонный&rids=121861'
    ...
    def test_prime_auction_on_parallel(self):
        ...
        """
        request = 'place=parallel&text=iphone&rids=213&debug=1'
    ...
    def test_use_delivery_for_parallel_relevance(self):
        ...
        https://st.yandex-team.ru/MARKETOUT-33408
        """
        request = 'place=parallel&text=iphone&rids=213&debug=1&debug-doc-count=1'
    ...
    def test_disable_offers_incut_auction(self):
        ...
        response = self.report.request_bs_pb(
            'place=parallel&text=gvozdoder&rearr-factors=market_offers_incut_threshold_disable=1;market_disable_auction_on_parallel=1'
        )
        self.assertFragmentNotIn(
            response,
            {
        ...
        response = self.report.request_bs_pb(
            'place=parallel&text=iphone&rearr-factors=market_disable_auction_on_parallel=1'
        )
        self.assertFragmentNotIn(
            response,
            {
    ...
    def test_disable_offers_incut_url_encryption(self):
        ...
        """
        query = 'place=parallel&text=gvozdoder&rearr-factors=market_offers_incut_threshold_disable=1;'
    ...
    def test_disable_offercard_encryption(self):
        ...
        request = 'place=parallel&text=gvozdoder&wprid=1123456789&rearr-factors={}'.format(';'.join(rearr))
        response = self.report.request_bs_pb(request)
        self.assertFragmentIn(
            response,
            {
        ...
        request = 'place=parallel&text=gvozdoder&rearr-factors={}'.format(';'.join(rearr))
        response = self.report.request_bs_pb(request)
        self.assertFragmentIn(
            response,
            {
    ...
    def test_disable_market_url_encryption(self):
        ...
        request = 'place=parallel&src_pof=971&text=special+blue+offer&x-yandex-encrypted-icookie=1123456&wprid=cb8f7a995444ab4dc3215cad33fcd6bb&rearr-factors={}'
    ...
    def test_disable_model_shard(self):
        ...
        """
        request = 'place=parallel&text=iphone&trace_wizard=1&debug=1'
    ...
    def test_zero_prices_filter(self):
        ...
        """
        response = self.report.request_json(
            'place=parallel&text=lego&rearr-factors=market_parallel_filter_zero_prices=1&debug=1&bsformat=2'
        )
        self.assertFragmentIn(
            response,
            [
