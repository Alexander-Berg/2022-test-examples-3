...
TEST(TestPriceRandomizer, Test_FoolCheckRandomness)
{
    ...
    TPriceRandomizer newPriceRandomizer(RandomSeed + 1);
...
TEST(TestPriceRandomizer, Test_PriceBounds)
{
    ...
    AddSku(data, 3, "3", 200.5, 201.2, 201);
...
TEST(TestPriceRandomizer, Test_ClosePriceBounds)
{
    ...
    AddSku(data, 2, "2", 200.5, 200.8, 190);
    AddSku(data, 3, "3", 201.5, 202.8, 200);
    ...
    // Zero high < low after ceil/floor
    EXPECT_EQ(priceRandomizer.GetPrice("2", 2), 201);
    // Low = High after ceil/floor
    EXPECT_EQ(priceRandomizer.GetPrice("3", 3), 202);
}
