...
class T(TestCase):
    ...
    def test_offer_moscow_moscow_with_delivery(self):
        response = self.report.request_json(
            'place=prime&rids=213&debug=da&text="moscow-pepyaka-with-delivery"&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_offer_moscow_bryansk_with_delivery(self):
        response = self.report.request_json(
            'place=prime&rids=191&debug=da&text="moscow-pepyaka-with-delivery"&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_invisible_region_delimiter(self):
        ...
        response = self.report.request_json(
            'place=prime&rids=191&debug=da&text="moscow-pepyaka-with-delivery"&rearr-factors=market_hide_regional_delimiter=0&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(response, {"entity": "regionalDelimiter"}, preserve_order=True)

        response = self.report.request_json(
            'place=prime&rids=191&debug=da&text="moscow-pepyaka-with-delivery"&rearr-factors=market_hide_regional_delimiter=1&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentNotIn(response, {"entity": "regionalDelimiter"}, preserve_order=True)

    def test_offer_moscow_moscow_with_pickup_in_moscow(self):
        response = self.report.request_json(
            'place=prime&rids=213&debug=da&text=moscow-pepyaka-with-pickup-in-moscow&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_offer_moscow_moscow_with_pickup_in_bryansk(self):
        response = self.report.request_json(
            ...
            '&rearr-factors=disable_panther_quorum=0;offer_regions_literal=1'
        )
    ...
    def test_offer_moscow_bryansk_with_pickup_in_bryansk(self):
        ...
        response = self.report.request_json(
            'place=prime&rids=191&debug=da&text="moscow-pepyaka-with-pickup-in-bryansk"&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_offer_moscow_moscow_with_store_in_moscow(self):
        response = self.report.request_json(
            'place=prime&rids=213&debug=da&text=moscow-pepyaka-with-store-in-moscow&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(response, {"name": "DELIVERY_TYPE", "value": "3", "width": "2"})
        self.assertFragmentNotIn(response, {"entity": "regionalDelimiter"})
        self.assertFragmentIn(
    ...
    def test_offer_moscow_bryansk_with_store_in_bryansk(self):
        response = self.report.request_json(
            'place=prime&rids=191&debug=da&text=moscow-pepyaka-with-store-in-bryansk&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(response, {"name": "DELIVERY_TYPE", "value": "3", "width": "2"})
        self.assertFragmentIn(
            response,
    ...
    def test_priority_forbidden_region(self):
        response = self.report.request_json(
            ...
            '&rearr-factors=market_no_strict_distances=0;disable_panther_quorum=0;offer_regions_literal=1'
        )
        ...
        response = self.report.request_json(
            ...
            '&rearr-factors=market_no_strict_distances=0;offer_regions_literal=1'
        )
    ...
    def test_non_priority_forbidden_region(self):
        ...
        response = self.report.request_json(
            'place=prime&rids=191&debug=da&text="bryansk-pepyaka-with-delivery-and-forbidden"&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_outlets_count_for_store(self):
        response = self.report.request_json(
            'place=productoffers&rids=191&bsformat=1&hyperid=50&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
        ...
        response = self.report.request_json(
            'place=productoffers&rids=191&bsformat=1&hyperid=49&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
        ...
        response = self.report.request_json(
            'place=productoffers&rids=191&bsformat=1&hyperid=100&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_pessimization_delivery_from_non_priority_region_on_prime(self):
        ...
        response = self.report.request_json(
            'place=prime&rids=191&text=pepyaka&debug=da' + '&local-offers-first=1&rearr-factors=offer_regions_literal=1'
        )
        ...
        response = self.report.request_json(
            'place=prime&rids=191&text=pepyaka&debug=da' + '&local-offers-first=0&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_shop_priority_country_netherlands_to_russia(self):
        response = self.report.request_json(
            'place=productoffers&hyperid=202&rids=213&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_shop_priority_country_kokosy_to_russia(self):
        response = self.report.request_json(
            'place=productoffers&hyperid=203&rids=213&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_offer_sbp_pickup(self):
        ...
        # Проверяем, что товар показывается и показывается НАД чертой
        response = self.report.request_json(
            'place=prime&rids=2&text=spbPepyakaWithPickup&debug=da&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_numeric_day_from_to(self):
        response = self.report.request_json(
            'place=prime&text=day_from_to&rids=213&rearr-factors=offer_regions_literal=1'
        )
    ...
    def test_offer_outlet_stats(self):
        response = self.report.request_json(
            'place=prime&rids=1&text=pepyaka-with-multiple-points_cpa_real&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_offer_outlet_stats_cpa_no(self):
        response = self.report.request_json(
            'place=prime&rids=1&text=pepyaka-with-multiple-points_cpa_no&rearr-factors=offer_regions_literal=1'
        )
        self.assertFragmentIn(
            response,
            {
    ...
    def test_differ_models_by_delivery(self):
        ...
        cgi = '&debug=da&rearr-factors=market_not_filter_out_vclusters_not_onstock=1&rearr-factors=offer_regions_literal=1'
    ...
    def _check_delivery_program(self, hyperid, program):
        response = self.report.request_json(
            'place=prime&rids=213&hyperid={}&raw_delivery_options=1&rearr-factors=offer_regions_literal=1'.format(
                hyperid
            )
        )
        self.assertFragmentIn(
    ...
    def _check_market_delivery_dates(self, inlet_shipment_day, day_from, day_to):
        response = self.report.request_json(
            'place=offerinfo&rids=213&offerid=DuE098x_rinQLZn3KKrELw&regset=1&show-urls=decrypted&rearr-factors=offer_regions_literal=1&inlet-shipment-day='
    ...
    def __check_mardo_buckets(self, hyperid, buckets, default_bucket_id=None):
        ...
        response = self.report.request_json(
            'place=prime&rids=213&hyperid={}&rearr-factors=offer_regions_literal=1'.format(hyperid)
        )
        self.assertFragmentIn(
            response,
    ...
    def test_mardo_default_option(self):
        ...
        response = self.report.request_json(
            'place=prime&rids=213&hyperid=757591&debug-all-courier-options=1&rearr-factors=offer_regions_literal=1'
        )
    ...
    def _test_payment_methods(
        ...
        for place in ['prime', 'productoffers']:
            for aux in ['', '&client=checkout&co-from=shopadmin-stub']:
                response = self.report.request_json(
                    'place={}&rids=213&hyperid={}{}&rearr-factors=offer_regions_literal=1'.format(place, hyperid, aux)
                )
        ...
        for place in ['prime', 'productoffers']:
            response = self.report.request_json(
                'place={}&rids=213&hyperid=299&rearr-factors=offer_regions_literal=1'.format(place)
            )
        ...
        for place in ['prime', 'productoffers']:
            for aux in ['', '&client=checkout&co-from=shopadmin-stub']:
                response = self.report.request_json(
                    'place={}&rids=2&hyperid={}&rearr-factors=offer_regions_literal=1'.format(place, hyperid)
                )
        ...
        """
        response = self.report.request_json(
            'place=offerinfo&rids=2&offerid=EpnWVxDQxj4wg7vVI1ElnA&show-urls=all&regset=1&client=checkout&co-from=shopadmin-stub&rearr-factors=offer_regions_literal=1'
        )
        if nonHomeRegion_cpaPartner_paymentMethods:
            self.assertFragmentIn(response, {"paymentMethods": nonHomeRegion_cpaPartner_paymentMethods})
        else:
