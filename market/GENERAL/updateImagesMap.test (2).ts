...
describe('updateImagesMap', () => {
  ...
  it('works with changes', () => {
    expect(
      ...
      testOfferId1: [{ url: 'return', type: 'REMOTE', picture: { parameterValues: {}, url: 'return' } }],
      testOfferId2: [{ url: 'return2', type: 'REMOTE', picture: { parameterValues: {}, url: 'return2' } }],
      testOfferId3: [{ url: 'test4', type: 'REMOTE' }],
    });
  });
});
