-- Automatically saved for VIEW.SITE_CATALOG.V_AS_CLUST_CLUTCHED_OFFER_TEST at 2022/04/12

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SITE_CATALOG"."V_AS_CLUST_CLUTCHED_OFFER_TEST" ("LIST_ID", "OFFER_ID") AS 
  SELECT list_id,
