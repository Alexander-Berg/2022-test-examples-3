...
CATEGORY_PANTHER_CONVERTER = yatest.common.binary_path("market/category_panther/stats_ctr/stats_ctr")

YT_SHOWLOG_RECORDS = [
    {
        "feed_id": "554251",
        "offer_id": "4968",
        "hyper_cat_id": yson.YsonUint64(289014),
        "geo_id": yson.YsonUint64(10748),
    }
]
...
YT_CLICKLOG_RECORDS = [
    {
        "feed_id": "554251",
        "offer_id": "4968",
        "hyper_category_id": yson.YsonUint64(289014),
        "geo_id": yson.YsonUint64(10748),
    }
]
...
class T(unittest.TestCase):
    ...
    def test_read_from_yt_and_write_to_mmap(self):
        ...
        YT_CLICKLOG_TABLE_PATH = '//tmp/local_clicklog_table/30min/0000-00-00T00:00:00'
        ...
        yt_client.create('table', YT_CLICKLOG_TABLE_PATH, ignore_existing=True, recursive=True)
        yt_client.write_table(YT_CLICKLOG_TABLE_PATH, YT_CLICKLOG_RECORDS)
        ...
        cmd_list = [
            ...
            '--clicklog-src', YT_CLICKLOG_TABLE_PATH,
        ]
