...
import { ReplenishmentInterWarehousePageOld } from './ReplenishmentInterWarehousePage';
...
beforeEach(() => {
  ({ app, api } = setupTestApp(`/replenishment/inter-warehouse/old`));
...
describe('<ReplenishmentInterWarehousePageOld />', () => {
  const getReplenishmentPage = () => app.find(ReplenishmentInterWarehousePageOld);
