...
import { DisplaySskuStatusWarning } from 'src/java/definitions';

const generateWarnings = (count: number): DisplaySskuStatusWarning[] =>
...
describe('StatusChangesWarningsModal', () => {
  ...
  it('main flow', () => {
    ...
    fireEvent.click(component.getByText(`Скачать ${warningsCount} ошибок`));
    expect(onDownload).toHaveBeenCalled();
    fireEvent.click(component.getByRole('button', { name: 'Закрыть' }));
    expect(onDownload).toHaveBeenCalled();
  });
