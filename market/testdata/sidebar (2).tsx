...
export const billingOrders = getLinkItem(
    ...
    'market-partner:html:business-billing-report:get',
);
...
export const pricelabsStatAlalytics = getLinkItem(
    'common.sidebar.shop:pricelabs-stats-analytics',
    'external:pricelabs-stats-analytics',
);

export const marketAnalyticsLanding = getLinkItem(
    'common.sidebar.shop:market-analytics-landing',
