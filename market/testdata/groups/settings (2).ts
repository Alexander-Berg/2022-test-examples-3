...
export const paymentsFrequency = getLinkItem(
    'common.sidebar.unified:business-payments-frequency',
    'market-partner:html:business-payments-frequency:get',
    {
        ignorePlatformParams: true,
        urlParamsMap: {
            businessId: 'businessId',
...
// Services
export const externalPriceLabsLog = getLinkItem('common.sidebar.shop:pricelabs-log', 'external:pricelabs-log');
