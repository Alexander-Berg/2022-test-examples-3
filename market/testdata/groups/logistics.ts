...
export const businessWarehouses = getLinkItem(
    'common.sidebar.unified:warehouses',
    'market-partner:html:platform-business-warehouse-list:get',
    {
...
export const fulfillmentStatGoodsTurnover = getLinkItem(
    'common.sidebar.unified:stat-goods-turnover',
    'market-partner:html:fulfillment-stat-goods-turnover:get',
);
