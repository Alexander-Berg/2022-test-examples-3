...
const firsOfferID = 'ADV-1';
const secondOfferID = 'fashion-block-17';
const thirdOfferID = 'fashion-block-18';
...
const offersState: OffersState = {
    ...
    offers: [firsOfferID, secondOfferID, thirdOfferID],
    servicePartsByOfferIds: {
        [firsOfferID]: [shopId],
        [secondOfferID]: [shopId],
        [thirdOfferID]: [shopId],
    },
    filters: {
        ...createEmptyFilters(),
...
export const offerIds = {firsOfferID, secondOfferID, thirdOfferID};
