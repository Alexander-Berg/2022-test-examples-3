...
object CodeBlocks {
    ...
    val emptyList: CodeBlock
        get() = CodeBlock.of("%M()", MemberName(PACKAGE_KOTLIN_COLLECTIONS, "emptyList"))
    ...
    val emptyMap: CodeBlock
        get() = CodeBlock.of("%M()", MemberName(PACKAGE_KOTLIN_COLLECTIONS, "emptyMap"))
    ...
    val emptySet: CodeBlock
        get() = CodeBlock.of("%M()", MemberName(PACKAGE_KOTLIN_COLLECTIONS, "emptySet"))
    ...
    fun staticMethodInvocation(staticMethod: ExecutableElement, parameters: Iterable<CodeBlock>): CodeBlock {
        return staticMethodInvocation(
            typeName = staticMethod.enclosingElement.asType().asTypeName(),
            methodName = staticMethod.simpleName.toString(),
