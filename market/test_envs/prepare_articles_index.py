...
class YtPrepareArticlesIndexTestEnv(BaseEnv):
    ...
    def execute(self, yt_stuff, result_path, path=None):
        ...
        self.outputs.update({
            "result_table": YtTableResource(yt_stuff, result_path),
        })

    def load_result_saas_properties(self):
    ...
    def result_data(self):
        ...
        return self.result_table.data

    @property
    def result_saas_docs(self):
        return self.load_result_saas_properties()
