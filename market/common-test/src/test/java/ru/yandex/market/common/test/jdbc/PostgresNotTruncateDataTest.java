...
/**
 * Тест проверяет работу аннотации {@link ru.yandex.market.common.test.db.DbUnitTruncatePolicy}.
 */
@DbUnitTruncatePolicy(truncateType = TruncateType.NOT_TRUNCATE)
public class PostgresNotTruncateDataTest extends BasePostgresTest {
