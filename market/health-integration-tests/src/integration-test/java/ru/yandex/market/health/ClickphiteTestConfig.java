...
import ru.yandex.market.clickphite.spring.ClickphiteInternalSpringConfig;
import ru.yandex.market.clickphite.spring.ClientsConfig;
import ru.yandex.market.clickphite.spring.DictionaryConfig;
...
@Configuration
@Import({
    TestsCommonConfig.class,
    MongoTestConfig.class,
    HealthConfigUtilsClickphiteInternalSpringConfig.class,
    ClickphiteInternalSpringConfig.class,
