...
def test_results_contex_exist_yt(yt_server, result_contex_yt_table):
    assert_that(
...
def test_result_contex_table_schema_yt(result_contex_yt_table):
    result_list = sorted(
...
def test_result_contex_table_row_count_yt(result_contex_yt_table):
    assert_that(
...
def test_big_sku_yt(result_contex_yt_table, result_yt_ext_table):
...
def test_original_yt(result_contex_yt_table):
...
def test_lookup_result_yt(yt_server, result_yt_table):
    """
...
def test_lookup_result_contex_yt(yt_server, result_contex_yt_table):
    """
    Тест проверяет, что полученная таблица является подобием key-value storage и в ней можно искать по msku
    """
