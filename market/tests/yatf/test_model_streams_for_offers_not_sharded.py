...
"""
    ...
    Исходные таблицы: стрим с title, стрим с alias и одна нешардированная табличка с синими офферами
"""
...
def offers(yt_stuff):
    ...
    table = YtTableResource(yt_stuff, "//home/in/offers", data)
    table.dump()
...
def workflow(yt_stuff,
    ...
    with YtModelStreamsForOffersTestEnv(**resources) as env:
        env.execute(yt_stuff,
                    offers_dir=offers.get_path(),  # offers - не шардированы (путь до таблицы)
                    parts_count=0,
...
def test_aliases_streams(aliases_result):
    """Проверяем что на выходе мап-редьюс операции в таблицу с aliases-стримом в колонку text попадают
       ...
       part=0 так как офферы не шардированы, порядок соответствует mode_id оффера
    """
    ...
    assert_that(
        ...
        contains_only([
            ...
            {'ware_md5': 'WareId_71', 'region_id': 225L, 'text': 'alias:Seventy one', 'value': '1', 'part': 0L},
        ]),
        "No expected aliases")
...
def test_titles_streams(titles_result):
    ...
    assert_that(
        ...
        contains_only([
            ...
            {'ware_md5': 'WareId_11_2', 'region_id': 225L, 'text': 'title:Одиннадцать', 'value': '1', 'part': 0L},
            {'ware_md5': 'WareId_71', 'region_id': 225L, 'text': 'title:Seven-Eleven', 'value': '1', 'part': 0L},
        ]),
        "No expected titles")
...
def test_marketing_descr_streams(marketing_descrs_result):
    ...
    assert_that(
        ...
        contains_only([
            {'ware_md5': 'WareId_71', 'region_id': 225L, 'text': 'marketing_descr:7Я', 'value': '1', 'part': 0L},
            {'ware_md5': 'WareId_5', 'region_id': 225L, 'text': 'marketing_descr:Магнит', 'value': '1', 'part': 0L},
            {'ware_md5': 'WareId_111', 'region_id': 225L, 'text': 'marketing_descr:Дикси', 'value': '1', 'part': 0L},
        ]),
...
def test_micro_model_descr_streams(micro_model_descrs_result):
    ...
    assert_that(
        ...
        contains_only([
            ...
            {'ware_md5': 'WareId_11_2', 'region_id': 225L, 'text': 'micro_model_descr:цвет: белый', 'value': '1', 'part': 0L},
        ]),
...
def test_cpa_queries_streams(cpa_queries_result):
    ...
    assert_that(
        ...
        contains_only([
            ...
            {'ware_md5': 'WareId_11_2', 'region_id': 225L, 'text': 'запрос 2', 'value': '1', 'part': 0L},
        ]),
