...
def test_results_ext_exist(yt_server, result_yt_ext_table):
    assert_that(
...
def test_result_ext_table_schema(result_yt_ext_table):
    result_list = sorted(
...
def test_big_sku(result_yt_table, result_yt_ext_table):
...
def test_min_sku(result_yt_table):
...
def test_min_psku(result_yt_table):
...
def test_lookup(yt_server, result_yt_table):
    """
