...
def offer_status_table_data():
    return [{'offer': message_from_data(offer, DTC.Offer()).SerializeToString()} for offer in OFFER_STATUS]


@pytest.fixture(scope='module')
def offer_status_table_path():
    return '//home/offer_status' + str(uuid.uuid4()) + '/20210101_0001'
...
def test_offer_status(scanner, expected):
    """
