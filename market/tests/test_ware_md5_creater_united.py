                ...
                'service': IsProtobufMap({
                    WHITE_SHOP_ID: {
                        'identifiers': {
                            ...
                            'shop_id': WHITE_SHOP_ID,
                            'extra': {
                                'ware_md5': '3xv1uT-WnVczO1nkPh2Jbw',
                            }
                        },
                    },
                    BLUE_SHOP_ID: {
                        'identifiers': {
                            ...
                            'shop_id': BLUE_SHOP_ID,
                            'extra': {
                                'ware_md5': '1KIgBXiBwiDE9lXHqCpf2Q',
                            }
                        },
                    },
                })
...
def test_ware_md5_update(workflow):
    """ Установка ware_md5, если у оффера он уже стоит: меняется и для белого, для синего
        Синий и белый процессоры не мешают друг другу
    """
                ...
                'service': IsProtobufMap({
                    ...
                    BLUE_SHOP_ID: {
                        'identifiers': {
                            ...
                            'shop_id': BLUE_SHOP_ID,
                            'extra': {
                                'ware_md5': 'SloZhXYTOTWl6v2Thq__CQ',
                            }
                        },
                    },
                })
