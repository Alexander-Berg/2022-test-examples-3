...
def test_price_randomizer(application, yt_context):
    expected_result = [
        { 'group_id': 0, 'msku': 1, 'is_price_random': True, 'new_price': 8275.0 },
        { 'group_id': 0, 'msku': 2, 'is_price_random': False, 'new_price': 8000.0 },
        { 'group_id': 0, 'msku': 3, 'is_price_random': True, 'new_price': 8250.0 },
        { 'group_id': 0, 'msku': 4, 'is_price_random': False, 'new_price': 8000.0 },
        { 'group_id': 0, 'msku': 5, 'is_price_random': True, 'new_price': 7821.0 },
