...
from market.monetize.efficiency.buybox.nirvana.prepare_elasticity_report.executables.python.prepare_elasticity import (
    interpolate_linear,
...
def test_calculate_demand():
    ...
    # price more than max with turn_high_demand_into_zero equals False
    assert calc_demand(9, price_demand, turn_high_demand_into_zero=False) == 3
