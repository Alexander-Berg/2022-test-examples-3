...
def get_value_dirs():
    return [
        ...
        yatest.common.source_path('market/sre/conf/fslb/prod/values-available'),
        yatest.common.source_path('market/sre/conf/fslb/prod/values-static'),
    ]
...
def ip_service_map():
    ...
    yaml = YAML(typ='safe')
    with open(yatest.common.source_path('market/sre/conf/fslb/prod/values-static/00-ip-service-map.yaml')) as fd:
        return yaml.load(fd)
