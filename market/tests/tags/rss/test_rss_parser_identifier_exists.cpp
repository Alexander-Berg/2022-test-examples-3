...
<channel>
    <item>
        <g:id>1</g:id>
        <g:identifier_exists></g:identifier_exists>
    </item>
    <item>
        <g:id>2</g:id>
        <g:identifier_exists>unsupported</g:identifier_exists>
    </item>
    <item>
        <g:id>3</g:id>
    ...
    <item>
        <g:id>5</g:id>
        <g:identifier_exists> 1 </g:identifier_exists>
    </item>
</channel>
</rss>
)wrap");
...
TEST(RssFeedParser, IdentifierExists) {
    const auto actual = RunRssFeedParser<NCommon::TGoogleMerchantRssParser>(
        ...
        [] (const TQueueItem& item) {
            ...
            if (merchant.has_identifier_exists()) {
                result["IdentifierExists"] = merchant.identifier_exists();
            }
            return result;
        }
    );
