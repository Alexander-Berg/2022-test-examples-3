...
<channel>
    ...
    <item>
        <g:id>2</g:id>
        <g:availability_date>unsupported</g:availability_date>
    </item>
    <item>
        <g:id>3</g:id>
        <g:availability_date>2016-11-25T13:00+0300</g:availability_date>
    </item>
</channel>
</rss>
)wrap");
...
TEST(RssFeedParser, AvailabilityDate) {
    const auto actual = RunRssFeedParser<NCommon::TGoogleMerchantRssParser>(
        ...
        [] (const TQueueItem& item) {
            ...
            if (merchant.has_availability_date()) {
                result["AvailabilityDate"] = NSc::TValue::From(merchant.availability_date());
            }
            return result;
        }
    );
