...
<channel>
    <item>
        <g:id>1</g:id>
        <g:ships_from_country></g:ships_from_country>
    </item>
    <item>
        <g:id>2</g:id>
        <g:ships_from_country>RU</g:ships_from_country>
    </item>
</channel>
</rss>
)wrap");
...
TEST(RssFeedParser, ShipsFromCountry) {
    const auto actual = RunRssFeedParser<NCommon::TGoogleMerchantRssParser>(
        ...
        [] (const TQueueItem& item) {
            ...
            if (merchant.shipping_detail().has_ships_from_country()) {
                result["ShipsFromCountry"] = merchant.shipping_detail().ships_from_country();
            }
            return result;
        }
    );
