...
from market.assortment.ecom_log.tests.graph.graph_generator import CustomGenerator
...
@click.option('--calculation_date', required=False, help='calculation date', default='-')
@click.option('--environment', required=False, help='production|testng|custom', default='-')
