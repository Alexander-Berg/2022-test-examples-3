...
const auto fname = JoinFsPaths(
    ArcadiaSourceRoot(),
    "market/idx/feeds/qparser/tests/data/MARKETINDEXER-36901-feed.xml"
);
...
static const TString EXPECTED_JSON = "null";  // офферы не просациваются


TEST(WhiteYmlParser, MARKETINDEXER_36901) {
...
TEST(BlueYmlParser, MARKETINDEXER_36901) {
