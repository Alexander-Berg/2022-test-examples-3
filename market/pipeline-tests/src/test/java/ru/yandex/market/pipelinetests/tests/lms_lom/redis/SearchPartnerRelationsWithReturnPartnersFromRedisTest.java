...
import ru.yandex.market.pipelinetests.tests.lms_lom.AbstractSearchPartnerRelationWithReturnPartnersTest;
...
public class SearchPartnerRelationsWithReturnPartnersFromRedisTest extends
    AbstractSearchPartnerRelationWithReturnPartnersTest {

    @Override
    public void searchAndComparePartnerRelationWithReturnPartners(
        Long partnerFromId,
        ...
        PartnerRelationCompareUtil.comparePartnerRelationWithReturnPartners(
            softly,
        ...
        List<PartnerRelationEntityDto> redisPartnerRelations =
            LOM_REDIS_STEPS.searchPartnerRelationWithReturnPartnersFromRedis(filter);
        PartnerRelationCompareUtil.comparePartnerRelationWithReturnPartners(
            softly,
            lmsPartnerRelations,
