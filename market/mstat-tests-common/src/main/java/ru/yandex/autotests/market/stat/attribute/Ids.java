...
public class Ids {
    ...
    public static Integer generateHyperId() {
        return Integer.valueOf(Values.generateRandomNumber(5));
    }
    ...
    public static Integer generateVclusterId() {
        return Integer.valueOf(Values.generateRandomNumber(7));
