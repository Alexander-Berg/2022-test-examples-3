...
public class CategId {
    public static final ImmutableList<String> someValidCategs = ImmutableList.of("10194", "20346", "800", "23447",
    ...
    public static ImmutableMap<String, String> KNOWN_HYPERIDS_FOR_CATEG =
            ImmutableMap.of("91491", "444", "13062140", "26388", "12385944", "25067");
    public static String generate() {
        int i = RandomUtils.nextInt(someValidCategs.size());
