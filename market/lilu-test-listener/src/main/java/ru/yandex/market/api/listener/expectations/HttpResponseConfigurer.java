...
import ru.yandex.market.api.listener.domain.HttpResponseStatus;
...
public class HttpResponseConfigurer {
    ...
    public HttpResponse getResponse() {
        return new HttpResponse(httpStatus == null ? HttpResponseStatus.OK.code() : httpStatus.code(), new ArrayList<>(), body);
    }
