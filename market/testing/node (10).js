...
// файл с токеном для походов в charts
const chartsTokenFile = `${SECRETS_DIR}/analytics.charts.token.json`;
...
module.exports = {
    ...
    hostsTld: {
        ...
        market: 'desktop.market.fslb.yandex.<tld>',
    ...
    chartsPath: '/Users/zomb-v-for-vendors',
    ...
    servant: {
        ...
        marketBillingAdminTariffs: {
            host: 'mbi-tariffs.tst.vs.market.yandex.net',
            protocol: 'https:',
        },
        marketBillingAdminCheckers: {
            host: 'checker.tst.vs.market.yandex.net',
            protocol: 'https:',
        },
        staff: {
    ...
    tvm: {
        env: 'market_front_billing-admin_testing',
