...
module.exports = mergePolicies(basePolicies, {
    'script-src': ['betastatic.yastatic.net', 'yastat.net'],

    'style-src': ['betastatic.yastatic.net', 'yastat.net'],

    'img-src': ['betastatic.yastatic.net', 'yastat.net'],

    'font-src': ['betastatic.yastatic.net', 'yastat.net'],
    'prefetch-src': [
