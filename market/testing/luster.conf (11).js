...
require('#root/src/app/helpers/logClusterEvents');

module.exports = {
    app: require.resolve('#root/dist/server/app'),
    ...
    extensions: {
        ...
        'luster-trace-log': {
            markers: {
                resource: path.join(logs, 'market_front_desktop-trace.log'),
                timers: path.join(logs, 'market_front_desktop-timers.log'),
                errors: path.join(logs, 'market_front_desktop-errors.log'),
