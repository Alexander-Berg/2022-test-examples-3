...
--
CREATE OR REPLACE PROCEDURE mb_stat_report.adm_clear_queue(p_table_name varchar2)
  /*
...
AS
  ...
  BEGIN
      ...
      INTO l_max_tran_id
      FROM mb_stat_report.mst_rcv_queue
    ...
    UPDATE mb_stat_report.mst_rcv_queue
    ...
    DELETE FROM mb_stat_report.mst_rcv_queue
