...
def collected_promo_details():
    return [
        {
            'feed_id': FEED_ID,
            'type': PromoType.BLUE_CASHBACK,
            'shop_promo_id': 'bluecashback',
            ...
            'ui_promo_tags': ['extra-cashback', 'sometag'],
            'promo_bucket_name': 'somename',
            'required_promo_buckets' : ['first', 'second', 'third'],
            'parent_promo_id': 'parent_promo',
            'cms_description_semantic_id': 'default-cashback',
            'blue_cashback': {
                'share': 1,
                'version': 1,
                'priority': 1,
                ...
                'details_group_key': 'somegroupkey',
                'details_group_name': 'somegroupname',
                'partner_info': {
                    'market_tariffs_version_id': 12345678,
                    'partner_id': 123,
                },
                'max_offer_total_thresholds': [
                    {'value': 123, 'code': 'code1'},
                    {'value': 456, 'code': 'blabla2'},
                    {'value': 678, 'code': 'code3'},
                ],
                'min_order_total_thresholds': [
                    {'value': 234, 'code': 'blabla1'},
                    {'value': 567, 'code': 'code2'},
                    {'value': 798, 'code': 'something3'},
                ],
                'predicates': [
                    {
                        ...
                        'experiment_rearr_flags': ['flag-for-promo-1', 'flag-for-promo-2']
                    }
                ],
                'max_offer_cashback': 1000,
            }
        },
    ]
...
def blue_cashback_workflow(collected_promo_details, yt_server):
...
def test_blue_cashback(blue_cashback_workflow, collected_promo_details):
    compare_promo_details_collections(
        blue_cashback_workflow.yt_promo_details,
