...
@SpringBootTest(classes = [DatabaseConfiguration::class, InventoryManagementTestConfiguration::class])
...
@DbUnitConfiguration(
    ...
    databaseConnection = ["inventoryManagementConnection"]
)
open class InventoryManagementIntegrationTest : BaseTest() {
    @Autowired
