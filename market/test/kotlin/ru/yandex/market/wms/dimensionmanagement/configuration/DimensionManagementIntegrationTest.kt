...
@SpringBootTest(classes = [DbConfig::class, DimensionManagementTestConfig::class])
...
@DbUnitConfiguration(
    ...
    databaseConnection = ["dimensionManagementConnection"]
)
open class DimensionManagementIntegrationTest : BaseTest() {
    @Autowired
