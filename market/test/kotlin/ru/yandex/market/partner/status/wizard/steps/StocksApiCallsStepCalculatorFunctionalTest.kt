...
class StocksApiCallsStepCalculatorFunctionalTest : WizardFunctionalTest() {
    ...
    fun testNone() {
        ...
        val result = partnerPlacementWizardApiClient.getPartnerStep(PARTNER_ID, WizardStepType.STOCKS)
            .schedule()
            .join()
        Assertions.assertEquals(
            listOf(
                WizardStepInfo()
                    .step(WizardStepType.STOCKS)
