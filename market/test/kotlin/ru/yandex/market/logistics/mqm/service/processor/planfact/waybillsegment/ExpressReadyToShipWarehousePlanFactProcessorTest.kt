...
class ExpressReadyToShipWarehousePlanFactProcessorTest: ExpressReadyToShipPlanFactProcessorTest() {

    override fun createProcessor(taxiExpressOrdersProperties: TaxiExpressOrdersProperties) =
        ExpressReadyToShipWarehousePlanFactProcessor(
            clock,
            planFactService,
    ...
    override fun getExpectedStatus(): SegmentStatus = SegmentStatus.IN
    ...
    override fun getProducerName(): String = "ExpressReadyToShipWarehousePlanFactProcessor"
