...
class CourierRecipientTransmitOnDemandPlanFactProcessorTest: BaseSelfSufficientOnDemandPlanFactProcessorTest() {
    ...
    override fun createProcessor() = CourierRecipientTransmitOnDemandPlanFactProcessor(
        settingService = settingsService,
        clock = clock,
        planFactService = planFactService,
    )

    override fun getProducerName() = CourierRecipientTransmitOnDemandPlanFactProcessor::class.simpleName!!
    ...
    override fun createSuccessPlanFact() =
        PlanFact(
            ...
            entityId = 100_102,
            expectedStatus = SegmentStatus.TRANSIT_TRANSMITTED_TO_RECIPIENT.name,
    ...
    private fun createSegmentStatusAddedContext(
        ...
        newSegmentStatus: SegmentStatus = SegmentStatus.TRANSIT_COURIER_SEARCH,
        ...
        if (withCloseStatusInNextSegment) {
            writeWaybillSegmentCheckpoint(thirdSegment, SegmentStatus.OUT, CHECKPOINT_TIME)
        }
