...
class DropshipDsShippedRecalculateRddQualityRuleProcessorTest: BaseRecalculateRddQualityRuleProcessorTest() {
    ...
    fun successProcessingIfPlanFactActualAndHasAdditionalData() {
        ...
        existingPlanFact.setData(RddPlanFactAdditionalData(DROPSHIP_TIME))
        ...
        val expectedStartTime = LocalDateTime.of(2021, 1, 4, 0, 0)
    ...
    override fun createProcessor(
        ...
        DropshipDsShippedRecalculateRddQualityRuleProcessor(lomClient, properties)
