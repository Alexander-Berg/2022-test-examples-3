...
class DropshipDropoffIntakePartnerRelationProducerTest{

    private val converter = AggregationEntityConverter()
    private val partnerService: LmsPartnerService = Mockito.mock(LmsPartnerService::class.java)
    private val producer = DropshipDropoffIntakePartnerRelationProducer(converter, partnerService)
