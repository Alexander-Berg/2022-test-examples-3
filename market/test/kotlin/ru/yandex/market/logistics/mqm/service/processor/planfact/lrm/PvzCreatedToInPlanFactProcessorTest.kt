...
class PvzCreatedToInPlanFactProcessorTest {

    private lateinit var processor: PvzCreatedToInPlanFactProcessor
    ...
    fun setUp() {
        ...
        processor = PvzCreatedToInPlanFactProcessor(
    ...
    private fun mockReturnSegmentEventContext(
        ...
        segmentStatus: ReturnSegmentStatus = ReturnSegmentStatus.CREATED
    ...
    fun planFactCreationSuccess() {
        ...
        assertSoftly {
            ...
            planFact.expectedStatusDatetime shouldBe Instant.parse("2021-12-27T16:00:00.00Z")
            planFact.producerName shouldBe "PvzCreatedToInPlanFactProcessor"
            planFact.planFactStatus shouldBe PlanFactStatus.CREATED
            planFact.processingStatus shouldBe ProcessingStatus.ENQUEUED
            planFact.scheduleTime shouldBe Instant.parse("2021-12-27T16:00:00.00Z")
        }
    }
    ...
    fun doNotCreatePlanFactIfExistsActive() {
        val existingPlanFact = PlanFact(
            producerName = PvzCreatedToInPlanFactProcessor::class.simpleName,
