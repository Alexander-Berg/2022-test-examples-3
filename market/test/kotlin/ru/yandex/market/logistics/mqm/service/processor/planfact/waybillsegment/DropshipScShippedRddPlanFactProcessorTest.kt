...
class DropshipScShippedRddPlanFactProcessorTest {
    private lateinit var processor: DropshipScShippedRddPlanFactProcessor
    ...
    @BeforeEach
    fun setUp() {
        processor = DropshipScShippedRddPlanFactProcessor(
            settingsService,
            clock,
            planFactService,
    ...
    fun planFactNotCreateIfSegmentNotScSc(partnerType: PartnerType) {
        val firstSegment = createFirstSegment()
    ...
    companion object {
        ...
        private const val PRODUCER_NAME = "DropshipScShippedRddPlanFactProcessor"
