 ...
 */
@Service
class EngineTestPagedByTokenWithSectionParamsAssembler: EngineTestPagedByTokenAssembler() {
    override fun getName() = "EngineTestPagedByTokenWithSectionParams"
    ...
    override fun doConvert(response: TestResponse, configNode: JsonNode?, builder: AssemblyResult.Builder) {
        ...
        builder.addSectionEventParams(AssemblyResult.NextPageSectionParams(mapOf(
            "testSectionParam" to response.total
        )))
    }
}
