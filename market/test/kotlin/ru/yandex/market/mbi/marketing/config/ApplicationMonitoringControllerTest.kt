...
import ru.yandex.market.mbi.marketing.monitoring.ApplicationMonitoringController
...
class ApplicationMonitoringControllerTest {
    ...
    fun closeInvocation() {
        val applicationContext = Mockito.mock(ConfigurableApplicationContext::class.java)
