-- Quartz tms tables and indexes
-- Documentation with queries: https://a.yandex-team.ru/arc/trunk/arcadia/market/jlibrary/tms-core-quartz2/README.md
...
create index if not exists i_tft_jnm_hnm__premod_qlog on qrtz_log(TRIGGER_FIRE_TIME, JOB_NAME, HOST_NAME);
create index if not exists i_id__premod_qlog on qrtz_log(ID);
