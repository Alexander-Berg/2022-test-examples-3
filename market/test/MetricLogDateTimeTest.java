...
import ru.yandex.market.jmf.module.metric.impl.MetricsServiceImpl;
...
public class MetricLogDateTimeTest {
    ...
    public void writeMillisecondsWith3Digit() {
        Assertions.assertEquals("2019-06-07T12:13:14.034+03:00", MetricsServiceImpl.formatDate(SAMPLE_DATE_TIME));
    }
}
