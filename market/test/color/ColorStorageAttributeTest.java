...
@ContextConfiguration(classes = ColorStorageAttributeTest.Configuration.class)
public class ColorStorageAttributeTest extends AbstractAttributeTest {
    ...
    public static class Configuration extends AbstractAttributeTestConfiguration {
        public Configuration() {
            super("classpath:color_storage_attribute_metadata.xml", "classpath:linkAttrMetaclass_metadata.xml");
        }
    }
}
