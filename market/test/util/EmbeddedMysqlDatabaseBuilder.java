...
public class EmbeddedMysqlDatabaseBuilder {
    ...
    private EmbeddedMysqlDatabase createDatabase(MysqldResource mysqldResource) {
        ...
        String url = "jdbc:mysql://localhost:" + port + "/" +
                databaseName + "?" + "createDatabaseIfNotExist=true&characterEncoding=utf8";
    ...
    private MysqldResource createMysqldResource() {
        ...
        databaseOptions.put("character-set-server", "utf8");
        databaseOptions.put("collation-server", "utf8_unicode_ci");
