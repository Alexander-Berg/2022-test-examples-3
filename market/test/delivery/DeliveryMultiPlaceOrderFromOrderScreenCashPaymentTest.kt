...
class DeliveryMultiPlaceOrderFromOrderScreenCashPaymentTest : BaseTest() {
    ...
    @Test
    @Issue("MARKETTPLAPP-1251")
    @TmsLink("courier-app-219")
    @Story("Выдача заказjd")
    @DisplayName("Выдача многоместа из карточки - оплата наличными")
    @Description("Выдача простого заказа из карточки в дровере с оплатой наличными")
    fun deliveryMultiPlaceOrderFromOrderScreenCashPaymentTest() {
