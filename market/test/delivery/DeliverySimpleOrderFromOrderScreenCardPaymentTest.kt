...
class DeliverySimpleOrderFromOrderScreenCardPaymentTest : BaseTest() {
    ...
    @Test
    @Issue("MARKETTPLAPP-761")
    @TmsLink("courier-app-127")
    @Story("Выдача заказов")
    @DisplayName("Выдача простого заказа из карточки в дровере - оплата картой")
    @Description("Выдача простого заказа из карточки в дровере с оплатой картой")
    fun deliverySimpleOrderFromOrderScreenCardPaymentTest() {
