...
class DeliveryPrepaidExpensiveMultiOrderTest: BaseTest() {
    ...
    @TmsLink("courier-app-235")
    @Story("Выдача заказов")
    @DisplayName("Обязательность фото к предоплаченному мульту со стоимостью более 50к")
    @Description("Выдача предоплаченного мульти заказа на сумму более 50 000р")
    fun deliveryPrepaidExpensiveMultiOrderTest() {
