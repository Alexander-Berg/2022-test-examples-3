...
class DeliveryMultiOrderFromOrderScreenCardPaymentTest : BaseTest() {
    ...
    @Test
    @Issue("MARKETTPLAPP-763")
    @TmsLink("courier-app-129")
    @Story("Выдача заказов")
    @DisplayName("Выдача мульта из карточки в дровере - оплата картой")
    @Description("Выдача мульта из карточки в дровере с оплатой картой")
    fun deliveryMultiOrderFromOrderScreenCardPaymentTest() {
