...
@ContextConfiguration(classes = UiTestConfigurationForModuleTests.class)
...
public class UiEntityControllerTest {
     ...
     */
    @Test
    public void getViewCard_entity() throws Exception {
     ...
     */
    @Test
    public void getViewCard_card() throws Exception {
        Entity entity = bcpService.create(FQN, Maps.of("title", Randoms.string()));
    ...
    public void getCard_exists() {
        ...
        Assertions.assertEquals("Метакласс для тестирования поиска", tab.getCaption());
