...
@ContextConfiguration(classes = IntegerConditionStorageAttributeTest.Configuration.class)
public class IntegerConditionStorageAttributeTest extends AbstractAttributeTest {
    @Override
