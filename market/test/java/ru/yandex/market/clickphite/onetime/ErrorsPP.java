...
public class ErrorsPP {
    ...
    /*
    4Q14
    wget "https://bsgraphite.yandex-team.ru/render?target=sum(one_min.yabs???_rt.ext_requests.market.requests)
    &format=json&from=1412107200&until=1420059600" -O rps.json
    wget "https://bsgraphite.yandex-team.ru/render?target=sum(one_min.yabs???_rt.errors.market_errors.errors)
    &format=json&from=1412107200&until=1420059600" -O errors.json

    1Q15
    wget "https://bsgraphite.yandex-team.ru/render?target=sum(one_min.yabs???_rt.ext_requests.market.requests)
    &format=json&from=1420059600&until=1427835600" -O rps.json
    wget "https://bsgraphite.yandex-team.ru/render?target=sum(one_min.yabs???_rt.errors.market_errors.errors)
    &format=json&from=1420059600&until=1427835600" -O errors.json
     */
