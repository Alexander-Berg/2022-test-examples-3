...
public class RecommendationRegionInfoLoader1pTest extends FunctionalTest {
    ...
    @YqlTest(
            ...
            yqlMock = "RecommendationRegionInfoLoader1pTest.yql.mock"
    )
    @DbUnitDataSet(before = "RecommendationRegionInfoLoader1pTest_before_commit.csv",
            after = "RecommendationRegionInfoLoader1pTest_after_commit.csv")
    public void importRecommendationRegionInfoLoader1pTest_WillCommitTran() {
    ...
    @DbUnitDataSet(before = "RecommendationRegionInfoLoader1pTest_expansion_before_commit.csv",
            after = "RecommendationRegionInfoLoader1pTest_expansion_after_commit.csv")
