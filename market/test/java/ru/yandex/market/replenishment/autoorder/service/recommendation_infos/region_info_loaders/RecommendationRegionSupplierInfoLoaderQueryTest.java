...
@ContextConfiguration(classes = {
    RecommendationRegionSupplierInfoLoader3p.class
})
public class RecommendationRegionSupplierInfoLoaderQueryTest extends YqlQueryTest {
    ...
    @Autowired
    private RecommendationRegionSupplierInfoLoader3p recommendationRegionSupplierInfoLoader3p;
    ...
    public void testQuery(){
        ...
        assertEquals(
            TestUtils.readResource("/queries/expected_recommendation_region_supplier_infos.yt.sql"),
            recommendationRegionSupplierInfoLoader3p.getQuery(event.getTablePath()));
    }
}
