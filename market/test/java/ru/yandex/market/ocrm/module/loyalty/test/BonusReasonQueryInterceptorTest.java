...
import ru.yandex.market.ocrm.module.loyalty.impl.BonusReasonQueryInterceptor;

import static org.mockito.ArgumentMatchers.any;
import static org.mockito.ArgumentMatchers.eq;
import static org.mockito.Mockito.when;

public class BonusReasonQueryInterceptorTest {
    ...
    public void getFiltersTest() {
        ...
        var queryInterceptor = new BonusReasonQueryInterceptor(securityService, securityDataService);
        ...
        var firstFilter = filter.iterator().next();
        ...
        Assertions.assertEquals(BonusReason.AVAILABLE_FOR_ROLES, firstFilterEq.getAttribute());
