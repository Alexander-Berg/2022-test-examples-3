...
public class FunctionalTestHelper {
    ...
    private static final RestTemplate REST_TEMPLATE = createJsonRestTemplate();
    private static final RestTemplate XML_REST_TEMPLATE = createXmlRestTemplate();
    ...
    public static String getResoure(Class c, String fileName) {
        try {
