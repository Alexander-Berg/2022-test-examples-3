...
public class SalesByMonthLoaderTest extends AbstractFunctionalTest {

    @Autowired
    private SalesByMonthLoader salesByMonthLoader;
    ...
    @YqlTest(
            ...
            csv = "SalesByMonthLoaderTest.yql.csv",
            yqlMock = "SalesByMonthLoaderTest_testLoading.yql.mock.json"
    )
    @DbUnitDataSet(after = "SalesByMonthLoaderTest_testLoading.after.csv")
    void test() {
        TestUtils.setMockedTimeServiceWithNowDateTime(salesByMonthLoader,
                LocalDateTime.of(2021, 12, 29, 0, 0, 0));
        salesByMonthLoader.load();
    }
