...
public class OrderReturningEventConverterTest {
    ...
    private final OrderReturningEventConverter converter = new OrderReturningEventConverter(phoneService);
    ...
    @Test
    public void orderReturningEvent() {
        ...
        assertThat(message.getType(), equalTo("LOM_ORDER_RETURNING"));
