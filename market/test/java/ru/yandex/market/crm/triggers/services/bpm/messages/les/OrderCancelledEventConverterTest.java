...
public class OrderCancelledEventConverterTest {
    ...
    private final OrderCancelledEventConverter converter = new OrderCancelledEventConverter(phoneService);
    ...
    public void orderCancelledEvent() {
        ...
        assertThat(message.getType(), equalTo("LOM_ORDER_CANCELLED"));
