...
public class OrderDeliveredEventConverterTest {
    ...
    private final OrderDeliveredEventConverter converter = new OrderDeliveredEventConverter(phoneService);
    ...
    @Test
    public void orderDeliveredEvent() {
        ...
        assertThat(message.getType(), equalTo("LOM_ORDER_DELIVERED"));
