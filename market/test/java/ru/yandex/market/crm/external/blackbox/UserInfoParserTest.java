...
import ru.yandex.market.crm.external.blackbox.userinfo.UserInfoParser;
import ru.yandex.market.crm.external.blackbox.userinfo.UserType;
...
public class UserInfoParserTest {
    ...
    private static final String BLACKBOX_RESPONSE_FILE = "blackbox-response.json";
