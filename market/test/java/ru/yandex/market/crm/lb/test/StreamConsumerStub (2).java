...
public class StreamConsumerStub implements BatchingStreamConsumer {
    ...
    public void assertNotLocked(String partitionId) {
        assertFalse("Partition " + partitionId + " is locked", lockedPartitions.containsKey(partitionId));
    }
    ...
    public void assertStarted() {
        assertNotNull("Consumer is not started", listener);
    }

    public void assertNotStarted() {
        assertNull("Consumer is started, but should not be", listener);
    }
