...
class StructuredMdmMetadataTest {

    @Test
    fun `should transform metadata to only top level rich attributes`() {
        // given
        ...
        val mdmMetadata = structuredMdmMetadataWithOneStructAttribute(
        ...
        attributes.first().toAttribute().internalName shouldBe "outer"
    ...
    fun `should convert entity to flat common entity and back`() {
        ...
        val metadata = StructuredMdmMetadata(
            outerEntityType,
