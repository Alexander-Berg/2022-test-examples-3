...
import ru.yandex.market.mdm.service.common_entity.config.CommonEntityConfiguration
...
@ContextConfiguration(
    ...
    classes = [
        CommonEntityConfiguration::class,
        TestConfig::class,
    ]
)
abstract class CommonEntityBaseTestClass
