...
class ImportRealSuppliersExecutorTest extends FunctionalTest {
    ...
    void setUp() {
        ...
        importRealSuppliersExecutor = new ImportRealSuppliersExecutor(
                ...
                3,
                sourceModule,
                environmentService, applicationEventPublisher);
    ...
    void partUpdate() {
        importRealSuppliersExecutor.doJob(null);
        verify(mboPartnerExportLogbrokerService, atLeast(1)).publishEvent(argThat(event -> {
            PartnerInfo.PartnerInfoEvent partnerInfoEvent = (PartnerInfo.PartnerInfoEvent) event.getPayload();
            return partnerInfoEvent.getIsFullfilment() &&
                    !partnerInfoEvent.getIsDropship() &&
                    !partnerInfoEvent.getIsDropshipBySeller() &&
                    !partnerInfoEvent.getIsCrossdock();
        }));
    }
