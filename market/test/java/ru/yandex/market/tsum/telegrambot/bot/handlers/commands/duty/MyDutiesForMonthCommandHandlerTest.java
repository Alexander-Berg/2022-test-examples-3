...
public class MyDutiesForMonthCommandHandlerTest {
    private static final String UPDATE_OBJECT_FILE_NAME = "bot/handlers/commands/duty/UpdateObjectForMyMonthDuties.json";
