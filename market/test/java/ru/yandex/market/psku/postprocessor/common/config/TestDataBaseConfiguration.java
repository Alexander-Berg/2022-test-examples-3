package ru.yandex.market.psku.postprocessor.common.config;
...
import ru.yandex.market.psku.postprocessor.common.spring.SpringTransactionProvider;
...
public class TestDataBaseConfiguration {
    ...
    @Bean
    SpringTransactionProvider transactionProvider(DataSourceTransactionManager transactionManager,
                                                  DataSourceConnectionProvider connectionProvider) {
    ...
    org.jooq.Configuration configuration(DataSourceConnectionProvider connectionProvider,
    ...
    @Bean
    @Qualifier("roConfiguration")
    org.jooq.Configuration roConfiguration(org.jooq.Configuration configuration) {
