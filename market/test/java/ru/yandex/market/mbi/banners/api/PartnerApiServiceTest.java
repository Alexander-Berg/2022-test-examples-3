...
import ru.yandex.market.mbi.banners.shop.model.BannerDisplayType;


// todo update for new classes
@Disabled
class PartnerApiServiceTest {
    ...
    private ResponseEntity<String> getPartnerBannersInfo(long campaignId) {
        return FunctionalTestHelper.get(BASE_URL + "/partner/banners?campaign_id=" + campaignId);
    }

    private ResponseEntity<String> getPartnerBannersInfo(long campaignId, String pageId) {
        return FunctionalTestHelper.get(
                String.format(BASE_URL + "/partner/banners?campaign_id=%s&page_id=%s", campaignId, pageId));
    }

    private ResponseEntity<String> getPartnerBannersInfo(long campaignId, String campaignType, String pageId) {
        return FunctionalTestHelper.get(
                String.format(BASE_URL + "/partner/banners?campaign_id=%s&campaign_type=%s&page_id=%s", campaignId, campaignType, pageId));
    }

    private ResponseEntity<String> getPartnerBannersInfo(long campaignId, Set<BannerDisplayType> displayTypes) {
        return FunctionalTestHelper.get(BASE_URL + "/partner/banners?campaign_id=" + campaignId + "&display_types=" +
    ...
    private ResponseEntity<String> getPartnerBannersInfoByBusiness(long businessId) {
        return FunctionalTestHelper.get(BASE_URL + "/partner/banners?businessId=" + businessId);
    }
}
