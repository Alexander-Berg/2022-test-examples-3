...
import ru.yandex.market.mbi.yt.remove.YtRemoveService;
import ru.yandex.market.mbi.yt.remove.YtStorageInterval;
...
class YtRemoveServiceTest extends FunctionalTest {
    ...
    private static class TestTableInfo {
        ...
        public TestTableInfo(String name, LocalDateTime creationTime, String type) {
            this.name = name;
