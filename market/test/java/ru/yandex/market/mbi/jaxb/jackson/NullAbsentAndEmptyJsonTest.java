...
public class NullAbsentAndEmptyJsonTest {
    ...
    public void testEmpty() throws JsonProcessingException {
        TestValue value = new TestValue.Builder()
                ...
                .setStringValue(null)
                .build();
        String expected = "{\"ints\":[],\"longs\":[],\"doubles\":[],\"strings\":[],\"intListElements\":[],\"longListElements\":[],\"doubleListElements\":[],\"stringListElements\":[]}";
        Assert.assertEquals(expected, MAPPER.writeValueAsString(value));
    }
    ...
    public void testSingleValue() throws JsonProcessingException {
        TestValue value = new TestValue.Builder()
                ...
                .setStringValue("16")
                .build();
        String expected = "{\"ints\":[1],\"longs\":[2],\"doubles\":[3.0],\"strings\":[\"4\"],\"intListElements\":[5],\"longListElements\":[6],\"doubleListElements\":[7.0],\"stringListElements\":[\"8\"],\"optionalInt\":9,\"optionalLong\":10,\"optionalDouble\":11.0,\"optionalString\":\"12\",\"intValue\":13,\"longValue\":14,\"doubleValue\":15.0,\"stringValue\":\"16\"}";
        Assert.assertEquals(expected, MAPPER.writeValueAsString(value));
    }
