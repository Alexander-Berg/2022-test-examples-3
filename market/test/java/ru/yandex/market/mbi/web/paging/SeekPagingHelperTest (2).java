...
public class SeekPagingHelperTest {
    ...
    @Test
    public void testInvariantString() throws JsonParseException, JsonMappingException {
    ...
    @Test
    public void testInvariantLong() throws JsonParseException, JsonMappingException {
        SeekSliceRequestBuilder<Long> pagingBuilder = createSeekPagingHelperBuilder(Long.class);
    ...
    @Test
    public void testInvariantCustomDTO() throws JsonParseException, JsonMappingException {
