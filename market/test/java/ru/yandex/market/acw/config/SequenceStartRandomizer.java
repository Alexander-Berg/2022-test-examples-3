...
import ru.yandex.market.acw.jooq.Public;
...
public class SequenceStartRandomizer implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        List<Sequence<?>> sequences = Public.PUBLIC.getSequences();
        ...
        for (Sequence<?> sequence : sequences) {
            ...
            dsl.execute("select setval('public." + sequence.getName() + "'," +  randomPositiveInt + ")");
        }
    }
}
