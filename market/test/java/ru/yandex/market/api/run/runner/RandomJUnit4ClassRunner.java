 ...
 * @author dimkarp93
 */
public class RandomJUnit4ClassRunner extends BlockJUnit4ClassRunner implements RandomRunner {
    private final Random random;

    public RandomJUnit4ClassRunner(Random random, Class<?> testClass) throws Exception {
        super(testClass);
        this.random = random;
    }
