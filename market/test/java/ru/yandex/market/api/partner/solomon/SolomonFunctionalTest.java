package ru.yandex.market.api.partner.solomon;
...
class SolomonFunctionalTest extends FunctionalTest {
    ...
    @Test
    void solomonTestOk() {
        ResponseEntity<String> responseEntity = FunctionalTestHelper.makeRequest(
                urlBasePrefix + "/solomon",
                HttpMethod.GET,
                String.class
        );
