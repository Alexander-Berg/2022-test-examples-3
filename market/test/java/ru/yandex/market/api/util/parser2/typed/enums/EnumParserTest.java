...
public class EnumParserTest extends UnitTestBase {
    ...
    private final Parser2<TestEnum> parser = Parsers2.enumParser(TestEnum.class)
    ...
    public void dependsOnVersion() {
        ...
        assertParsed("A", TestEnum.A);
        assertNotAllowed("B", TestEnum.A, TestEnum.C, TestEnum.D, TestEnum.E);
    }
    ...
    public void restrictedToClient() {
        ...
        assertParsed("D", TestEnum.D);
        assertNotAllowed("C", TestEnum.A, TestEnum.B, TestEnum.E);
        assertParsed("E", TestEnum.E);
    }
