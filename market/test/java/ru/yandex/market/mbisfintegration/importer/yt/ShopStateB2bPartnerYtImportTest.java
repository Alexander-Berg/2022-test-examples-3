...
import ru.yandex.market.mbisfintegration.converters.impl.yt.ShopStateB2bPartnerYtConverter;
 ...
 * @date 25.03.2022
 */
public class ShopStateB2bPartnerYtImportTest extends AbstractYtImportTest {
    ...
    protected void setUp() throws Exception {
        ...
        entityType = SHOP;
        converter = new ShopStateB2bPartnerYtConverter();
        ...
        ytMockHelper.mockSelectSingleRow(
                ...
                "supplier_id", new YTreeIntegerNodeImpl(true, IMPORTED_SHOP_ID, Map.of()),
...
//              "agency_manager_name", new YTreeStringNodeImpl("F A", Map.of()),
        ...
        ytImporter = new ShopStateB2bPartnerYtImport(ytClientMock, ytAccountPreparationService,
