...
import ru.yandex.market.global.checkout.domain.promo.apply.first_order_discount_no_adult.FirstOrderDiscountNoAdultArgs;
import ru.yandex.market.global.checkout.domain.promo.apply.first_order_discount_no_adult.FirstOrderDiscountNoAdultPromoApplyHandler;
...
public class FirstOrderDiscountNoAdultTest extends BasePromoTest {
    ...
    private final FirstOrderDiscountNoAdultPromoApplyHandler promoApplyHandler;
    ...
    private Promo createPromo() {
        return testPromoFactory.createPromo(TestPromoFactory.CreatePromoBuilder.builder()
                .setupPromo(p -> p
                        .setName("FIRST_ORDER_PROMO_NO_ADULT_30")
                ...
                .setupArgs((a) -> new FirstOrderDiscountNoAdultArgs()
