package ru.yandex.market.saas_java_client.http.searcher.query;
...
import ru.yandex.market.saas_java_client.http.common.SaasAttr.NoProperty;
...
public class TermTest {
    private static final SaasAttr<IntKind, Search, NoGroup, NoProperty> INT_FIELD
            = SaasAttr.intAttr("i_field").search();

    private static final SaasAttr<StringKind, Search, NoGroup, NoProperty> STR_FIELD
            = SaasAttr.stringAttr("s_field").search();

    private static final SaasAttr<StringKind, Zone, NoGroup, NoProperty> ZONE_FIELD
