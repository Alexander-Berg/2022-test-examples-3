package ru.yandex.market.stat.dicts.integration.help;
...
public class SpringDataProviderRunner extends SpringJUnit4ClassRunner {
     ...
     */
    private TestClass getTestClassInt() {
        return getTestClass();
    }
     ...
     * @return the exploded list of test methods (never {@code null})
     */
    private List<FrameworkMethod> generateExplodedTestMethodsFor(List<FrameworkMethod> testMethods) {
     ...
     */
    private FrameworkMethod getDataProviderMethod(FrameworkMethod testMethod) {
        if (testMethod == null) {
     ...
     * </p>
     */
    private TestClass findDataProviderLocation(UseDataProvider useDataProvider) {
