...
public class AssortmentApiControllerPricesTest extends MockedWebTestBase {
    ...
    @Test
    void shouldReturnBasePriceFromPotentialPromo() throws Exception {
        ...
        assertThat(pagingResponse.getItems(), hasItem(allOf(
                ...
                hasProperty("actualPromos", notNullValue()),
                hasProperty("mechanicsProperties", allOf(
//                        hasProperty("fixedPrice", nullValue()),
//                        hasProperty("fixedBasePrice", comparesEqualTo(BigDecimal.valueOf(2000))),
    ...
    @Test
    void shouldReturnPricesFromActualPromo() throws Exception {
        datacampOfferDao.replace(List.of(
                datacampOffer(
                        name(SSKU_1),
                        shopSku(SSKU_1),
        ...
        assertThat(pagingResponse.getItems(), hasItem(allOf(
                ...
                hasProperty("actualPromos", notNullValue()),
                hasProperty("mechanicsProperties", allOf(
//                        hasProperty("fixedPrice", comparesEqualTo(BigDecimal.valueOf(500))),
//                        hasProperty("fixedBasePrice", comparesEqualTo(BigDecimal.valueOf(2500))),
                        hasProperty("minimalDiscountPercentSize", comparesEqualTo(BigDecimal.TEN))
                ))
        )));
    }
    ...
    @Test
    void shouldGetBasePriceFromPotentialPromoIfNull() throws Exception {
        datacampOfferDao.replace(List.of(
                datacampOffer(
                        name(SSKU_1),
                        shopSku(SSKU_1),
...
//                        hasProperty("fixedBasePrice", comparesEqualTo(BigDecimal.valueOf(2000))),
    ...
    @Test
    void shouldReturnPricesFromLocalPromo() throws Exception {
        datacampOfferDao.replace(List.of(
                datacampOffer(
                        name(SSKU_1),
                        shopSku(SSKU_1),
        ...
        assertThat(pagingResponse.getItems(), hasItem(allOf(
                ...
                hasProperty("actualPromos", notNullValue()),
                hasProperty("mechanicsProperties", allOf(
//                        hasProperty("fixedPrice", comparesEqualTo(BigDecimal.valueOf(800))),
//                        hasProperty("fixedBasePrice", comparesEqualTo(BigDecimal.valueOf(3000))),
                        hasProperty("minimalDiscountPercentSize", comparesEqualTo(BigDecimal.TEN))
                ))
        )));
    }
