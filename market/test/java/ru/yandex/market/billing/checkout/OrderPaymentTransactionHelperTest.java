...
class OrderPaymentTransactionHelperTest extends FunctionalTest {
    ...
    private static final String RESOURCE_PREFIX =
            "ru/yandex/market/billing/checkout/resources/checkouter_response/refunds/";
    private static final LocalDate LOCAL_DATE = LocalDate.of(2018, 12, 12);
    private static final Date DATE_2018_12_12 =
            new Date(LOCAL_DATE.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant().toEpochMilli());
