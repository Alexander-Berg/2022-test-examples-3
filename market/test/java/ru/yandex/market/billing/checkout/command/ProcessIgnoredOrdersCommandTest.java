...
@DbUnitDataSet(before = {"../db/cpa_order_status.csv", "../db/datasource.csv", "../db/deliveryTypes.csv"})
class ProcessIgnoredOrdersCommandTest extends FunctionalTest {
    ...
    @DbUnitDataSet(
            before = "db/ProcessIgnoredOrdersCommandTest.testProcessEvents.before.xml",
            after = "db/ProcessIgnoredOrdersCommandTest.testProcessEvents.before.xml",
            type = DataSetType.XML
    )
