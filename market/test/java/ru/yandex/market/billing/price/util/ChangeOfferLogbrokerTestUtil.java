package ru.yandex.market.billing.price.util;
...
public class ChangeOfferLogbrokerTestUtil {
     ...
     */
    public static List<SyncChangeOfferLogbrokerEvent> getLogbrokerEvents(
            LogbrokerEventPublisher<SyncChangeOfferLogbrokerEvent> logbrokerService, int numberOfInvocation) {
    ...
    public static Map<DataCampOfferIdentifiers.OfferIdentifiers, DataCampOffer.Offer> getOffers(
            List<SyncChangeOfferLogbrokerEvent> allValues, int index
    ) {
