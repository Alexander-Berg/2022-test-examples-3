...
class PromoOrderItemDaoTest extends FunctionalTest {
    ...
    @Autowired
    PromoOrderItemDao pgPromoOrderItemDao;
    ...
    void fetchPromoOrderItemsByDate() {
        assertThat(pgPromoOrderItemDao.getItemIdsForDeliveryDate(LocalDate.parse("2021-06-15")))
    ...
    void fetchSamePromoOrderItemsByDate() {
        assertThat(pgPromoOrderItemDao.getItemIdsForDeliveryDate(LocalDate.parse("2021-06-20")))
    ...
    void fetchPromoOrderItemsForSameCampaignByDate() {
        assertThat(pgPromoOrderItemDao.getItemIdsForDeliveryDate(LocalDate.parse("2021-07-01")))
    ...
    void fetchPromoOrderItemMarketingCampaignsByDate() {
        ...
        List<Long> itemIds = pgPromoOrderItemDao.getItemIdsForDeliveryDate(date);
        assertThat(
                pgMarketingCampaignDao.getCampaignsByAnaplanIds(
                        pgPromoOrderItemDao.getOrderCampaignAnaplanIdsByItemIds(date, itemIds)
                ).stream()
    ...
    void fetchSamePromoOrderItemMarketingCampaignsByDate() {
        ...
        List<Long> itemIds = pgPromoOrderItemDao.getItemIdsForDeliveryDate(date);
        assertThat(pgMarketingCampaignDao.getCampaignsByAnaplanIds(
                pgPromoOrderItemDao.getOrderCampaignAnaplanIdsByItemIds(date, itemIds)
                )
                        .stream()
                        .map(MarketingCampaign::getId)
    ...
    void fetchPromoOrderItemByIdsAndDate() {
        ...
        LocalDate date = LocalDate.parse("2021-06-15");
        List<Long> itemIds = pgPromoOrderItemDao.getItemIdsForDeliveryDate(date);
        assertThat(pgPromoOrderItemDao.getPromoOrderItemsForDeliveryDate(date, itemIds))
    ...
    void deletePromoOrderItems() {
        LocalDate date = LocalDate.parse("2021-06-20");
        pgPromoOrderItemDao.deletePromoOrderItemsImportedAt(date);
    }
    ...
    void persistPromoOrderItems() {
        ...
        pgPromoOrderItemDao.persistPromoOrderItems(promoOrderItems);
    }
}
