...
class BankOrdersImportExecutorTest {
    ...
    void testImportBankOrders() {
        when(bankOrdersImportService.importBankOrders(any(BalanceServiceId.class), any(Instant.class),
                any(Instant.class)))
        ...
        bankOrdersImportExecutor.doJob();
    ...
    void testWithNoProperty() {
        ...
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class,
                () -> bankOrdersImportExecutor.doJob());
        assertEquals("Property market.billing.bank_orders_import_executor.last.time.610 not found",
