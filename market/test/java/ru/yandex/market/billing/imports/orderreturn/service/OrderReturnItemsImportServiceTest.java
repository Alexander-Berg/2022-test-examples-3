...
/**
 * Тесты для {@link OrderReturnItemsImportService}
 * <p>
 ...
 * LIMIT 100;
 */
class OrderReturnItemsImportServiceTest extends FunctionalTest {
    ...
    private static final Map<String, Function<Object, YTreeNode>> RETURN_ITEM_YT_FIELDS = Map.of(
            "id", LONG_NODE,
            "return_id", LONG_NODE,
            "order_id", LONG_NODE,
            "item_id", LONG_NODE,
    ...
    @Autowired
    private OrderReturnItemsImportService orderReturnItemsImportService;
    ...
    private static List<YTreeMapNode> toYtNodes(List<Map<String, Object>> orderReturns) {
        return orderReturns.stream()
                .map(orderReturnItem -> YtUtilTest.treeMapNode(
                                RETURN_ITEM_YT_FIELDS.entrySet().stream()
    ...
    void testImport() {
        ...
        orderReturnItemsImportService.runAtCluster(ytCluster);
    }
    ...
    void testImportLongReturnReason() {
        ...
        assertDoesNotThrow(() -> orderReturnItemsImportService.runAtCluster(ytCluster));
    }
