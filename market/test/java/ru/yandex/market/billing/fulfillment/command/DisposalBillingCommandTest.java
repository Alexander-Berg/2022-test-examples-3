...
import ru.yandex.market.billing.fulfillment.disposal.DisposalBillingCommand;
import ru.yandex.market.billing.fulfillment.disposal.DisposalBillingService;
...
public class DisposalBillingCommandTest {
    ...
    private void init(Instant fixedInstant, String fromDate) {
        ...
        when(partnerDao.existingPartnerId(Set.of(FIRST_SUPPLIER_ID, SECOND_SUPPLIER_ID)))
                .thenReturn(Set.of(FIRST_SUPPLIER_ID, SECOND_SUPPLIER_ID));
    }
