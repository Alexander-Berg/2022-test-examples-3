package ru.yandex.market.billing.fulfillment.xdoc;
...
class XdocSupplyBillingServiceTest extends FunctionalTest {
    ...
    private static final BigDecimal AMOUNT_300_RUB = new BigDecimal("300.00");
    private static final BigDecimal AMOUNT_1850_RUB = new BigDecimal("1850.00");
    ...
    private List<TariffDTO> getXdocTariffs() {
        return List.of(
                createTariff(1L, LocalDate.of(2019, 8, 16), LocalDate.of(2020, 9, 15), List.of(
                        createMeta(AMOUNT_250_RUB, XdocSupplyServiceEnum.MSK, XdocSupplyServiceEnum.ROSTOV_ND,
                                BillingUnitEnum.SUPPLY_BOX),
                        createMeta(AMOUNT_2900_RUB, XdocSupplyServiceEnum.MSK, XdocSupplyServiceEnum.ROSTOV_ND,
                                BillingUnitEnum.SUPPLY_PALLET),

                        createMeta(AMOUNT_250_RUB, XdocSupplyServiceEnum.ROSTOV_ND, XdocSupplyServiceEnum.MSK,
                                BillingUnitEnum.SUPPLY_BOX),
                        createMeta(AMOUNT_2900_RUB, XdocSupplyServiceEnum.ROSTOV_ND, XdocSupplyServiceEnum.MSK,
                                BillingUnitEnum.SUPPLY_PALLET),

                        createMeta(AMOUNT_250_RUB, XdocSupplyServiceEnum.SPB, XdocSupplyServiceEnum.MSK,
                                BillingUnitEnum.SUPPLY_BOX),
                        createMeta(AMOUNT_2900_RUB, XdocSupplyServiceEnum.SPB, XdocSupplyServiceEnum.MSK,
                                BillingUnitEnum.SUPPLY_PALLET),

                        createMeta(AMOUNT_300_RUB, XdocSupplyServiceEnum.KRASNODAR, XdocSupplyServiceEnum.ROSTOV_ND,
                                BillingUnitEnum.SUPPLY_BOX),
                        createMeta(AMOUNT_1850_RUB, XdocSupplyServiceEnum.KRASNODAR, XdocSupplyServiceEnum.ROSTOV_ND,
                                BillingUnitEnum.SUPPLY_PALLET),

                        createMeta(AMOUNT_250_RUB, XdocSupplyServiceEnum.TOMILINO_XDOC, XdocSupplyServiceEnum.SPB,
                                BillingUnitEnum.SUPPLY_BOX),
                        createMeta(AMOUNT_2900_RUB, XdocSupplyServiceEnum.TOMILINO_XDOC, XdocSupplyServiceEnum.SPB,
                                BillingUnitEnum.SUPPLY_PALLET)
                )),
                createTariff(2L, LocalDate.of(2020, 9, 15), LocalDate.of(2021, 4, 1), List.of(
                        createMeta(AMOUNT_1_RUB, XdocSupplyServiceEnum.MSK, XdocSupplyServiceEnum.ROSTOV_ND,
                                BillingUnitEnum.SUPPLY_BOX),
                        createMeta(AMOUNT_1_RUB, XdocSupplyServiceEnum.MSK, XdocSupplyServiceEnum.ROSTOV_ND,
                                BillingUnitEnum.SUPPLY_PALLET),
    ...
    private CommonJsonSchema createMeta(BigDecimal amount, XdocSupplyServiceEnum from, XdocSupplyServiceEnum to,
