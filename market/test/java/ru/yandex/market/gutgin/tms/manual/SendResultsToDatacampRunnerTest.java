...
public class SendResultsToDatacampRunnerTest {

    private SendResultsToDatacampTaskAction action;
    ...
    public void setUp() throws Exception {
        this.action = new SendResultsToDatacampTaskAction(gcSkuTicketDao,
                datacampOfferDao,
                null,
                mock(SkuRatingEvaluator.class),
                modelStorageHelper
                );
    }
    ...
    public void run() {
        ...
        long databucket = copyDataFromProduction(34094641);
