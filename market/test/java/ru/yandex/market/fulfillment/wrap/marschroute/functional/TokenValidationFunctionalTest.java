...
class TokenValidationFunctionalTest extends IntegrationTest {
    ...
    void wrapReturnsErrorWhenTokenDoesNotExistInDb() throws Exception {
        String wrapRequest = "functional/token_validation/unknown_token/wrap_request.xml";
        String expectedWrapResponse = "functional/token_validation/unknown_token/wrap_response.xml";
    ...
    void wrapReturnsErrorWhenTokenDoesNotSupportRequestType() throws Exception {
        String wrapRequest = "functional/token_validation/unsupported_request_type/wrap_request.xml";
        String expectedWrapResponse = "functional/token_validation/unsupported_request_type/wrap_response.xml";
