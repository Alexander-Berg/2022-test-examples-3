...
public class GetInboundStatusNegativeScenarioWrongResponse extends FunctionalTestScenario<RequestWrapper<GetInboundsStatusRequest>, ResponseWrapper<GetInboundsStatusResponse>> {

    private final static String REQUEST_PATH = "functional/get_inbound_status/positive/request.xml";
    private final static String RESPONSE_PATH = "functional/get_inbound_status/negative/bad_response.json";

    private final String requestUrl;

    public GetInboundStatusNegativeScenarioWrongResponse(RestTemplate restTemplate, String requestUrl) {
        super(restTemplate);
    ...
    public void doAssertions(SoftAssertions assertions,
        ...
        assertions.assertThat(errorCodes.get(0).getMessage())
            .as("Asserting error message")
            .isEqualTo("Marschroute error message [tra ta ta]");

        assertions.assertThat(errorCodes.get(0).getDescription())
            .as("Asserting error message")
            .isEqualTo("Marschroute error code [123]");
    }
}
