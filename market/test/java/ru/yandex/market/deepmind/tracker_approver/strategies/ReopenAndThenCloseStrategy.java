 ...
 */
public class ReopenAndThenCloseStrategy implements TrackerApproverStrategy<MyKey, MyMeta, MyMeta> {
    public static final String TYPE = "reopen_and_to_close";
    ...
    public ProcessResponse<MyKey, MyMeta, MyMeta> process(ProcessRequest<MyKey, MyMeta, MyMeta> request) {
        return ProcessResponse.of(reopened ? BaseStatusMeta.Status.OK : ProcessResponse.Status.NOT_OK);
    }
