...
public class TrackerApproverExecutorTest extends BaseTrackerApproverTest {
    private TrackerApproverFactory trackerApproverFactory;
    private TrackerApproverExecutor executor;
    private TrackerApproverExecutionContext executorContext;
    @Autowired
    ...
    @Before
    public void setUp() {
        executorContext = new TrackerApproverExecutionContext()
            .setThreadCount(1);
        trackerApproverFactory = new TrackerApproverFactory(dataRepository, ticketRepository, transactionTemplate,
            objectMapper);
        executor = new TrackerApproverExecutor(executorContext, trackerApproverFactory, ticketRepository,
            transactionTemplate);
    ...
    public void dontRunMoreThenMaxRetryCount() {
        executorContext.setMaxRetryCount(2);
