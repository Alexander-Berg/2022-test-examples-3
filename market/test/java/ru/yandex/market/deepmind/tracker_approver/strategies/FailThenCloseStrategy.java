...
/**
 * Стратегия, которая всегда при первом прогоне падает, а потом при втором отрабатывает.
 */
public class FailThenCloseStrategy implements TrackerApproverStrategy<MyKey, MyMeta, MyMeta> {
    public static final String TYPE = "fail_than_close";
