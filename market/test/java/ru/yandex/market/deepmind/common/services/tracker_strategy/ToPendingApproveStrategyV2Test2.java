...
public class ToPendingApproveStrategyV2Test2 extends ToPendingApproveStrategyBaseTestClass {
    ...
    public void sskuStatusChangedBeforeCreateSpecialOrderForAllTest() {
        sskuStatusRepository.save(
            sskuStatus(111, "shop-sku-111", INACTIVE_TMP, "comment1"),
            sskuStatus(222, "shop-sku-222", INACTIVE_TMP, "comment2")
        );
