...
/**
 * Tests of {@link BackToPendingApproveStrategyV2}.
 */
public abstract class BackToPendingApproveStrategyBaseTestClass
    extends DeepmindBaseEnhancedTrackerApproverExecutorTestClass {
    ...
    protected BackToPendingApproveStrategyV2 strategySpy;
    protected TrackerApproverFacade<ServiceOfferKey, MetaV2, KeyMetaV2> facade;

    protected FromUserExcelComposerMock fromUserExcelComposer;
    ...
    public void setUp() {
        ...
        var excelComposer = new EnrichApproveToPendingExcelComposer(deepmindMskuRepository,
        ...
        strategySpy = Mockito.spy(new BackToPendingApproveStrategyV2(
            session,
