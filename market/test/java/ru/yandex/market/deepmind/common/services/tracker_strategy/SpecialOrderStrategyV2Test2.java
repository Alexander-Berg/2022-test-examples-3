...
public class SpecialOrderStrategyV2Test2 extends SpecialOrderStrategyBaseTestClass {
    ...
    public void autoRuleFailTest() {
        ...
        var userAttachment = getExcelFrom("excel_files/specialOrderAutoRuleFailTest.xlsx");
    ...
    public void autoRuleOkTest() {
        ...
        var userAttachment = getExcelFrom("excel_files/specialOrderAutoRuleOkTest.xlsx");
        SessionUtils.addExcelAttachment(session, ticket, "test.xlsx", Instant.now().plusSeconds(1),
            userAttachment, user);
    ...
    public void autoRuleVisitTwiceTest() {
        ...
        userAttachment = getExcelFrom("excel_files/specialOrderAutoRuleOkTest.xlsx");
        SessionUtils.addExcelAttachment(session, ticket, "test.xlsx", Instant.now().plusSeconds(1),
            userAttachment, user);
    ...
    public void autoRuleWithWrongExcelTest() {
        ...
        userAttachment = getExcelFrom("excel_files/specialOrderAutoRuleOkTest.xlsx");
        SessionUtils.addExcelAttachment(session, ticket, "test2.xlsx", Instant.now().plusSeconds(1),
            userAttachment, user);
    ...
    public void economicMetricsRowWithoutSupplierIdTest() {
        ...
        var userAttachment = getExcelFrom("excel_files/specialOrderRowWithoutSupplierId.xlsx");
        SessionUtils.addExcelAttachment(session, ticket, "test.xlsx", Instant.now().plusSeconds(1),
            userAttachment, user);
        ...
        Mockito.doReturn(new MessageDTO())
            .when(replenishmentService).specialOrderRequestDeclineRest(any());
    ...
    @Test
    public void sskuStatusChangedBeforeProcessingTest() {
        sskuStatusRepository.save(
            sskuStatus(111, "shop-sku-111", INACTIVE_TMP, NO_PURCHASE_PRICE.getLiteral()),
            sskuStatus(222, "shop-sku-222", DELISTED, "comment2")
        );
