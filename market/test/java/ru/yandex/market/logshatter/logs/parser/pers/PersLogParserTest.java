...
import static ru.yandex.market.logshatter.logs.parser.pers.PersLogParser.DATE_PATTERN;


public class PersLogParserTest {
    LogParserChecker checker = new LogParserChecker(new PersLogParser());
    SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_PATTERN);

    @Test
    void parse() throws Exception {
        checker.setFile("pers-tms.log");
        checker.setHost("testing-market-pers-tms-vla-1.vla.yp-c.yandex.net");
        checker.setLogBrokerTopic("rt3.kafka-bs--market-devexp@testing@pers--pers-tms");
        ...
        checker.check(
            ...
            "", // trace_id
            "", // span_id
            "pers-tms.log", // component
            UUID.nameUUIDFromBytes(line.getBytes()), // record_id
            "", // validation_err
            "{\"threadName\":\"requestThreadPool-38\",\"methodId\":\"methodId\",\"timestamp\":\"timestamp\"}" // rest
        );
    }
}
