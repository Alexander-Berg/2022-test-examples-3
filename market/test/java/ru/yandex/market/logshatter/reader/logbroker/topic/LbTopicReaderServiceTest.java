package ru.yandex.market.logshatter.reader.logbroker.topic;
...
import ru.yandex.market.logshatter.reader.logbroker.TestScheduledExecutorService;
import ru.yandex.market.logshatter.reader.logbroker.TestSingleThreadExecutorServiceFactory;
...
public class LbTopicReaderServiceTest {
    ...
    @Test
    public void startConsumeAndStopConsumeRelease() {
        mockStreamConsumerFactoryToReturnStreamConsumer();
        mockStreamConsumerStartToRememberStreamListener();
    ...
    @Test
    public void startConsumeAndContinueConsumeRelease() {
        mockStreamConsumerFactoryToReturnStreamConsumer();
        mockStreamConsumerStartToRememberStreamListener();
    ...
    private void logBrokerSendsRelease(boolean canCommit) {
        streamListener.onRelease(new ConsumerReleaseMessage("", 0, canCommit, 0));
    }
}
