...
public class AutoParserTest {
    ...
    private final SimpleDateFormat dateFormat = new SimpleDateFormat(MboGwtLogParser.DATE_PATTERN);
    ...
    public void testDefaultOnEmpty() throws Exception {
        ...
        String line = "tskv\tdate=2017-12-05T10:36:57.000+03\t" +
            "host=blacksmith01h.market.yandex.net\tmethod=\tclient_ip=";
        checker.check(line,
    ...
    @Test
    public void testDefaultOnParsingException() throws Exception {
        LogParserChecker checker = getChecker("/configs/testDefaultOnParsingException.json");

        String line = "tskv\tdate=2017-12-05T10:36:57.000+03\tint=aaaaaaaaaaaaaaaa";
        checker.check(line,
            dateFormat.parse("2017-12-05 10:36:57,000"),
            0
        );
    ...
    @Test
    public void tskvUnescape() throws Exception {
        LogParserChecker checker = getChecker("/configs/tskvUnescape.json");

        String line = "tskv\tdate=2017-12-05T10:36:57.000+03\tcolumn=\\tvalue\\n\\\\";
        checker.check(line,
            dateFormat.parse("2017-12-05 10:36:57,000"),
            "\tvalue\n\\"
        );
    ...
    private ParserConfig readParserConfig(String configFilePath) throws IOException, ConfigValidationException {
        ...
        return ConfigurationService.getParserConfig(ConfigurationService.getConfigObject(configData));
    }
}
