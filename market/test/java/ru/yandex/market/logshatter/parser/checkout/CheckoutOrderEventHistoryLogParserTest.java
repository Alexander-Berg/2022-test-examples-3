...
public class CheckoutOrderEventHistoryLogParserTest {
    ...
    @Test
    public void logCheckerTestSingleWithAtSupplierWarehouse() throws Exception {
        LogParserChecker checker = new LogParserChecker(new CheckoutOrderEventHistoryLogParser());
        String line = readLogFile("order_events_history_at_supplier_warehouse.log");
        Object[] expected = getDefault();
        expected[0] = "vla2-8719-fe7-vla-market-prod--2b1-20310";
        expected[1] = 187242052L;
        expected[2] = "ORDER_STATUS_UPDATED";
        expected[3] = 10108115L;
        expected[8] = "UNPAID";
        expected[9] = "PROCESSING";
        expected[10] = expected[11] = "DELIVERY";
        expected[12] = expected[13] = "APPLE_PAY";
        expected[16] = "WAITING_USER_INPUT";
        expected[17] = "STARTED";
        expected[18] = 431782L;
        expected[19] = 213L;
        expected[20] = "BLUE";
        expected[21] = false;
        expected[22] = "12840405";
        expected[23] = 18043918L;
        expected[24] = "ludakh@yandex.ru";
        expected[25] = "79154219547";
        expected[26] = "IOS";
        expected[27] = true;
        expected[28] = 47828;
        expected[30] = Lists.newArrayList(200);
        expected[31] = true;
        expected[32] = false;
        expected[34] = "WEB_INTERFACE";
        ...
        checker.check(
            line,
            dateFormat.parse("06-11-2019 16:24:38"),
            expected
        );
    }

    @Test
    public void logCheckerTestSingleWithBnpl() throws Exception {
        LogParserChecker checker = new LogParserChecker(new CheckoutOrderEventHistoryLogParser());
        String line = readLogFile("order_events_history_single_bnpl.log");
        Object[] expected = getDefault();
        //bnpl
        expected[32] = true;
    ...
    @Test
    public void logCheckerTestSingleWithPaymentSubmethod() throws Exception {
        LogParserChecker checker = new LogParserChecker(new CheckoutOrderEventHistoryLogParser());
        String line = readLogFile("order_events_history_single_payment_submethod.log");
        Object[] expected = getDefault();
        //paymentSubmethod
        expected[33] = "DEFAULT";
    ...
    @Test
    public void logCheckerTestSingleWithPhoneAndPersonalPhoneId() throws Exception {
        LogParserChecker checker = new LogParserChecker(new CheckoutOrderEventHistoryLogParser());
        String line = readLogFile("order_events_history_single_phone_and_personal_phone_id.log");
        Object[] expected = getDefault();
        //personalPhoneId
        expected[35] = "0123456789abcdef0123456789abcdef";
    ...
    @Test
    public void logCheckerTestSingleWithPersonalPhoneIdOnly() throws Exception {
        LogParserChecker checker = new LogParserChecker(new CheckoutOrderEventHistoryLogParser());
        String line = readLogFile("order_events_history_single_personal_phone_id_only.log");
        Object[] expected = getDefault();
        //phone
        expected[25] = "";
        //personalPhoneId
