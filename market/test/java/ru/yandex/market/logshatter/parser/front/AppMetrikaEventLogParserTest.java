...
public class AppMetrikaEventLogParserTest {
    ...
    public void parseAndroidWithStackTrace() throws Exception {
        ...
        checker.check(
            ...
            "market_front_bluetouch", checker.getHost(), "1558713411440/468c1be92fe146ccb9b59" +
                "298474434ae", "ADD_CART_ITEM_ERROR", "error", "Error on adding item to cart",
            "CommunicationException[SERVICE_ERROR(500)]\n" +
                ...
                "\tat ru.yandex.market.db.CartOnlineRepository.addCartItemFromContentApi" +
                "(CartOnlineRepository.kt:157)\n" +
                "\tat ru.yandex.market.db.CartOnlineRepository.access$addCartItemFromContentApi" +
                "(CartOnlineRepository.kt:41)\n" +
                "\tat ru.yandex.market.db.CartOnlineRepository$addItemToCart$uploadCartItem$1.apply" +
                "(CartOnlineRepository.kt:134)\n" +
                "\tat ru.yandex.market.db.CartOnlineRepository$addItemToCart$uploadCartItem$1.apply" +
                "(CartOnlineRepository.kt:41)\n" +
                "\tat io.reactivex.internal.operators.single.SingleMap$MapSingleObserver.onSuccess" +
                "(SingleMap.java:57)\n" +
                "\tat io.reactivex.internal.operators.single.SingleFromCallable.subscribeActual" +
                "(SingleFromCallable.java:56)\n" +
                "\tat io.reactivex.Single.subscribe" +
                "(Single.java:3603)\n" +
                "\tat io.reactivex.internal.operators.single.SingleMap.subscribeActual" +
                "(SingleMap.java:34)\n" +
                "\tat io.reactivex.Single.subscribe" +
                "(Single.java:3603)\n" +
                "\tat io.reactivex.internal.operators.single.SingleSubscribeOn$SubscribeOnObserver.run" +
                "(SingleSubscribeOn.java:89)\n" +
                "\tat io.reactivex.Scheduler$DisposeTask.run" +
                "(Scheduler.java:578)\n" +
                "\tat ru.yandex.market.rx.schedulers.RxSchedulersFactory$ActionWrapper.run" +
                "(RxSchedulersFactory.java:106)\n" +
                "\tat io.reactivex.internal.schedulers.ScheduledRunnable.run" +
                "(ScheduledRunnable.java:66)\n" +
                "\tat io.reactivex.internal.schedulers.ScheduledRunnable.call" +
                "(ScheduledRunnable.java:57)\n" +
                "\tat java.util.concurrent.FutureTask.run" +
                "(FutureTask.java:237)\n" +
                "\tat java.util.concurrent.ScheduledThreadPoolExecutor$ScheduledFutureTask.run" +
                "(ScheduledThreadPoolExecutor.java:272)\n" +
    ...
    public void parseAndroidWithoutInfo() throws Exception {
        ...
        checker.check(
            ...
            "market_front_bluetouch", checker.getHost(), "1557919508493/c873f5720f044ecaab4b" +
                "6c9ccbc82a47", "SCREEN_OPENED", "info", "", "", "", "", 0, tags, keys,
            values, "1.55", UNKNOWN, "android"
        );
    }
    ...
    public void parseIosWithoutStackTrace() throws Exception {
        ...
        String[] values = {
            "a9fc48beec6943aa9715876fe7baef3e",
            "1152921504669614276:UR0hJwfCScsxQYj+q7xOzUggVdF/BS5l",
            "CART_SCREEN"
        };
        ...
        checker.check(
            ...
            "market_front_bluetouch", checker.getHost(),
            "1557929124783/55051A64507C40CA932B2587B99BB899",
            "SCREEN_OPENED", "info", "SCREEN_OPENED", "", "", "", 0, tags, keys, values, "223", UNKNOWN, "iOS"
        );
    }
    ...
    public void dontParseNonFlatObjectsInInfo() throws Exception {
        String line = "ADVID=91c4b0b2-e03b-4899-9540-b96e04e086f1\tAPIKey=1389598\tAPIKey128=36ef1512-b352-4415-87bd-" +
            ...
            "mestamp=1558713410\tEventType=EVENT_STATBOX\tEventValue={\"level\":\"error\",\"name\":\"ADD_CART_ITEM" +
            "_ERROR\",\"portion\":\"SEARCH_RESULT_SCREEN\",\"type\":\"LOG\",\"duration\":0,\"requestId\":\"1558713" +
            "411440/468c1be92fe146ccb9b59298474434ae\",\"info\":{\"offer_id\":{\"name\": " +
            "\"yDpJekrrgZH6Ra11ieiXri4vCeFRTe5RN" +
            "TKWMEHyprChGQ8uNUV6iPKCVkIQuWJ1zxpCiC9OE6FvJo9y2MpYOfjb73dDKMvEMMLeaFCGlb88Wgs4HCCLlmKcYlIADLeEoyguDvY" +
            "r7AWCTzoTFuOFAGQxp0J20t0HIU6NlDRAiDUBcHsZhpPWm3C-dBxSWwShyP9ZnCN3a-g87Y3GdWPdZNplnyDD0k9J_jOoXLpnfqkln" +
            "EF7p7OR81JRqxIp92ZD2iFR5n4fq9A_bzpDUbsSFW9v67L-Aqac\"},\"message\":\"Error on adding item to cart\",\"st" +
            "ackTrace\":\"CommunicationException[SERVICE_ERROR(500)]\\n\\tat ru.yandex.market.net.http.RequestExecut" +
        ...
        String[] tags = {};
        String[] keys = {"offer_id", "uid", "muid", "portion"};
        String[] values = {"", "8357013411558604071", "1152921504671574927:UR0hJwfCScvLkQALzuDS4vjJJS7ew4Wb",
        ...
        checker.check(
            ...
            "market_front_bluetouch", checker.getHost(), "1558713411440/468c1be92fe146ccb9b59" +
                "298474434ae", "ADD_CART_ITEM_ERROR", "error", "Error on adding item to cart",
            "CommunicationException[SERVICE_ERROR(500)]\n" +
                "\tat ru.yandex.market.net.http.RequestExecutor.executeRequest" +
                "(RequestExecutor.java:55)\n" +
                "\tat ru.yandex.market.net.http.RequestExecutor.executeRequest" +
                "(RequestExecutor.java:38)\n" +
                "\tat ru.yandex.market.net.http.ContentApiClient.addCartItem" +
                "(ContentApiClient.java:469)\n" +
                "\tat ru.yandex.market.db.CartOnlineRepository.addCartItemFromContentApi" +
                "(CartOnlineRepository.kt:157)\n" +
                "\tat ru.yandex.market.db.CartOnlineRepository.access$addCartItemFromContentApi" +
                "(CartOnlineRepository.kt:41)\n" +
