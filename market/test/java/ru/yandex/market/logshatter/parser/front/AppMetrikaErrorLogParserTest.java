...
public class AppMetrikaErrorLogParserTest {
    ...
    public void setUp() {
        ...
        checker.setParam("allowedAppEvents", "EVENT_CRASH,EVENT_PROTOBUF_ANR");
        checker.setParam(
    ...
    public void parseWithoutErrorMessage() throws Exception {
        ...
        String[] tags = {};
        String[] keys = {"uuid", "deviceId", "eventId"};
        String[] values = {
            "fbfa908f5d3d9546ecb27db703b97821",
            "eaa1a4e6138a06351784852e4446d943",
            "12951947817559953868"
        };

        checker.check(
            line,
            new Date(1544193948000L),
            "market_mobile", checker.getHost(), "", "crash",
            "critical", "",
    ...
    public void parseWithErrorMessage() throws Exception {
        String line = "tskv\ttskv_format=metrika-mobile-log\ttimestamp=2018-12-11 13:33:14\ttimezone=+0000\tAPIKe" +
            ...
            "DHash=14959878514340525980\tStartDate=2018-12-11\tUUID=fbfa908f5d3d9546ecb27db703b97821\tD" +
        ...
        String[] values = {
            "fbfa908f5d3d9546ecb27db703b97821",
            "ee6f5c3b1a7694d70f99b73dc940d5f5",
            "5225295815239968060"
        };
    ...
    public void parseWithDoubleErrorMessage() throws Exception {
        String line = "tskv_format=metrika-mobile-log\ttimestamp=2018-12-19 20:29:12\ttimezone=+0000\tAPIKey=1389" +
            ...
            "h=9257515450591655498\tStartDate=2018-12-19\tUUID=fbfa908f5d3d9546ecb27db703b97821\tDevice" +
        ...
        String[] values = {
            "fbfa908f5d3d9546ecb27db703b97821",
            "bd07ec6739f82bbf847ee915939e2083",
            "7934676156642795251"
        };
        ...
        checker.check(
            ...
            "market_front_bluetouch", checker.getHost(), "", "crash",
    ...
    public void parseWithAndroidShortErrorMessage() throws Exception {
        String line = "tskv\ttskv_format=metrika-mobile-log\ttimestamp=2018-12-19 21:01:24\ttimezone=+0000\tAPIKe" +
            ...
            "UIDHash=16456991729672471399\tStartDate=2018-12-20\tUUID=fbfa908f5d3d9546ecb27db703b97821" +
        ...
        String[] values = {
            "fbfa908f5d3d9546ecb27db703b97821",
            "bdb8d2e75494603aa3e31f41314d35d9",
            "8272082399897274278"
        };
    ...
    public void parseErrorMessage() throws Exception {
        String line = "ADVID=0e7b3bc8-c6aa-4359-a967-9cf61c18c534\tAPIKey=1389598\tAPIKey128=36ef1512-b352-4415" +
            ...
            "artTimestamp=1556120789\tUUID=fbfa908f5d3d9546ecb27db703b97821\tUUIDHash=10189134413446969278\tWifi" +
        ...
        String[] values = {
            "fbfa908f5d3d9546ecb27db703b97821",
            "125288bca970581f0c463515f81cf1ef",
            "9760154410970374107"
        };
    ...
    public void parseWithIOsErrorMessage() throws Exception {
        String line = "tskv_format=metrika-mobile-log\ttimestamp=2018-12-19 22:14:27\ttimezone=+00" +
            ...
            "butionIDUUIDHash=3999058486263797332\tStartDate=2018-12-20\tUUID=fbfa908f5d3d9546ecb27db70" +
            "3b97821\tDeviceID=F834E974-5D2D-4F0D-A15F-2E714C415636\tOriginalDeviceID=B0BC5AF1-829D-4C2" +
        ...
        String[] values = {
            "fbfa908f5d3d9546ecb27db703b97821",
            "F834E974-5D2D-4F0D-A15F-2E714C415636",
            "335753216948518725"
        };
        ...
        checker.check(
            ...
            "market_front_bluetouch", checker.getHost(), "", "crash",
            "critical",
            "Application threw exception NSRangeException: *** -[__NSArray0 objectAtIndex:]: index 2 beyond " +
    ...
    @Test
    public void parseAnrError() throws Exception {
        String line = "tskv\ttskv_format=metrika-mobile-log\ttimestamp=2018-12-19 21:01:24\ttimezone=+0000\tAPIKe" +
            "y=1389598\tAPIKey128=36ef1512-b352-4415-87bd-cf45c4f7e46b\tAttributionID=1\tAttributionIDU" +
            "UIDHash=16456991729672471399\tStartDate=2018-12-20\tUUID=fbfa908f5d3d9546ecb27db703b97821" +
            "\tDeviceID=bdb8d2e75494603aa3e31f41314d35d9\tUUIDHash=4444523966327805198\tDeviceIDHash=969" +
            ...
            "etworksInterfaces_Macs=[\"D2F88CA23EDC\",\"C66A616F0031\",\"D0F88CA23EDC\"]\tDeviceType=TA" +
            "BLET\tEventID=8272082399897274278\tEventNumber=1\tEventDate=2018-12-20\tEventDateTime=2018" +
            "-12-20 00:00:52\tEventTimestamp=1545253252\tEventTimeZone=10800\tEventType=EVENT_PROTOBUF_ANR\tEv" +
            "entName=ANR\tEventSource=sdk\tEventFirstOccurrence=undefined\tEvent" +
            "Value=java.lang.Object.Object.java \\u0048\\u0065\\u006C\\u006C\\u006F" +
            "\tCrashID=17195427211382060370\tCrashGroupID=15113" +
            "618746461067532\tClickDate=1970-01-01\tRegionID=116980\tAppID=ru.beru.android\tClientIP=::" +
            "ffff:109.252.50.156\tClientIPHash=8413107664649086293\tClientPort=19308\tSex=2\tAge=25\tDe" +
            "duplicationEnabled=1\tProfileAttributeVersion=25925047583506433\tCustomAttribute_Types=[3" +
        ...
        checker.check(
            line,
            new Date(1545253252000L),
            "market_front_bluetouch", checker.getHost(), "", "anr",
            "warning", "",
            "java.lang.Object.Object.java Hello",
            "10397723144028491658", "", 0, tags, keys, values, "1.27", UNKNOWN, "android"
        );
    }
