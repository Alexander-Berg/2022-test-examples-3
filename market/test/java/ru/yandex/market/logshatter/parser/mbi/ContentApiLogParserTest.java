...
public class ContentApiLogParserTest {
    ...
    public void httpRequestRetry() throws Exception {
        String line = "[2015-03-10 15:53:10,880] INFO  [defaultEventExecutor-3-1] 03e14c02489c5b #http_request_end, " +
            "BlackBox, 8e97:2, URL: http://blackbox.yandex.net/blackbox?method=userinfo&userip=213.87.122" +
            ".76&regname=yes&dbfields=account_info.fio.uid&uid=300401650, RESPONSE_CODE: 200, DURATION: 7, #tm100";
        checker.check(line,
    ...
    public void httpRequestWithError() throws Exception {
        String line = "[2015-03-10 15:56:28,822] INFO  [defaultEventExecutor-3-1] 06d14c021334a8 #http_request_end, " +
            "PersStatic, 9ce6:1, URL: http://pers-static.yandex" +
            ".net:34522/modelOpinions?page_size=30&page_num=1&sort_by=date&sort_desc=1&modelid=4929085, " +
            "RESPONSE_CODE: -, ERROR: java.util.concurrent.CancellationException, ERROR_MSG: null, DURATION: 111, " +
            "#tm200";
        checker.check(line,
    ...
    public void httpRequestWithoutError() throws Exception {
        String line = "[2015-03-10 15:53:10,880] INFO  [defaultEventExecutor-3-1] 03e14c02489c5b #http_request_end, " +
            "BlackBox, 8e97:1, URL: http://blackbox.yandex.net/blackbox?method=userinfo&userip=213.87.122" +
            ".76&regname=yes&dbfields=account_info.fio.uid&uid=300401650, RESPONSE_CODE: 200, DURATION: 7, #tm100";
        checker.check(line,
            dateFormat.parse("2015-03-10 15:53:10,880"),
            "hostname.test",
    ...
    public void profiler() throws Exception {
        String line = "[2015-03-10 12:01:15,148] INFO  [requestThreadPool-27] vos14c0277dd25 #profiler, METHOD: " +
            "XmlView.render, DURATION: 4, #tm100";
        checker.check(line,
