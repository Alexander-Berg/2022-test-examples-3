...
public class MemoryReportByProcLogParserTest {
    ...
    public void testTskvParse() throws Exception {
        ...
        String line1 = "date=2016-11-07T15:03:29+0300\tprocess=reports_total\trss_bytes=34770006016\tpss_bytes" +
            "=34635713536\tanon_bytes=24036470784\tuss_bytes=34503966720";
        checker.check(
            line1,
        ...
        String line3 = "date=2016-11-07T15:04:29+0300\tprocess=market-report\trss_bytes=34775396352\tpss_bytes" +
            "=34641101824\tanon_bytes=24041676800\tuss_bytes=34509357056";
        checker.check(
            line3,
            new Date(1478520269000L),
            checker.getHost(),
