...
import ru.yandex.market.logshatter.reader.logbroker.TestParser;
...
public class OutputQueueTest {
    ...
    public void addAndRemoveTwice() throws Exception {
        SourceContext sourceContext = createEmptySourceContext("id1");
    ...
    public void addTwoSourceContextForDifferentConfigsAndRemoveTwice() throws Exception {
        SourceContext sourceContext1 = createEmptySourceContext("id1");
        SourceContext sourceContext2 = createEmptySourceContext("id2");
    ...
    public void addTwoSourceContextForTheSameConfigAndRemoveTwice() throws Exception {
        LogShatterConfig logShatterConfig = createLogshatterConfig("testConfig");
    ...
    /**
     * См. {@link LogShatterOutputWorker#outputOnce()}
     */
    ...
    private static SourceContext createEmptySourceContext(String id) throws ConfigValidationException {
        return createEmptySourceContext(createLogshatterConfig(id));
    }

    public static LogbrokerSourceContext createEmptySourceContext(LogShatterConfig logShatterConfig) {
    ...
    public static LogShatterConfig createLogshatterConfig(String id) throws ConfigValidationException {
