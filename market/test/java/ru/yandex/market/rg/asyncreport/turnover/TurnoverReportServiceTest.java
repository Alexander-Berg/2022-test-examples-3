...
import ru.yandex.market.rg.asyncreport.turnover.yt.TurnoverReportItemYtModel;
import ru.yandex.market.rg.asyncreport.turnover.yt.TurnoverReportSummaryYtModel;
...
class TurnoverReportServiceTest extends FunctionalTest {
    ...
    void init() {
        ...
        environmentService.setValue("TurnoverReportService.use.billing.path", "false");
    }
    ...
    void sameCategory() throws IOException, InvalidFormatException {
        var models = new ArrayList<TurnoverReportItemYtModel>();
        for (int i = 0; i < 250; ++i) {
            TurnoverReportItemYtModel model = new TurnoverReportItemYtModel();
            ...
            model.setTurnover(i == 0 ? Double.POSITIVE_INFINITY : i);
        ...
        var summary = new ArrayList<TurnoverReportSummaryYtModel>();
        TurnoverReportSummaryYtModel ytSummary = new TurnoverReportSummaryYtModel();
    ...
    void differentCategories() throws IOException, InvalidFormatException {
        ...
        for (int i = 0; i <= 1; ++i) {
            ...
            ytSummary.setCategoryTurnover(i == 0 ? Double.POSITIVE_INFINITY : (99. + i));
    ...
    void checkReport(List<TurnoverReportItemYtModel> models,
                     List<TurnoverReportSummaryYtModel> summary,
...
//        .REPLACE_EXISTING);
    ...
    private void mockYt(List<TurnoverReportItemYtModel> models, List<TurnoverReportSummaryYtModel> summary) {
