...
import ru.yandex.market.rg.crm.XMLMarshallableShopData;
 ...
 * @author otedikova
 */
class CRMLegacyDailyShopDataExportTest extends FunctionalTest {
    @Autowired
    ...
    void setUp() {
        ReportXML.DataWriterFactory<ShopFullData> writerFactory =
                ReportXML.jaxb(XMLMarshallableShopData.class, XMLMarshallableShopData::new)
                        .withChrome(ReportXML.standardChrome("shops"));
        resourceSender = new TestCRMExportResourceSender();
        executor = new ExportExecutor<>(crmRepository::provideShopDataIteratorTo, writerFactory,
    ...
    void testShopsExport() {
        ...
        String expectedXMLData = StringTestUtil.getString(getClass(), "expected_legacy_daily_shops_export.xml");
