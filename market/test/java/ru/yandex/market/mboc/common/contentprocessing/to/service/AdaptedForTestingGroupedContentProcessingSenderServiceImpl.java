...
public class AdaptedForTestingGroupedContentProcessingSenderServiceImpl
    extends GroupedContentProcessingSenderServiceImpl {

    public AdaptedForTestingGroupedContentProcessingSenderServiceImpl(
        ...
        super(queue, agService, transactionHelper, offerRepository, mskuRepository, categoryService, supplierService,
            ...
            dataCampConverterService, dataCampService, datacampImportService,
