...
public class EvaluateAndDescribeEvaluatedExprHandlerTest extends ExprHandlerBaseTest {

    @Test
    public void testHandler() {
        EvaluateAndDescribeEvaluatedExprHandler handler = new EvaluateAndDescribeEvaluatedExprHandler();
