...
public class TestYqlOverPgDatasourceConfig extends YqlConfig {
    ...
    private final TestSqlDatasourceConfig testSqlDatasourceConfig;

    public TestYqlOverPgDatasourceConfig(TestSqlDatasourceConfig testSqlDatasourceConfig) {
        this.testSqlDatasourceConfig = testSqlDatasourceConfig;
    }

    @Bean(name = YQL_OVER_PG_DATASOURCE)
    public DataSource yqlDataSource() {
        return testSqlDatasourceConfig.sqlDataSource();
    }
