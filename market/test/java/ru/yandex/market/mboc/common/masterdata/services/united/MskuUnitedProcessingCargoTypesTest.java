...
public class MskuUnitedProcessingCargoTypesTest extends UnitedProcessingServiceSetupBaseTest {
    ...
    private void processCalculation(
        ...
        enqueueMskusWithReason(List.of(MSKU_ID), MdmEnqueueReason.DEFAULT);
