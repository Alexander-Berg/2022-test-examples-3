 ...
 * @date 5/25/21
 */
public class MskuUnitedProcessingMasterDataSourceTest extends UnitedProcessingServiceSetupBaseTest {
    ...
    private void addMasterDataForSsku(ShopSkuKey offer) {
        ...
        md.setVat(VatRate.fromString("7").get());
    ...
    private void checkNumericValueAndSource(MskuParamValue mpv,
        ...
        Assertions.assertThat(mpv.getNumeric().get()).isEqualTo(expectedValue);
