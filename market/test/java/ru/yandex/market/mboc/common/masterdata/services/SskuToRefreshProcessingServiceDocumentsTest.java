...
public class SskuToRefreshProcessingServiceDocumentsTest extends SskuToRefreshProcessingServiceBaseTest {
    ...
    @Autowired
    private SskuGoldenVerdictRepository verdictRepository;
