package ru.yandex.market.logistics.lom.service.flow.platform.daas;
...
public class YandexDeliveryCalculateTotalWeightStrategyTest extends AbstractTest {

    @DisplayName("Стратегия для расчета веса для грузомест заказов DAAS")
    @ParameterizedTest(name = TUPLE_PARAMETERIZED_DISPLAY_NAME)
    @MethodSource("arguments")
    public void testCalcTotalWeight(String name, StorageUnit rootUnit, BigDecimal expectedWeight) {
        var strategy = new YandexDeliveryCalculateTotalWeightStrategy();
