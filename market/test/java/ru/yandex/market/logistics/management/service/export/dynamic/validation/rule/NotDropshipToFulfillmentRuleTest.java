...
class NotDropshipToFulfillmentRuleTest extends AbstractValidationRuleTest<PartnerRelationModel> {

    private static final ValidationRule RULE = new NotDropshipToFulfillmentRule();
    ...
    private static Stream<? extends Arguments> provideArguments() {
        return Stream.of(
            ...
            Arguments.arguments(
                ...
                NotDropshipToFulfillmentRule.FAIL_MESSAGE
            ),
            Arguments.arguments(
                new PartnerRelationDto()
                    .setId(5L)
