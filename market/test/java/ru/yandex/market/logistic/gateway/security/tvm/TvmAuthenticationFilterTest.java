package ru.yandex.market.logistic.gateway.security.tvm;
...
public class TvmAuthenticationFilterTest extends BaseTest {

    private static final String SERVICE_TICKET_HEADER = "X-Ya-Service-Ticket";
    private static final String USER_TICKET_HEADER = "X-Ya-User-Ticket";
    ...
    private HttpServletRequest getRequest(String serviceTicketValue, String userTicketValue) {
        ...
        httpServletRequest.addHeader(USER_TICKET_HEADER, userTicketValue);
