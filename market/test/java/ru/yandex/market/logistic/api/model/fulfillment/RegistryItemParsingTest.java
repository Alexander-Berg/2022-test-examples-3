...
class RegistryItemParsingTest extends ParsingTest<RegistryItem> {
    RegistryItemParsingTest() {
        super(RegistryItem.class, "fixture/entities/fulfillment/registry_item_full.xml");
    }

    @Test
    void testValidation() throws IOException {
        String fileContent = getFileContent("fixture/entities/fulfillment/registry_item_full.xml");
