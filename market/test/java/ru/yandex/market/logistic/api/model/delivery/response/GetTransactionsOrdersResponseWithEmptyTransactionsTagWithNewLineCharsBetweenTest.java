...
public class GetTransactionsOrdersResponseWithEmptyTransactionsTagWithNewLineCharsBetweenTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetTransactionsOrdersResponse> {

    public GetTransactionsOrdersResponseWithEmptyTransactionsTagWithNewLineCharsBetweenTest() {
        super(
            ResponseWrapper.class,
            GetTransactionsOrdersResponse.class,
            "fixture/response/" +
                "ds_get_transactions_orders_with_empty_transactions_tag_with_new_line_chars_between.xml"
        );
    }
