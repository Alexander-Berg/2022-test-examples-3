...
public class GetConsolidatedTransactionsResponseWithEmptyTransactionsTagWithNoCharsBetweenTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetConsolidatedTransactionsResponse> {

    public GetConsolidatedTransactionsResponseWithEmptyTransactionsTagWithNoCharsBetweenTest() {
        super(
            ResponseWrapper.class,
            GetConsolidatedTransactionsResponse.class,
            "fixture/response/ff_get_consolidated_transactions_with_empty_transactions_tag_with_no_chars_between.xml"
        );
    }
