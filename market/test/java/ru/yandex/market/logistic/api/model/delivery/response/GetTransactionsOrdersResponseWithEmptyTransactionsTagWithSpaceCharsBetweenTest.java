...
public class GetTransactionsOrdersResponseWithEmptyTransactionsTagWithSpaceCharsBetweenTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetTransactionsOrdersResponse> {

    public GetTransactionsOrdersResponseWithEmptyTransactionsTagWithSpaceCharsBetweenTest() {
        super(
            ResponseWrapper.class,
            GetTransactionsOrdersResponse.class,
            "fixture/response/" +
                "ds_get_transactions_orders_with_empty_transactions_tag_with_space_chars_between.xml"
        );
    }
