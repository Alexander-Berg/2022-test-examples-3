...
public class PutOutboundTest extends CommonServiceClientTest {
    ...
    void testSuccessfulResponse() throws Exception {
        ...
        client.putOutbound(OutboundFactory.createOutbound(), props);
    }
    ...
    void testErrorResponse() throws Exception {
        ...
        assertions.assertThatThrownBy(() -> client.putOutbound(OutboundFactory.createOutbound(), props))
    ...
    void testValidationConstraints() {
        assertions.assertThatThrownBy(
            () -> client.putOutbound(OutboundFactory.createInvalidOutbound(), getPartnerProperties())
        )
    ...
    void testInvalidInterval() {
        assertions.assertThatThrownBy(
            () -> client.putOutbound(OutboundFactory.createOutboundInvalidInterval(), getPartnerProperties())
        )
