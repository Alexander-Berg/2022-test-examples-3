...
public class GetConsolidatedTransactionsResponseWithEmptyTransactionsTagWithNewLineCharsBetweenTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetConsolidatedTransactionsResponse> {

    public GetConsolidatedTransactionsResponseWithEmptyTransactionsTagWithNewLineCharsBetweenTest() {
        super(
            ResponseWrapper.class,
            GetConsolidatedTransactionsResponse.class,
            "fixture/response/" +
                "ff_get_consolidated_transactions_with_empty_transactions_tag_with_new_line_chars_between.xml"
        );
    }

    @Test
    public void checkThatTransactionWithEmptyTransactionsTagWithNewLineCharsBetweenIsValid() throws IOException {
