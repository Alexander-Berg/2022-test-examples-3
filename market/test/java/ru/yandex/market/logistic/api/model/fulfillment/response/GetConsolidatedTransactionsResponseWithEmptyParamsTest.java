...
public class GetConsolidatedTransactionsResponseWithEmptyParamsTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetConsolidatedTransactionsResponse> {

    public GetConsolidatedTransactionsResponseWithEmptyParamsTest() {
        super(
            ResponseWrapper.class,
            GetConsolidatedTransactionsResponse.class,
            "fixture/response/ff_get_consolidated_transactions_with_empty_params.xml"
        );
    }

    @Test
    public void checkThatTransactionWithEmptyParamsIsValid() throws IOException {
