...
public class GetConsolidatedTransactionsResponseWithEmptyTransactionsTagTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetConsolidatedTransactionsResponse> {

    public GetConsolidatedTransactionsResponseWithEmptyTransactionsTagTest() {
        super(
            ResponseWrapper.class,
            GetConsolidatedTransactionsResponse.class,
            "fixture/response/ff_get_consolidated_transactions_with_empty_transactions_tag.xml"
        );
    }
