...
import ru.yandex.market.logistic.api.model.delivery.InboundRegistry;
import ru.yandex.market.logistic.api.model.delivery.MovementRegistry;
import ru.yandex.market.logistic.api.model.delivery.OutboundRegistry;
import ru.yandex.market.logistic.api.model.delivery.RegistryItem;
...
public class RegistryDtoFactory {
    ...
    public static MovementRegistry createMinimalMovementRegistry() {
        return MovementRegistry.builder(
            ...
            .setItems(createSingleRegistryItem("test item", "8.99"))
            .build();
    }
    ...
    public static List<RegistryItem> createSingleRegistryItem(String description, String price) {
