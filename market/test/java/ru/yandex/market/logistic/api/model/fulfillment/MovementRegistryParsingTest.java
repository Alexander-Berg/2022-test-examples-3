...
class MovementRegistryParsingTest extends ParsingTest<MovementRegistry> {
    MovementRegistryParsingTest() {
        super(MovementRegistry.class, "fixture/entities/fulfillment/movement_registry.xml");
    }

    @Test
    void testValidation() throws IOException {
        String fileContent = getFileContent("fixture/entities/fulfillment/movement_registry.xml");
