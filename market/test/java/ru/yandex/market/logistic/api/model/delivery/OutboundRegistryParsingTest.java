...
class OutboundRegistryParsingTest extends ParsingTest<OutboundRegistry> {
    OutboundRegistryParsingTest() {
        super(OutboundRegistry.class, "fixture/entities/delivery/outbound_registry.xml");
    }

    @Test
    void testValidation() throws IOException {
        String fileContent = getFileContent("fixture/entities/delivery/outbound_registry.xml");
