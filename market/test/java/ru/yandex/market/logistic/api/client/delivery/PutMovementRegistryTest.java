...
import ru.yandex.market.logistic.api.model.delivery.response.PutMovementRegistryResponse;
...
import static ru.yandex.market.logistic.api.utils.delivery.RegistryDtoFactory.createMinimalMovementRegistry;
...
class PutMovementRegistryTest extends CommonServiceClientTest {
    ...
    void testSuccessfulResponse() throws Exception {
        ...
        prepareMockServiceNormalized(
            "put_movement_registry/ds_request",
