...
public class GetTransactionsOrdersResponseWithEmptyParamsTest
    extends ParsingXmlWrapperTest<ResponseWrapper, GetTransactionsOrdersResponse> {

    public GetTransactionsOrdersResponseWithEmptyParamsTest() {
        super(
            ResponseWrapper.class,
            GetTransactionsOrdersResponse.class,
            "fixture/response/ff_get_transactions_orders_with_empty_params.xml"
        );
    }
