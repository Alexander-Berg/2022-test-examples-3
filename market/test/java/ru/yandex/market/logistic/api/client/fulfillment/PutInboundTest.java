...
public class PutInboundTest extends CommonServiceClientTest {
    ...
    void testSuccessfulResponse() throws Exception {
        ...
        client.putInbound(InboundFactory.createInbound(), null, props);
    ...
    void testSuccessfulResponseWithRestrictedData() throws Exception {
        PartnerProperties props = getPartnerProperties();
        prepareMockServiceNormalized("put_inbound_confirmed", "put_inbound", props.getUrl());
        client.putInbound(InboundFactory.createInbound(),
                InboundFactory.createInboundRestrictedData(true, "test_supplier", "Зпер123", "TMT123"), props);
    }
    ...
    void testErrorResponse() throws Exception {
        ...
        assertions.assertThatThrownBy(() -> client.putInbound(InboundFactory.createInbound(), null, props))
    ...
    void testValidationConstraints() {
        assertions.assertThatThrownBy(
            () -> client.putInbound(InboundFactory.createInvalidInbound(), null, getPartnerProperties())
        )
    ...
    void testInvalidInterval() {
        assertions.assertThatThrownBy(
            () -> client.putInbound(InboundFactory.createInboundInvalidInterval(), null, getPartnerProperties())
        )
