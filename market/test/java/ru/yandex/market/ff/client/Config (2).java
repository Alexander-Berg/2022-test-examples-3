...
import ru.yandex.market.ff.client.tvm.config.FulfillmentWorkflowConfiguration;
 ...
 */
@Configuration
@Import(FulfillmentWorkflowConfiguration.class)
...
public class Config {
    ...
    public MockRestServiceServer mockRestServiceServer(
        @Qualifier("fulfillmentHttpTemplate") HttpTemplate fulfillmentWorkflowTemplate) {
        return MockRestServiceServer.createServer(((HttpTemplateImpl) fulfillmentWorkflowTemplate).getRestTemplate());
    }

    @Bean(name = "secondHttpTemplate")
    public MockRestServiceServer mockRestServiceServerSecondHttpTemplate(
        @Qualifier("fulfillmentHttpTemplateForReturnRegistryClient") HttpTemplate fulfillmentWorkflowTemplate
    ) {
        return MockRestServiceServer.createServer(((HttpTemplateImpl) fulfillmentWorkflowTemplate).getRestTemplate());
    }
