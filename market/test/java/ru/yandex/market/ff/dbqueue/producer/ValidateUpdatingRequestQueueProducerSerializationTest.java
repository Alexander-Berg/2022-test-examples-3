...
public class ValidateUpdatingRequestQueueProducerSerializationTest extends IntegrationTest {

    private static final String PAYLOAD_STRING = "{\"requestId\":123}";

    @Autowired
    private ValidateUpdatingRequestQueueProducer validateUpdatingRequestQueueProducer;

    @Test
    public void testSerializeWorks() {
        ValidateRequestPayload payload = new ValidateRequestPayload(123);
        String payloadString = validateUpdatingRequestQueueProducer.getPayloadTransformer().fromObject(payload);
