...
public class ReprocessUpdateItemsFromRegistriesQueueProducerSerializationTest extends IntegrationTest {

    private static final String PAYLOAD_STRING = "{\"requestId\":123}";

    @Autowired
    private ReprocessUpdateItemsFromRegistriesQueueProducer producer;

    @Test
    public void testSerializeWorks() {
        ReprocessUpdateItemsFromRegistriesPayload payload = new ReprocessUpdateItemsFromRegistriesPayload(123);
