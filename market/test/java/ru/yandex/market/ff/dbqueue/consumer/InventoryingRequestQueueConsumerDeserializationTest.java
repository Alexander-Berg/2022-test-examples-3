...
public class InventoryingRequestQueueConsumerDeserializationTest extends IntegrationTestWithDbQueueConsumers {

    private static final String PAYLOAD_STRING = "{\"requestId\":123}";

    @Autowired
    private InventoryingRequestQueueConsumer inventoryingRequestQueueConsumer;

    @Test
    public void testDeserializationWorks() {
        InventoryingRequestPayload payload = inventoryingRequestQueueConsumer.getPayloadTransformer()
