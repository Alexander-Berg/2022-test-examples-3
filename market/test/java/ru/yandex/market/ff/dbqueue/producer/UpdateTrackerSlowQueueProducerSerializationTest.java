...
public class UpdateTrackerSlowQueueProducerSerializationTest extends IntegrationTest {
    ...
    @Autowired
    private UpdateTrackerSlowQueueProducer updateTrackQueueSlowProducer;

    @Test
    public void testSerializeWorks() {
        UpdateTrackerStatusPayload payload = new UpdateTrackerStatusPayload(1, Set.of(101L, 102L),
                createTrackList());
        String result = updateTrackQueueSlowProducer.getPayloadTransformer().fromObject(payload);
