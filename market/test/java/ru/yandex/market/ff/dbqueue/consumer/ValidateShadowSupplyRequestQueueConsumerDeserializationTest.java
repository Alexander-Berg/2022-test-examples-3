...
public class ValidateShadowSupplyRequestQueueConsumerDeserializationTest extends IntegrationTestWithDbQueueConsumers {

    private static final String PAYLOAD_STRING = "{\"requestId\":123}";

    @Autowired
    private ValidateShadowSupplyRequestQueueProducer validateShadowSupplyRequestQueueConsumer;

    @Test
    public void testDeserializationWorks() {
        ValidateRequestPayload payload = validateShadowSupplyRequestQueueConsumer.getPayloadTransformer()
