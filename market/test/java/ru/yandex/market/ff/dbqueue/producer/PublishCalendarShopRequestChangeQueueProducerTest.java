...
class PublishCalendarShopRequestChangeQueueProducerTest extends IntegrationTest {
    ...
    @Autowired
    private PublishCalendarShopRequestChangeQueueProducer producer;
    ...
    public void testSerializeWorks() {
        ...
        var payload = new PublishCalendaringChangePayload(
                823600L,
                oldMeta,
                newMeta,
