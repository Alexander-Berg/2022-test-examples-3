...
public class SendCommonRequestToServiceQueueConsumerDeserializationTest extends IntegrationTestWithDbQueueConsumers {

    private static final String PAYLOAD_STRING = "{\"requestId\":123}";

    @Autowired
    private SendCommonRequestToServiceQueueConsumer sendCommonRequestToServiceQueueConsumer;

    @Test
    public void testDeserializationWorks() {
        SendRequestToServicePayload payload = sendCommonRequestToServiceQueueConsumer.getPayloadTransformer()
