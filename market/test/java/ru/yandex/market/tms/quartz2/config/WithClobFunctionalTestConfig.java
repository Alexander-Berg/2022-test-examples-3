...
@PropertySource("classpath:/ru/yandex/market/tms/quartz2/spring/EnableMarketTmsTestClob.properties")
public class WithClobFunctionalTestConfig extends H2Config {
