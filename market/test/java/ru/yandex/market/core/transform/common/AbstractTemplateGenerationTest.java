...
public abstract class AbstractTemplateGenerationTest extends FunctionalTest {

    private static final String TEMPLATE_PATH = "shops_web/template/xsl";
    private static final String EXTRA_DATA_PATH = "shops_web/template/extra";
