 ...
 * @author alexminakov
 */
class RemovePchoVerdictDatacampEventTest extends AbstractDataCampEventTest {

    @DisplayName("Корректность заполнения всех полей DataCampOffer.Offer")
    @Test
    void convertToDataCampOffer_allField_correctMapping() {
        RemovePchoVerdictDatacampEvent datacampEvent = new RemovePchoVerdictDatacampEvent(
        ...
        assertDataCampEvent("removePchoVerdict.json", datacampEvent);
    }
}
