...
public class AutomationRuleTestUtils {
    ...
    public EventAutomationRule createApprovedEventRule(Entity entity,
        ...
        EventAutomationRule rule = createDraftEventRule(entity, configPath, ruleGroup, responsibleEmployees,
                responsibleOus, args);
        bcpService.edit(rule, Map.of(AutomationRule.STATUS, SnapshottedByStatus.Statuses.REVIEW));
        bcpService.edit(rule, Map.of(AutomationRule.STATUS, SnapshottedByStatus.Statuses.ACTIVE));
        return rule;
    }
