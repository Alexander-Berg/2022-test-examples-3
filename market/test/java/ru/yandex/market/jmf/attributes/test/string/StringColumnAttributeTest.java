...
@ContextConfiguration(classes = StringColumnAttributeTest.Configuration.class)
public class StringColumnAttributeTest extends AbstractStringAttributeTest {
    ...
    public static class Configuration extends AbstractAttributeTestConfiguration {
        public Configuration() {
            super("classpath:string_column_attribute_metadata.xml", "classpath:linkAttrMetaclass_metadata.xml");
        }
    }
}
