...
@ContextConfiguration(classes = EmailStorageAttributeTest.Configuration.class)
public class EmailStorageAttributeTest extends AbstractAttributeTest {
    ...
    public static class Configuration extends AbstractAttributeTestConfiguration {
        public Configuration() {
            super("classpath:email_storage_attribute_metadata.xml", "classpath:linkAttrMetaclass_metadata.xml");
        }
    }
}
