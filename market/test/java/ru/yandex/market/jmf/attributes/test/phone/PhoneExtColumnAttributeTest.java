...
@ContextConfiguration(classes = PhoneExtColumnAttributeTest.Configuration.class)
public class PhoneExtColumnAttributeTest extends AbstractAttributeTest {

    @Override
    protected Object randomAttributeValue() {
        String phone = Randoms.phoneNumber() + "#" + Randoms.stringNumber();
        return Phone.fromNormalized(phone);
    }
