...
public class InMemoryScriptStorageService implements ScriptStorageService {
    ...
    public static class Builder {
        ...
        public Builder withScript(String code, String body) {
            scripts.add(new ScriptImpl(code, Map.of(), body, Now.offsetDateTime(), ScriptType.DEFAULT, Set.of()));
            return this;
        }

        public Builder withModule(String code, String body) {
            scripts.add(new ScriptImpl(code, Map.of(), body, Now.offsetDateTime(), ScriptType.MODULE, Set.of()));
            return this;
        }
