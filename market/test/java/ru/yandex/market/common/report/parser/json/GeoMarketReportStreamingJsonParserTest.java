...
public class GeoMarketReportStreamingJsonParserTest {
    private GeoMarketReportStreamingJsonParser geoMarketReportJsonParser;

    @Before
    public void setUp() throws Exception {
        geoMarketReportJsonParser = new GeoMarketReportStreamingJsonParser();
    }
