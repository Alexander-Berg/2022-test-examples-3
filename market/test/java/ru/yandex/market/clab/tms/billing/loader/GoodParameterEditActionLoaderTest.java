 ...
 * @since 26.04.2019
 */
public class GoodParameterEditActionLoaderTest {
    ...
    private GoodParameterEditActionLoader loader;
    ...
    public void setUp() {
        ...
        loader = new GoodParameterEditActionLoader(auditRepository, goodRepository);
        ...
        BillingTarif tarif = new BillingTarif(2L, CATEGORY_ID, Dates.SUMMER_DAY.minusMonths(2)
            .toLocalDateTime(), PaidAction.MSKU_PARAMETER_VALUE_CHANGE, PRICE);
        when(tarifProvider.getTarif(PaidAction.MSKU_PARAMETER_VALUE_CHANGE, CATEGORY_ID))
            .thenReturn(tarif);
    }
    ...
    public void countOneChange() {
        ...
        assertThat(linkedAction.getEntityType()).isEqualTo(EntityType.MSKU_PARAMETER);
    ...
    private static BillingAction changeValueAction(LocalDateTime verifiedTime, String login) {
        return new BillingAction()
            ...
            .setPaidAction(PaidAction.MSKU_PARAMETER_VALUE_CHANGE)
    ...
    @AuditedEntity(EntityType.MSKU_PARAMETER)
