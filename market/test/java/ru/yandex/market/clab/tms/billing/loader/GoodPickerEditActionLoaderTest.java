 ...
 * @since 26.04.2019
 */
public class GoodPickerEditActionLoaderTest {
    ...
    private GoodPickerEditActionLoader loader;
    ...
    public void setUp() {
        ...
        loader = new GoodPickerEditActionLoader(auditRepository, goodRepository);
        ...
        when(tarifProvider.getTarif(PaidAction.MSKU_PICKER_CHANGE, CATEGORY_ID))
            .thenReturn(createTarif(PaidAction.MSKU_PICKER_CHANGE, PRICE));
        when(tarifProvider.getTarif(PaidAction.MSKU_PICKER_DELETE, CATEGORY_ID))
            .thenReturn(createTarif(PaidAction.MSKU_PICKER_DELETE, PRICE_DELETE));
    }
    ...
    public void countOneChange() {
        ...
        assertThat(linkedAction.getEntityType()).isEqualTo(EntityType.MSKU_VALUE_LINK);
    ...
    private static BillingAction changeAction(LocalDateTime verifiedTime, String login) {
        return new BillingAction()
            ...
            .setPaidAction(PaidAction.MSKU_PICKER_CHANGE)
    ...
    private static BillingAction deleteAction(LocalDateTime verifiedTime, String login) {
        return new BillingAction()
            ...
            .setStaffLogin(login)
            .setCategoryId(CATEGORY_ID)
            .setPaidAction(PaidAction.MSKU_PICKER_DELETE)
    ...
    @AuditedEntity(EntityType.MSKU_VALUE_LINK)
