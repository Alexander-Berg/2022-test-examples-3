...
class LegalPartnerCalendarControllerTest extends BaseShallowTest {
    ...
    void getCalendarForFullBrand() throws Exception {
        ...
        PickupPoint pickupPoint = pickupPointFactory.createPickupPointFromCrm(TestPickupPointFactory
        ...
        mockMvc.perform(
                        get(String.format("/v1/pi/partners/%d/pickup-points/%d/calendar", legalPartner.getPartnerId(),
    ...
    void adminUpdateCalendar() throws Exception {
        ...
        mockMvc.perform(
                patch(String.format("/v1/pi/partners/%d/pickup-points/%d/calendar/admin", legalPartner.getPartnerId(),
                                pickupPoint.getPvzMarketId()))
    ...
    void getCalendarOverridesNotInUneditableIntervals() throws Exception {
        var legalPartner = legalPartnerFactory.createLegalPartner();
        PickupPoint pickupPoint = pickupPointFactory.createPickupPoint(TestPickupPointFactory
                .CreatePickupPointBuilder
                .builder()
                .legalPartner(legalPartner)
                .params(TestPickupPointFactory.PickupPointTestParams.builder()
                        .schedule(TestPickupPointFactory.PickupPointScheduleTestParams.builder()
