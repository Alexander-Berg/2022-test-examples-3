...
/**
 * Тест для {@link WebTemplateProvider}.
 *
 * @author avetokhin 28/07/16.
 */
public class WebTemplateProviderTest extends BaseTemplateProviderTest {
    private static final NotificationTransport TRANSPORT = NotificationTransport.MBI_WEB_UI;
    ...
    public void provideTextContent() {
        ...
        var provider = new WebTemplateProvider(templateService);
    ...
    public void provideHtmlContent() {
        ...
        var provider = new WebTemplateProvider(templateDao);
        var mbiTemplate = checkAndCastTemplate(provider.provide(getContext(TRANSPORT)));
