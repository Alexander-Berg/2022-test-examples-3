 ...
 */
public class PersistentNotificationRowMapperTest extends AbstractRowMapperTest {
    ...
    public void testMapper() throws Exception {
        ...
        final PersistentNotification expected = new PersistentNotification(
            1L, 2L, notificationType, PREPARED, now, binaryData, delivery, "");
        ...
        when(resultSet.getLong(Columns.COLUMN_TYPE)).thenReturn(notificationType.getCode());
        when(resultSet.getInt(Columns.COLUMN_STATUS_TYPE)).thenReturn(expected.getStatus().getCode());
        ...
        when(resultSet.getInt(Columns.COLUMN_TRANSPORT_TYPE)).thenReturn(transport.getCode());
        when(resultSet.getInt(Columns.COLUMN_PRIORITY_TYPE)).thenReturn(priority.getCode());
        ...
        final Clob clob = createClob(binaryData);
