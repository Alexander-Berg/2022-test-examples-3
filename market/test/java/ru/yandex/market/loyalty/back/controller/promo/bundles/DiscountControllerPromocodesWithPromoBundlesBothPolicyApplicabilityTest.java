...
public class DiscountControllerPromocodesWithPromoBundlesBothPolicyApplicabilityTest extends MarketLoyaltyBackMockedDbTestBase {
    ...
    @Test
    public void shouldApplyPromocodeForItemsWhichNotInBundleWhenRestrictedOnBundle() {
        CoinKey expectedCoin = createPromocode(USER_ID);
        String expectedPromoBundle = generateBundleIdWithRestrictions();
