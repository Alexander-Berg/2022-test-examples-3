...
public class DiscountControllerCoinsWithCheapestAsGiftTest extends CheapestAsGiftTestBase {
    ...
    @Test
    public void shouldApplyCheapestAsGiftForOneItemWithCoinTogether() {
        ...
        final ItemPromoResponse coinPromo = getPromo(item.getPromos(), PromoType.SMART_SHOPPING);
    ...
    @Test
    public void shouldApplyCheapestAsGiftForTwoItemsWithCoinTogether() {
        OrderWithBundlesRequest order = orderRequestWithBundlesBuilder()
                .withOrderItem(
                        itemKey(FEED_ID, md5(FIRST_ITEM_SSKU)),
                        ssku(FIRST_ITEM_SSKU),
        ...
        final ItemPromoResponse firstCoinPromo = getPromo(firstItem.getPromos(), PromoType.SMART_SHOPPING);
        ...
        final ItemPromoResponse secondCoinPromo = getPromo(secondItem.getPromos(), PromoType.SMART_SHOPPING);
