...
@Deprecated
public class DiscountControllerCouponWithPromoBundlesBothPolicyApplicabilityTest extends MarketLoyaltyBackMockedDbTestBase {
    ...
    @Test
    public void shouldApplyCouponForItemsWhichNotInBundleWhenRestrictedOnBundle() {
        createCouponPromo();
        final String expectedPromoBundle = generateBundleIdWithRestrictions();
        ...
        assertThat(discountResponse.getCouponError(), is(nullValue()));
