...
@Deprecated
public class DiscountControllerCouponWithBlueSetAnyPolicyApplicabilityTest extends MarketLoyaltyBackMockedDbTestBase {
    ...
    public void shouldApplyCouponWhenRestrictedOnlyCoupon() {
        createCouponPromoWithRestrictionsOnBundle(RuleType.DONT_USE_WITH_BLUE_SET_FILTER_RULE);
        bundleService.createPromoBundle(blueSetDescription());
    ...
    @Test
    public void shouldApplyCouponWhenRestrictedOnBothButWithWrongRuleType() {
        createCouponPromoWithRestrictionsOnBundle(RuleType.DONT_USE_WITH_BLUE_FLASH_FILTER_RULE);
        bundleService.createPromoBundle(blueSetDescription(
                restrictions(
                        restrictPromocode()
                )
    ...
    private <T extends Rule> void createCouponPromoWithRestrictionsOnBundle(RuleType<T> ruleType) {
        promoManager.createCouponPromo(
                PromoUtils.Coupon.defaultInfiniteUse()
                        .setPlatform(CoreMarketPlatform.BLUE)
                        .setCouponCode(COUPON_CODE)
                        .setBudget(INITIAL_CURRENT_BUDGET)
                        .addPromoRule(ruleType)
        );
    }
