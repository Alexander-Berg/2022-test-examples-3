...
public class DiscountControllerPromocodesWithPromoBundlesTest extends MarketLoyaltyBackMockedDbTestBase {
    ...
    @Test
    public void shouldApplyPromoBundleWithPromocodeTogether() {
    ...
    @Test
    public void shouldApplyPromoBundleWithFixedDiscountWithPromocodeTogether() {
        OrderWithBundlesRequest order = orderRequestWithBundlesBuilder()
                .withOrderItem(
                        itemKey(FEED_ID, PROMO_ITEM_SSKU),
                        ssku(PROMO_ITEM_SSKU),
    ...
    @Test
    public void shouldApplyPromoBundleWithPromocodeOnPrimaryItemSplitting() {
        OrderWithBundlesRequest order = orderRequestWithBundlesBuilder()
                .withOrderItem(
                        itemKey(FEED_ID, PROMO_ITEM_SSKU),
                        ssku(PROMO_ITEM_SSKU),
    ...
    @Test
    public void shouldApplyPromoBundleWithFixedDiscountWithPromocodeOnPrimaryItemSplitting() {
        OrderWithBundlesRequest order = orderRequestWithBundlesBuilder()
                .withOrderItem(
                        itemKey(FEED_ID, PROMO_ITEM_SSKU),
                        ssku(PROMO_ITEM_SSKU),
    ...
    @Test
    public void shouldApplyPromoBundleWithPromocodeOnSecondaryItemSplitting() {
        OrderWithBundlesRequest order = orderRequestWithBundlesBuilder()
                .withOrderItem(
                        itemKey(FEED_ID, PROMO_ITEM_SSKU),
                        ssku(PROMO_ITEM_SSKU),
    ...
    @Test
    public void shouldApplyPromoBundleWithFixedDiscountWithPromocodeOnSecondaryItemSplitting() {
        OrderWithBundlesRequest order = orderRequestWithBundlesBuilder()
                .withOrderItem(
                        itemKey(FEED_ID, PROMO_ITEM_SSKU),
                        ssku(PROMO_ITEM_SSKU),
