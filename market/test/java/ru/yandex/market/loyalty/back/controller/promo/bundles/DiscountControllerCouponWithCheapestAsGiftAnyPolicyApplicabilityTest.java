...
@Deprecated
public class DiscountControllerCouponWithCheapestAsGiftAnyPolicyApplicabilityTest
    ...
    public void shouldApplyCouponWhenRestrictedOnlyCoupon() {
        createCouponPromoWithRestrictionsOnBundle(RuleType.DONT_USE_WITH_CHEAPEST_AS_GIFT_FILTER_RULE);
        bundleService.createPromoBundle(cheapestAsGiftDescription());
