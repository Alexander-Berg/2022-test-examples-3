...
public class BlueSetPromoYtImporterZeroDiscountTest extends MarketLoyaltyAdminMockedDbTest {
    ...
    public void shouldImportBlueSetBundle() {
        List<PromoYtImporter.ImportResult> importResults = promoBundlesTestHelper.withMock(
                this::prepareData,
        ...
        Collection<PromoYtImporter.PromoImportResult> results = importResults.get(0).getImportResults();
                ...
                hasProperty("items", hasItems(allOf(
                        ...
                        hasProperty("condition", hasProperty("conditions", hasItems(
                                allOf(
                                        ...
                                        hasProperty("proportion", comparesEqualTo(BigDecimal.ZERO))
                                ),
                                allOf(
