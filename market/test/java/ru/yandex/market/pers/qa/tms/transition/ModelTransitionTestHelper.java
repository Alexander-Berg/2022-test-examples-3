...
public class ModelTransitionTestHelper {
    ...
    public static final long newEntityId = 12;
    public static final boolean oldEntityDeleted = false;
    public static final long oldEntityId = 123;
    public static final ModelStorage.ModelTransition.TransitionReason transitionReason = ModelStorage.ModelTransition.TransitionReason.MODEL_SPLIT_TO_MODIF;
    public static ModelStorage.ModelTransition.TransitionType transitionType = ModelStorage.ModelTransition.TransitionType.SPLIT;
    ...
    public static ModelStorage.ModelTransition generateModelTransition(long id,
        ...
        return generateModelTransition(id, modelType, transitionReason, transitionType, primaryTransition, oldEntityId, newEntityId);
    }
