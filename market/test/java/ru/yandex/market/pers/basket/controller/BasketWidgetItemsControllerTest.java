...
import ru.yandex.market.pers.list.mock.BasketWidgetItemsMvcMocks;
 ...
 */
public class BasketWidgetItemsControllerTest extends AbstractBasketControllerTest {

    @Autowired
    private BasketWidgetItemsMvcMocks basketItemsMvc;
