...
import ru.yandex.market.wms.common.spring.servicebus.model.dto.LifetimeDto;
            ...
            List<SkuTrustworthyInfoDto> skuDtos = request
                    ...
                    .map(it -> SkuTrustworthyInfoDto.builder()
                            ...
                            .korobyte(KorobyteDto.builder()
                                    ...
                                    .build())
                            .barcodes(List.of(new Barcode("EAN-" + it.getManufacturerSku(), "EAN")))
                            .build()
                    )
                    .collect(collectingAndThen(toList(), Collections::unmodifiableList));
            skuDtos.stream()
                    .filter(dto -> "IPC647BOOKCCRYWHIOSG".equals(dto.getManufacturerSku()))
                    .forEach(dto -> dto.setLifetime(LifetimeDto.builder()
                            .hasLifetime(true)
                            .hasLifetimeTimestampMs(1585460096L)
                            .lifetimeDays(30)
                            .lifetimeDaysTimestampMs(1585460096L)
                            .build()));
