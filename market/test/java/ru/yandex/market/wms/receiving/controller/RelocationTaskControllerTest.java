...
public class RelocationTaskControllerTest extends ReceivingIntegrationTest {
    ...
    public void changeNotMyTaskStatusTest() throws Exception {
        mockMvc.perform(put("/relocation/tasks/1/status")
    ...
    public void getTaskAssignedTest() throws Exception {
        mockMvc.perform(get("/relocation/tasks/1"))
                .andExpect(status().isOk())
                .andExpect(content().json(getFileContent(
    ...
    public void getTaskForObjectWhenExistTest() throws Exception {
        mockMvc.perform(get("/relocation/objects/PLT00004"))
                .andExpect(status().isOk())
                .andExpect(content().json(getFileContent(
    ...
    public void moveNotMyTaskTest() throws Exception {
        mockMvc.perform(put("/relocation/tasks/1/destination")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    // https://st.yandex-team.ru/MARKETWMS-5184
    @Test
    ...
    public void moveToLocationTestReturns() throws Exception {
        mockMvc.perform(put("/relocation/tasks/1/destination")
                ...
                .andExpect(status().isOk());
        mockMvc.perform(put("/relocation/tasks/2/destination")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(getFileContent("controller/relocation-task/move-to-location-returns/request.json")))
                .andExpect(status().isOk());
    }
    ...
    public void pickTaskTaskNotFound() throws Exception {
        mockMvc.perform(put("/relocation/tasks/pick-task/123")
                .contentType(MediaType.APPLICATION_JSON))
    ...
    public void pickTaskTaskIsNotNew() throws Exception {
        mockMvc.perform(put("/relocation/tasks/pick-task/PLT00004")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is4xxClientError());
    }
    ...
    public void getPickedTasks() throws Exception {
        mockMvc.perform(get("/relocation/tasks/picked-containers"))
                .andExpect(status().isOk())
                .andExpect(content().json(getFileContent(
    ...
    //четыре задания, два ОК, одно не в интрансите, другое не в статусе 3, получаем только два
    @Test
    ...
    public void dissociateTask() throws Exception {
        mockMvc.perform(put("/relocation/tasks/start-placement/1")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    public void skipTask() throws Exception {
        mockMvc.perform(put("/relocation/tasks/skip/1")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void getActiveTasks() throws Exception {
        mockMvc.perform(get("/relocation/tasks/active"))
                .andExpect(status().isOk())
                .andExpect(content().json(getFileContent(
