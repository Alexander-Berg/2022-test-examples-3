...
public class CreationDateTimeIsNotInFutureValidationRuleTest {

    private CreationDateTimeIsNotInFutureValidationRule rule;

    @BeforeEach
    public void init() {
        Clock clock = Clock.fixed(Instant.parse("2020-04-18T12:00:00.000Z"), ZoneOffset.UTC);
        rule = new CreationDateTimeIsNotInFutureValidationRule(clock);
    }
