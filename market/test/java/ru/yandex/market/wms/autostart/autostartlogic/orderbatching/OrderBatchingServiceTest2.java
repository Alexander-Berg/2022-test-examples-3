...
@ContextConfiguration(classes = {
        OrderBatchingServiceTest2.TestBatchingServiceConfiguration.class,
})
class OrderBatchingServiceTest2
                        ...
                        Batch.builder().id("0").subBatches(
                                listOf(
                                        ...
                                        SubBatch.builder()
                                                ...
                                                .orders(Arrays.asList(owdB000003003(), owdB000004001(),
                                                        owdB000005002(), owdB000003004()))
                                                .build(),
                                        // 2020-01-01
                                        SubBatch.builder()
                                                .sortingStation(DOOR_S_04)
                                                .orders(Arrays.asList(owdB000003002(), owdB000001003(),
                                                        owdB000001004(), owdB000002002()))
                                                .build()
                                )
                        ).build()
