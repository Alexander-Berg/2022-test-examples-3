...
import ru.yandex.market.clickhouse.dealer.DealerSkipInactiveConfigException;
...
public class DealerConfigParserTest {
    ...
    public void parseConfig() throws Exception {
        ...
        DealerConfig expectedConfig = buildExpectedDealerConfig(emptyConfig);
    ...
    @Test
    public void parseActiveConfigByDefaultWhenOnlyActiveParsingEnable() throws Exception {
        DealerGlobalConfig onlyActiveConfigParsing =
            DealerGlobalConfig.newBuilder().withOnlyActiveConfigFileParsing(true).build();
        DealerConfigParser parser = dealerConfigParser("/config/properties-example.properties",
            onlyActiveConfigParsing);
        DealerConfig actualConfig = parser.parseConfig(readJsonObject("/config/config-example.json"), null);

        DealerConfig expectedConfig = buildExpectedDealerConfig(onlyActiveConfigParsing);

        Assert.assertEquals(expectedConfig, actualConfig);
    }

    @Test
    public void parseActiveConfigWhenOnlyActiveParsingEnable() throws Exception {
        DealerGlobalConfig onlyActiveConfigParsing =
            DealerGlobalConfig.newBuilder().withOnlyActiveConfigFileParsing(true).build();
        DealerConfigParser parser = dealerConfigParser("/config/properties-example.properties",
            onlyActiveConfigParsing);
        DealerConfig actualConfig = parser.parseConfig(readJsonObject("/config/dealer/active-config-example.json"),
            null);
    ...
    @Test(expected = DealerSkipInactiveConfigException.class)
    public void parseInactiveConfigWhenOnlyActiveParsingEnable() throws Exception {
        DealerGlobalConfig onlyActiveConfigParsing =
            DealerGlobalConfig.newBuilder().withOnlyActiveConfigFileParsing(true).build();
        DealerConfigParser parser = dealerConfigParser("/config/properties-example.properties",
            onlyActiveConfigParsing);
        parser.parseConfig(readJsonObject("/config/dealer/inactive-config-example.json"), null);
    }

    @Test
    public void parseInactiveConfigWhenOnlyActiveParsingDisable() throws Exception {
        DealerGlobalConfig onlyActiveConfigParsing =
            DealerGlobalConfig.newBuilder().withOnlyActiveConfigFileParsing(false).build();
        DealerConfigParser parser = dealerConfigParser("/config/properties-example.properties",
            onlyActiveConfigParsing);
        DealerConfig actualConfig = parser.parseConfig(readJsonObject("/config/dealer/inactive-config-example.json"),
            null);
    ...
    private DealerConfig buildExpectedDealerConfig(DealerGlobalConfig config) {
        return DealerConfig.newBuilder()
