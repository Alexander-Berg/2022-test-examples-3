...
public class EnumColumnTypeTest {
    ...
    public static final ClickHouseTableDefinition TABLE_DEFINITION = new ClickHouseTableDefinitionImpl(
        "market.nginx2_lr",
        Collections.singletonList(new Column("environment",
            EnumColumnType.enum8(EnumColumnTypeTest.Environment.class), "'UNKNOWN'")),
    ...
    public void testDefaultValueMatch() {
        ClickHouseTableDefinition existingTableDefinition = TableUtils.parseDDL(
            "CREATE TABLE market.nginx2_lr ( " +
                "some_column UInt32,  " +
                "environment Enum8('DEVELOPMENT' = 0, 'TESTING' = 1, 'PRESTABLE' = 2, 'PRODUCTION' = 3, 'UNKNOWN' = " +
                "4) DEFAULT CAST('UNKNOWN', 'Enum8(\\'DEVELOPMENT\\' = 0, \\'TESTING\\' = 1, \\'PRESTABLE\\' = 2, " +
                "\\'PRODUCTION\\' = 3, \\'UNKNOWN\\' = 4)'),  " +
