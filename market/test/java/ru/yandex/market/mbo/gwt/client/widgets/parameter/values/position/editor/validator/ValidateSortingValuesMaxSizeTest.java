...
public class ValidateSortingValuesMaxSizeTest {

    CategoryParam param;
    List<Option> optionList;
    boolean expectedTrue;

    public ValidateSortingValuesMaxSizeTest(Integer shortEnumCount, Integer optionListLength, Boolean expectedTrue) {
