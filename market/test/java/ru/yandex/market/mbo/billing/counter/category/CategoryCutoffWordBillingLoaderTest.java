package ru.yandex.market.mbo.billing.counter.category;
...
public class CategoryCutoffWordBillingLoaderTest extends AbstractFIllCustomWithRollbackBillingLoaderTest {
    ...
    public void setUp() {
        ...
        loader = new CategoryCutoffBillingLoader();
    ...
    protected AuditAction.EntityType getEntityType() {
        return AuditAction.EntityType.CATEGORY;
    }
