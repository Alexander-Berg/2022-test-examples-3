...
public class FillTaskCounterTest extends SimpleTaskCounterBaseTest {
    @Spy
    private FillTaskCounter counter = new FillTaskCounter();
    ...
    public void testTaskBillingActionsCreated() {
        ...
        assertThat(billed).containsExactlyInAnyOrder(
            createBilledEntityAction(PaidAction.FILL_MODEL_CARD, TASK_OWN_ID1, CATEGORY_ID, UID1, CONTENT_ID_1,
                    AuditAction.EntityType.MODEL_GURU),
            createBilledEntityAction(PaidAction.FILL_MODEL_CARD, TASK_OWN_ID2, CATEGORY_ID, UID2, CONTENT_ID_1,
                    AuditAction.EntityType.MODEL_GURU),
            createBilledEntityAction(PaidAction.FILL_MODEL_CARD, TASK_OWN_ID3, CATEGORY_ID, UID2, CONTENT_ID_2,
                    AuditAction.EntityType.MODEL_GURU)
        );
    }
}
