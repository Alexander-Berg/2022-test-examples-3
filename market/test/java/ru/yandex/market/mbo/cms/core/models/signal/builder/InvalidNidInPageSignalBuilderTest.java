...
public class InvalidNidInPageSignalBuilderTest extends PageSignalBuilderAbstractTest {

    private static final String TYPE = "type";
    private static final long ID = 1;
    private static final long REVISION_ID = 2;
    private static final String NAME = "name";
    private static final long NID = 3;
    ...
    protected Signal getSignalForTest() {
        ...
        page.setName(NAME);
        return new InvalidNidInPageSignalBuilder().withPage(page).withNid(NID).build();
    }
}
