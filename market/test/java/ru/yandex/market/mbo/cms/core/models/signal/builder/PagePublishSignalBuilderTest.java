...
public class PagePublishSignalBuilderTest extends PageSignalBuilderAbstractTest {
    ...
    protected Signal getSignalForTest() {
        ...
        page.setName(NAME);
        return new PagePublishSignalBuilder().withPage(page).withUserId(USER_ID).build();
    }
}
