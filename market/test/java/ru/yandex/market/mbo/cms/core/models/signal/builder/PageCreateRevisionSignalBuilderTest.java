...
public class PageCreateRevisionSignalBuilderTest extends PageSignalBuilderAbstractTest {
    ...
    protected Signal getSignalForTest() {
        ...
        page.setName(NAME);
        return new PageCreateRevisionSignalBuilder().withPage(page).withUserId(USER_ID).build();
    }
}
