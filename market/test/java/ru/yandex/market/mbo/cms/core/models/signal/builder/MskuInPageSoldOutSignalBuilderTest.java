...
public class MskuInPageSoldOutSignalBuilderTest extends PageSignalBuilderAbstractTest {
    ...
    protected Signal getSignalForTest() {
        ...
        page.setName(NAME);
        return new MskuInPageSoldOutSignalBuilder().withPage(page).withMsku(MSKU).build();
    }
}
