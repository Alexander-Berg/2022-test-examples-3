...
public class InvalidMskuInPageSignalBuilderTest extends PageSignalBuilderAbstractTest {

    private static final String TYPE = "type";
    private static final long ID = 1;
    private static final long REVISION_ID = 2;
    private static final String NAME = "name";
    private static final long MSKU = 3;
    ...
    protected Signal getSignalForTest() {
        ...
        page.setName(NAME);
        return new InvalidMskuInPageSignalBuilder().withPage(page).withMsku(MSKU).build();
    }
}
