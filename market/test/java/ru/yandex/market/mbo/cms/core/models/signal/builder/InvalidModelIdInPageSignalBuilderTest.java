...
public class InvalidModelIdInPageSignalBuilderTest extends PageSignalBuilderAbstractTest {
    ...
    protected Map<String, Object> getExpectedData() {
        ...
        expectedData.put("modelId", MODEL_ID);
        return expectedData;
    }
    ...
    protected Signal getSignalForTest() {
        ...
        page.setName(NAME);
        return new InvalidModelIdInPageSignalBuilder().withPage(page).withModelId(MODEL_ID).build();
    }
}
