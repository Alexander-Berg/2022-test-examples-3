...
public class PageUnpublishSignalBuilderTest extends PageSignalBuilderAbstractTest {
    ...
    protected Signal getSignalForTest() {
        return new PageUnpublishSignalBuilder().withPageId(ID).withPageType(TYPE).withUserId(USER_ID).build();
    }
}
