...
public class GoodListDeleteListenerTest {

    @Mock
    private GoodIdSaveService goodIdSaveService;

    private GoodListDeleteListener listener;

    @Before
    public void before() throws Exception {
        listener = new GoodListDeleteListener();
        listener.setGoodIdSaveService(goodIdSaveService);
    }

    @Test
    public void deleteGoodIdTest() {
        ...
        after.put("good_id", Arrays.asList("11111111111111111111111111111111"));
