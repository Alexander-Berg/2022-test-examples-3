...
public class EmployeeStaffSyncExecutorTest extends AbstractTmsTest {
    @Autowired
    private Scheduler scheduler;

    @Test
    void shouldRegisterSyncEmployeesTask() throws SchedulerException {
        JobDetail employeeStaffSyncExecutor = scheduler.getJobDetail(new JobKey("employeeStaffSyncExecutor"));
