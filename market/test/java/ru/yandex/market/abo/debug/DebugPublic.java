 ...
 * @date 21.01.19
 */
public class DebugPublic {
    private static final Logger log = LoggerFactory.getLogger(DebugPublic.class);
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("configs.path", "./abo-public/src/main/properties.d");
        ...
        try {
            ...
            log.info("Abo-public up and running");
        } catch (Exception e) {
            log.error("Abo-public failed to start", e);
            System.exit(1);
        }
