...
/**
 * curl -X "POST" --cookie "Session_id=..." -H "Content-Type: application/json" -H "Authorization: Bearer your-token"
 * https://grafana.yandex-team.ru/api/dashboards/db -d @dashboard.json
 *
