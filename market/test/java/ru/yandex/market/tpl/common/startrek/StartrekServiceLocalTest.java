...
import ru.yandex.market.tpl.common.startrek.config.StartrekExternalConfiguration;
...
import ru.yandex.market.tpl.common.startrek.ticket.TicketField;
import ru.yandex.market.tpl.common.startrek.ticket.TicketFieldResolver;
import ru.yandex.market.tpl.common.startrek.ticket.TicketLinkType;
...
import static ru.yandex.market.tpl.common.startrek.QuickStartWorkflowResolution.RESOLVED;
import static ru.yandex.market.tpl.common.startrek.QuickStartWorkflowStatus.CLOSED;
import static ru.yandex.market.tpl.common.startrek.ticket.TicketQueueType.TESTPARENT;
...
class StartrekServiceLocalTest {
    ...
    void prepare() {
        ...
        TicketFieldResolver ticketFieldResolver = new TicketFieldResolver(beanFactory);

        StartrekExternalConfiguration configuration = new StartrekExternalConfiguration();
        Session trackerSession = configuration.trackerSession(
                "https://st-api.yandex-team.ru",
                oAuthToken, 10, 10, ticketFieldResolver);
    ...
    void testTransit() {
        ...
        parent.doTransitWithUpdate(CLOSED);

        assertThat(parent.getStatus(QuickStartWorkflowStatus.class)).isEqualTo(CLOSED);
    ...
    void testFields() {
        StartrekTicket ticket = startrekService.createTicket(IssueCreate.builder()
                ...
                .components(90438L)
                .set("employee", "timursha")
                .set("start", LocalDate.of(2021, 3, 1).toString())
                .set("end", LocalDate.of(2021, 3, 5).toString())
                .build());
