...
import ru.yandex.market.tpl.tms.service.task.handlers.CreateScForLmsHandler;
...
public class CreateScForLmsHandlerTest extends TplTmsAbstractTest {
    private final TestUserHelper testUserHelper;
    private final CreateScForLmsHandler createScForLmsHandler;
    ...
    void test() {
        ...
        createScForLmsHandler.handle(draft);
        ...
        assertThat(newDraft.getScId()).isEqualTo(1L);
        assertThat(newDraft.getStatus()).isEqualTo(CreateDbsStatus.CREATE_SC_FOR_TPL);
