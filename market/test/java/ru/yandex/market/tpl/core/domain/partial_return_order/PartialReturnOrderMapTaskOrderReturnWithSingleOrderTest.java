...
public class PartialReturnOrderMapTaskOrderReturnWithSingleOrderTest extends TplAbstractTest {
    ...
    void mapTaskOrderReturn() {
        ...
        var partialReturnOrder = partialReturnOrderGenerateService.generatePartialReturnWithOnlyOneReturnItemInstance(order);
        partialReturnOrderGenerateService.generatePartialReturnBoxes(partialReturnOrder, 2);
        ...
        assertThat(returnTask.getOrders()).hasSize(2);
        assertThat(returnTask.getDestinations()).hasSize(1);
