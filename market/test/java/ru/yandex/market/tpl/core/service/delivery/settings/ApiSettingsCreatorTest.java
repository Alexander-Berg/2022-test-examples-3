...
import static ru.yandex.market.tpl.core.service.delivery.settings.ApiSettingsCreator.CRON_TEMPLATE;
...
class ApiSettingsCreatorTest {
    ...
    private static final ru.yandex.market.logistics.management.entity.type.ApiType API_TYPE = DELIVERY;
    private static final String VERSION = "1";
    private static final String FORMAT = "XML";
    private static final String CRON = sf(CRON_TEMPLATE, 0);
    private static final long DEFAULT_SETTINGS_API_ID = 101;
    private static final ApiSettingsCreator.MethodOptions CRON_METHOD = new ApiSettingsCreator.MethodOptions("update", "url", true);
    private static final ApiSettingsCreator.MethodOptions NON_CRON_METHOD = new ApiSettingsCreator.MethodOptions("create", "url", false);
    ...
    private static final List<ApiSettingsCreator.MethodOptions> METHODS = List.of(CRON_METHOD, NON_CRON_METHOD);
