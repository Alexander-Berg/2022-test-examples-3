...
@CoreTest
public class UserShiftFailCancelAfterSwitchTaskTest {
    ...
    void switchToOtherRoutePoint() {
        ...
        commandService.switchOpenRoutePoint(user, new UserShiftCommand.SwitchOpenRoutePoint(userShift.getId(),
                userShift.getRoutePoints().get(3).getId(), RoutePointSwitchReasonType.WRONG_ROUTE, null));
