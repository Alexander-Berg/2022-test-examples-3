package ru.yandex.market.tpl.core.service.transferact;
...
public class TransferActPushCouriersServiceTest extends TplAbstractTest {
    ...
    void pushCourier() {
        ...
        Long userShiftId = userShiftTestHelper.start(UserShiftCommand.Create.builder()
                .userId(user.getId())
                .shiftId(shift.getId())
        ...
        transactionTemplate.execute(status -> {
            UserShift findUserShift = userShiftRepository.getOne(userShiftId);
            OrderPickupTask orderPickupTask = userShiftTestHelper.getOrderPickupTask(findUserShift);
