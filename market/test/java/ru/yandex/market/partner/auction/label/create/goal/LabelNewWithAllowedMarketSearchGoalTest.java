...
/**
 * Маркировка новых ставок для маректного поиска.
...
public class LabelNewWithAllowedMarketSearchGoalTest extends AbstractParserTest {
    @InjectMocks
    ...
    public LabelNewWithAllowedMarketSearchGoalTest(BulkUpdateRequest request, ExpectedLabelBidsStats expectedLabelBidsStats) {
    ...
    public static Collection<Object[]> testCases() {
        return Arrays.asList(
                new Object[][]{
                         ...
                         * {@link AuctionBidComponentsLink}.
                        */
                        {createUReqByName(OFFER_NAME_1, MARKET_SEARCH_IRRELEVANT_PLACE, CARD_NO_LINK_FEE_PRIORITY), RECOMMENDED_OK},
                }
        );
    }
