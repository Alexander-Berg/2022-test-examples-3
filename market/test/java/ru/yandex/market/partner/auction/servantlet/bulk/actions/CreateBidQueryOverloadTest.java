...
/**
 * Приоритет аргументов задающих поисковый запрос при создании ставок.
 * Проверяются итоговые аргументы вызова в {@link AuctionService#setOfferBids(long, List, long)}.
 *
 * @author vbudnev
 */
@RunWith(Parameterized.class)
public class CreateBidQueryOverloadTest extends AuctionBulkServantletlMockBase {

    private final String testDescription;
    private final String servantletQueryMixin;
    private final String expectedSetQuery;

    public CreateBidQueryOverloadTest(String testDescription, String servantletQueryMixin, String expectedSetQuery) {
    ...
    public static Collection<Object[]> testCases() {
        return Arrays.asList(
                new Object[][]{
                        //создание ставки с использованием цели для параллельных рекомендаций
                        {
                        ...
                        //создание ставки с использованием цели для маркетных рекомендаций
                        {
                        ...
                        //создание ставки с указанием явного значения
                        {
    ...
    @Test
    public void test_queryOverloadOnBidCreation() {
