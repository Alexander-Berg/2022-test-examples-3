...
/**
 * При создании ставки для маркетных рекомендаций проверяем, что при установке ставки с использованием целей
...
public class CreateBidsByMarketSearchRecommendationTest extends AuctionBulkServantletlMockBase {

    private final AuctionGoalPlace requestGoalValue;
    private final BigInteger expectedBidValue;

    public CreateBidsByMarketSearchRecommendationTest(
     ...
     */
    @Test
    public void test_createBid_when_updateViaMSGoal_and_explicitSearchQueryFlag() {
        mockServantletPassedArgs("" +
                "req.size=1" +
                "&req1.offerName=" + SOME_OFFER_NAME +
                "&req1.goal.type=" + MARKET_SEARCH +
