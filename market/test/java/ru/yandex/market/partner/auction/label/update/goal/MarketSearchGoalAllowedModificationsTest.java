...
/**
 * Изменение значений существующих ставок с использованием целей для маркетного поиска на основе типа связи оффера,
 * переданного в запросе.
 *
 * @author vbudnev
 */
@RunWith(Parameterized.class)
public class MarketSearchGoalAllowedModificationsTest extends AbstractParserTest {
    @InjectMocks
    ...
    public MarketSearchGoalAllowedModificationsTest(Pair<BulkUpdateRequest, ExpectedLabelBidsStats> testCase) {
    ...
    public static Collection<Object[]> testCases() {
        ...
        List<Pair<BulkUpdateRequest, ExpectedLabelBidsStats>> testCases = ImmutableList.of(
                Pair.of(createUReqByName(OFFER_NAME_1, MARKET_SEARCH_IRRELEVANT_PLACE, null), RECOMMENDED_OK),
                Pair.of(createUReqByName(OFFER_NAME_2, MARKET_SEARCH_IRRELEVANT_PLACE, null), RECOMMENDED_OK),
                Pair.of(createUReqByName(OFFER_NAME_3, MARKET_SEARCH_IRRELEVANT_PLACE, null), RECOMMENDED_OK)
        );
