...
/**
 * Для параллельных рекомендаций проверяем, что при установке ставки с использованием целей
...
public class UpdateBidsByParallelSearchRecommendationTest extends AuctionBulkServantletlMockBase {

    private final AuctionGoalPlace requestGoalValue;
    private final BigInteger expectedBidValue;

    public UpdateBidsByParallelSearchRecommendationTest(
     ...
     */
    @Test
    public void test_updateBid_when_updateViaPSGoalTied_should_calculateFromReportAndPassToBidding() {
        mockServantletPassedArgs("" +
                "req.size=1" +
                "&req1.offerName=" + SOME_OFFER_NAME +
                "&req1.goal.type=" + PARALLEL_SEARCH +
     ...
     */
    @Test
    public void test_updateBid_when_updateViaPSGoal_and_explicitSearchQueryFlag() {
        mockServantletPassedArgs("" +
                "req.size=1" +
                "&req1.offerName=" + SOME_OFFER_NAME +
                "&req1.goal.type=" + PARALLEL_SEARCH +
