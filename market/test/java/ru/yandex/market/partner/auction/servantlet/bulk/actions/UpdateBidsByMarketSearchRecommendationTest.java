...
/**
 * Для маркетных рекомендаций проверяем, что при установке ставки с использованием целей
...
public class UpdateBidsByMarketSearchRecommendationTest extends AuctionBulkServantletlMockBase {

    private final AuctionGoalPlace requestGoalValue;
    private final BigInteger expectedBidValue;

    public UpdateBidsByMarketSearchRecommendationTest(
    ...
    @Test
    public void test_updateBid_when_updateViaMSGoal_should_calculateFromReportAndPassToBidding() {
    ...
    /**
     * В запросе выставлен маркер tied=true - cbid должны быть выставлена эквивалентно bid.
     */
    @Test
    public void test_updateBid_when_updateViaMSGoalTied_should_calculateFromReportAndPassToBidding() {
        mockServantletPassedArgs("" +
                "req.size=1" +
                "&req1.offerName=" + SOME_OFFER_NAME +
                "&req1.goal.type=" + MARKET_SEARCH +
        ...
        assertThat(passedBidValue, hasPlaceBid(BidPlace.SEARCH, expectedBidValue));
        assertThat(passedBidValue, hasPlaceBid(BidPlace.MARKET_PLACE, KEEP_OLD_BID_VALUE));
        assertThat(passedBidValue, hasPlaceBid(BidPlace.CARD, expectedBidValue));
        assertThat(passedBidValue, hasPlaceBid(BidPlace.MARKET_SEARCH, KEEP_OLD_BID_VALUE));
        assertThat(passedBidValue, hasLinkType(CARD_NO_LINK_CPC_ONLY));
    }
     ...
     */
    @Test
    public void test_updateBid_when_updateViaMSGoal_and_explicitSearchQueryFlag() {
        mockServantletPassedArgs("" +
                "req.size=1" +
                "&req1.offerName=" + SOME_OFFER_NAME +
                "&req1.goal.type=" + MARKET_SEARCH +
