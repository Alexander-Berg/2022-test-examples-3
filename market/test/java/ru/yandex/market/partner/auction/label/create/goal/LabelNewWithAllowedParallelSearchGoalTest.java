...
/**
 * Маркировка новых ставок для параллельного поиска.
...
public class LabelNewWithAllowedParallelSearchGoalTest extends AbstractParserTest {
    @InjectMocks
    ...
    public LabelNewWithAllowedParallelSearchGoalTest(BulkUpdateRequest request, ExpectedLabelBidsStats expectedLabelBidsStats) {
    ...
    public static Collection<Object[]> testCases() {
        return Arrays.asList(
                new Object[][]{
                        {createUReqByName(OFFER_NAME_1, PARALLEL_SEARCH_IRRELEVANT_PLACE, null), RECOMMENDED_OK},
                }
        );
    }
