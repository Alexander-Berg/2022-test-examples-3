...
class GetMarketSearchRecommendationsByOfferIdReportTranslationTest extends AuctionBulkServantletlMockBase {
     ...
     */
    @Test
    void test_getRecommendationsByOffer() {
        ...
        assertThat(recRequest, hasSearchQuery(SOME_SEARCH_QUERY));
    }
     ...
     */
    @Test
    void test_getRecommendationsByOffer_when_explicitQualityFactorInRequest() {
        mockShopAuctionType(AuctionOfferIdType.TITLE);
        ...
        mockServantletPassedArgs("" +
                ...
                "&req1.offerName=" + SOME_OFFER_NAME +
                "&req1.searchQuery=" + SOME_SEARCH_QUERY +
                "&req1.qualityFactor=" + PARAM_QUALITY_FACTOR
        );
