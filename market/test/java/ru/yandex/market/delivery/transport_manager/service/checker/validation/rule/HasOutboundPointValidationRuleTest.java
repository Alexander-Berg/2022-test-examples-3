...
public class HasOutboundPointValidationRuleTest {
    private final HasOutboundPointValidationRule rule = new HasOutboundPointValidationRule(
    ...
    void isValid_neededMethods_noPoint_false() {
        ...
        transportationPartnerMethod.setPartnerId(1L);
        transportationPartnerMethod.setMethod(PartnerMethod.PUT_OUTBOUND);
