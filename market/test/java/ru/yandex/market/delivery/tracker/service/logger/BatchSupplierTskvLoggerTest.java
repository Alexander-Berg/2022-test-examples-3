...
class BatchSupplierTskvLoggerTest {
    @Mock
    private TskvLogger tskvLogger;

    @InjectMocks
    private BatchSupplierTskvLogger batchSupplierTskvLogger;
    ...
    void setUp() {
        ...
        batchSupplierTskvLogger = new BatchSupplierTskvLogger(tskvLogger, clock);
    }
    ...
    void logExecutionTime() {
        ...
        Date batchStartDate = Date.from(clock.instant().plus(2, ChronoUnit.MINUTES));
        ...
        batchSupplierTskvLogger.logExecutionTime(context, RequestType.ORDER_STATUS, jobStartDate, batchStartDate);

        Map<String, String> expectedTskvMap = ImmutableMap.<String, String>builder()
            .put("jobName", jobName)
            .put("instanceId", instanceId)
            .put("batchType", "ORDER_STATUS")
            .put("scheduledFireTs", "2020-01-01 00:00:00.000+0000")
            .put("jobStartTs", "2020-01-01 00:01:00.000+0000")
            .put("batchStartTs", "2020-01-01 00:02:00.000+0000")
            .put("batchProcessingDelayMs", "60000")
            .put("batchProcessingTimeMs", "-120000") // expected because of clock skew
            .build();
