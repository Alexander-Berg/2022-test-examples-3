...
public class AbstractByDatePartitionStrategyTest extends AbstractByDatePartitionStrategy {
    protected AbstractByDatePartitionStrategyTest() {
        super(Fqns.versionOf(Fqn.of("test")));
    }

    private static List<Arguments> correctData() {
        return List.of(
                Arguments.of("tbl_ticket_version__partition__2021_07", LocalDate.of(2021, 7, 1)),
                Arguments.of("tbl_ticket_version__partition__2021_7", LocalDate.of(2021, 7, 1)),
                Arguments.of("tbl_employeedistributionstatus_version__partition__2021_09", LocalDate.of(2021, 9, 1))
        );
    }
    ...
    private static List<Arguments> incorrectData() {
        return List.of(
                ...
                Arguments.of("tbl_ticket_version__partition__2000_0", DateTimeException.class),
