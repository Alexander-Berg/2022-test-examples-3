...
def build_ammo(args):
    ...
    if args['add_baseline_test_ids']:
        cmd.extend(['--add-baseline-test-ids', args['add_baseline_test_ids']])

    if args['add_experiment_test_ids']:
        cmd.extend(['--add-experiment-test-ids', args['add_experiment_test_ids']])
