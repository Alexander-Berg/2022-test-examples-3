...
from matching.human_matching import graph_clustering
from matching.human_matching.graph_clustering import Edge, Component
...
class TestGraphClustering(unittest.TestCase):
    ...
    def test_reassign_corner_values_ok(self):
        ...
        components = [
            Component(edges1, 4, 1),
            Component(edges2, 3, 2)
        ]
    ...
    def test_reassign_corner_values_ok_vice_versa(self):
        ...
        components = [
            Component(edges1, 3, 2),
            Component(edges2, 4, 1)
        ]
