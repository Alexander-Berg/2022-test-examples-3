...
from crypta.graph.v1.python.matching.human_matching.stats.radius import radius_metrics_calc
...
class TestGetMetrics(unittest.TestCase):
    ...
    def test_metrics_reference(self):
        ...
        crypta_graph = {
            "cid1": [{"yuid": "mob1"}, {"yuid": "desk1"}, {"yuid": "desk2"}],
    ...
    def test_metrics_perfect_match(self):
        rlogin_graph = {"a": [{"yuid": "1"}, {"yuid": "2"}, {"yuid": "3"}], "b": [{"yuid": "4"}, {"yuid": "5"}]}
        crypta_graph = {"x": [{"yuid": "1"}, {"yuid": "2"}, {"yuid": "3"}], "y": [{"yuid": "4"}, {"yuid": "5"}]}
    ...
    def test_metrics_found_1_more(self):
        rlogin_graph = {"a": [{"yuid": "1"}, {"yuid": "3"}], "b": [{"yuid": "4"}, {"yuid": "5"}]}
        crypta_graph = {
            "x": [{"yuid": "1"}, {"yuid": "2_found_more"}, {"yuid": "3"}],
            "y": [{"yuid": "4"}, {"yuid": "5"}],
        }
    ...
    def test_metrics_found_2_more(self):
        rlogin_graph = {"a": [{"yuid": "1"}, {"yuid": "3"}], "b": [{"yuid": "4"}]}
        crypta_graph = {
            "x": [{"yuid": "1"}, {"yuid": "2_found_more"}, {"yuid": "3"}],
    ...
    def test_metrics_found_2_less(self):
        rlogin_graph = {
            "a": [{"yuid": "1"}, {"yuid": "2"}, {"yuid": "3_not_found"}],
            "b": [{"yuid": "4"}, {"yuid": "5_not_found"}],
        }
        crypta_graph = {"x": [{"yuid": "1"}, {"yuid": "2"}], "y": [{"yuid": "4"}]}
    ...
    def test_metrics_found_3_less(self):
        rlogin_graph = {
            "a": [{"yuid": "1"}, {"yuid": "2"}, {"yuid": "3_not_found"}, {"yuid": "4_not_found"}],
            "b": [{"yuid": "4"}, {"yuid": "5_not_found"}],
        }
        crypta_graph = {"x": [{"yuid": "1"}, {"yuid": "2"}], "y": [{"yuid": "4"}]}
    ...
    def test_metrics_found_2_less_1_more(self):
        ...
        crypta_graph = {"x": [{"yuid": "1"}, {"yuid": "2"}], "y": [{"yuid": "4"}, {"yuid": "6_found_more"}]}
    ...
    def test_metrics_found_all_in_2_crypta_ids(self):
        ...
        crypta_graph = {"x": [{"yuid": "1"}, {"yuid": "2"}], "y": [{"yuid": "3"}, {"yuid": "4_some_other"}]}
    ...
    def test_single_devices_are_not_taken_into_account(self):
        rlogin_graph = {"a": [{"yuid": "1"}], "b": [{"yuid": "2"}]}
        crypta_graph = {"x": [{"yuid": "1"}], "y": [{"yuid": "2"}]}
