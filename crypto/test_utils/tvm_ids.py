class TvmIds(object):
    def __init__(self, tvm_api):
        ...
        self.identify_only = tvm_api.issue_id()
        self.full_except_identify = tvm_api.issue_id()

        self.upload_only = tvm_api.issue_id()
        self.full_except_upload = tvm_api.issue_id()
        ...
        self.expire_only = tvm_api.issue_id()
        self.full_except_expire = tvm_api.issue_id()

        self.delete_only = tvm_api.issue_id()
        self.full_except_delete = tvm_api.issue_id()

        self.identify_offline_only = tvm_api.issue_id()
