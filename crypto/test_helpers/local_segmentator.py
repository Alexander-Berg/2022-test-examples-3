...
class LocalSegmentator(test_utils.TestBinaryContextManager):
    config_template_path = "crypta/siberia/bin/segmentator/bundle/templates/config.yaml"
    binary_path = "crypta/siberia/bin/segmentator/bin/crypta-siberia-segmentator"

    def __init__(self, working_dir, ydb_endpoint, ydb_database, logbroker_config):
        super(LocalSegmentator, self).__init__("Siberia Segmentator")
