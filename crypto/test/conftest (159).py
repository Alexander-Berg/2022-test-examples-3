...
from crypta.siberia.bin.custom_audience.hosts_filter.proto.config_pb2 import TConfig
...
def config_file(local_yt):
    ...
    templater.render_file(
        yatest.common.source_path("crypta/siberia/bin/custom_audience/hosts_filter/bundle/config.yaml"),
        config_file_path,
        {
            "environment": "qa",
