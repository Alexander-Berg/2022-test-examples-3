...
from crypta.siberia.bin.custom_audience.bs_apps_cluster_mapping.proto.config_pb2 import TConfig
...
def config_file(local_yt):
    ...
    templater.render_file(
        yatest.common.source_path("crypta/siberia/bin/custom_audience/bs_apps_cluster_mapping/bundle/config.yaml"),
        config_file_path,
        {
            "environment": "qa",
