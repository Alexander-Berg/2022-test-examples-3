...
import static ru.yandex.autotests.mediaplan.datafactories.AddMediplanFactory.twoMediaplans;
...
@Description("Создание 2 медиапланов")
@RunWith(Parameterized.class)
public class MediaPlanNegativeTest {
    ...
    public void createMediaPlan() {
        ...
        assertThat("сохраненные медипланы соответсвуют ожиданиям", addMediaplansResult.getAddResults().stream()
