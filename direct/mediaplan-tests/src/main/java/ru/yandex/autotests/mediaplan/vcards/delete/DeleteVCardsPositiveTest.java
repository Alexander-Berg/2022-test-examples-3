...
@Description("Удаление визитных карточек из медиаплана")
...
public class DeleteVCardsPositiveTest {
    ...
    public DeleteVCardsPositiveTest(String text, ParamsApi5AddVcards paramsApi5AddVcards) {
    ...
    public void deleteVCard() {
        ...
        assertThat("Ссылки удалились", api5DeleteSitelinksResult.getDeleteResults(), hasSize(paramsApi5AddVcards.getVCards().size()));
    }
}
