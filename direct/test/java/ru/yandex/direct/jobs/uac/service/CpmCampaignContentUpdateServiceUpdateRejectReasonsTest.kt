...
class CpmCampaignContentUpdateServiceUpdateRejectReasonsTest : AbstractUacRepositoryJobTest() {
    ...
    fun parametersForRejectReasons() =
        listOf(
            Arguments.of(
                "Тип BANNER для title/text контента -> получаем список причин",
                BANNER, false, true,
            ),
            Arguments.of(
                "Тип BANNER для title/text контента -> получаем список причин",
            ...
            Arguments.of(
                "Тип HTML5_CREATIVE для html5 контента -> получаем список причин",
                HTML5_CREATIVE, true, false,
            ),
            Arguments.of(
                "Тип HTML5_CREATIVE для video контента -> получаем список причин",
                HTML5_CREATIVE, false, true,
            ),
            Arguments.of(
                "Тип VIDEO_ADDITION для video контента -> получаем список причин",
                VIDEO_ADDITION, false, true,
            ),
            Arguments.of(
                "Тип VIDEO_ADDITION для image контента -> не получаем список причин",
