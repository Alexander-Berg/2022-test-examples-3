...
public class MetricaExportObjectForPerfFiltersLateDateTest {
    ...
    public void initTestData() {
        ...
        perfFilter.setLastchange(lastChangeTime.minusMinutes(1));
    ...
    public void objectInfoForPerfFiltersTest() throws Exception {
        ...
        assertThat(response.getObjects())
                .extracting(PerformanceFilterInfo::getSortId)
                .doesNotContain(filterId);
    }
