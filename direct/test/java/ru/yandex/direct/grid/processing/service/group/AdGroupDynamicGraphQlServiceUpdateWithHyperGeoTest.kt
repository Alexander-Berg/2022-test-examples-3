...
private val UPDATE_MUTATION = GraphQlTestExecutor.TemplateMutation("updateDynamicAdGroups", UPDATE_ADGROUP_TEMPLATE,
    GdUpdateDynamicAdGroup::class.java, GdUpdateAdGroupPayload::class.java)

@GridProcessingTest
@RunWith(SpringJUnit4ClassRunner::class)
class AdGroupDynamicGraphQlServiceUpdateWithHyperGeoTest {
     ...
     */
    @Test
    fun updateDynamicAdGroups_withHyperGeo() {
     ...
     */
    @Test
    fun updateDynamicAdGroups_withWrongHyperGeo_GetError() {
     ...
     */
    @Test
    fun updateDynamicAdGroups_withHyperGeoAndWithoutFeature_GetError() {
     ...
     */
    @Test
    fun updateDynamicAdGroups_withMultipleSegmentsOfHyperGeoAndWithFeature() {
    ...
    private fun runAndGetPayload(hyperGeoId: Long): GdUpdateAdGroupPayload {
        val gdUpdateDynamicAdGroupItem = createGdUpdateDynamicAdGroupItem(hyperGeoId)

        val gdUpdateDynamicAdGroup = GdUpdateDynamicAdGroup().withUpdateItems(listOf(gdUpdateDynamicAdGroupItem))
        return graphQlTestExecutor.doMutationAndGetPayload(UPDATE_MUTATION, gdUpdateDynamicAdGroup, operator)
    }
    ...
    private fun createGdUpdateDynamicAdGroupItem(hyperGeoId: Long): GdUpdateDynamicAdGroupItem {
        return GdUpdateDynamicAdGroupItem()
