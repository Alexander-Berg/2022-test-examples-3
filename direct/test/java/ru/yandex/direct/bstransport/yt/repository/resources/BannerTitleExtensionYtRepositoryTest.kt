...
internal class BannerTitleExtensionYtRepositoryTest : AbstractBannerResourcesYtRepositoryTest(BannerTitleExtensionYtRepository::class.java) {
    @Test
    fun getSchemaWithMappingTest() {
        val resource = BannerResources.newBuilder()
            ...
            .setExportId(123L)
            .setTitleExtension("По МО по выгодной цене")
            .build()
        val expectedColumnNameToValue = mapOf<String, Any>(
            ...
            "IterID" to 1987L,
            "TitleExtension" to "По МО по выгодной цене"
        )
