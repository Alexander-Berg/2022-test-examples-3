...
public class CpmTrafficLightPredictionNegativeTest extends CampaignForecastControllerTestBase {
    ...
    @Test
    public void getCpmTrafficLightPrediction_BadResult_InternalErrorStatusCode() throws JsonProcessingException {
        badResponse();

        ResponseEntity<WebResponse> response =
                controller.getCpmTrafficLightPrediction(defaultRequest(campaignInfo.getCampaignId()), clientInfo.getLogin());

        assertThat("Должен вернуться правильный код ответа", response.getStatusCodeValue(), is(INTERNAL_ERROR_CODE));
    }

    @Test
    public void getCpmTrafficLightPrediction_BadResult_NoErrorsAndWarnings() throws JsonProcessingException {
        badResponse();
    ...
    public void getCpmTrafficLightPrediction_Timeout_ExceptionIsThrown() throws JsonProcessingException {
        exceptionResponse();
    ...
    private void badResponse() throws JsonProcessingException {
        when(client.getTrafficLightPrediction(anyString(), nullable(String.class), nullable(String.class),
                ...
                new CampaignPredictionAvailableResponse(emptyList(), null, null, null, null, null,
