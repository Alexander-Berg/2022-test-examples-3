...
public class CpmTrafficLightPredictionValidationTest extends CampaignForecastControllerTestBase {

    @Autowired
    private InventoriController controller;

    @Test
    public void getTrafficLightPrediction_CampaignWithNoAdGroups() throws JsonProcessingException {
    ...
    @Test
    public void getTrafficLightPrediction_AdGroupWithNoRetargetingCondition() throws JsonProcessingException {
    ...
    private void checkSuccessResultWithErrors(CpmForecastRequest request, WebDefect... errors)
        ...
        CpmTrafficLightPredictionResponse cpmForecastResponse = (CpmTrafficLightPredictionResponse) response.getBody();
