...
public class ResumeAudienceTargetsDelegateTest {
    ...
    private ResumeAudienceTargetsDelegate delegate;
    ...
    public void before() {
        ...
        delegate = new ResumeAudienceTargetsDelegate(
                auth,
                retargetingService,
    ...
    public void validateInternalRequest_CpmVideoAdGroup_Ok() {
        ...
        assertThat(vr).as("Тип cpm_video поддерживается в методе audiencetargets.resume").is(hasNoDefects());
    }
}
