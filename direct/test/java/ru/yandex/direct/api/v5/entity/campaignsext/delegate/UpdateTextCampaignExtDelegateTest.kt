...
import com.yandex.direct.api.v5.campaignsext.StrategyPayForConversionCrr
...
class UpdateTextCampaignExtDelegateTest : UpdateCampaignsExtDelegateBaseTest() {

    private lateinit var campaignInfo: CampaignInfo<TextCampaign>
    private val FACTORY = com.yandex.direct.api.v5.campaignsext.ObjectFactory()
