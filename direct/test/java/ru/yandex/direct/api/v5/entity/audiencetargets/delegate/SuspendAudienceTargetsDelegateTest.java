...
public class SuspendAudienceTargetsDelegateTest {
    ...
    private SuspendAudienceTargetsDelegate delegate;
    ...
    public void before() {
        ...
        delegate = new SuspendAudienceTargetsDelegate(
                auth,
                retargetingService,
    ...
    public void validateInternalRequest_CpmVideoAdGroup_Ok() {
        ...
        assertThat(vr).as("Тип cpm_video поддерживается в методе audiencetargets.suspend").is(hasNoDefects());
    }
}
