...
public class SuspendAdsDelegateTest {
    ...
    private SuspendAdsDelegate delegate;
    ...
    public void before() {
        ...
        delegate = new SuspendAdsDelegate(
                bannerService,
                auth,
    ...
    @Test
    public void suspendCmpAd_success() {
        ...
        checkSuccessfulSuspend(adGroupInfo.getShard(), bannerId);
    }

    @Test
    public void suspendPerformanceAd_success() {
    ...
    private ValidationResult<List<ModelChanges<BannerWithSystemFields>>, DefectType> validate(Long bannerId) {
        ...
        var suspendRequest = new SuspendRequest().withSelectionCriteria(idsCriteria);
        List<ModelChanges<BannerWithSystemFields>> modelChanges = delegate.convertRequest(suspendRequest);
        return delegate.validateInternalRequest(modelChanges);
    }

    private void checkSuccessfulSuspend(int shard, Long bannerId) {
        ...
        assertThat(actualBanner.getStatusShow()).isFalse();
    }
}
