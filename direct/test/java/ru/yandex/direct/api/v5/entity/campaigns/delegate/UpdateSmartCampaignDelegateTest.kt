...
class UpdateSmartCampaignDelegateTest : UpdateCampaignsDelegateBaseTest() {
    ...
    fun `update all available fields`() {
        ...
        val updateItem = CampaignUpdateItem().apply {
            ...
            smartCampaign = SmartCampaignUpdateItem().apply {
                ...
                trackingParams = OBJECT_FACTORY.createSmartCampaignUpdateItemTrackingParams(expectedTrackingParams)
            }
