...
@Component
class DefaultManualStrategySteps(
...
) : StrategySteps<DefaultManualStrategy, DefaultManualStrategyInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): DefaultManualStrategyInfo {
        return DefaultManualStrategyInfo(clientInfo)
    }
}
