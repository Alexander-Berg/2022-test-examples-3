...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetAvgCpaPerFilterInfo
...
@Component
class AutobudgetAvgCpaPerFilterSteps(
...
) : StrategySteps<AutobudgetAvgCpaPerFilter, AutobudgetAvgCpaPerFilterInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpaPerFilterInfo {
        return AutobudgetAvgCpaPerFilterInfo(clientInfo)
    }
}
