...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetAvgCpvCustomPeriodInfo
...
@Component
class AutobudgetAvgCpvCustomPeriodSteps(
...
) : StrategySteps<AutobudgetAvgCpvCustomPeriod, AutobudgetAvgCpvCustomPeriodInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpvCustomPeriodInfo {
        return AutobudgetAvgCpvCustomPeriodInfo(clientInfo)
    }
}
