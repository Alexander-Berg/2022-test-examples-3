...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetMaxReachInfo
...
class AutobudgetMaxReachSteps(
...
) : StrategySteps<AutobudgetMaxReach, AutobudgetMaxReachInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetMaxReachInfo {
        return AutobudgetMaxReachInfo(clientInfo)
    }
}
