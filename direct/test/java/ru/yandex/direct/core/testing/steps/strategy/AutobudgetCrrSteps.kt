...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetCrrInfo
...
class AutobudgetCrrSteps(
...
) : StrategySteps<AutobudgetCrr, AutobudgetCrrInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetCrrInfo {
        return AutobudgetCrrInfo(clientInfo)
    }
}
