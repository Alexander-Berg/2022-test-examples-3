...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetMaxReachCustomPeriodInfo
...
@Component
class AutobudgetMaxReachCustomPeriodSteps(
...
) : StrategySteps<AutobudgetMaxReachCustomPeriod, AutobudgetMaxReachCustomPeriodInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetMaxReachCustomPeriodInfo {
        return AutobudgetMaxReachCustomPeriodInfo(clientInfo)
    }
}
