...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetMaxImpressionsInfo
...
@Component
class AutobudgetMaxImpressionsSteps(
...
) : StrategySteps<AutobudgetMaxImpressions, AutobudgetMaxImpressionsInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetMaxImpressionsInfo {
        return AutobudgetMaxImpressionsInfo(clientInfo)
    }
}
