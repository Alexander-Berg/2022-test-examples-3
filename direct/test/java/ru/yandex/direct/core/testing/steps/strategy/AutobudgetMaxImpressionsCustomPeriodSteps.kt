...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetMaxImpressionsCustomPeriodInfo
...
@Component
class AutobudgetMaxImpressionsCustomPeriodSteps(
...
) : StrategySteps<AutobudgetMaxImpressionsCustomPeriod, AutobudgetMaxImpressionsCustomPeriodInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetMaxImpressionsCustomPeriodInfo {
        return AutobudgetMaxImpressionsCustomPeriodInfo(clientInfo)
    }
}
