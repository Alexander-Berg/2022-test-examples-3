...
import ru.yandex.direct.core.testing.info.strategy.CpmDefaultInfo
...
class CpmDefaultSteps(
...
) : StrategySteps<CpmDefault, CpmDefaultInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): CpmDefaultInfo {
        return CpmDefaultInfo(clientInfo)
    }
}
