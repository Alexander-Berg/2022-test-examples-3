...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetAvgCpcPerCampInfo
...
@Component
class AutobudgetAvgCpcPerCampSteps(
...
) : StrategySteps<AutobudgetAvgCpcPerCamp, AutobudgetAvgCpcPerCampInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpcPerCampInfo {
        return AutobudgetAvgCpcPerCampInfo(clientInfo)
    }
}
