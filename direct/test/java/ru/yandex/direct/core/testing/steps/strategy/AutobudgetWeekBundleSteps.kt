...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetWeekBundleInfo
...
@Component
class AutobudgetWeekBundleSteps(
...
) : StrategySteps<AutobudgetWeekBundle, AutobudgetWeekBundleInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetWeekBundleInfo {
        return AutobudgetWeekBundleInfo(clientInfo)
    }
}
