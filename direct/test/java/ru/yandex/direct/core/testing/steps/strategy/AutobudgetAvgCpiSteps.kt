...
class AutobudgetAvgCpiSteps(
...
) : StrategySteps<AutobudgetAvgCpi, AutobudgetAvgCpiInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpiInfo {
        return AutobudgetAvgCpiInfo(clientInfo)
    }
}
