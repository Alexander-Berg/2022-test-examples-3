...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetWeekSumInfo
...
class AutobudgetWeekSumSteps(
...
) : StrategySteps<AutobudgetWeekSum, AutobudgetWeekSumInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetWeekSumInfo {
        return AutobudgetWeekSumInfo(clientInfo)
    }
}
