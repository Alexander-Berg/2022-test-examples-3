...
class AutobudgetAvgCpaSteps(
...
) : StrategySteps<AutobudgetAvgCpa, AutobudgetAvgCpaInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpaInfo {
        return AutobudgetAvgCpaInfo(clientInfo)
    }
}
