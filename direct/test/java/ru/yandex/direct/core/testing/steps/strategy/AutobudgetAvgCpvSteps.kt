...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetAvgCpvInfo
...
class AutobudgetAvgCpvSteps(
...
) : StrategySteps<AutobudgetAvgCpv, AutobudgetAvgCpvInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpvInfo {
        return AutobudgetAvgCpvInfo(clientInfo)
    }
}
