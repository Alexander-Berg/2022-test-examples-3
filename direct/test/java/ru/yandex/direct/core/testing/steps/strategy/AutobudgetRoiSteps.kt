...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetRoiInfo
...
class AutobudgetRoiSteps(
...
) : StrategySteps<AutobudgetRoi, AutobudgetRoiInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetRoiInfo {
        return AutobudgetRoiInfo(clientInfo)
    }
}
