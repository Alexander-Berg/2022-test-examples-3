...
@Component
class AutobudgetAvgCpcPerFilterSteps(
...
) : StrategySteps<AutobudgetAvgCpcPerFilter, AutobudgetAvgCpcPerFilterInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgCpcPerFilterInfo {
        return AutobudgetAvgCpcPerFilterInfo(clientInfo)
    }
}
