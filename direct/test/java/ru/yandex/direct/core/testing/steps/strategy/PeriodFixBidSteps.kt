...
import ru.yandex.direct.core.testing.info.strategy.PeriodFixBidInfo
...
class PeriodFixBidSteps(
...
) : StrategySteps<PeriodFixBid, PeriodFixBidInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): PeriodFixBidInfo {
        return PeriodFixBidInfo(clientInfo)
    }
}
