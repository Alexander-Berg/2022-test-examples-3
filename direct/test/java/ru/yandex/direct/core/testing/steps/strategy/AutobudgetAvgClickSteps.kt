...
import ru.yandex.direct.core.testing.info.strategy.AutobudgetAvgClickInfo
...
class AutobudgetAvgClickSteps(
...
) : StrategySteps<AutobudgetAvgClick, AutobudgetAvgClickInfo>(
    dslContextProvider,
    shardHelper,
    ...
    override fun defaultStrategyInfo(clientInfo: ClientInfo): AutobudgetAvgClickInfo {
        return AutobudgetAvgClickInfo(clientInfo)
    }
}
