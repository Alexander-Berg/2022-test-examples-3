...
public class CopyOperationContentPromoitionCampaignBetweenClientsTest {
    @Autowired
    private Steps steps;
    ...
    public void setUp() {
        ...
        CampaignInfo campaignInfo = steps.campaignSteps().createCampaign(
                activeContentPromotionCampaign(clientId, clientInfo.getUid()).withEmail("test@yandex-team.ru")
    ...
    @Test
    public void contentPromotionCampaignNotCopied() {
