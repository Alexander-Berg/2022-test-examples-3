...
public class DefaultBannerWithCreativeModerationForceModerateUpdatePositiveTest
    ...
    public static Collection<Object[]> parameters() {
        return asList(new Object[][]{
                {
                        "обновление: баннер черновик, без изменений -> креатив отправляется на модерацию",
                        // исходные значения
                ...
                {
                        "обновление: баннер активен, без изменений -> креатив остается в том же статусе",
                        // исходные значения
                ...
                {
                        "обновление: баннер активен, изменился креатив -> креатив переходит в черновик",
                        // исходные значения
                        BannerStatusModerate.YES,
                        BannerStatusPostModerate.YES,
                        CpmIndoorBanner.class,
