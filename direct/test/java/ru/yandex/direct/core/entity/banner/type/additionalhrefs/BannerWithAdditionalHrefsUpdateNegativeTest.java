...
public class BannerWithAdditionalHrefsUpdateNegativeTest extends BannerClientInfoUpdateOperationTestBase {
    ...
    public void invalidAdditionalHref() {
        ...
        ModelChanges<CpmBanner> changes = ModelChanges.build(banner.getId(), CpmBanner.class, ADDITIONAL_HREFS,
                List.of(new BannerAdditionalHref().withHref("invalid href")));
