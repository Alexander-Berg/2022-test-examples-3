...
public class MobileHtml5SenderTest extends AbstractHtml5CreativeBannerSenderTest {
    ...
    public void before() {
        ...
        var bannerInfo = steps.imageBannerSteps().createImageBanner(
                new NewImageBannerInfo().withClientInfo(clientInfo).withCampaignInfo(campaignInfo).withAdGroupInfo(adGroupInfo).withBanner(b).withCreative(creative));
        var bannerInfo2 = steps.imageBannerSteps().createImageBanner(
                new NewImageBannerInfo().withClientInfo(clientInfo).withCampaignInfo(campaignInfo).withAdGroupInfo(adGroupInfo).withBanner(b2).withCreative(creative));
