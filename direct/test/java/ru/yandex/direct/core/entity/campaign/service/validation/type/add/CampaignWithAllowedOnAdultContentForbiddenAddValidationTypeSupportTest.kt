...
class CampaignWithAllowedOnAdultContentForbiddenAddValidationTypeSupportTest {

    lateinit var typeSupport: CampaignWithAllowedOnAdultContentForbiddenAddValidationTypeSupport
    ...
    @Before
    fun setUp() {
        typeSupport = CampaignWithAllowedOnAdultContentForbiddenAddValidationTypeSupport()
    }

    @Test
    @Parameters(method = "testData")
    @TestCaseName("campaign is {0} and not copy")
    fun shouldAddDefectIfFlagIsPresent(testCase: String, campaign: CampaignWithAllowedOnAdultContentForbidden) {
        val container = mock(RestrictedCampaignsAddOperationContainer::class.java)
        campaign.isAllowedOnAdultContent = true
    ...
    @Parameters(method = "testData")
    @TestCaseName("campaign is {0} and not copy")
    fun shouldValidateOkIfFlagIsNotPresent(testCase: String, campaign: CampaignWithAllowedOnAdultContentForbidden) {
        val container = mock(RestrictedCampaignsAddOperationContainer::class.java)
    ...
    @Parameters(method = "testData")
    @TestCaseName("campaign is {0} and not copy")
    fun shouldValidateOkIfCopy(testCase: String, campaign: CampaignWithAllowedOnAdultContentForbidden) {
        val container = mock(RestrictedCampaignsAddOperationContainer::class.java)
