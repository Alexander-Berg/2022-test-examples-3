    ...
    public void testMapping() {
        try {
            ...
            Assert.fail("вызов конвертирующего метода " +
                    AdGroupMappings.class.getCanonicalName() + "." + method.getName() +
