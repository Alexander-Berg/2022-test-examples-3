...
public class ContentPromotionServiceBannerUpdateAutoModerationDefaultModeTest extends UpdateModerationTestBase {
    ...
    protected Long createBanner(AdGroupInfo adGroupInfo) {
        ...
        return steps.bannerSteps().createActiveContentPromotionBanner(
                activeContentPromotionBannerServiceType(adGroupInfo.getAdGroupId(), adGroupInfo.getCampaignId())
                        .withTitle(TITLE)
