...
public class RetargetingMappingsTest {

    @Parameterized.Parameters(name = "метод: {1}, аргумент: {2}")
    public static Collection<Object[]> methodsAndArguments() {
        return MappingTestUtils.methodsAndArguments(RetargetingMappings.class);
    }
    ...
    public void testMapping() {
        try {
            ...
            Assert.fail("вызов конвертирующего метода " +
                    RetargetingMappings.class.getCanonicalName() + "." + method.getName() +
