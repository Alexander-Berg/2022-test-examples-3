...
public class CampaignWithCustomStrategyValidatorDynamicCampaignPositiveTest {
    ...
    private DynamicCampaign dynamicCampaign;
    ...
    @Before
    public void before() {
        CampaignInfo campaignInfo = steps.campaignSteps().createActiveDynamicCampaign();
        currency = clientService.getWorkCurrency(campaignInfo.getClientId());
        dynamicCampaign = (DynamicCampaign) campaignTypedRepository.getTypedCampaigns(campaignInfo.getShard(),
    ...
    public void checkValidatedSuccessfully() {
        dynamicCampaign.withStrategy(dbStrategy);
        ValidationResult<CampaignWithCustomStrategy, Defect> vr = new CampaignWithCustomStrategyValidator(currency,
                ...
                getBannersSiteLinkSetsFunction, dynamicCampaign,
