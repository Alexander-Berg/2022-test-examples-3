...
public class CpmCanvasSenderTest extends AbstractCanvasCreativeBannerSenderTest {
    ...
    public void before() throws IOException {
        ...
        banner = steps.bannerSteps().createActiveCpmBanner(
                activeCpmBanner(campaignInfo.getCampaignId(), null, creativeInfo.getCreativeId())
