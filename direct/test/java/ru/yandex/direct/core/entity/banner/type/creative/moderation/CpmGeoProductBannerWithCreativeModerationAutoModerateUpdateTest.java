...
public class CpmGeoProductBannerWithCreativeModerationAutoModerateUpdateTest
    ...
    public static Collection<Object[]> parameters() {
        return asList(new Object[][]{
                {
                        "обновление активного баннера с геопродуктом: изменился креатив -> креатив автоматически " +
                                "модерируется",
                        // исходные значения
                ...
                {
                        "обновление активного баннера с геопродуктом: креатив на модерации, изменился креатив " +
