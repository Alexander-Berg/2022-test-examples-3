 ...
 * текстовый активный баннер
 * ModerationMode.DEFAULT
 */
@CoreTest
@RunWith(Parameterized.class)
public class DefaultBannerUpdateModerationDefaultModeActiveBannerTest extends UpdateModerationTestBase {

    @Parameterized.Parameters(name = "{4}: {0}")
    public static Collection<Object[]> parameters() {
        return asList(new Object[][]{
                {
                        "Обновление: Активный баннер, Группа и кампания - черновики, изменяем баннер " +
                ...
                {
                        "Обновление: Активный баннер, Группа и кампания отправлены на модерацию, баннер изменился " +
                ...
                {
                        "Обновление: Активный баннер, Группа и кампания отправлены на модерацию, баннер не изменился " +
                                "-> баннер остается в том же статусе, " +
                                "группа и кампания остаются в том же статусе",
                        // исходные значения
                        StatusModerate.SENT,
                ...
                {
                        "Обновление: Активный баннер, Группа и кампания промодерированы, изменяем баннер " +
                                "-> баннер становится готовым к отправке, " +
                                "группа и кампания остаются в том же статусе",
                        // исходные значения
                        StatusModerate.YES,
                ...
                {
                        "Обновление: Активный баннер, Группа и кампания отклонены, изменяем баннер " +
                                "-> баннер становится готовым к отправке, " +
                ...
                {
                        "Обновление: Активный баннер, Группа - черновик, а кампания принята, изменяем баннер " +
                                "-> баннер становится готовым к отправке, " +
                ...
                {
                        "Обновление: Активный баннер, Группа отправлена на модерацию, а кампания принята, изменяем баннер " +
                                "-> баннер становится готовым к отправке, " +
                                "группа и кампания остаются в том же статусе",
                        // исходные значения
                        StatusModerate.SENT,
                ...
                {
                        "Обновление: Активный баннер, Группа отклонена, а кампания принята, изменяем баннер " +
                                "-> баннер становится готовым к отправке, " +
                ...
                {
                        "Обновление: Активный баннер, Группа - черновик, а кампания отклонена, изменяем баннер" +
                                " -> баннер становится готовым к отправке, " +
                                "группа и кампания становится готовыми к переотправке",
                        // исходные значения
                        StatusModerate.NEW,
