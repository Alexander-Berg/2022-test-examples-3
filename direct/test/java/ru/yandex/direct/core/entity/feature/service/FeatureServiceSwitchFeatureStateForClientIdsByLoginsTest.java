...
public class FeatureServiceSwitchFeatureStateForClientIdsByLoginsTest {
    @Autowired
    ...
    public void switchFeature() {
        ...
        var featureTextIdToLoginState = new FeatureTextIdToLoginState()
                .withLogin(defaultUser.getClientInfo().getLogin())
                .withTextId(defaultFeature.getFeatureTextId())
                .withState(status);
        featureManagingService.switchFeaturesStateForClientIdsByLogins(List.of(featureTextIdToLoginState));
