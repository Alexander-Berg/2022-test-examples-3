...
public class CpmGeoProductBannerWithTurboLandingModerationNoAutoModerateUpdateTest
    ...
    public static Collection<Object[]> parameters() {
        return asList(new Object[][]{
                {
                        "обновление активного баннера с геопродуктом: изменился турболендинг -> турболендинг " +
                                "на модерации",
                        // исходные значения
