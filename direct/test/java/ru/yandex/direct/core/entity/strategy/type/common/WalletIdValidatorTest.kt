...
internal class WalletIdValidatorTest {
    ...
    @TestCaseName("walletId=[{0}]")
    fun `walletId validation is correct`(walletId: Long?, defect: Defect<Long?>?) {
        val validationResult = WalletIdValidator().apply(walletId)
        if (defect != null) {
