...
public class SendCpcHtml5ModerationRequestTest {
    ...
    private NewImageBannerInfo createBanner(TurboLanding turbolanding) {
        ...
        return steps.imageBannerSteps().createImageBanner(
                new NewImageBannerInfo().withClientInfo(clientInfo).withBanner(banner).withCreative(creative));
    }

    @Test
    public void makeHtml5ModerationRequests_RequestDataIsCorrect() {
        List<Html5BannerModerationRequest> requests = makeCpcHtml5ModerationRequests(shard,
    ...
    private List<Html5BannerModerationRequest> makeCpcHtml5ModerationRequests(int shard, List<Long> bids) {
