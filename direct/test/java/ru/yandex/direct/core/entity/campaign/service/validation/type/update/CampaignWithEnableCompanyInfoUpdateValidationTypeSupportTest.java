...
public class CampaignWithEnableCompanyInfoUpdateValidationTypeSupportTest {

    private static ClientId clientId;
    private static Long uid;

    private static CampaignWithEnableCompanyInfo createCampaign() {
    ...
    public void validate_Successfully() {
        ...
        var vr = new CampaignWithEnableCompanyInfoUpdateValidationTypeSupport()
