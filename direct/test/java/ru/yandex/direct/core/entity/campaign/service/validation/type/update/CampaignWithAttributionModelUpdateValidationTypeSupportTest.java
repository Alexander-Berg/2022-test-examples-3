...
public class CampaignWithAttributionModelUpdateValidationTypeSupportTest {
    @Rule
    public MockitoRule mockitoRule = MockitoJUnit.rule().silent();

    private CampaignWithAttributionModelUpdateValidationTypeSupport validationTypeSupport;
    ...
    @Before
    public void before() {
        validationTypeSupport = new CampaignWithAttributionModelUpdateValidationTypeSupport(featureService);
