...
class StrategyWithConversionValidatorProviderAvgCpaPerCampTest : StrategyWithConversionValidatorProviderBaseTest() {
    private fun strategy() = autobudgetAvgCpaPerCamp()
