...
class StrategyWithBidAddValidationTypeSupportTest : StrategyAddOperationTestBase() {
    ...
    fun shouldReturnValidationError_ifValueIsNull() {
        val currencyMinPrice = CurrencyRub.getInstance().minPrice
        val strategy = autobudgetWeekBundle()
            .withBid(currencyMinPrice.subtract(BigDecimal.ONE))
