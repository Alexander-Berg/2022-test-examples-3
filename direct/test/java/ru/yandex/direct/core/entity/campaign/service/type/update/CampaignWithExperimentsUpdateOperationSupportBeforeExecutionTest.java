...
public class CampaignWithExperimentsUpdateOperationSupportBeforeExecutionTest {
    @Rule
    ...
    @InjectMocks
    private CampaignWithExperimentsUpdateOperationSupport operationSupport;
    ...
    public void beforeExecution_onlySectionIds_featureEnabled() {
        ...
        ModelChanges<CampaignWithExperiments> modelChanges =
                ModelChanges.build(campaign, TextCampaign.SECTION_IDS, sectionIds);

        AppliedChanges<CampaignWithExperiments> appliedChanges = modelChanges.applyTo(campaign);
        operationSupport.beforeExecution(updateParameters, List.of(appliedChanges));

        assertThat(appliedChanges.getNewValue(CampaignWithExperiments.AB_SEGMENT_STATISTIC_RETARGETING_CONDITION_ID))
                .isEqualTo(abStatisticRetargetingConditionId);
        assertThat(appliedChanges.getNewValue(CampaignWithExperiments.AB_SEGMENT_RETARGETING_CONDITION_ID))
                .isEqualTo(abRetargetingConditionId);
    ...
    public void beforeExecution_onlySectionIds_featureDisabled() {
        ...
        assertThat(appliedChanges.getActuallyChangedProps())
                .containsExactly(CampaignWithExperiments.SECTION_IDS);
    }
    ...
    public void beforeExecution_sectionIdsAndAbSegmentIds_featureEnabled() {
        ...
        ModelChanges<CampaignWithExperiments> modelChanges = ModelChanges
                .build(campaign, TextCampaign.SECTION_IDS, sectionIds)
                .process(abSegmentIds, TextCampaign.AB_SEGMENT_GOAL_IDS);
    ...
    public void beforeExecution_sectionIdsAndAbSegmentIds_featureDisabled() {
        ...
        ModelChanges<CampaignWithExperiments> modelChanges = ModelChanges
                .build(campaign, CampaignWithExperiments.SECTION_IDS, sectionIds)
                .process(abSegmentIds, CampaignWithExperiments.AB_SEGMENT_GOAL_IDS);

        AppliedChanges<CampaignWithExperiments> appliedChanges = modelChanges.applyTo(campaign);
        operationSupport.beforeExecution(updateParameters, List.of(appliedChanges));

        assertThat(appliedChanges.getActuallyChangedProps())
                .containsExactlyInAnyOrder(CampaignWithExperiments.SECTION_IDS,
