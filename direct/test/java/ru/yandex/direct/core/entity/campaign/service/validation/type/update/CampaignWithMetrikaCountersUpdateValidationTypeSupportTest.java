...
public class CampaignWithMetrikaCountersUpdateValidationTypeSupportTest {
    @Rule
    ...
    public void before() {
        ...
        defaultCampaign = ((CampaignWithMetrikaCounters) TestCampaigns.newCampaignByCampaignType(campaignType))
                ...
                .withMetrikaCounters(List.of((long) defaultCounterId));
    ...
    @Test
    public void testValidateSuccessfully_withoutCountersAccessValidation() {
