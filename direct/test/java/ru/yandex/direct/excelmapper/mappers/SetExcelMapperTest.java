...
import static ru.yandex.direct.excelmapper.ExcelMappers.setMapper;
...
class SetExcelMapperTest {
    private static final String TITLE = "Number";
    private ExcelMapper<Set<Long>> mapper;

    @BeforeEach
    void setUp() {
        mapper = setMapper(longMapper(TITLE));
    }
    ...
    void writeSingleValueTest() {
        ...
        mapper.write(sheetRange, Set.of(1L));
    ...
    void writeSeveralValueTest() {
        ...
        //ImmutableSet - для сохранения порядка
        mapper.write(sheetRange, ImmutableSet.of(1L, 2L, 3L));
    ...
    void writeEmptyListTest() {
        ...
        CantWriteEmptyException exception = assertThrows(CantWriteEmptyException.class, () ->
                mapper.write(sheetRange, Set.of())
        );
        assertThat(exception, hasProperty("columns", equalTo(List.of(TITLE))));
    }
    ...
    void writeNullItemTest() {
        ...
        CantWriteEmptyException exception = assertThrows(CantWriteEmptyException.class, () ->
                mapper.write(sheetRange, Collections.singleton(null))
        );
        assertThat(exception, hasProperty("columns", equalTo(List.of(TITLE))));
    }
    ...
    void readSingleValueTest() {
        ...
        Set<Long> value = mapper.read(sheetRange).getValue();

        assertThat(value, equalTo(Set.of(2L)));
    }
    ...
    void readSeveralValueTest() {
        ...
        assertThat(value, equalTo(Set.of(1L, 2L, 3L)));
    }
