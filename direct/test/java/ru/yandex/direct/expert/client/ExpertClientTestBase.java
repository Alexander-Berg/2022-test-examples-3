...
public abstract class ExpertClientTestBase {
    static final String TICKET_BODY = "ticketBody";

    private final static Logger logger = LoggerFactory.getLogger(ExpertClientTestBase.class);
    ...
    public void setUp() throws IOException {
        ...
        expertClient = new ExpertClient(url(), TvmService.DUMMY, parallelFetcherFactory, tvmIntegration);
    }
