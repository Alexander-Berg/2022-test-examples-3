...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestUpdateLog.status'
        db.add_column('testupdate_testupdatelog', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'TestUpdateLog.status'
        db.delete_column('testupdate_testupdatelog', 'status')
