...
class TextBannerModerationRepositoryHrefParamsTest @Autowired constructor(
    private val steps: Steps,
    private val textBannerModerationRepository: TextBannerModerationRepository,
    ...
    fun `build banner href with campaign params`() {
        ...
        val bannerForModeration = textBannerModerationRepository.loadObjectForModeration(
