describe('b-banner-preview2_view_mobile-content-edit', function() {
    var sandbox,
        model,
        block;
    ...
    beforeEach(function() {
        ...
        block = u.getInitedBlock({
            ...
            mods: { type: 'mobile-content', view: 'mobile-content-edit' },
            data: model.toJSON(),
            modelsParams: {
            ...
            describe('b-banner-preview2__' + elemName, function() {
                describe('Настройки flagsSettings переопределяются корректно', function() {
                    [
                        ...
                        it(JSON.stringify(settings) + ' = ' + JSON.stringify(result), function() {
                            model.update({
                                flagsSettings: {
                                    age: settings,
                                    other: settings
                            ...
                            expect(adWarningsBlock.params.can).to.eql(result);
                        });
                    });
                });
            });
