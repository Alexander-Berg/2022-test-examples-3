(function(global) {
    ...
    u.register({
        ...
        /**
         * Возвращает стаб константы SCRIPT_OBJECT
         * @return {{protocol: string, host: string, path: string}}
         */
        getScriptObjectForStub: function() {
            return {
                protocol: 'http',
        ...
        /**
         * Стабит параметры dm
         * @param {Function} stub - уже готовые стабы констант
         */
        stubDMParams: function(stub) {
            (stub || sinon.stub(u, 'consts'))
                .withArgs('dmParams').returns(constsStubs.dmParams)
        ...
        /**
         * Используйте stubCurrencies2 вместо stubCurrencies, чтобы добавлять стабы в sandbox, а не глобально
         *
         * @example
         *
         *   before(function() {
         ...
         *           .withArgs('PRICE_PLACES').returns(window.CONSTS.PRICE_PLACES);
         *   });
         *
         *   after(function() {
         *       sandbox.restore();
         ...
         */
        stubCurrencies2: function(sandbox) {
            var constStub = sandbox.stub(u, 'consts');

            constStub.withArgs('currencies').returns(constsStubs.currencies);
            constStub.withArgs('fixed_currency_rates').returns({
                YND_FIXED: {
                    KZT: {
                        0: {
                            without_nds: 100,
            ...
            constStub.withArgs('pseudo_currency').returns({
                rate: 30,
                name: 'руб.',
                id: 'rub'
            });
