...
public class IntapiConstants {
    ...
    public static final String NOTIFY_ORDER_MONEY_IN_SUBJECT_TEXT = "Яндекс.Директ/Поступила оплата кампании N%d";
    ...
    public static final String NOTIFY_ORDER_MONEY_IN_FOR_WALLET_SUBJECT_TEXT =
            "Яндекс.Директ/Поступила оплата на счет логина %s в Яндекс.Директе";
    ...
    public static final String NOTIFY_ORDER_MONEY_IN_SMS_TEXT = "Директ: зачислен платеж %s на заказ  N%d.";
