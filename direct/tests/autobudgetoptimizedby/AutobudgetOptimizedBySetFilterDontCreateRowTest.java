...
import ru.yandex.autotests.directapi.logic.ppc.BidsPerformance;
...
public class AutobudgetOptimizedBySetFilterDontCreateRowTest {
    ...
    public void callSetOrderForCampaignWithoutRowInCampaignsPerformance() {
        ...
        BidsPerformance bidsPerformance =
                api.userSteps.getDBSteps().getBidsPerformanceSteps().getBidsPerformance(id, shard);
