...
@Aqua.Test(title = "NotifyOrder2 - валютный клиент (Беларусские рубли)")
...
@Description("Проверяем, что для Белорусских клиентов принимаются нотификации с ProductCurrency = '' | BYN")
@RunWith(Parameterized.class)
public class NotifyOrder2CurrencyBYClientTest {
    private static final String LOGIN = Logins.LOGIN_BYN;
    private static DarkSideSteps darkSideSteps = new DarkSideSteps();
    private Long campaignId;
    protected static LogSteps log = LogSteps.getLogger(NotifyOrder2CurrencyBYClientTest.class);
