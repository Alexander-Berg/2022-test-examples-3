 ...
 */
@Aqua.Test(title = "NotifyClient2 - недостаточный набор параметров")
@Tag(TagDictionary.RELEASE)
@Tag(TagDictionary.TRUNK)
@Features(FeatureNames.JSON_BALANCE_NOTIFY_CLIENT2)
@Issue("https://st.yandex-team.ru/DIRECT-37012")
public class NotifyClient2LackOfParametersTest {

    private static DarkSideSteps darkSideSteps = new DarkSideSteps();
    protected static LogSteps log = LogSteps.getLogger(NotifyClient2LackOfParametersTest.class);
    ...
    @Test
    public void notifyClientWithNoParameters() {
        log.info("Вызываем метод NotifyClient без параметров.");
        darkSideSteps.getBalanceClientNotifyClientJsonSteps().notifyClientExpectErrors(
                new NotifyClient2JSONRequest(),
                500, -32603, "ClientID cannot be null"
        );
    }
