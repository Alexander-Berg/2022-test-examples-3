...
@Aqua.Test
@Title("Тест статистики по всем кампаниям на логин в сетях")
@Features(TestFeatures.ALL_CAMPAIGNS_REPORT)
public class AllCampaignsLoginReportContextTest extends AllCampaignsLoginReportTestBase {

    @Test
    @Title("Тест статистики по всем кампаниям на логин в сетях")
    public void allCampaignsLoginReportContextTest() {
