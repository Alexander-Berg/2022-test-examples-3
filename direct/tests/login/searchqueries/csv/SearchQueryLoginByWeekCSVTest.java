...
@Title("Тест выгрузки в csv статистики по поисковым запросам (логин) по неделям")
public class SearchQueryLoginByWeekCSVTest extends SearchQueryLoginReportTestBase {
    @Override
    ...
    @Test
    @Title("тест статистики по поисковым запросам csv (логин) по неделям")
    public void searchQueryLoginReportByWeekCSVTest() {
        super.test();
    }
