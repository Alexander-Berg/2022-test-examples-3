...
@Title("Тест выгрузки в xls статистики по поисковым запросам (логин) с НДС")
public class SearchQueryLoginWithNdsXlsTest extends SearchQueryLoginReportTestBase {
    @Override
    ...
    @Test
    @Title("тест статистики по поисковым запросам xls (логин) с НДС")
    public void searchQueryLoginReportWithNdsXlsTest() {
        super.test();
    }
