...
@Title("Тест выгрузки в xls статистики по поисковым запросам (логин) по дням")
public class SearchQueryLoginByDayXlsTest extends SearchQueryLoginReportTestBase {
    @Override
    ...
    @Test
    @Title("тест статистики по поисковым запросам xls (логин) по дням")
    public void searchQueryLoginReportByDayXlsTest() {
        super.test();
    }
