...
@Title("Тест выгрузки в xls статистики по поисковым запросам (логин) по месяцам")
public class SearchQueryLoginByMonthXlsTest extends SearchQueryLoginReportTestBase {
    @Override
    ...
    @Test
    @Title("тест статистики по поисковым запросам xls (логин) по месяцам")
    public void searchQueryLoginReportByMonthXlsTest() {
        super.test();
    }
