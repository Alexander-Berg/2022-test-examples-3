package ru.yandex.autotests.direct.tests.login.mol.csv;
...
@Title("Тест выгрузки в csv МОЛ статистики с полным набором параметров")
public class MolCSVComplexRequest extends MolReportTestBase {
    ...
    @Title("Тест выгрузки в csv МОЛ статистики с полным набором параметров")
    @Test
    public void molCSVComplexRequestTest() {
        super.test();
    }

    @Override
    protected ShowStatRequest getRequest() {
        return getComplexRequest().withFileFormat(ReportFileFormat.CSV);
    }
}
