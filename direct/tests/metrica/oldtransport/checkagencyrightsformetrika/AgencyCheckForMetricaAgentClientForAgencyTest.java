 ...
 */
@Aqua.Test(title = "AgencyCheckForMetrica: представитель = агентство, клиент от другого представителя агентства")
@Tag(TagDictionary.RELEASE)
@Tag(TagDictionary.TRUNK)
@Features(FeatureNames.METRICA_AGENCY_CHECK_FOR_METRICA)
public class AgencyCheckForMetricaAgentClientForAgencyTest {
    DarkSideSteps darkSideSteps = new DarkSideSteps();

    @Test
    public void agencyCheckForMetricaAgentClientForAgencyTest() {
