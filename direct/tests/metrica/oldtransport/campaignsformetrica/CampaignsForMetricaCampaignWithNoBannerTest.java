 ...
 */
@Aqua.Test(title = "CampaignsForMetrica для кампании без баннера")
@Tag(TagDictionary.RELEASE)
@Tag(TagDictionary.TRUNK)
@Features(FeatureNames.METRICA_CAMPAIGNS_FOR_METRICA)
@RunWith(Parameterized.class)
public class CampaignsForMetricaCampaignWithNoBannerTest {
    ...
    @Test
    public void campaignsForMetricaCampaignWithNoBannerTest() {
