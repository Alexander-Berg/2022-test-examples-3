...
public class ExportRightsUidToCidTest {
    ...
    public static Collection strategies() {
        Object[][] data = new Object[][]{
                ...
                {"сервисируемый клиент, кампания создана супером",
                        Logins.SUPER_LOGIN, LOGIN_FOR_USD, Arrays.asList(), YesNoEnum.YES},
                {"сервисируемый клиент, кампания создана менеджером",
                        Logins.MANAGER_DEFAULT, LOGIN_FOR_USD, Arrays.asList(Uids.MANAGER_UID, Uids.TEAMLEADER_UID), YesNoEnum.YES},
                {"субклиент, на которого имеет права представитель агентства по работе с клиентами",
                        ...
                        Arrays.asList(Uids.MANAGER_UID, Uids.TEAMLEADER_UID, Uids.AGENCY_TMONEY_UID, Uids.AGENCY_TMONEY_REP_UID), YesNoEnum.YES},
                {"субклиент, на которого не имеет прав представитель агентства по работе с клиентами",
                        ...
                        Arrays.asList(Uids.MANAGER_UID, Uids.TEAMLEADER_UID, Uids.AGENCY_TMONEY_UID), YesNoEnum.YES},
                {"субклиент, у агентства которого есть представитель",
                        Logins.AGENCY_CAMPAIGNS, Logins.SUB_CLIENT_WITHOUT_EDIT_RIGHTS,
                        Arrays.asList(Uids.MANAGER_UID, Uids.TEAMLEADER_UID, Uids.AGENCY_CAMPAIGNS_UID, Uids.AGENCY_CAMPAIGNS_REP_UID), YesNoEnum.YES},
                {"at-direct-api-test, кампанию создает менеджер",
                        Logins.MANAGER_DEFAULT, Logins.CLIENT_FREE_YE_DEFAULT,
                        Arrays.asList(Uids.MANAGER_UID, Uids.AGENCY_DEFAULT_UID, Uids.TEAMLEADER_UID,
                                Uids.AGENCY_DEFAULT_UNLIMIT_REP_UID,
                                Uids.TRANSFER_MANAGER_UID, Uids.AGENCY_DEFAULT_ANOTHER_REP_UID), YesNoEnum.YES},
    ...
    public void getUidsByCid() {
        ...
        assertThat("вернулись правильные пары uid - cid", response.getUidCidPairs(), beanDiffer(expectedPairs));
    }
}
