 ...
 */
@Aqua.Test(title = "GetBannersPhrases")
@Tag(TagDictionary.RELEASE)
@Tag(TagDictionary.TRUNK)
@Features(FeatureNames.GET_BANNERS_PHRASES)
public class GetBannersPhrasesTest {
    static Logger log = LogManager.getLogger(GetBannersPhrasesTest.class);
    ...
    private static final String PHRASE_1 = "чай";
    private static final String PHRASE_2 = "кофе";
    ...
    public static void before() {
        ...
        Long pid1 = api.userSteps.adGroupsSteps().addDefaultGroup(cid);
        Long pid2 = api.userSteps.adGroupsSteps().addDefaultGroup(cid);
    ...
    public void getBannersPhrasesCorrectCid() {
        assertThat("У всех фраз в ответе должен быть cid из запроса",
                ...
                everyItem(having(on(GetBannersPhrasesResponse.Phrase.class).getCid(), equalTo(cid))));
    }
