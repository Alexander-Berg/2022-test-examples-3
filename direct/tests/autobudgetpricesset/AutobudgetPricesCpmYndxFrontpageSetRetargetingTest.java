...
import ru.yandex.autotests.directapi.logic.ppc.BidsRetargeting;
...
public class AutobudgetPricesCpmYndxFrontpageSetRetargetingTest {
    ...
    public void init() {
        ...
        List<BidsRetargeting> bids = API.userSteps.getDBSteps().getBidsRetargetingSteps()
                .getBidsRetargetingByPid(BigInteger.valueOf(pid), shard);
