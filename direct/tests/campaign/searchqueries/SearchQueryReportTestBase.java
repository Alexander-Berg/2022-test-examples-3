package ru.yandex.autotests.direct.tests.campaign.searchqueries;
...
public abstract class SearchQueryReportTestBase extends ReportBackToBackBase {
    ...
    private static final String ALL_SLICES = "sim_distance,search_query,adgroup,banner,contextcond_orig,"
            + "contexttype_orig,match_type,matched_phrase,page_group";

    private final String START_DATE = "2021-08-10";
    private final String END_DATE = "2021-08-30";
