...
@Aqua.Test
@Title("Тест статистики по регионам на поиске xls")
@Features(TestFeatures.BY_REGIONS_REPORT)
public class ByRegionsReportSearchTest extends ByRegionsReportTestBase {
    @Test
    @Title("Тест статистики по регионам на поиске xls")
    public void byRegionsReportSearchTest() {
