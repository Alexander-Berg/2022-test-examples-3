...
@Description("Проверка прав и шаблонов при запросе с operator_uid и creative_id")
@Issue("https://st.yandex-team.ru/DIRECT-43716")
@RunWith(Parameterized.class)
public class BsFrontAuthWithOperatorAndCreativeTest {
    ...
    public static Collection strategies() {
        Object[][] data = new Object[][]{
                {"супер", Logins.SUPER_LOGIN, Logins.SUPER_LOGIN,
                        new ArrayList<String>(), new ArrayList<Integer>()},
                {"супер и креатив клиента", Logins.SUPER_LOGIN, Logins.CLIENT_FOR_RUB,
                        new ArrayList<String>(), new ArrayList<Integer>()},
                {"менеджер", Logins.MANAGER_DEFAULT, Logins.MANAGER_DEFAULT,
                        new ArrayList<String>(), new ArrayList<Integer>()},
                {"агентство", Logins.AGENCY_YE_DEFAULT, Logins.AGENCY_YE_DEFAULT,
                        new ArrayList<String>(), new ArrayList<Integer>()},
                {"клиент", Logins.CLIENT_FOR_RUB, Logins.CLIENT_FOR_RUB,
                        BsFrontAuthResponse.allActions, BsFrontAuthResponse.genericTemplates},
                {"клиент и чужой креатив", Logins.CLIENT_FOR_RUB, Logins.LOGIN_FOR_RUB,
                        new ArrayList<String>(), new ArrayList<Integer>()},
                {"сервисируемый клиент", Logins.LOGIN_FOR_RUB, Logins.LOGIN_FOR_RUB,
                        BsFrontAuthResponse.allActions, BsFrontAuthResponse.genericTemplates},
                {"легкий клиент", Logins.CLIENT_LIGHT, Logins.CLIENT_LIGHT,
                        BsFrontAuthResponse.allActions, BsFrontAuthResponse.genericTemplates},
                {"субклиент с правами редактирования", Logins.SUB_CLIENT_WITH_EDIT_RIGHTS,
                        Logins.SUB_CLIENT_WITH_EDIT_RIGHTS,
                        BsFrontAuthResponse.allActions, BsFrontAuthResponse.genericTemplates},
                {"субклиент с правами редактирования и чужой креатив", Logins.SUB_CLIENT_WITH_EDIT_RIGHTS,
    ...
    public void callBsFront() {
        ...
        bsFrontAuthResponse =
                api.userSteps.getDarkSideSteps().getBsFrontSteps().auth(
                        new BsFrontRequest().withOperatorUid(uid).withCreativeId(creativeId));
    }
