...
@Aqua.Test
@Description("metrika/retargeting-goals")
...
@Tag("DIRECT-64729")
@Issue("DIRECT-64729")
public class MetrikaGetGoalsTest {
    ...
    @Before
    public void setUp() {
        results = directRule.intapiSteps().metrikaControllerSteps().getRetargetingGoals(GOAL_DIVISOR, 0L);
    }
