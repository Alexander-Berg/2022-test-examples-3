...
public class DeleteRetargetingCondition {
    ...
    @Test
    public void canDeleteRetargetingCondition() {
        boolean result =
                directRule.webApiSteps().retargetingSteps()
                        .deleteRetargetingCondition(Collections.singletonList(retargetingConditionRule.getRetCondId()),
