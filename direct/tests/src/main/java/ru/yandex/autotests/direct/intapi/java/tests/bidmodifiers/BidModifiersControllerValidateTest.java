...
public class BidModifiersControllerValidateTest {
    ...
    private static BidModifierControllerSteps bidModifierControllerSteps;
    ...
    public void validate_InvalidRequest_FailedValidate() {
        ...
        IntapiValidationResponse response = bidModifierControllerSteps.validate(clientId, "cpm_banner", request);
