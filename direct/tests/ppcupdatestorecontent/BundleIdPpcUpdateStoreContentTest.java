...
@Description("ppcUpdateStoreContent.pl обновление bundle_id")
@RunWith(Parameterized.class)
public class BundleIdPpcUpdateStoreContentTest extends BasePpcUpdateStoreContentTest {
    @Override
    protected String getLogin() {
        return "at-direct-upd-store-bundle";
    }

    @Parameterized.Parameter(0)
    public String bundleId;

    @Parameterized.Parameters(name = "bundleId = {0}")
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"ru.yandex.autotests.new.bundle.id"}
                , {null}
    ...
    public void test() {
        ...
        assertThat("поле bundle_id заполнилось верно", mobileContent.getBundleId(), equalTo(bundleId));
    }
}
