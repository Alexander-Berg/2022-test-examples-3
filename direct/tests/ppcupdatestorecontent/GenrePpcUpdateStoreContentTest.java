...
@Description("ppcUpdateStoreContent.pl обновление genre")
public class GenrePpcUpdateStoreContentTest extends BasePpcUpdateStoreContentTest {
    @Override
    protected String getLogin() {
        return "at-direct-upd-store-genre";
    }

    private static final String GENRE = "AWESOMEGENRE";
    ...
    public void test() {
        ...
        assertThat("поле genre заполнилось верно", mobileContent.getGenre(), equalTo(GENRE));
    }
}
