...
@Description("Сумма на кошельке выше установленного минимума")
@Issue("https://st.yandex-team.ru/DIRECT-52054")

public class PpcProcessAutoPaymentsWIthMuchMoneyOnAccountTest {
    private static final String LOGIN = Logins.AUTOPAY_LOGIN16;
    ...
    public void before() {
        dbSteps.walletCampaignsSteps().updateWalletCampaigns(
                dbSteps.walletCampaignsSteps().getWalletCampaigns(walletCid)
                        ...
                        .setTotalSum(PAY_SUM.add(BigDecimal.ONE))
        );
    ...
    public void testNoWalletPaymentTransactions() {
        ...
        assumeThat("запрос на автопополнение не отправлен", walletPaymentTransactionsRecords
                , iterableWithSize(0));
    }
