...
@Description("Проверка подсчета товаров по категориям")
@Issue("https://st.yandex-team.ru/DIRECT-43907")
@RunWith(Parameterized.class)
public class BmapiCategoryIdInResponseTest {
    @ClassRule
    ...
    public ItemOfCategoryId[] itemOfCategoryIds;
    ...
    public static Collection feeds() {
        Object[][] data = new Object[][]{
                {"one offer without categoryId",
                        new Offers()
                                .withOffers(new Offer()
                                .withName(OFFER_NAME)
                                .withVendor(VENDOR_NAME1)
                        ),
                        new ItemOfCategoryId[]{new ItemOfCategoryId("", 1)}, 1},
                {"one offer with categoryId",
                        new Offers()
                                .withOffers(new Offer()
                                .withName(OFFER_NAME)
                                .withVendor(VENDOR_NAME1)
                        ...
                        new ItemOfCategoryId[]{new ItemOfCategoryId(CATEGORY_ID1, 1)}, 1},
                {"two offers without categoryIds",
                        new Offers()
                                .withOffers(new Offer()
                                        .withName(OFFER_NAME)
                                        .withVendor(VENDOR_NAME1),
                        ...
                        new ItemOfCategoryId[]{new ItemOfCategoryId("", 2)}, 2},
                {"two offers with same categoryId",
                        new Offers()
                                .withOffers(new Offer()
                                        .withName(OFFER_NAME)
                                        .withVendor(VENDOR_NAME1)
                        ...
                        new ItemOfCategoryId[]{new ItemOfCategoryId(CATEGORY_ID1, 2)}, 2},
                {"first offer without categoryId, second offer with categoryId",
                        new Offers()
                                .withOffers(new Offer()
                                        .withName(OFFER_NAME)
                                        .withVendor(VENDOR_NAME1),
                        ...
                        new ItemOfCategoryId[]{
                                new ItemOfCategoryId("", 1),
                                new ItemOfCategoryId(CATEGORY_ID1, 1)
                        }, 2},
                {"two offers with different categoryIds",
                        new Offers()
                                .withOffers(new Offer()
                                        .withName(OFFER_NAME)
                                        .withVendor(VENDOR_NAME1)
                        ...
                        new ItemOfCategoryId[]{
                                new ItemOfCategoryId(CATEGORY_ID1, 1),
                                new ItemOfCategoryId(CATEGORY_ID2, 1)
                        }, 2}
        };
    ...
    public void checkBmapiResponse() {
        ...
        BmapiResponse expectedResponse = new BmapiResponse()
                .withVendor(new ItemOfVendor(VENDOR_NAME1, amountOfOffers))
                .withEmptyErrors()
                .withEmptyWarnings()
                .withCategs(
                ...
                .withAllElementsAmount(amountOfOffers);

        ItemOfCategoryId[] expectedItemOfCategoryIds = Arrays.stream(itemOfCategoryIds)
                .filter(itemOfCategoryId -> !itemOfCategoryId.getId().isEmpty())
                .collect(Collectors.toList())
                .toArray(new ItemOfCategoryId[0]);
        // в ответе ожидаем только категории с id
        if (expectedItemOfCategoryIds.length > 0) {
            expectedResponse.withCategoryId(expectedItemOfCategoryIds);
        }
