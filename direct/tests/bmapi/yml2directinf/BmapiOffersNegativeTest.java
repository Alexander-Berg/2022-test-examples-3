...
@Description("Фид с неправильными офферами")
@Issue("https://st.yandex-team.ru/DIRECT-43907")
@RunWith(Parameterized.class)
public class BmapiOffersNegativeTest {
    @ClassRule
    ...
    public static Collection feeds() {
        Object[][] data = new Object[][]{
                {"empty array of offers", new Offers(), Error.NO_OFFERS},
                {"without offers", null, Error.NO_OFFERS},//ToDO пока здесь неправильный код
                {"offer without name", new Offers()
                        .withOffers(new Offer()
                        .withVendor(VENDOR_NAME1)
                        .withCategoryId(CATEGORY_ID1)
                ), Error.NO_MODEL_OR_NAME},
        };
