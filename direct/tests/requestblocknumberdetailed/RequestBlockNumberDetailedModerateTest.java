...
@Description("Проверка корректного подсчёта объектов в кампании с промодерированным объявлением.")
public class RequestBlockNumberDetailedModerateTest {
    protected static LogSteps log = LogSteps.getLogger(RequestBlockNumberDetailedModerateTest.class);
    ...
    public static void prepareTestData() {
        ...
        log.info("Одно из объявлений сделаем промодерированным.");
        api.userSteps.bannersFakeSteps().setBannerFakeStatusModerate(firstAdId, Status.READY);
        response =
    ...
    public void checkDetails() {
        ...
        expectedResponse.setModerateBlock("1");
        expectedResponse.setModerateRequest("3");
        expectedResponse.setModerateGroup("1");
        expectedResponse.setActiveBlock("0");
        expectedResponse.setArchiveBlock("0");
        expectedResponse.setDraftBlock("1");
