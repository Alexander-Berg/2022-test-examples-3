...
@Description("Проверка корректного подсчёта объектов в кампании с активным объявлением.")
public class RequestBlockNumberDetailedActiveTest {
    protected static LogSteps log = LogSteps.getLogger(RequestBlockNumberDetailedActiveTest.class);
    ...
    public static void prepareTestData() {
        ...
        log.info("Одно из объявлений сделаем активным.");
    ...
    public void checkDetails() {
        ...
        expectedResponse.setActiveBlock("1");
        expectedResponse.setActiveRequest("3");
        expectedResponse.setActiveGroup("1");
