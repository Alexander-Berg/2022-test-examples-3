...
@Aqua.Test
@Description("Проверка статусов синхронизации при добавлении фраз в группу текстовой кампании со страницы статистики cmd_ajaxUpdateShowConditions")
...
@Tag(TrunkTag.YES)
public class SyncStatusesAddPhrasesTextCampAjaxUpdateShowCondTest extends SyncStatusesAddPhrasesAjaxUpdateShowCondTestBase {
    @Override
