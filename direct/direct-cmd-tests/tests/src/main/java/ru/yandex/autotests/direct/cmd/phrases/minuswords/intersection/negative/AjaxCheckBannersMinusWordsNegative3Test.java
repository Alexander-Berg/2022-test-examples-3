...
public class AjaxCheckBannersMinusWordsNegative3Test  extends AjaxCheckMinusWordsNegativeBase {
    ...
    public static Collection<Object[]> testData() {
        return Arrays.asList(new Object[][]{
                ...
                {"\"решетка для !камина\"", "камин"},
                {"\"решетка для !камина\"", "+камина"},
                {"\"решетка для !камина\"", "!камина"},
                {"\"решетка для !камина\"", "[камин]"},
                {"\"решетка для !камина\"", "[!камина]"},
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("10733")
