...
// TESTIRT-8758
@Aqua.Test
@Description("Сохранение запрещенных площадок и ssp-платформ при редактировании кампании")
...
public class DontShowParamAtSaveCampTest {
    ...
    public DontShowParamAtSaveCampTest(CampaignTypeEnum campType, String dontShow, String[] expectedDontShow) {
        this.dontShow = dontShow;
        this.expectedDontShow = expectedDontShow;
        bannersRule = BannersRuleFactory.getBannersRuleBuilderByCampType(campType).withUlogin(CLIENT);
    ...
    public static Collection<Object[]> testData() {
        return Arrays.asList(new Object[][]{
                ...
                // площадка со спец символами
                {CampaignTypeEnum.TEXT, "ru.bestfeeds.pro.vk-feed &#34;", new String[]{"ru.bestfeeds.pro.vk-feed"}},
                {CampaignTypeEnum.TEXT, "ru.bestfeeds.pro.vk-feed &#34;,ru.bestfeeds.pro.vk-feed", new String[]{"ru.bestfeeds.pro.vk-feed"}},
                // 1 площадка
    ...
    @Test
    @Description("Сохранение запрещенных площадок и ssp-платформ при редактировании кампании")
    @ru.yandex.qatools.allure.annotations.TestCaseId("9551")
    public void testDontShowParamAtSaveCamp() {
    ...
    private SaveCampRequest getSaveCampRequest() {
        SaveCampRequest request = bannersRule.getSaveCampRequest().withMobileAppId(null);
