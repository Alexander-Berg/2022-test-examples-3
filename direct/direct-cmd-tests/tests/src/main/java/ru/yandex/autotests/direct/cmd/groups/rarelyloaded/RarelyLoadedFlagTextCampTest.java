...
@Description("Проверка флага мало показов в текстовой кампании")
@Tag(CmdTag.SHOW_CAMP)
@Tag(CmdTag.SHOW_CAMP_MULTI_EDIT)
@Tag(CampTypeTag.TEXT)
@Tag(TrunkTag.YES)
public class RarelyLoadedFlagTextCampTest extends RarelyLoadedFlagTestBase {
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10694")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10693")
