...
@Aqua.Test
@Description("Позитивные сценарии загрузки картинки для баннера по ссылке (cmd uploadBannerImage)")
...
public class UploadBannerImageFromUrlValidTest extends BaseUploadBannerImageTest {
...
//                {GIF, 450, 450}
    ...
    @Test
    @Description("Загрузка правильной картинки для баннера по урлу (cmd uploadBannerImage)")
    @ru.yandex.qatools.allure.annotations.TestCaseId("9890")
    public void testValidUploadImageByUrl() {
        super.test();
    }
