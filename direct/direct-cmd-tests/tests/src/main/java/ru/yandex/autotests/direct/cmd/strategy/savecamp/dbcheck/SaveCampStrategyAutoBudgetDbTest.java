...
@Aqua.Test
@Description("Проверка сохранения стратегии autobudget в бд")
...
public class SaveCampStrategyAutoBudgetDbTest extends SaveCampStrategyDbTestBase {
    ...
    protected CampaignsRecord getExpectedCampaignDb() {
        ...
        return new CampaignsRecord()
                .setStrategyName(CampaignsStrategyName.autobudget)
