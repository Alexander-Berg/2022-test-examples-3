...
public class AjaxCheckBannersMinusPhrasesNegative1Test extends AjaxCheckMinusPhrasesNegativeBase {

    @Parameterized.Parameters(name = "Должно появиться предупреждение при пересечение КС {0} и МФ {1}:")
    public static Collection<Object[]> testData() {
        return Arrays.asList(new Object[][]{
                {"цветы в горшках недорого", "цветы недорого"},
                {"цветы в горшках недорого", "цветы горшок недорого"},
                ...
                {"цветы +в горшках", "цветы +в горшках"},
                {"цветы +в горшках", "цветы [в] горшках"},
                {"цветы +в горшках", "цветы в"},
                {"цветы +в горшках", "цветы +в"},
                {"цветы +в горшках", "цветы !в"},
                {"цветы +в горшках", "цветы +в горшке"},

                {"+в горшках цветы", "в горшках цветы"},
                {"+в горшках цветы", "!в горшках цветы"},
                {"+в горшках цветы", "+в горшках цветы"},
                {"+в горшках цветы", "[в] горшках цветы"},
                {"+в горшках цветы", "в горшках"},
                {"+в горшках цветы", "+в горшках"},
                {"+в горшках цветы", "!в горшках"},
                ...
                {"одежда +и обувь +для мужчины", "одежда обувь мужчины"},
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("10703")
