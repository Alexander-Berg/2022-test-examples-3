...
public class AfterSimpleVcardGroupChangeStatusModerateNoTest extends AfterSimpleVcardStatusModerateTestBase {

    private Group expectedGroup;

    public AfterSimpleVcardGroupChangeStatusModerateNoTest(CampaignTypeEnum campaignType) {
        super(campaignType);
    }
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10754")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10755")
