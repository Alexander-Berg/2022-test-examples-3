...
public class AjaxCheckBannersMinusPhrasesNegative2Test  extends AjaxCheckMinusPhrasesNegativeBase {
    ...
    public static Collection<Object[]> testData() {
        return Arrays.asList(new Object[][]{
                ...
                {"купить !цветы розы", "купить !цветы"},
                {"купить !цветы розы", "купить цветок"},
                ...
                //+ и !
                {"!купить цветы +в горшках", "купить цветы в горшках"},
                {"!купить цветы +в горшках", "!купить цветы в горшках"},
                {"!купить цветы +в горшках", "купить цветы +в горшках"},
                {"!купить цветы +в горшках", "!купить цветы +в горшках"},
                {"!купить цветы +в горшках", "купить цветы !в горшках"},
                {"!купить цветы +в горшках", "!купить цветы !в горшках"},
                {"!купить цветы +в горшках", "!купить +в горшках"},
                {"!купить цветы +в горшках", "!купить [в] горшках"},
                {"!купить цветы +в горшках", "!купить цветок +в горшок"},
        });
    }

    @Test
    @Description("Предупреждение при пересечение ключевых слов и минус-фразы на странице группы")
    @ru.yandex.qatools.allure.annotations.TestCaseId("10704")
