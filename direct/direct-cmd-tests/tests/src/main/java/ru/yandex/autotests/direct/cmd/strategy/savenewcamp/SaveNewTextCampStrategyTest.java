...
@Aqua.Test
@Description("Проверка сохранения стратегий для контроллера saveNewCamp (текстовая кампания)")
...
public class SaveNewTextCampStrategyTest extends SaveNewCampStrategyTestBase {

    public SaveNewTextCampStrategyTest(Strategies strategy) {
        super(strategy);
    }
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10028")
