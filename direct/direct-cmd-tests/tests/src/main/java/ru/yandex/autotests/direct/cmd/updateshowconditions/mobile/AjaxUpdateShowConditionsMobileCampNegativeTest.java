...
import ru.yandex.autotests.direct.cmd.updateshowconditions.base.AjaxUpdateShowConditionsNegativeTestBase;
...
@Aqua.Test
@Description("Ошибки при добавлении фраз в группу мобильной кампании со страницы статистики cmd_ajaxUpdateShowConditions")
...
public class AjaxUpdateShowConditionsMobileCampNegativeTest extends AjaxUpdateShowConditionsNegativeTestBase {
    @Override
