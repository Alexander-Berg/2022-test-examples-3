...
@Tag(TrunkTag.YES)
public class ChangeImageBannerXlsMobileAppCampTest extends ChangeImageBannerXlsTestBase {
    private static final String NEW_TRACKING_HREF = AppMetricaHrefs.HREF_ONE;

    public ChangeImageBannerXlsMobileAppCampTest() {
        super(CampaignTypeEnum.MOBILE);
    }

    @Test
    @Description("Изменение трекинговой ссылки ГО баннера в группе через excel")
    @ru.yandex.qatools.allure.annotations.TestCaseId("9709")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("9708")
    public void changeImageViaXls() {
        super.changeImageViaXls();
    }
}
