...
public class CopyDtoGroupModerationTest extends CopyGroupStatusModerateBaseTest {
    ...
    public CopyDtoGroupModerationTest() {
        bannerRule = new DynamicBannersRule().withUlogin(CLIENT);
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("9770")
