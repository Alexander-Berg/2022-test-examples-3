 ...
 */
@Aqua.Test
@Description("Переотправка динамических баннеров на модерацию с флагом forex")
...
public class RemoderateForexDynamicBannerBaseTest extends ForexDynamicBannerBaseTest {
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9165")
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9166")
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9167")
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9168")
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9169")
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9170")
    ...
    @ru.yandex.qatools.allure.annotations.TestCaseId("9171")
