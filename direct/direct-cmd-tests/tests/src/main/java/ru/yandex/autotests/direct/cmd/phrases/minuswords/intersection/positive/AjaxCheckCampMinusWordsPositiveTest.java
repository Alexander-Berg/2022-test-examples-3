...
@Aqua.Test
@Description("Пересечения ключевых слов и минус слов в попапе на странице редактирования кампании")
...
public class AjaxCheckCampMinusWordsPositiveTest extends AjaxCheckMinusWordsPositiveBase {

    @Test
    @Description("Пересечение ключевых слов и минус слов на странице кампании")
    @ru.yandex.qatools.allure.annotations.TestCaseId("10738")
