...
@Aqua.Test
@Description("Проверка сохранения стратегии autobudget_avg_cpc_per_camp в бд")
...
public class SaveCampStrategyAutoBudgetAvgCpcPerCampDbTest extends SaveCampStrategyDbTestBase {
    ...
    protected CampaignsRecord getExpectedCampaignDb() {
        StrategyData strategyData = new StrategyData()
                .withName(CampaignsStrategyName.autobudget_avg_cpc_per_camp)
                .withAvgBid(AVG_BID)
                .withBid(BID)
                .withSum(SUM)
                .withVersion(1);
        return new CampaignsRecord()
                .setStrategyName(CampaignsStrategyName.autobudget_avg_cpc_per_camp)
