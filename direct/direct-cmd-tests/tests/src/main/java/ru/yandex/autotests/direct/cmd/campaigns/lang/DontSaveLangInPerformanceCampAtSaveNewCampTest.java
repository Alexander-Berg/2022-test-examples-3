...
@Aqua.Test
@Description("Не-сохранение параметра content_lang при создании перфоманс-кампании")
...
@Ignore
public class DontSaveLangInPerformanceCampAtSaveNewCampTest {
    ...
    private BannersRule bannersRule = new PerformanceBannersRule().
            overrideGroupTemplate(new Group().withGeo(Geo.AUSTRIA.toString())).
    ...
    @Test
    @Description("Не-сохранение параметра content_lang при создании перфоманс-кампании")
    @ru.yandex.qatools.allure.annotations.TestCaseId("9407")
    public void testNoCampLangSaveAtSaveNewCamp() {
