...
@Tag("TESTIRT-9435")
public class AfterVcardChangeStatusModerateSentTest extends AfterVcardStatusModerateTestBase {

    public AfterVcardChangeStatusModerateSentTest() {
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10769")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10770")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10771")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10772")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10773")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10774")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10775")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10776")
    ...
    @Test
    @Override
    @ru.yandex.qatools.allure.annotations.TestCaseId("10777")
