...
public enum AbSegmentMultiplierPctErrors implements ITextResource {
    ...
    AbSegmentMultiplierPctErrors(String value) {
        this.value = value;
    }
    ...
    public String getBundle() {
        return "backend.campaigns.AbSegmentMultiplierPctErrors";
    }
