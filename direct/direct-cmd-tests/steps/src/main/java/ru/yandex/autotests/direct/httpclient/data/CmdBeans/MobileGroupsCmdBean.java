 ...
 */
public class MobileGroupsCmdBean extends JsonStringTransformableCmdBean {
    private static final String GROUPS_PATH = "groups";

    @JsonPath(requestPath = GROUPS_PATH, responsePath = "/" + GROUPS_PATH)
    private List<MobileGroupCmdBean> groups;
    ...
    public List<MobileGroupCmdBean> getGroups() {
        return groups;
    }

    public void setGroups(List<MobileGroupCmdBean> groups) {
        this.groups = groups;
    }
}
