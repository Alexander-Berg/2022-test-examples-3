 ...
 *         Date: 25.11.14
 */
public class SaveCampSteps extends DirectBackEndSteps {

    @Step("Сохраняем кампанию")
    public DirectResponse saveCamp(CSRFToken token, SaveCampParameters params) {
        return execute(getRequestBuilder().post(CMD.SAVE_CAMP, token, params));
    }
}
