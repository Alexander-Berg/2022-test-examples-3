...
public enum MobileMultiplierPctGroupErrors implements ITextResource {
    ...
    MobileMultiplierPctGroupErrors(String value) {
        this.value = value;
    }
    ...
    public String getBundle() {
        return "backend.groups.MobileMultiplierPctErrors";
    }
