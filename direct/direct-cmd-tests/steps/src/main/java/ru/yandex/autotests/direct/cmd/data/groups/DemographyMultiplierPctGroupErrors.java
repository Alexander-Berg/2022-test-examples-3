...
public enum DemographyMultiplierPctGroupErrors implements ITextResource {
    NOT_AN_INT("100.1"),
    TOO_SHORT("-1"),
    TOO_LONG("1301"),
    ...
    DemographyMultiplierPctGroupErrors(String value) {
        this.value = value;
    }
    ...
    public String getBundle() {
        return "backend.groups.DemographyMultiplierPctErrors";
    }
