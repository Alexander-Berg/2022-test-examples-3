...
const Model = require(`models/draw/types/initials-eur`);
const certData = {
    service: 'direct',
    firstname: 'Наташа',
...
describe('Draw `initials-eur` model', () => {
    testBase(Model, certData);

    describe('`isSuitable`', () => {
        it('should return true if type is cert and not contain cjk symbols', () => {
        ...
        it('should return false if name contain cjk symbols', () => {
            const data = Object.assign({}, certData, {
                firstname: '璐瑶'
            });
            const certModel = new Model(data, 'png');
