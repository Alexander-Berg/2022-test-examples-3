...
from travel.avia.library.python.tester.initializer import reinit_db
from travel.avia.library.python.tester.transaction_context import enter_atomic, rollback_atomic
...
def pytest_pyfunc_call(pyfuncitem):
    ...
    if is_dbuser:
        ...
        patcher = mock.patch('travel.avia.library.python.common.utils.mysql_switcher.base.DatabaseWrapper.cursor', side_effect=side_effect)
        patcher.start()
