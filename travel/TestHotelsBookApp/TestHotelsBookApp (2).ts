...
import {TEST_OFFER_PARAMS} from './constants/testOfferParams';
...
export class TestHotelsBookApp {
    ...
    bookWithPromoCode(
        offerParams: IBookOfferRequestParams = TEST_OFFER_PARAMS,
    ): Promise<IBookResult> {
    ...
    async book(
        ...
        const discountedPriceAmount =
            await this.hotelsBookPage.priceInfo.totalPrice.getValue();
