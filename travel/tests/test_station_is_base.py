...
class TestStationIsBase(TestCase):
    ...
    def test_is_base_first(self):
        """ Если базовый автовокзал первый, то признаки выставлять не надо """
    ...
    def test_is_base_in_the_middle(self):
        """ Если базовый автовокзал в середине, то начиная с него признаки False """
    ...
    def test_is_base_last(self):
        """ Если базовый автовокзал последний, то признаки выставляем только ему """
