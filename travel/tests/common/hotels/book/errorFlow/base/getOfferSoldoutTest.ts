...
export async function getOfferSoldoutTest(
    ...
    // страница с сообщением "Все номера такого типа уже забронированы"
    ...
    // В самом низу блока об отеле расположены две кнопки: Начать новый поиск и Найти номера в отеле
    assert(
    ...
    await hotelPage.state.waitForLoadingFinished(30000);
}
