...
@mock.patch('travel.avia.library.python.common.models.currency.Currency.fetch_rates',
            return_value=('rates source', RATES))
@mock.patch('travel.avia.library.python.common.utils.currency_converter.ConverterCache.get_national_currency',
            side_effect=lambda national_version: NATIONAL_CURRENCIES[national_version])
@mock.patch('travel.avia.library.python.common.utils.currency_converter.ConverterCache.get_currency_geoid',
