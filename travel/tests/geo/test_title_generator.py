...
from travel.rasp.library.python.common23.tester.factories import create_settlement, create_station, create_country, create_thread
from travel.rasp.library.python.common23.models.core.geo.title_generator import (
    build_simple_title_common, build_default_title_common, TitleGenerator, generalize_point, DASH
)
...
def tests_build_default_title_common():
    ...
    assert TitleGenerator.L_title(title_dict, lang='ru') == 'Settlement from {} Station to'.format(DASH)
    ...
    assert TitleGenerator.L_title(title_dict, lang='ru') == 'Station from {} Station to'.format(DASH)
...
def test_title_generator_simple_case():
    ...
    assert generator.title == 'Settlement from {} Station to'.format(DASH)
