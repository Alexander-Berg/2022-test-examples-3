...
from common.tester.factories import create_route
from common.tester.mocks import set_setting

from route_search.by_number.models import RouteNumberIndex
from route_search.by_number.helpers import (get_t_type_ids, get_t_type_id, build_t_type_ids_list, get_search_result,
...
class TestHelpers(TestCase):
    ...
    def test_get_search_result(self):
        ...
        with mock.patch('route_search.by_number.helpers._find_numeric_routes') as m_num_r, \
                mock.patch('route_search.by_number.helpers._find_special_train_routes') as m_sp_r, \
                mock.patch('route_search.by_number.helpers._find_routes_by_wide_search') as m_wide_r:
            query = u'123'
    ...
    def test_find_special_train_routes(self):
        DeLuxeTrain.objects.create(title=u'de', numbers=u'11/12/15')
        query = u'de'
        ...
        query = u'delu'
        DeLuxeTrain.objects.create(title=u'deluxe', numbers=u'101/102')
    ...
    def test_old_sub_find_threads(self):
        query = u' 123 '
        with mock.patch('route_search.by_number.helpers.get_search_result') as m_search_result:
