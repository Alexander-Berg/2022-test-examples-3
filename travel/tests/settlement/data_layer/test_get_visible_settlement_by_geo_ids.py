...
from travel.rasp.morda_backend.morda_backend.settlement.data_layer.settlement import (
    get_visible_nearest_settlement_by_geo_ids
)
...
class TestGetVisibleSettlementByGeoIds(TestCase):
    ...
    def test_first_hidden_second_hidden_region_capital_found(self):
        ...
        with mock.patch('travel.rasp.morda_backend.morda_backend.settlement.data_layer.settlement.get_visible_region_capital',
    ...
    def test_first_hidden_second_hidden_region_capital_hidden_country_capital_found(self):
        ...
        with mock.patch('travel.rasp.morda_backend.morda_backend.settlement.data_layer.settlement.get_visible_region_capital') \
            as m_get_visible_region_capital, \
                mock.patch('travel.rasp.morda_backend.morda_backend.settlement.data_layer.settlement.get_visible_country_capital',
                           return_value=country_capital) as m_get_visible_country_capital:
    ...
    def test_first_hidden_second_hidden_region_capital_hidden_country_capital_hidden(self):
        ...
        with mock.patch('travel.rasp.morda_backend.morda_backend.settlement.data_layer.settlement.'
                        'get_visible_region_capital') as m_get_visible_region_capital, \
                mock.patch('travel.rasp.morda_backend.morda_backend.settlement.data_layer.settlement.get_visible_country_capital') \
                    as m_get_visible_country_capital:
