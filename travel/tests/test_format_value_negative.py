...
class TestCurrencyFormatValueNegative(TestCase):
    def setUp(self):
        self.rur = create_currency(name=u'рубли', code=u'RUR',
    ...
    def test_format_49_996(self, m_get_language):
    ...
    def test_format_50_004(self, m_get_language):
    ...
    def test_format_50_006(self, m_get_language):
    ...
    def test_format_100500100500_45(self, m_get_language):
        assert (self.rur.format_value(-10500100500.45, show_cents=True) ==
                u'-10{0}500{0}100{0}500 rub. 45 kop.'.format(NBSP))
