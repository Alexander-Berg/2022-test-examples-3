...
from travel.rasp.wizards.train_wizard_api.serialization.direction import load_query
from travel.rasp.wizards.train_wizard_api.serialization.open_direction import AUSTRIA_ID
...
def create_some_countries():
    COUNTRIES = {Country.UKRAINE_ID, AUSTRIA_ID}
...
@pytest.mark.parametrize('departure_country, expected_valid_departure', (
    (Country.RUSSIA_ID, True), ({}, False), (None, False), (Country.UKRAINE_ID, True), (AUSTRIA_ID, False),
))
