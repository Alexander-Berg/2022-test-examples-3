...
def get(path='/', version='HTTP/1.1', headers=None, data=''):
    """Create GET request
...
def raw_get(path='/', version='HTTP/1.1', headers=None, data=''):
...
def head(path='/', version='HTTP/1.1', headers=None, data=''):
    """Create HEAD request
...
def raw_head(path='/', version='HTTP/1.1', headers=None, data=''):
...
def trace(path='/', version='HTTP/1.1', headers=None, data=''):
...
def raw_trace(path='/', version='HTTP/1.1', headers=None, data=''):
...
def custom(method, path='/', version='HTTP/1.1', headers=None, data=''):
...
def raw_custom(method, path='/', version='HTTP/1.1', headers=None, data=''):
