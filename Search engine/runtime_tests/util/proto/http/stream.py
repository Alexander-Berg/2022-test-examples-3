...
from runtime_tests.util.proto.iface.message import RawMessageBuilder
import runtime_tests.util.proto.http.message as http_message
import runtime_tests.util.proto.iface.data as d
from runtime_tests.util.stream.io import stream, byte
...
class HTTPStream(object):
    ...
    def write_data(self, data):
        ...
        """
        if isinstance(data, d.PlainData):
