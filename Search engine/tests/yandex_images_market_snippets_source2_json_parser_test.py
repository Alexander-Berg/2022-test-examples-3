...
class TestYandexImagesMarketSnippetsSource2JSONParser(TestParser):
    ...
    def test_content(self):
        ...
        content_keys = ['text.title', 'text.source', 'text.snippet', 'componentUrl', 'imageCandidates', 'text.model_id']
